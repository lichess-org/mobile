...
class AppLocalizationsZh extends AppLocalizations {
  ...
  String arenaViewAllXTeams(int count) {
    String _temp0 = intl.Intl.pluralLogic(count, locale: localeName, other: '查看所有$count团队');
    return '$_temp0';
  }
  ...
  String get studyFromFenStringText =>
      '粘贴一个局面的FEN代码<br><i>4k3/4rb2/8/7p/8/5Q2/1PP5/1K6 w</i><br>来从这个局面开始章节';
  ...
  String get studyFromPgnGameText =>
      '粘贴一局棋的PGN代码<br><i>4k3/4rb2/8/7p/8/5Q2/1PP5/1K6 w</i><br>在章节中导入所有的棋步，注释和变招。';
