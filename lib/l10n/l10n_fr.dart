...
class AppLocalizationsFr extends AppLocalizations {
  ...
  String activitySupportedNbMonths(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'A soutenu lichess.org pendant $count mois en tant que $param2',
    );
    return '$_temp0';
  }
  ...
  String activityPracticedNbPositions(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'A pratiqué $count position de $param2',
    );
    return '$_temp0';
  }
  ...
  String activitySolvedNbPuzzles(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'A résolu $count problème tactique',
    );
    return '$_temp0';
  }
  ...
  String activityPlayedNbGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'A joué $count partie de $param2',
    );
    return '$_temp0';
  }
  ...
  String activityPostedNbMessages(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'A posté $count message dans $param2',
    );
    return '$_temp0';
  }
  ...
  String activityInNbCorrespondenceGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'dans $count partie par correspondance',
    );
    return '$_temp0';
  }
  ...
  String activityCompletedNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count partie par correspondance terminée',
    );
    return '$_temp0';
  }
  ...
  String activityFollowedNbPlayers(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'A commencé à suivre $count joueur',
    );
    return '$_temp0';
  }
  ...
  String activityGainedNbFollowers(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'A gagné $count nouveau suiveur',
    );
    return '$_temp0';
  }
  ...
  String activityHostedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'A hébergé $count simultanée',
    );
    return '$_temp0';
  }
  ...
  String activityJoinedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'A participé à $count simultanée(s)',
    );
    return '$_temp0';
  }
  ...
  String activityCreatedNbStudies(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'A créé $count nouvelle étude',
    );
    return '$_temp0';
  }
  ...
  String activityCompetedInNbTournaments(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'A participé à $count tournoi',
    );
    return '$_temp0';
  }
  ...
  String activityRankedInTournament(int count, String param2, String param3, String param4) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Classé #$count (pourcentage: $param2%) avec $param3 partie en $param4',
    );
    return '$_temp0';
  }
  ...
  String activityCompetedInNbSwissTournaments(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'A participé à $count tournoi(s) suisse(s)',
    );
    return '$_temp0';
  }
  ...
  @override
  String get recommendNotTouching => 'Nous recommandons de ne pas modifier cela.';

  @override
  String get fewerPlayers => 'Si vous définissez des conditions d\'admission, votre tournoi aura moins de joueurs.';
  ...
  @override
  String get insult => 'Insulte';

  @override
  String get troll => 'Troll';

  @override
  String get ratingManipulation => 'Manipulation du classement';
  ...
  @override
  String get boardGeometry => 'Forme de l\'échiquier';

  @override
  String get boardTheme => 'Thème de l\'échiquier';

  @override
  String get boardSize => 'Taille de l\'échiquier';
  ...
  String opponentLeftCounter(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Votre adversaire a quitté la partie. Vous pourrez revendiquer la victoire dans $count seconde.',
    );
    return '$_temp0';
  }
  ...
  String ratingXOverYGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Classement $count après $param2 partie',
    );
    return '$_temp0';
  }
  ...
  String moreThanNbPerfRatedGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '≥ $count partie de $param2 classée',
    );
    return '$_temp0';
  }
  ...
  String needNbMorePerfGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Vous devez encore jouer $count partie de $param2 classée',
    );
    return '$_temp0';
  }
  ...
  String needNbMoreGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Vous devez encore jouer $count partie classée',
    );
    return '$_temp0';
  }
  ...
  String nbPerfTypePlayersThisWeek(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count joueur de $param2 cette semaine.',
    );
    return '$_temp0';
  }
  ...
  String availableInNbLanguages(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Disponible en $count langue !',
    );
    return '$_temp0';
  }
  ...
  String nbSecondsToPlayTheFirstMove(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count seconde pour jouer le premier coup',
    );
    return '$_temp0';
  }
  ...
  String andSaveNbPremoveLines(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'et enregistrer $count variante de précoups',
    );
    return '$_temp0';
  }
  ...
  @override
  String get preferencesSayGgWpAfterLosingOrDrawing => 'Dire \"Good game, well played\" c.-à.-d. \"Bonne partie, bien joué\", en cas de défaite ou de nulle';
  ...
  String puzzleNbPointsBelowYourPuzzleRating(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Un point en dessous de votre classement de problème',
    );
    return '$_temp0';
  }
  ...
  String puzzleNbPointsAboveYourPuzzleRating(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Un point au dessus de votre classement de problème',
    );
    return '$_temp0';
  }
  ...
  @override
  String get searchAdvancedSearch => 'Recherche avancée';

  @override
  String get searchOpponentName => 'Nom de l\'adversaire';

  @override
  String get searchLoser => 'Perdant';

  @override
  String get searchFrom => 'De';

  @override
  String get searchTo => 'À';

  @override
  String get searchHumanOrComputer => 'Si l\'adversaire du joueur était humain ou ordinateur';

  @override
  String get searchAiLevel => 'Niveau de l\'IA';

  @override
  String get searchSource => 'Source';

  @override
  String get searchNbTurns => 'Nombre de coups';

  @override
  String get searchResult => 'Résultat';

  @override
  String get searchWinnerColor => 'Couleur du vainqueur';
  ...
  @override
  String get searchOnlyAnalysed => 'N\'afficher que les parties où l\'analyse de l\'ordinateur est disponible';

  @override
  String get searchColor => 'Couleur';

  @override
  String get searchEvaluation => 'Évaluation';

  @override
  String get searchMaxNumber => 'Nombre maximum';

  @override
  String get searchMaxNumberExplanation => 'Nombre maximum de parties à retourner';

  @override
  String get searchInclude => 'Inclus';

  @override
  String get searchDescending => 'Décroissant';

  @override
  String get searchAscending => 'Croissant';

  @override
  String get searchRatingExplanation => 'Classement moyen des deux joueurs';
  ...
  String searchSearchInXGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Rechercher dans $count parties d\'échecs',
      one: 'Rechercher dans $count partie d\'échecs',
      zero: 'Rechercher dans $count partie d\'échecs',
    );
    return '$_temp0';
  }
  ...
  String searchXGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count parties trouvées',
      one: 'Une partie trouvée',
      zero: 'Une partie trouvée',
    );
    return '$_temp0';
  }
  ...
  String searchGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other: '$count parties trouvées',
      one: '$count partie trouvée',
      zero: '$count partie trouvée',
    );
    return '$_temp0';
  }
  ...
  @override
  String get streamerLive => 'EN DIRECT !';

  @override
  String get streamerOffline => 'HORS LIGNE';

  @override
  String streamerCurrentlyStreaming(String param) {
    return 'En cours de streaming $param';
  }

  @override
  String streamerLastStream(String param) {
    return 'Dernière diffusion $param';
  }

  @override
  String get streamerBecomeStreamer => 'Devenir un streamer sur Lichess';

  @override
  String get streamerDoYouHaveStream => 'Avez-vous une chaîne Twitch ou YouTube ?';

  @override
  String get streamerHereWeGo => 'Allons-y !';

  @override
  String get streamerAllStreamers => 'Tous les streamers';

  @override
  String get streamerEditPage => 'Modifier votre page de streamer';

  @override
  String get streamerYourPage => 'Votre page de streamer';

  @override
  String get streamerDownloadKit => 'Téléchargez le kit streamer';

  @override
  String streamerXIsStreaming(String param) {
    return '$param est en train de streamer';
  }

  @override
  String get streamerRules => 'Règles de streaming';

  @override
  String get streamerRule1 => 'Incluez \"lichess.org\" dans votre titre de streaming lorsque vous streamez sur Lichess.';

  @override
  String get streamerRule2 => 'Retirez le mot-clé lorsque vous ne streamez pas à propos de Lichess.';

  @override
  String get streamerRule3 => 'Lichess détectera automatiquement votre stream et activera les avantages suivants :';

  @override
  String streamerRule4(String param) {
    return 'Lisez la $param pour assurer l\'esprit sportif pour tous pendant la diffusion.';
  }

  @override
  String get streamerStreamingFairplayFAQ => 'FAQ sur l\'esprit sportif pendant les diffusions';

  @override
  String get streamerPerks => 'Avantages du streaming avec le mot-clé';

  @override
  String get streamerPerk1 => 'Obtenez une flamboyante icône de streamer sur votre profil Lichess.';

  @override
  String get streamerPerk2 => 'Soyez remonté en haut de la liste des streamers.';

  @override
  String get streamerPerk3 => 'Notifier vos suiveurs sur Lichess.';

  @override
  String get streamerPerk4 => 'Montrez votre stream dans vos parties, tournois et études.';

  @override
  String get streamerApproved => 'Votre stream est approuvé.';

  @override
  String get streamerPendingReview => 'Votre stream est en cours de révision par les modérateurs.';

  @override
  String get streamerPleaseFillIn => 'Veuillez remplir vos informations de streamer et envoyer une photo.';

  @override
  String streamerWhenReady(String param) {
    return 'Lorsque vous êtes prêt à être listé en tant que streamer Lichess, $param';
  }

  @override
  String get streamerRequestReview => 'demander une revue par un modérateur';

  @override
  String get streamerStreamerLanguageSettings => 'La page de diffusion en continu de Lichess cible votre public avec la langue fournie par votre plateforme de diffusion. Définissez la langue par défaut pour vos diffusions dans l\'application ou le service que vous utilisez.';

  @override
  String get streamerTwitchUsername => 'Votre nom d\'utilisateur Twitch ou votre URL';

  @override
  String get streamerOptionalOrEmpty => 'Optionnel. Laisser vide si aucun';

  @override
  String get streamerYouTubeChannelId => 'ID de votre chaîne YouTube';

  @override
  String get streamerStreamerName => 'Votre nom de streamer sur Lichess';

  @override
  String get streamerVisibility => 'Visible sur la page des streamers';

  @override
  String get streamerWhenApproved => 'Lorsque approuvé par les modérateurs';

  @override
  String get streamerHeadline => 'Titre';

  @override
  String get streamerTellUsAboutTheStream => 'Décrivez votre stream en une phrase';

  @override
  String get streamerLongDescription => 'Description détaillée';

  @override
  String streamerXStreamerPicture(String param) {
    return '$param photo de streamer';
  }

  @override
  String get streamerChangePicture => 'Modifier/supprimer votre photo';

  @override
  String get streamerUploadPicture => 'Téléverser une image';

  @override
  String streamerMaxSize(String param) {
    return 'Taille max : $param';
  }
  ...
  String streamerKeepItShort(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Restez brief $count caractères max',
      one: 'Restez brief $count caractère max',
      zero: 'Restez brief $count caractère max',
    );
    return '$_temp0';
  }
  ...
  String stormPlayedNbRunsOfPuzzleStorm(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'A fait un essai de $param2',
    );
    return '$_temp0';
  }
  ...
  @override
  String get studyPleaseOnlyInvitePeopleYouKnow => 'Veuillez n\'inviter que des personnes que vous connaissez et qui souhaitent activement participer à cette étude.';
  ...
  @override
  String get studyCopyChapterPgnDescription => 'Copier le fichier PGN du chapitre dans le presse-papiers.';
  ...
  String studyPasteYourPgnTextHereUpToNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Collez votre texte PGN ici, jusqu\'à $count partie',
    );
    return '$_temp0';
  }
}
