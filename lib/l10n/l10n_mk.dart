...
class AppLocalizationsMk extends AppLocalizations {
  ...
  String get puzzleThemeSmotheredMateDescription =>
      'Мат зададен од коњ при кој кралот не може да се движи бидејќи го опкружуваат (односно задушуваат) сопствените фигури.';
  ...
  String get toInviteSomeoneToPlayGiveThisUrl =>
      'Споделете ја оваа адреса за да поканите некого на заедничка игра';
