...
class AppLocalizationsMk extends AppLocalizations {
  ...
  String activitySupportedNbMonths(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Ја поддржуваше lichess.org $count месец како $param2',
    );
    return '$_temp0';
  }
  ...
  String activityPracticedNbPositions(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Вежбаше $count позиција на $param2',
    );
    return '$_temp0';
  }
  ...
  String activitySolvedNbPuzzles(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Реши $count тактичка загатка',
    );
    return '$_temp0';
  }
  ...
  String activityPostedNbMessages(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Напиша $count порака во $param2',
    );
    return '$_temp0';
  }
  ...
  String activityCompletedNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Изигра $count дописна игра',
    );
    return '$_temp0';
  }
  ...
  String activityJoinedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Учествуваше во $count симултана партија',
    );
    return '$_temp0';
  }
  ...
  String activityCreatedNbStudies(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Создаде $count нова студија',
    );
    return '$_temp0';
  }
  ...
  String activityCompetedInNbTournaments(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Учествуваше во $count турнир',
    );
    return '$_temp0';
  }
  ...
  String activityRankedInTournament(int count, String param2, String param3, String param4) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Рангиран #$count (топ $param2%) со $param3 игра во $param4',
    );
    return '$_temp0';
  }
  ...
  String activityCompetedInNbSwissTournaments(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Се натпреварувал во $count швајцарски турнир',
    );
    return '$_temp0';
  }
  ...
  @override
  String get recommendNotTouching => 'Препорачуваме да не ги менувате овие поставки.';

  @override
  String get fewerPlayers => 'Ако поставите услови за влез, вашиот турнир ќе има помалку играчи.';

  @override
  String get showAdvancedSettings => 'Покажи ги напредните поставки';
  ...
  @override
  String get insult => 'Навреда';

  @override
  String get troll => 'Трол';

  @override
  String get ratingManipulation => 'Манипулација на рејтинг';
  ...
  @override
  String get boardGeometry => 'Геометрија на таблата';

  @override
  String get boardTheme => 'Тема на таблата';

  @override
  String get boardSize => 'Големина на таблата';
  ...
  String opponentLeftCounter(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Противникот ја напушти играта. Победувате за $count секунда.',
    );
    return '$_temp0';
  }
  ...
  String moreThanNbPerfRatedGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '≥ $count $param2 рангирана партија',
    );
    return '$_temp0';
  }
  ...
  String needNbMorePerfGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Мора да одиграте уште $count рангирана $param2 партија',
    );
    return '$_temp0';
  }
  ...
  String needNbMoreGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Мора да одиграте уште $count рангирана партија',
    );
    return '$_temp0';
  }
  ...
  String nbPerfTypePlayersThisWeek(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '„$param2“ има $count играч оваа седмица.',
    );
    return '$_temp0';
  }
  ...
  String nbSecondsToPlayTheFirstMove(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count секунда за првиот потег',
    );
    return '$_temp0';
  }
  ...
  String andSaveNbPremoveLines(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'и заштеди $count пред-потег',
    );
    return '$_temp0';
  }
  ...
  String puzzleNbPointsBelowYourPuzzleRating(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Еден поен под вашиот рејтинг',
    );
    return '$_temp0';
  }
  ...
  String puzzleNbPointsAboveYourPuzzleRating(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Еден поен над вашиот рејтинг',
    );
    return '$_temp0';
  }
  ...
  @override
  String get searchAdvancedSearch => 'Напредно пребарување';

  @override
  String get searchOpponentName => 'Име на противникот';
  ...
  @override
  String get searchHumanOrComputer => 'Покажува дали играчот е човек или компјутер';

  @override
  String get searchAiLevel => 'Ниво на В.И.';

  @override
  String get searchSource => 'Извор';

  @override
  String get searchNbTurns => 'Број на потези';

  @override
  String get searchResult => 'Резултат';

  @override
  String get searchWinnerColor => 'Победничка боја';
  ...
  @override
  String get searchOnlyAnalysed => 'Само партии со достапна компјутерска анализа';

  @override
  String get searchColor => 'Боја';

  @override
  String get searchEvaluation => 'Евалуација';

  @override
  String get searchMaxNumber => 'Максимален број';

  @override
  String get searchMaxNumberExplanation => 'Максимален број на игри да се вратат';

  @override
  String get searchInclude => 'Вклучено';

  @override
  String get searchDescending => 'Опаѓачки';

  @override
  String get searchAscending => 'Растечки';

  @override
  String get searchRatingExplanation => 'Просечен рејтинг на двајцата играчи';
  ...
  String searchSearchInXGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Пребарување во $count партии',
      one: 'Пребарување во $count партија',
      zero: 'Пребарување во $count партија',
    );
    return '$_temp0';
  }
  ...
  String searchXGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Пронајдени се $count партии',
      one: 'Пронајдена е една партија',
      zero: 'Пронајдена е една партија',
    );
    return '$_temp0';
  }
  ...
  String searchGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other: 'Пронајдени се $count партии',
      one: 'Пронајдена е $count партија',
      zero: 'Пронајдена е $count партија',
    );
    return '$_temp0';
  }
