...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get boardGeometry => '盤の表示形式';

  @override
  String get boardTheme => '盤のデザイン';

  @override
  String get boardSize => '盤のサイズ';
  ...
  @override
  String get searchAdvancedSearch => '高度な検索';

  @override
  String get searchOpponentName => '対戦相手名';

  @override
  String get searchLoser => '敗者';
  ...
  @override
  String get searchHumanOrComputer => '対戦相手が人間かコンピュータか';

  @override
  String get searchAiLevel => 'AI レベル';

  @override
  String get searchSource => '検索対象';

  @override
  String get searchNbTurns => '手数';

  @override
  String get searchResult => '結果';

  @override
  String get searchWinnerColor => '勝者の色';

  @override
  String get searchDate => '日付';

  @override
  String get searchSortBy => '並べ替え基準';

  @override
  String get searchAnalysis => '解析';

  @override
  String get searchOnlyAnalysed => 'コンピュータ解析のある棋譜だけが対象';

  @override
  String get searchColor => '色';

  @override
  String get searchEvaluation => '評価値';

  @override
  String get searchMaxNumber => '最大局数';

  @override
  String get searchMaxNumberExplanation => '表示するゲームの最大数';

  @override
  String get searchInclude => '含める';

  @override
  String get searchDescending => '降順';

  @override
  String get searchAscending => '昇順';

  @override
  String get searchRatingExplanation => '両プレイヤーのレーティング平均';
  ...
  @override
  String get streamerLichessStreamer => 'Lichess 配信者';

  @override
  String get streamerLive => 'ライブ配信中';

  @override
  String get streamerOffline => 'オフライン';
  ...
  @override
  String get streamerBecomeStreamer => 'Lichess の配信者になるには';

  @override
  String get streamerDoYouHaveStream => 'Twitch や YouTube の配信動画をお持ちですか？';

  @override
  String get streamerHereWeGo => 'やります！';

  @override
  String get streamerAllStreamers => 'すべての配信者';

  @override
  String get streamerEditPage => '配信者ページを編集';

  @override
  String get streamerYourPage => '自分の配信者ページ';

  @override
  String get streamerDownloadKit => '配信者用キットをダウンロード';
  ...
  @override
  String get streamerRules => '配信のルール';

  @override
  String get streamerRule1 => 'Lichess について配信する際にはタイトルにキーワード「lichess.org」を入れてください。';

  @override
  String get streamerRule2 => 'Lichess 以外について配信する際にはキーワードを入れないように。';

  @override
  String get streamerRule3 => 'Lichess はあなたの配信動画を自動的に検知して以下の特典を与えます。';

  @override
  String streamerRule4(String param) {
    return 'あなたの配信中に全員がフェアプレイを守れるよう $param を読んでおくこと。';
  }

  @override
  String get streamerStreamingFairplayFAQ => '配信フェアプレイ FAQ';

  @override
  String get streamerPerks => 'キーワードを入れた配信に対する特典';

  @override
  String get streamerPerk1 => 'Lichess のプロフィール・ページに配信者として表示。';

  @override
  String get streamerPerk2 => '配信者リストのトップに上がる。';

  @override
  String get streamerPerk3 => 'Lichess でのフォロワーに通知が行く。';

  @override
  String get streamerPerk4 => '対局・トーナメント・研究の中に配信動画を表示できる。';

  @override
  String get streamerApproved => '配信動画が承認されました。';

  @override
  String get streamerPendingReview => 'あなたの配信動画はモデレーターが審査中です。';

  @override
  String get streamerPleaseFillIn => '配信者としての情報を入力し、写真をアップロードしてください。';

  @override
  String streamerWhenReady(String param) {
    return 'Lichess 配信者登録の用意ができたら、$param';
  }

  @override
  String get streamerRequestReview => 'モデレーターによる審査を求めます';

  @override
  String get streamerStreamerLanguageSettings => 'Lichess の配信者ページは、配信プラットフォームで指定した言語の視聴者を対象にします。配信に使うアプリやサービスでデフォルト言語を正しく設定しておいてください。';

  @override
  String get streamerTwitchUsername => 'あなたの Twitch ユーザー名または URL';

  @override
  String get streamerOptionalOrEmpty => '任意。なければ空白';

  @override
  String get streamerYouTubeChannelId => 'あなたの YouTube チャンネル ID';

  @override
  String get streamerStreamerName => 'Lichess での配信者名';

  @override
  String get streamerVisibility => '配信者ページに表示';

  @override
  String get streamerWhenApproved => '（モデレーターに承認されれば）';

  @override
  String get streamerHeadline => '見出し';

  @override
  String get streamerTellUsAboutTheStream => '動画の内容を一行で説明してください';

  @override
  String get streamerLongDescription => '詳しい説明';
  ...
  @override
  String get streamerChangePicture => '写真の変更／削除';

  @override
  String get streamerUploadPicture => '写真をアップロード';
  ...
  @override
  String get studyCopyChapterPgnDescription => '章の PGN をクリップボードにコピーする。';
