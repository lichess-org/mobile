...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get preferencesNotifyBroadcasts => 'イベント中継';
  ...
  String get checkSpamOrJunkFolder =>
      '確認メールが届かない場合は迷惑メールフォルダを確認してください。重要な連絡を見逃さないように、Lichess からのメッセージを必ず「安全」「非スパム」などと指定しておいてください。';
  ...
  @override
  String get reopen => 'もう一度開く';

  @override
  String get quote => '引用する';

  @override
  String get postEdited => '編集済';
