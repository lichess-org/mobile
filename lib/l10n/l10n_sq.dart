...
class AppLocalizationsSq extends AppLocalizations {
  ...
  @override
  String get boardGeometry => 'Gjeometri fushe';

  @override
  String get boardTheme => 'Temë fushe';

  @override
  String get boardSize => 'Madhësi fushe';
  ...
  @override
  String get searchAdvancedSearch => 'Kërkim i avancuar';

  @override
  String get searchOpponentName => 'Emri i kundërshtarit';

  @override
  String get searchLoser => 'Humbës';

  @override
  String get searchFrom => 'Nga';

  @override
  String get searchTo => 'Deri më';

  @override
  String get searchHumanOrComputer => 'Nëse kundërshtari i lojtarit ishte njeri ose kompjuter';

  @override
  String get searchAiLevel => 'Nivel A.I';

  @override
  String get searchSource => 'Burim';

  @override
  String get searchNbTurns => 'Numër radhësh';

  @override
  String get searchResult => 'Përfundim';

  @override
  String get searchWinnerColor => 'Ngjyra e fituesit';

  @override
  String get searchDate => 'Data';

  @override
  String get searchSortBy => 'Renditi sipas';

  @override
  String get searchAnalysis => 'Analizë';

  @override
  String get searchOnlyAnalysed => 'Vetëm lojërat për të cilat ka analizim nga kompjuteri';

  @override
  String get searchColor => 'Ngjyrë';

  @override
  String get searchEvaluation => 'Vlerësim';

  @override
  String get searchMaxNumber => 'Numër maksimum';

  @override
  String get searchMaxNumberExplanation => 'Numri maksimum i lojërave si përgjigje';

  @override
  String get searchInclude => 'Përfshi';

  @override
  String get searchDescending => 'Zbritës';

  @override
  String get searchAscending => 'Rritës';

  @override
  String get searchRatingExplanation => 'Vlerësimi mesatar i të dy lojtarëve';
  ...
  String searchSearchInXGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Kërko në $count lojëra shahu',
      one: 'Kërko në $count lojë shahu',
      zero: 'Kërko në $count lojë shahu',
    );
    return '$_temp0';
  }
  ...
  String searchXGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'U gjetën $count lojëra',
      one: 'U gjet një lojë',
      zero: 'U gjet një lojë',
    );
    return '$_temp0';
  }
  ...
  String searchGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other: 'U gjetën $count lojëra',
      one: 'U gjet $count lojë',
      zero: 'U gjet $count lojë',
    );
    return '$_temp0';
  }
  ...
  @override
  String get streamerLichessStreamer => 'Transmetues Lichess';

  @override
  String get streamerLive => 'Drejtpërsëdrejti!';

  @override
  String get streamerOffline => 'Jashtë Linje';

  @override
  String streamerCurrentlyStreaming(String param) {
    return 'Tani po transmetohet: $param';
  }

  @override
  String streamerLastStream(String param) {
    return 'Transmetimi i fundit $param';
  }

  @override
  String get streamerBecomeStreamer => 'Bëhuni një transmetues në Lichess';

  @override
  String get streamerDoYouHaveStream => 'Keni një kanal Twitch ose YouTube?';

  @override
  String get streamerHereWeGo => 'Ja ku jemi!';

  @override
  String get streamerAllStreamers => 'Krejt transmetuesit';

  @override
  String get streamerEditPage => 'Përpunoni faqe transmetuesi';

  @override
  String get streamerYourPage => 'Faqja juaj e transmetuesit';

  @override
  String get streamerDownloadKit => 'Shkarkoni mjetet e transmetimit';

  @override
  String streamerXIsStreaming(String param) {
    return '$param po transmeton';
  }

  @override
  String get streamerRules => 'Rregulla transmetimi';

  @override
  String get streamerRule1 => 'Përfshini fjalëkyçen “lichess.org” në titullin e transmetimit dhe përdorni kategorinë “Shah”, kur transmetoni në Lichess.';

  @override
  String get streamerRule2 => 'Hiqeni fjalëkyçen kur transmetoni gjëra që s’kanë të bëjnë me Lichess-in.';

  @override
  String get streamerRule3 => 'Lichess-i do ta pikasë automatikisht transmetimin tuaj dhe do të aktivizojë anët vijuese:';

  @override
  String streamerRule4(String param) {
    return 'Lexoni $param për të garantuar lojë të drejtë për këdo gjatë transmetimit tuaj';
  }

  @override
  String get streamerStreamingFairplayFAQ => 'PBR tonat mbi lojë të drejtë në transmetime';

  @override
  String get streamerPerks => 'Përfitime transmetimi me fjalëkyç';

  @override
  String get streamerPerk1 => 'Merrni një ikonë të ndezur transmetuesi te profili juaj në Lichess.';

  @override
  String get streamerPerk2 => 'Përfitoni kalim në krye të listës së transmetuesve.';

  @override
  String get streamerPerk3 => 'Njoftoni ndjekësit tuaj të Lichess-it.';

  @override
  String get streamerPerk4 => 'Shfaqeni transmetimin tuaj në lojëra, turne dhe mësime.';

  @override
  String get streamerApproved => 'Transmetimi juaj u miratua.';

  @override
  String get streamerPendingReview => 'Transmetimi juaj po shqyrtohet nga moderatorët.';

  @override
  String get streamerPleaseFillIn => 'Ju lutemi, plotësoni hollësitë tuaja si transmetuesit dhe ngarkoni një fotografi.';

  @override
  String streamerWhenReady(String param) {
    return 'Kur të jeni gati të renditeni si një transmetues Lichess, $param';
  }

  @override
  String get streamerRequestReview => 'kërkoni një shqyrtim nga moderator';

  @override
  String get streamerStreamerLanguageSettings => 'Faqja e transmetuesit Lichess aplikon për publikun tuaj gjuhën e dhënë nga platforma juaj e transmetimit. Caktoni gjuhën e saktë parazgjedhje për transmetime shahu nga ju, te aplikacioni apo shërbimi që përdorni për të transmetuar.';

  @override
  String get streamerTwitchUsername => 'Emër përdoruesi ose URL-ja juaj Twitch';

  @override
  String get streamerOptionalOrEmpty => 'Opsionale. Lëreni të zbrazët, në mos pastë';

  @override
  String get streamerYouTubeChannelId => 'ID-ja e kanalit tuaj YouTube';

  @override
  String get streamerStreamerName => 'Emri i transmetuesit tuaj në Lichess';

  @override
  String get streamerVisibility => 'E dukshme në faqen e transmetuesve';

  @override
  String get streamerWhenApproved => 'Kur miratohet nga moderatorët';

  @override
  String get streamerHeadline => 'Titulli';

  @override
  String get streamerTellUsAboutTheStream => 'Tregonani për transmetimin tuaj, me një fjali';

  @override
  String get streamerLongDescription => 'Përshkrimi i gjatë';

  @override
  String streamerXStreamerPicture(String param) {
    return 'Foto transmetuesi $param';
  }

  @override
  String get streamerChangePicture => 'Ndryshoni/fshini foton tuaj';

  @override
  String get streamerUploadPicture => 'Ngarko një foto';

  @override
  String streamerMaxSize(String param) {
    return 'Madhësi maks.: $param';
  }
  ...
  String streamerKeepItShort(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Bjerini shkurt: $count shenja e shumta',
      one: 'Bjerini shkurt: $count shenjë e shumta',
      zero: 'Bjerini shkurt: $count shenjë e shumta',
    );
    return '$_temp0';
  }
  ...
  @override
  String get studyCopyChapterPgnDescription => 'Kopjo në të papastër PGN kapitulli.';
  ...
  String studyPasteYourPgnTextHereUpToNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Hidhni këtu tekstin e PGN-s tuaj, deri në $count lojë',
    );
    return '$_temp0';
  }
}
