...
class AppLocalizationsSq extends AppLocalizations {
  ...
  String get mobileCustomizeHomeTip =>
      'Ndihmëz: Mundeni të shtoni më tepër widget-e te Skena e Kreut, ose të hiqni ata që s’ju duhen!';
  ...
  String get mobileOpeningExplorerNotAvailableOffline =>
      'Hapja e Explorer-it s’bëhet dot jashtë linje.';

  @override
  String get mobileChallengeCreated =>
      'Sfida u krijua: Do të njoftoheni, kur të fillojë loja.\nMund ta përdorni që nga skeda shtëpi.';
  ...
  String get broadcastDefaultRoundNameHelp =>
      'Mbajtja e emrit parazgjedhje do ta përkthejë automatikisht në krejt gjuhët e tjera.';
  ...
  String get preferencesHoverOverSettingLabelsForHelp =>
      'Për ndihmë, kalojeni kursorin sipër etiketave të rregullimeve';
  ...
  String get puzzleThemeCornerMateDescription =>
      'Mbërthejeni mbretin në qoshe, duke përdorur një torre, ose një mbretëreshë dhe një kalë, për të dhënë shah-mat.';
  ...
  String get puzzleThemeEpauletteMateDescription =>
      'Dy katrorë shpëtimi ngjitur njëri me tjetrin, për një mbret nën shah, janë të zënë nga gurë të tjerë.';
  ...
  String get puzzleThemePillsburysMateDescription =>
      'Torreja jep shahmat, teksa oficeri ndihmon të kufizohet ai.';
  ...
  String get puzzleThemeMorphysMateDescription =>
      'Përdorni oficerin për t’i dhënë shah mbretit, teksa torreja juaj ndihmon të kufohet ai.';
  ...
  String get puzzleThemeSwallowstailMateDescription =>
      'Një model shah-mati që nga ana pamore ngjan me bishtin e një harabeli, e ngjashme me një formë V.';
  ...
  String get puzzleThemeOperaMateDescription =>
      'Jepini shah mbretit me një torre dhe përdorni një oficer që të mbroni torren.';
  ...
  String get permanentLinkForAnyoneToChallengeYou =>
      'Një lidhje e përhershme, për këdo që dëshiron t’ju sfidojë me saktësisht këto rregullime.';
  ...
  String get multipleLinesDescription =>
      'Caktoni numër rreshtash vleftësimi dhe kalojini shigjetat te fusha';
  ...
  String get threadsDescription =>
      'Vëreni këtë nën numër rrjedhash të CPU-së tuaj, shenjat tregojnë një zgjedhje të mirë të parrezik';

  @override
  String get threadsDescriptionMobile =>
      'Më tepër rrjedha do të përdorin më tepër bateri për analizim më të mirë';
  ...
  String get signupEmailPromise =>
      'Do t’ju dërgojmë email-e vetëm rreth llogarisë tuaj dhe s’do ta japim kurrë email-in tuaj gjetkë.';
  ...
  String get signUpToHostOrJoinASimul =>
      'Regjistrohuni që të organizoni, ose të merrni pjesë, në një simultane';
