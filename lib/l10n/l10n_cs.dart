...
class AppLocalizationsCs extends AppLocalizations {
  ...
  String get mobileSettingsShapeDrawingSubtitle =>
      'Pomocí dvou prstů kreslete tvary: podržte jeden prst na prázdném poli a tahem druhého prstu nakreslete tvar.';
  ...
  String get mobileSettingsTouchFeedbackSubtitle =>
      'Je-li zapnuto, zařízení po tahu nebo braní figury krátce zavibruje.';
  ...
  String get mobileCustomizeHomeTip =>
      'Tip: Můžete přidat další widgety na domovskou obrazovku nebo odebrat ty, které nepotřebujete!';
  ...
  String get mobileOpeningExplorerNotAvailableOffline =>
      'Průzkumník otevření není dostupný offline.';
  ...
  String get threadsDescription =>
      'Nastavte tuto hodnotu nižší než je počet vláken vašho procesoru; hodnoty označené fajfkou představují dobrou a bezpečnou volbu';
  ...
  String get primaryColorArrowsHowTo =>
      'Ctrl nebo shift = červená; command, alt nebo meta = modrá; klávesa z každé skupiny (tedy jedna klávesa ze skupiny ctrl nebo shift a druhá klávesa ze skupiny command, alt nebo meta - obě klávesy musí být stisknuty současně) = žlutá.';
