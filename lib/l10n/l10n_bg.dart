...
class AppLocalizationsBg extends AppLocalizations {
  ...
  @override
  String get boardGeometry => 'Геометрия на дъската';

  @override
  String get boardTheme => 'Дизайн на дъската';

  @override
  String get boardSize => 'Големина на дъската';
  ...
  @override
  String get searchAdvancedSearch => 'Разширено търсене';

  @override
  String get searchOpponentName => 'Името на противника';

  @override
  String get searchLoser => 'Победен';

  @override
  String get searchFrom => 'От';

  @override
  String get searchTo => 'До';

  @override
  String get searchHumanOrComputer => 'Дали съперникът е бил човек или компютър';

  @override
  String get searchAiLevel => 'Ниво на ИИ';

  @override
  String get searchSource => 'Източник';

  @override
  String get searchNbTurns => 'Брой ходове';

  @override
  String get searchResult => 'Резултат';

  @override
  String get searchWinnerColor => 'Цвят на победителя';

  @override
  String get searchDate => 'Дата';

  @override
  String get searchSortBy => 'Подреди по';

  @override
  String get searchAnalysis => 'Анализ';

  @override
  String get searchOnlyAnalysed => 'Само партии за които е направен компютърен анализ';

  @override
  String get searchColor => 'Цвят';

  @override
  String get searchEvaluation => 'Оценка';

  @override
  String get searchMaxNumber => 'Максимален брой';

  @override
  String get searchMaxNumberExplanation => 'Максимален брой партии';

  @override
  String get searchInclude => 'Включи';

  @override
  String get searchDescending => 'Низходящ ред';

  @override
  String get searchAscending => 'Възходящ ред';

  @override
  String get searchRatingExplanation => 'Среден рейтинг на двамата играча';
  ...
  String searchSearchInXGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Търсене в $count игри',
      one: 'Търсене в $count игра',
      zero: 'Търсене в $count игра',
    );
    return '$_temp0';
  }
  ...
  String searchXGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Открити са $count игри',
      one: 'Открита е една игра',
      zero: 'Открита е една игра',
    );
    return '$_temp0';
  }
  ...
  String searchGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other: 'Открити са $count игри',
      one: 'Открита е $count игра',
      zero: 'Открита е $count игра',
    );
    return '$_temp0';
  }
  ...
  @override
  String get streamerLichessStreamer => 'Lichess стриймър';

  @override
  String get streamerLive => 'НА ЖИВО!';

  @override
  String get streamerOffline => 'ИЗВЪН ЛИНИЯ';

  @override
  String streamerCurrentlyStreaming(String param) {
    return 'Текущо предаване: $param';
  }

  @override
  String streamerLastStream(String param) {
    return 'Последен стрийм $param';
  }

  @override
  String get streamerBecomeStreamer => 'Станете Lichess стриймър';

  @override
  String get streamerDoYouHaveStream => 'Имате ли канал в Twitch или YouTube?';

  @override
  String get streamerHereWeGo => 'Идем!';

  @override
  String get streamerAllStreamers => 'Всички стриймъри';

  @override
  String get streamerEditPage => 'Редактирай стриймър страницата';

  @override
  String get streamerYourPage => 'Вашата стриймър страница';

  @override
  String get streamerDownloadKit => 'Изтеглете комплект за стриймър';

  @override
  String streamerXIsStreaming(String param) {
    return '$param стриймва';
  }

  @override
  String get streamerRules => 'Правила за стриймове';

  @override
  String get streamerRule1 => 'Включете ключовата дума \"lichess.org\" в заглавието на стрийма Ви и използвайте категорията \"Шах\", когато стриймвате в Lichess.';

  @override
  String get streamerRule2 => 'Премахнете ключовата дума, когато стриймвате неща, които не са в Lichess.';

  @override
  String get streamerRule3 => 'Lichess ще открие стрийма автоматично и ще позволи следните предимства:';

  @override
  String streamerRule4(String param) {
    return 'Прочетете нашите $param, за да гарантирате честна игра за всички по време на потока.';
  }

  @override
  String get streamerStreamingFairplayFAQ => 'стрийминг ЧЗВ. за честна игра';

  @override
  String get streamerPerks => 'Предимства на стриймването с ключовата дума';

  @override
  String get streamerPerk1 => 'Вземете икона на пламтяща лента в профила си в Lichess.';

  @override
  String get streamerPerk2 => 'Влезте в горната част на списъка на стриймъри.';

  @override
  String get streamerPerk3 => 'Известие до последователите ви в Lichess.';

  @override
  String get streamerPerk4 => 'Покажете своя поток във вашите игри, турнири и проучвания.';

  @override
  String get streamerApproved => 'Вашият стрийм е одобрен.';

  @override
  String get streamerPendingReview => 'Вашият стрийм се преглежда от модератори.';

  @override
  String get streamerPleaseFillIn => 'Моля, попълнете информацията за своя стрийм и качете снимка.';
  ...
  @override
  String get streamerRequestReview => 'заявка за преглед от модератор';

  @override
  String get streamerStreamerLanguageSettings => 'Страницата за стрийминг на Lichess е насочена към вашата аудитория с езика, предоставен от вашата платформа за стрийминг. Задайте правилния език по подразбиране за вашите шахматни стриймове в приложението или услугата, която използвате за излъчване.';

  @override
  String get streamerTwitchUsername => 'Вашето потребителско име в Twitch или URL адрес';

  @override
  String get streamerOptionalOrEmpty => 'По избор. Оставете празно, ако няма';

  @override
  String get streamerYouTubeChannelId => 'ID на канала Ви в YouTube';

  @override
  String get streamerStreamerName => 'Име на вашата стрийм страница в Lichess';

  @override
  String get streamerVisibility => 'Видимо на публичната страницата със стриймъри';

  @override
  String get streamerWhenApproved => 'Когато е одобрена от модераторите';

  @override
  String get streamerHeadline => 'Заглавие';

  @override
  String get streamerTellUsAboutTheStream => 'Разкажете ни за вашия поток с едно изречение';

  @override
  String get streamerLongDescription => 'Дълго описание';
  ...
  @override
  String get streamerChangePicture => 'Промяна/изтриване на снимката ви';

  @override
  String get streamerUploadPicture => 'Качване на снимка';

  @override
  String streamerMaxSize(String param) {
    return 'Максимална големина: $param';
  }
  ...
  @override
  String get studyCopyChapterPgnDescription => 'Копирай PGN на главата.';
  ...
  String studyPasteYourPgnTextHereUpToNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Постави твоя PGN текст тук, до $count партия',
    );
    return '$_temp0';
  }
}
