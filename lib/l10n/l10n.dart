...
abstract class AppLocalizations {
  ...
  /// No description provided for @boardGeometry.
  ///
  /// In en, this message translates to:
  /// **'Board geometry'**
  String get boardGeometry;
  ...
  /// No description provided for @searchAdvancedSearch.
  ///
  /// In en, this message translates to:
  /// **'Advanced search'**
  String get searchAdvancedSearch;

  /// No description provided for @searchOpponentName.
  ///
  /// In en, this message translates to:
  /// **'Opponent name'**
  String get searchOpponentName;

  /// No description provided for @searchLoser.
  ///
  /// In en, this message translates to:
  /// **'Loser'**
  String get searchLoser;
  ...
  /// No description provided for @searchHumanOrComputer.
  ///
  /// In en, this message translates to:
  /// **'Whether the player\'s opponent was human or a computer'**
  String get searchHumanOrComputer;

  /// No description provided for @searchAiLevel.
  ///
  /// In en, this message translates to:
  /// **'A.I. level'**
  String get searchAiLevel;
  ...
  /// No description provided for @searchNbTurns.
  ///
  /// In en, this message translates to:
  /// **'Number of turns'**
  String get searchNbTurns;
  ...
  /// No description provided for @searchWinnerColor.
  ///
  /// In en, this message translates to:
  /// **'Winner color'**
  String get searchWinnerColor;
  ...
  /// No description provided for @searchAnalysis.
  ///
  /// In en, this message translates to:
  /// **'Analysis'**
  String get searchAnalysis;

  /// No description provided for @searchOnlyAnalysed.
  ///
  /// In en, this message translates to:
  /// **'Only games where a computer analysis is available'**
  String get searchOnlyAnalysed;
  ...
  /// No description provided for @searchEvaluation.
  ///
  /// In en, this message translates to:
  /// **'Evaluation'**
  String get searchEvaluation;

  /// No description provided for @searchMaxNumber.
  ///
  /// In en, this message translates to:
  /// **'Maximum number'**
  String get searchMaxNumber;

  /// No description provided for @searchMaxNumberExplanation.
  ///
  /// In en, this message translates to:
  /// **'The maximum number of games to return'**
  String get searchMaxNumberExplanation;

  /// No description provided for @searchInclude.
  ///
  /// In en, this message translates to:
  /// **'Include'**
  ...
  /// No description provided for @searchRatingExplanation.
  ///
  /// In en, this message translates to:
  /// **'The average rating of both players'**
  String get searchRatingExplanation;

  /// No description provided for @searchSearchInXGames.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =0{Search in {count} chess game} =1{Search in {count} chess game} other{Search in {count} chess games}}'**
  String searchSearchInXGames(int count);

  /// No description provided for @searchXGamesFound.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =0{One game found} =1{One game found} other{{count} games found}}'**
  String searchXGamesFound(int count);

  /// No description provided for @searchGamesFound.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =0{{count} game found} =1{{count} game found} other{{count} games found}}'**
  ...
  /// No description provided for @streamerLichessStreamer.
  ///
  /// In en, this message translates to:
  /// **'Lichess streamer'**
  String get streamerLichessStreamer;

  /// No description provided for @streamerLive.
  ///
  /// In en, this message translates to:
  /// **'LIVE!'**
  String get streamerLive;

  /// No description provided for @streamerOffline.
  ///
  /// In en, this message translates to:
  /// **'OFFLINE'**
  String get streamerOffline;

  /// No description provided for @streamerCurrentlyStreaming.
  ///
  /// In en, this message translates to:
  /// **'Currently streaming: {param}'**
  String streamerCurrentlyStreaming(String param);

  /// No description provided for @streamerLastStream.
  ///
  /// In en, this message translates to:
  /// **'Last stream {param}'**
  String streamerLastStream(String param);

  /// No description provided for @streamerBecomeStreamer.
  ///
  /// In en, this message translates to:
  /// **'Become a Lichess streamer'**
  String get streamerBecomeStreamer;

  /// No description provided for @streamerDoYouHaveStream.
  ///
  /// In en, this message translates to:
  /// **'Do you have a Twitch or YouTube channel?'**
  String get streamerDoYouHaveStream;

  /// No description provided for @streamerHereWeGo.
  ///
  /// In en, this message translates to:
  /// **'Here we go!'**
  String get streamerHereWeGo;

  /// No description provided for @streamerAllStreamers.
  ///
  /// In en, this message translates to:
  /// **'All streamers'**
  String get streamerAllStreamers;

  /// No description provided for @streamerEditPage.
  ///
  /// In en, this message translates to:
  /// **'Edit streamer page'**
  String get streamerEditPage;

  /// No description provided for @streamerYourPage.
  ///
  /// In en, this message translates to:
  /// **'Your streamer page'**
  String get streamerYourPage;

  /// No description provided for @streamerDownloadKit.
  ///
  /// In en, this message translates to:
  /// **'Download streamer kit'**
  String get streamerDownloadKit;

  /// No description provided for @streamerXIsStreaming.
  ///
  /// In en, this message translates to:
  /// **'{param} is streaming'**
  String streamerXIsStreaming(String param);

  /// No description provided for @streamerRules.
  ///
  /// In en, this message translates to:
  /// **'Streaming rules'**
  String get streamerRules;

  /// No description provided for @streamerRule1.
  ///
  /// In en, this message translates to:
  /// **'Include the keyword \"lichess.org\" in your stream title and use the category \"Chess\" when you stream on Lichess.'**
  String get streamerRule1;

  /// No description provided for @streamerRule2.
  ///
  /// In en, this message translates to:
  /// **'Remove the keyword when you stream non-Lichess stuff.'**
  String get streamerRule2;

  /// No description provided for @streamerRule3.
  ///
  /// In en, this message translates to:
  /// **'Lichess will detect your stream automatically and enable the following perks:'**
  String get streamerRule3;

  /// No description provided for @streamerRule4.
  ///
  /// In en, this message translates to:
  /// **'Read our {param} to ensure fair play for everyone during your stream.'**
  String streamerRule4(String param);

  /// No description provided for @streamerStreamingFairplayFAQ.
  ///
  /// In en, this message translates to:
  /// **'streaming Fairplay FAQ'**
  String get streamerStreamingFairplayFAQ;

  /// No description provided for @streamerPerks.
  ///
  /// In en, this message translates to:
  /// **'Benefits of streaming with the keyword'**
  String get streamerPerks;

  /// No description provided for @streamerPerk1.
  ///
  /// In en, this message translates to:
  /// **'Get a flaming streamer icon on your Lichess profile.'**
  String get streamerPerk1;

  /// No description provided for @streamerPerk2.
  ///
  /// In en, this message translates to:
  /// **'Get bumped up to the top of the streamers list.'**
  String get streamerPerk2;

  /// No description provided for @streamerPerk3.
  ///
  /// In en, this message translates to:
  /// **'Notify your Lichess followers.'**
  String get streamerPerk3;

  /// No description provided for @streamerPerk4.
  ///
  /// In en, this message translates to:
  /// **'Show your stream in your games, tournaments and studies.'**
  String get streamerPerk4;

  /// No description provided for @streamerApproved.
  ///
  /// In en, this message translates to:
  /// **'Your stream is approved.'**
  String get streamerApproved;

  /// No description provided for @streamerPendingReview.
  ///
  /// In en, this message translates to:
  /// **'Your stream is being reviewed by moderators.'**
  String get streamerPendingReview;

  /// No description provided for @streamerPleaseFillIn.
  ///
  /// In en, this message translates to:
  /// **'Please fill in your streamer information, and upload a picture.'**
  String get streamerPleaseFillIn;

  /// No description provided for @streamerWhenReady.
  ///
  /// In en, this message translates to:
  /// **'When you are ready to be listed as a Lichess streamer, {param}'**
  String streamerWhenReady(String param);

  /// No description provided for @streamerRequestReview.
  ///
  /// In en, this message translates to:
  /// **'request a moderator review'**
  String get streamerRequestReview;

  /// No description provided for @streamerStreamerLanguageSettings.
  ///
  /// In en, this message translates to:
  ...
  String get streamerStreamerLanguageSettings;

  /// No description provided for @streamerTwitchUsername.
  ///
  /// In en, this message translates to:
  /// **'Your Twitch username or URL'**
  String get streamerTwitchUsername;

  /// No description provided for @streamerOptionalOrEmpty.
  ///
  /// In en, this message translates to:
  /// **'Optional. Leave empty if none'**
  String get streamerOptionalOrEmpty;

  /// No description provided for @streamerYouTubeChannelId.
  ///
  /// In en, this message translates to:
  /// **'Your YouTube channel ID'**
  String get streamerYouTubeChannelId;

  /// No description provided for @streamerStreamerName.
  ///
  /// In en, this message translates to:
  /// **'Your streamer name on Lichess'**
  String get streamerStreamerName;

  /// No description provided for @streamerVisibility.
  ///
  /// In en, this message translates to:
  /// **'Visible on the streamers page'**
  String get streamerVisibility;

  /// No description provided for @streamerWhenApproved.
  ///
  /// In en, this message translates to:
  /// **'When approved by moderators'**
  String get streamerWhenApproved;

  /// No description provided for @streamerHeadline.
  ///
  /// In en, this message translates to:
  /// **'Headline'**
  String get streamerHeadline;

  /// No description provided for @streamerTellUsAboutTheStream.
  ///
  /// In en, this message translates to:
  /// **'Tell us about your stream in one sentence'**
  String get streamerTellUsAboutTheStream;

  /// No description provided for @streamerLongDescription.
  ///
  /// In en, this message translates to:
  /// **'Long description'**
  String get streamerLongDescription;

  /// No description provided for @streamerXStreamerPicture.
  ///
  /// In en, this message translates to:
  /// **'{param} streamer picture'**
  String streamerXStreamerPicture(String param);

  /// No description provided for @streamerChangePicture.
  ///
  /// In en, this message translates to:
  /// **'Change/delete your picture'**
  String get streamerChangePicture;

  /// No description provided for @streamerUploadPicture.
  ///
  /// In en, this message translates to:
  /// **'Upload a picture'**
  String get streamerUploadPicture;

  /// No description provided for @streamerMaxSize.
  ///
  /// In en, this message translates to:
  /// **'Max size: {param}'**
  String streamerMaxSize(String param);

  /// No description provided for @streamerKeepItShort.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =0{Keep it short: {count} character max} =1{Keep it short: {count} character max} other{Keep it short: {count} characters max}}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Please only invite people you know, and who actively want to join this study.'**
  ...
  /// No description provided for @studyCopyChapterPgnDescription.
  ///
  /// In en, this message translates to:
  /// **'Copy chapter PGN to clipboard.'**
  String get studyCopyChapterPgnDescription;
  ...
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =0{{count} Chapter} =1{{count} Chapter} other{{count} Chapters}}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =0{{count} Member} =1{{count} Member} other{{count} Members}}'**
  String studyNbMembers(int count);

  /// No description provided for @studyPasteYourPgnTextHereUpToNbGames.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =0{Paste your PGN text here, up to {count} game} =1{Paste your PGN text here, up to {count} game} other{Paste your PGN text here, up to {count} games}}'**
