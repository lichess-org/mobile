...
class AppLocalizationsEu extends AppLocalizations {
  ...
  String activitySupportedNbMonths(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Lichess.org-i laguntza eman zion hilabete $count-z $param2 gisa',
    );
    return '$_temp0';
  }
  ...
  String activityPracticedNbPositions(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$param2 erako posizio $count praktikatu du',
    );
    return '$_temp0';
  }
  ...
  String activityPlayedNbGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$param2 partida $count jokatu du',
    );
    return '$_temp0';
  }
  ...
  String activityPostedNbMessages(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$param2 foroan mezu $count argitaratu du',
    );
    return '$_temp0';
  }
  ...
  String activityInNbCorrespondenceGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'posta bidezko partida $count-en',
    );
    return '$_temp0';
  }
  ...
  String activityCompletedNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Posta bidezko partida $count jokatu du',
    );
    return '$_temp0';
  }
  ...
  String activityFollowedNbPlayers(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Jokalari $count jarraitzen hasi da',
    );
    return '$_temp0';
  }
  ...
  String activityGainedNbFollowers(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Jarraitzaile berri $count lortu du',
    );
    return '$_temp0';
  }
  ...
  String activityHostedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Aldibereko partiden saio $count antolatu du',
    );
    return '$_temp0';
  }
  ...
  String activityJoinedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Aldibireko saio ${count}ean hartu du parte',
    );
    return '$_temp0';
  }
  ...
  String activityCreatedNbStudies(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Azterlan berri $count sortu du',
    );
    return '$_temp0';
  }
  ...
  String activityCompetedInNbTournaments(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Txapelketa ${count}ean parte hartu du',
    );
    return '$_temp0';
  }
  ...
  String activityRankedInTournament(int count, String param2, String param3, String param4) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count. postua lortu du (% $param2 onenen artean) partida $param3 jokatuta $param4 txapelketan',
    );
    return '$_temp0';
  }
  ...
  String activityCompetedInNbSwissTournaments(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Txapelketa suitzar ${count}en hartu du parte',
    );
    return '$_temp0';
  }
  ...
  @override
  String get recommendNotTouching => 'Hobe ez ukitu hau.';

  @override
  String get fewerPlayers => 'Parte hartzeko baldintzak jartzen badituzu, jokalari gutxiago sartuko dira txapelketan.';

  @override
  String get showAdvancedSettings => 'Ezarpen aurreratuak';
  ...
  @override
  String get insult => 'Irainak';

  @override
  String get troll => 'Trolla';

  @override
  String get ratingManipulation => 'Puntuazioa manipulatu';
  ...
  @override
  String get boardGeometry => 'Taularen geometria';

  @override
  String get boardTheme => 'Taularen itxura';

  @override
  String get boardSize => 'Taularen tamaina';
  ...
  String opponentLeftCounter(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Zure aurkariak partida utzi egin du. Partida irabaztea eskatu dezakezu segundo ${count}en.',
    );
    return '$_temp0';
  }
  ...
  String mateInXHalfMoves(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Mate jokaldi erdi ${count}n',
    );
    return '$_temp0';
  }
  ...
  String ratingXOverYGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count puntuazioa partida ${param2}en',
    );
    return '$_temp0';
  }
  ...
  String nbBookmarks(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count partida nabarmenduak',
    );
    return '$_temp0';
  }
  ...
  String rankIsUpdatedEveryNbMinutes(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Sailkapena minutuero eguneratzen da',
    );
    return '$_temp0';
  }
  ...
  String moreThanNbRatedGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Sailkapenerako partida $count baino gehiago',
    );
    return '$_temp0';
  }
  ...
  String moreThanNbPerfRatedGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$param2 partida $count baino gehiago',
    );
    return '$_temp0';
  }
  ...
  String needNbMorePerfGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Sailkapenerako balio duen beste $param2 partida $count jokatu behar duzu',
    );
    return '$_temp0';
  }
  ...
  String needNbMoreGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Sailkapenerako balio duen beste partida $count jokatu behar duzu',
    );
    return '$_temp0';
  }
  ...
  String nbImportedGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count inportatutako partidak',
    );
    return '$_temp0';
  }
  ...
  String lessThanNbMinutes(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count minutu baino gutxiago',
    );
    return '$_temp0';
  }
  ...
  String nbGamesInPlay(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count partida une honetan',
    );
    return '$_temp0';
  }
  ...
  String nbPerfTypePlayersThisWeek(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count $param2 jokalari aste honetan.',
    );
    return '$_temp0';
  }
  ...
  String availableInNbLanguages(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count hizkuntzatan eskuragarri!',
    );
    return '$_temp0';
  }
  ...
  String nbSecondsToPlayTheFirstMove(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Segundo $count lehenengo jokaldia egiteko',
    );
    return '$_temp0';
  }
  ...
  String andSaveNbPremoveLines(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'eta aurrejokaldi linea $count gorde',
    );
    return '$_temp0';
  }
  ...
  String puzzleNbPointsBelowYourPuzzleRating(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Ariketen zure puntuazioa baino puntu bat beherago',
    );
    return '$_temp0';
  }
  ...
  String puzzleNbPointsAboveYourPuzzleRating(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Ariketen zure puntuazioa baino puntu bat gorago',
    );
    return '$_temp0';
  }
  ...
  @override
  String get searchAdvancedSearch => 'Bilaketa aurreratua';

  @override
  String get searchOpponentName => 'Aurkariaren izena';

  @override
  String get searchLoser => 'Galtzailea';

  @override
  String get searchFrom => 'Noiztik';

  @override
  String get searchTo => 'Noiz arte';

  @override
  String get searchHumanOrComputer => 'Aurkaria ordenagailua zen ala ez';

  @override
  String get searchAiLevel => 'I.A. maila';

  @override
  String get searchSource => 'Jatorria';

  @override
  String get searchNbTurns => 'Txanda kopurua';

  @override
  String get searchResult => 'Emaitza';

  @override
  String get searchWinnerColor => 'Irabazlearen kolorea';

  @override
  String get searchDate => 'Data';

  @override
  String get searchSortBy => 'Honen arabera ordenatu';

  @override
  String get searchAnalysis => 'Analisia';

  @override
  String get searchOnlyAnalysed => 'Ordenagailuaren analisia duten partidak bakarrik';

  @override
  String get searchColor => 'Kolorea';

  @override
  String get searchEvaluation => 'Ebaluazioa';

  @override
  String get searchMaxNumber => 'Zenbaki maximoa';

  @override
  String get searchMaxNumberExplanation => 'Itzuli beharreko gehienezko partida kopurua';

  @override
  String get searchInclude => 'Sartu';

  @override
  String get searchDescending => 'Beherantz';

  @override
  String get searchAscending => 'Gorantz';

  @override
  String get searchRatingExplanation => 'Bi jokalarien batez besteko puntuazioa';
  ...
  String searchSearchInXGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count partidatan bilatu',
      one: 'Partida ${count}en bilatu',
      zero: 'Partida ${count}en bilatu',
    );
    return '$_temp0';
  }
  ...
  String searchXGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count partida aurkitu dira',
      one: 'Partida bat aurkitu da',
      zero: 'Partida bat aurkitu da',
    );
    return '$_temp0';
  }
  ...
  String searchGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other: '$count partida aurkitu dira',
      one: 'Partida $count aurkitu da',
      zero: 'Partida $count aurkitu da',
    );
    return '$_temp0';
  }
  ...
  @override
  String get streamerLichessStreamer => 'Lichess streamerra';

  @override
  String get streamerLive => 'ZUZENEAN!';
  ...
  String streamerCurrentlyStreaming(String param) {
    return 'Orain zuzenean ematen: $param';
  }

  @override
  String streamerLastStream(String param) {
    return 'Azken emanaldia $param';
  }

  @override
  String get streamerBecomeStreamer => 'Lichess streamer bihurtu';

  @override
  String get streamerDoYouHaveStream => 'Twitch edo YouTube kanala duzu?';

  @override
  String get streamerHereWeGo => 'Aurrera!';

  @override
  String get streamerAllStreamers => 'Streamer guztiak';

  @override
  String get streamerEditPage => 'Streamerraren orrialdea aldatu';

  @override
  String get streamerYourPage => 'Zure streamer orrialdea';

  @override
  String get streamerDownloadKit => 'Streamer kita deskargatu';

  @override
  String streamerXIsStreaming(String param) {
    return '$param zuzenean ematen ari da';
  }

  @override
  String get streamerRules => 'Zuzenekoetarako arauak';

  @override
  String get streamerRule1 => 'Gehitu lichess.org hitz gakoa zure emanaldiaren izenburuan Lichessen emanaldia egiten ari zarenean.';

  @override
  String get streamerRule2 => 'Ezabatu hitz-gakoa Lichessekoa ez den zerbait ematen ari zarenean.';

  @override
  String get streamerRule3 => 'Lichessek zure emanaldia automatikoki detektatuko du eta zera aktibatuko du:';

  @override
  String streamerRule4(String param) {
    return 'Irakurri gure $param guztion joko garbia bermatzeko.';
  }

  @override
  String get streamerStreamingFairplayFAQ => 'joko garbiaren galdera-erantzunak';

  @override
  String get streamerPerks => 'Hitz gakoarekin emanaldia egitearen onurak';

  @override
  String get streamerPerk1 => 'Zure Lichess profilean ikono bat.';

  @override
  String get streamerPerk2 => 'Streamerren zerrendan gorago agertuko zara.';

  @override
  String get streamerPerk3 => 'Zure Lichess jarraitzaileei jakinarazpena bidaliko diegu.';

  @override
  String get streamerPerk4 => 'Zure emanaldia zure partida, txapelketa eta azterlanetan agertuko da.';

  @override
  String get streamerApproved => 'Zure emanaldia onartu egin da.';

  @override
  String get streamerPendingReview => 'Zure emanaldia moderatzaileak ikuskatzeko zain dago.';

  @override
  String get streamerPleaseFillIn => 'Bete zure informazioa eta kargatu irudia.';

  @override
  String streamerWhenReady(String param) {
    return 'Lichess streamer gisa zerrendatzeko prest zaudenean, $param';
  }

  @override
  String get streamerRequestReview => 'moderatzaileek ikuskatzea eskatu';

  @override
  String get streamerStreamerLanguageSettings => 'Lichess streamerraren orriak zure audientzia du helburu zure streaming plataformak ematen duen hizkuntzarekin. Ezarri zure xake emanaldien hizkuntza emanaldiak egiteko erabiltzen duzun app edo zerbitzuan.';

  @override
  String get streamerTwitchUsername => 'Zure Twitch erabiltzeaile-izena edo URLa';

  @override
  String get streamerOptionalOrEmpty => 'Hautazkoa. Utzi hutsik ez baduzu';

  @override
  String get streamerYouTubeChannelId => 'Zure YouTube kanalaren IDa';

  @override
  String get streamerStreamerName => 'Zure streamer izena Lichessen';

  @override
  String get streamerVisibility => 'Streamerren orrialdean ikusgai';

  @override
  String get streamerWhenApproved => 'Moderatzaileek onartzen dutenean';

  @override
  String get streamerHeadline => 'Izenburua';

  @override
  String get streamerTellUsAboutTheStream => 'Lerro baten, esan iezaguzu zerbait zure emanaldiei buruz';

  @override
  String get streamerLongDescription => 'Deskribapen luzea';

  @override
  String streamerXStreamerPicture(String param) {
    return '$param streamerraren argazkiak';
  }

  @override
  String get streamerChangePicture => 'Zure argazkiak aldatu/ezabatu';

  @override
  String get streamerUploadPicture => 'Argazkia kargatu';

  @override
  String streamerMaxSize(String param) {
    return 'Gehienezko tamaina: $param';
  }
  ...
  String streamerKeepItShort(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Laburra izan dadila: gehienez $count karaktere',
      one: 'Laburra izan dadila: gehienez karaktere $count',
      zero: 'Laburra izan dadila: gehienez karaktere $count',
    );
    return '$_temp0';
  }
  ...
  String stormPlayedNbRunsOfPuzzleStorm(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$param2 ariketaren saiakera bat egin duzu',
    );
    return '$_temp0';
  }
  ...
  @override
  String get studyCopyChapterPgnDescription => 'Kopiatu kapituluaren PGNa arbelera.';
  ...
  String studyPasteYourPgnTextHereUpToNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Itsatsi hemen zure PGNa, gehienez partida $count',
    );
    return '$_temp0';
  }
}
