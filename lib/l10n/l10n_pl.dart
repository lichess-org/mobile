...
class AppLocalizationsPl extends AppLocalizations {
  ...
  String activitySupportedNbMonths(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Wspomógł/-ogła lichess.org na miesiąc jako $param2',
    );
    return '$_temp0';
  }
  ...
  String activitySolvedNbPuzzles(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Rozwiązano $count zadanie szachowe',
    );
    return '$_temp0';
  }
  ...
  String activityPlayedNbGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Rozegrana $count partia $param2',
    );
    return '$_temp0';
  }
  ...
  String activityInNbCorrespondenceGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'w $count partii korespondencyjnej',
    );
    return '$_temp0';
  }
  ...
  String activityCompletedNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Zakończenie partii korespondencyjnej',
    );
    return '$_temp0';
  }
  ...
  String activityFollowedNbPlayers(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Rozpoczęcie obserwowania gracza',
    );
    return '$_temp0';
  }
  ...
  String activityGainedNbFollowers(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Zyskano $count nowego obserwującego/-ą',
    );
    return '$_temp0';
  }
  ...
  String activityJoinedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Udział w $count symultanie',
    );
    return '$_temp0';
  }
  ...
  String activityRankedInTournament(int count, String param2, String param3, String param4) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count miejsce w klasyfikacji (top $param2%) z $param3 partią w $param4',
    );
    return '$_temp0';
  }
  ...
  String activityCompetedInNbSwissTournaments(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Uczestniczył(a) w $count turnieju szwajcarskim',
    );
    return '$_temp0';
  }
  ...
  @override
  String get recommendNotTouching => 'Zalecamy nie zmieniać tych ustawień.';

  @override
  String get fewerPlayers => 'Ustawienie warunków wstępu sprawi, że do turnieju przystąpi mniej osób.';

  @override
  String get showAdvancedSettings => 'Pokaż ustawienia zaawansowane';
  ...
  @override
  String get insult => 'Znieważenie';

  @override
  String get troll => 'Natręt (troll)';

  @override
  String get ratingManipulation => 'Manipulacja rankingiem';
  ...
  @override
  String get boardGeometry => 'Szachownica';

  @override
  String get boardTheme => 'Kolory pól';

  @override
  String get boardSize => 'Rozmiar szachownicy';
  ...
  String opponentLeftCounter(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Przeciwnik opuścił grę. Możesz ogłosić wygraną za $count sekundę.',
    );
    return '$_temp0';
  }
  ...
  String ratingXOverYGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count ranking na podstawie $param2 partii',
    );
    return '$_temp0';
  }
  ...
  String rankIsUpdatedEveryNbMinutes(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Ranking jest aktualizowany co minutę',
    );
    return '$_temp0';
  }
  ...
  String moreThanNbPerfRatedGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Przynajmniej $count partia rankingowa ($param2)',
    );
    return '$_temp0';
  }
  ...
  String needNbMoreGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Musisz rozegrać jeszcze $count partię rankingową',
    );
    return '$_temp0';
  }
  ...
  String nbImportedGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count zaimportowana partia',
    );
    return '$_temp0';
  }
  ...
  String nbPerfTypePlayersThisWeek(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count gracz w tym tygodniu ($param2).',
    );
    return '$_temp0';
  }
  ...
  String nbSecondsToPlayTheFirstMove(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count sekunda na wykonanie pierwszego ruchu',
    );
    return '$_temp0';
  }
  ...
  String andSaveNbPremoveLines(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'i zapisz wariant warunkowy',
    );
    return '$_temp0';
  }
  ...
  String puzzleNbPointsBelowYourPuzzleRating(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Jeden punkt poniżej Twojego rankingu w rozwiązywaniu zadań',
    );
    return '$_temp0';
  }
  ...
  String puzzleNbPointsAboveYourPuzzleRating(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Jeden punkt powyżej Twojego rankingu w rozwiązywaniu zadań',
    );
    return '$_temp0';
  }
  ...
  @override
  String get searchAdvancedSearch => 'Wyszukiwanie zaawansowane';

  @override
  String get searchOpponentName => 'Nazwa przeciwnika';

  @override
  String get searchLoser => 'Przegrany';
  ...
  @override
  String get searchHumanOrComputer => 'Przeciwnik był człowiekiem czy komputerem';

  @override
  String get searchAiLevel => 'Poziom A.I.';

  @override
  String get searchSource => 'Źródło';

  @override
  String get searchNbTurns => 'Liczba ruchów';

  @override
  String get searchResult => 'Wynik';

  @override
  String get searchWinnerColor => 'Kolor zwycięzcy';

  @override
  String get searchDate => 'Data';

  @override
  String get searchSortBy => 'Sortuj według';

  @override
  String get searchAnalysis => 'Analiza';

  @override
  String get searchOnlyAnalysed => 'Tylko partie z dostępną analizą komputerową';

  @override
  String get searchColor => 'Kolor';

  @override
  String get searchEvaluation => 'Ocena';

  @override
  String get searchMaxNumber => 'Maksymalna liczba';

  @override
  String get searchMaxNumberExplanation => 'Maksymalna liczba partii do zwrócenia';

  @override
  String get searchInclude => 'Dołącz';

  @override
  String get searchDescending => 'Malejąco';

  @override
  String get searchAscending => 'Rosnąco';

  @override
  String get searchRatingExplanation => 'Średni ranking obu graczy';
  ...
  String searchSearchInXGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Szukaj wśród $count partii',
      many: 'Szukaj wśród $count partii',
      few: 'Szukaj wśród $count partii',
      one: 'Szukaj w jednej partii',
      zero: 'Szukaj w jednej partii',
    );
    return '$_temp0';
  }
  ...
  String searchXGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Znaleziono $count partii',
      many: 'Znaleziono $count partii',
      few: 'Znaleziono $count partie',
      one: 'Znaleziono jedną partię',
      zero: 'Znaleziono jedną partię',
    );
    return '$_temp0';
  }
  ...
  String searchGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      many: 'znaleziono $count partii',
      few: 'znaleziono $count partie',
      one: 'znaleziono $count partię',
      zero: 'znaleziono $count partię',
    );
    return '$_temp0';
  }
  ...
  @override
  String get streamerLive => 'NA ŻYWO!';

  @override
  String get streamerOffline => 'NIEAKTYWNY';

  @override
  String streamerCurrentlyStreaming(String param) {
    return 'Aktualny stream: $param';
  }

  @override
  String streamerLastStream(String param) {
    return 'Ostatni stream $param';
  }

  @override
  String get streamerBecomeStreamer => 'Zostań streamerem Lichess';

  @override
  String get streamerDoYouHaveStream => 'Czy masz stream na Twitch lub YouTube?';

  @override
  String get streamerHereWeGo => 'No to zaczynamy!';

  @override
  String get streamerAllStreamers => 'Wszyscy streamerzy';

  @override
  String get streamerEditPage => 'Edytuj stronę streamera';

  @override
  String get streamerYourPage => 'Twoja strona streamera';

  @override
  String get streamerDownloadKit => 'Pobierz zestaw streamera';

  @override
  String streamerXIsStreaming(String param) {
    return '$param streamuje';
  }

  @override
  String get streamerRules => 'Zasady streamowania';

  @override
  String get streamerRule1 => 'Dołącz słowo kluczowe \"lichess.org\" w tytule emisji podczas strumieniowania Lichess.';

  @override
  String get streamerRule2 => 'Usuń słowo kluczowe, gdy strumieniujesz coś spoza Lichess.';

  @override
  String get streamerRule3 => 'Lichess automatycznie wykryje Twoją emisję i aktywuje poniższe korzyści:';

  @override
  String streamerRule4(String param) {
    return 'Przeczytaj $param, aby zapewnić wszystkim uczciwą grę.';
  }

  @override
  String get streamerStreamingFairplayFAQ => 'często zadawane pytania dotyczące dobrych praktyk podczas streamowania';

  @override
  String get streamerPerks => 'Korzyści przy emisji ze słowem kluczowym';

  @override
  String get streamerPerk1 => 'Ikona płomienia na profilu Lichess.';

  @override
  String get streamerPerk2 => 'Awans na górę listy streamerów.';

  @override
  String get streamerPerk3 => 'Powiadomienie obserwujących Cię na Lichess.';

  @override
  String get streamerPerk4 => 'Informacja o emisji w Twoich partiach, turniejach i opracowaniach.';

  @override
  String get streamerApproved => 'Twój stream został zatwierdzony.';

  @override
  String get streamerPendingReview => 'Twój stream jest sprawdzany przez moderatorów.';

  @override
  String get streamerPleaseFillIn => 'Wypełnij informacje o sobie i prześlij swoje zdjęcie.';

  @override
  String streamerWhenReady(String param) {
    return 'Gdy jesteś gotowy do pojawienia się na liście streamerów Lichess, $param';
  }

  @override
  String get streamerRequestReview => 'poproś o recenzję moderatora';

  @override
  String get streamerStreamerLanguageSettings => 'Lichess używa informacji o języku, jaki dostarcza mu Twoja platforma streamingowa, aby dotrzeć do Twoich docelowych odbiorców. Ustaw prawidłowy język transmisji w aplikacji lub serwisie, którego używasz do streamowania.';

  @override
  String get streamerTwitchUsername => 'Twoja nazwa użytkownika lub adres URL na Twitch';

  @override
  String get streamerOptionalOrEmpty => 'Opcjonalne. Jeśli brak, pozostaw puste';

  @override
  String get streamerYouTubeChannelId => 'Twój identyfikator kanału YouTube';

  @override
  String get streamerStreamerName => 'Twoja nazwa streamera na Lichess';

  @override
  String get streamerVisibility => 'Widoczne na stronie streamerów';

  @override
  String get streamerWhenApproved => 'Po zatwierdzeniu przez moderatorów';

  @override
  String get streamerHeadline => 'Nagłówek';

  @override
  String get streamerTellUsAboutTheStream => 'W jednym zdaniu powiedz nam o Twoim streamie';

  @override
  String get streamerLongDescription => 'Szczegółowy opis';

  @override
  String streamerXStreamerPicture(String param) {
    return '$param - zdjęcie streamera';
  }

  @override
  String get streamerChangePicture => 'Zmień/usuń swoje zdjęcie';

  @override
  String get streamerUploadPicture => 'Prześlij zdjęcie';

  @override
  String streamerMaxSize(String param) {
    return 'Maksymalny rozmiar: $param';
  }
  ...
  String streamerKeepItShort(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Zachowaj zwięzłość: maksymalnie $count znaków',
      many: 'Zachowaj zwięzłość: maksymalnie $count znaków',
      few: 'Zachowaj zwięzłość: maksymalnie $count znaki',
      one: 'Zachowaj zwięzłość: maksymalnie $count znak',
      zero: 'Zachowaj zwięzłość: maksymalnie $count znak',
    );
    return '$_temp0';
  }
  ...
  String stormPlayedNbRunsOfPuzzleStorm(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Rozegrano jedną sesję $param2',
    );
    return '$_temp0';
  }
  ...
  @override
  String get studyCopyChapterPgnDescription => 'Skopiuj rozdział w PGN do schowka.';
  ...
  String studyPasteYourPgnTextHereUpToNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Wklej tutaj swój PGN, max $count partię',
    );
    return '$_temp0';
  }
}
