...
class AppLocalizationsAz extends AppLocalizations {
  ...
  String activitySupportedNbMonths(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Lichess.org\'u $count aylığına $param2 olaraq dəstəklədi',
    );
    return '$_temp0';
  }
  ...
  String activityPracticedNbPositions(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$param2 mövzusunda $count pozisiya məşq etdi',
    );
    return '$_temp0';
  }
  ...
  String activitySolvedNbPuzzles(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count taktiki tapmaca həll etdi',
    );
    return '$_temp0';
  }
  ...
  String activityPostedNbMessages(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$param2 mövzusunda $count mesaj paylaşdı',
    );
    return '$_temp0';
  }
  ...
  String activityCompletedNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count yazışmalı oyun tamamladı',
    );
    return '$_temp0';
  }
  ...
  String activityFollowedNbPlayers(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count oyunçunu izləməyə başladı',
    );
    return '$_temp0';
  }
  ...
  String activityGainedNbFollowers(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count yeni izləyici qazandı',
    );
    return '$_temp0';
  }
  ...
  String activityHostedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count sinxron seansa ev sahibliyi etdi',
    );
    return '$_temp0';
  }
  ...
  String activityJoinedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count sinxron seansda iştirak etdi',
    );
    return '$_temp0';
  }
  ...
  String activityCreatedNbStudies(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count yeni çalışma yaratdı',
    );
    return '$_temp0';
  }
  ...
  String activityRankedInTournament(int count, String param2, String param3, String param4) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$param3 oyun oynayaraq $param4 turnirində $count. oldu (en yaxşı$param2% içində)',
    );
    return '$_temp0';
  }
  ...
  String activityCompetedInNbSwissTournaments(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count İsveçrə sistemli turnirə qatıldı',
    );
    return '$_temp0';
  }
  ...
  String activityJoinedNbTeams(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count komandasına qatıldı',
    );
    return '$_temp0';
  }
  ...
  @override
  String get boardGeometry => 'Lövhə geometriyası';

  @override
  String get boardTheme => 'Lövhə teması';

  @override
  String get boardSize => 'Lövhə ölçüsü';
  ...
  String opponentLeftCounter(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Rəqibiniz oyunu tərk etdi. $count saniyə sonra qələbə tələb edə bilərsiniz.',
    );
    return '$_temp0';
  }
  ...
  String ratingXOverYGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$param2 oyunundan çox $count reytinqi',
    );
    return '$_temp0';
  }
  ...
  String nbBookmarks(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count yadda saxlanılmış oyun',
    );
    return '$_temp0';
  }
  ...
  String rankIsUpdatedEveryNbMinutes(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Sıralama hər $count dəqiqədə bir yenilənir',
    );
    return '$_temp0';
  }
  ...
  String nbGamesWithYou(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count sizinlə oynadığı oyun sayı',
    );
    return '$_temp0';
  }
  ...
  String moreThanNbPerfRatedGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '≥ $count reytinqli $param2 oyunu',
    );
    return '$_temp0';
  }
  ...
  String needNbMorePerfGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count dənə daha reytinqli $param2 oyunu oynamalısınız',
    );
    return '$_temp0';
  }
  ...
  String needNbMoreGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count dənə daha reytinqli oyun oynamalısınız',
    );
    return '$_temp0';
  }
  ...
  String nbPerfTypePlayersThisWeek(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Bu həftə $count $param2 oyunçusu.',
    );
    return '$_temp0';
  }
  ...
  String nbSecondsToPlayTheFirstMove(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'ilk gedişi etmək üçün son $count saniyə',
    );
    return '$_temp0';
  }
  ...
  String andSaveNbPremoveLines(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'və $count öngediş variantını saxla',
    );
    return '$_temp0';
  }
  ...
  @override
  String get searchAdvancedSearch => 'Ətraflı Axtarış';

  @override
  String get searchOpponentName => 'Rəqibin adı';

  @override
  String get searchLoser => 'Məğlub';

  @override
  String get searchFrom => 'Bu tarixdən';

  @override
  String get searchTo => 'Bu tarixə';

  @override
  String get searchHumanOrComputer => 'Oyunçunun rəqibi insan yoxsa kompüterdirmi';

  @override
  String get searchAiLevel => 'Süni zəka səviyyəsi';

  @override
  String get searchSource => 'Mənbə';

  @override
  String get searchNbTurns => 'Gediş sayı';

  @override
  String get searchResult => 'Nəticə';

  @override
  String get searchWinnerColor => 'Qalibin rəngi';

  @override
  String get searchDate => 'Tarix';

  @override
  String get searchSortBy => 'Sıralama şəkli';

  @override
  String get searchAnalysis => 'Analiz';

  @override
  String get searchOnlyAnalysed => 'Sadəcə kompüter analizi mövcud oyunları göstər';
  ...
  String searchSearchInXGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count şahmat oyunu içində axtar',
      one: '$count şahmat oyunu içində axtar',
      zero: '$count şahmat oyunu içində axtar',
    );
    return '$_temp0';
  }
  ...
  String searchXGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count oyun tapıldı',
      one: 'Bir oyun tapıldı',
      zero: 'Bir oyun tapıldı',
    );
    return '$_temp0';
  }
  ...
  @override
  String get streamerLichessStreamer => 'Lichess yayımçısı';

  @override
  String get streamerLive => 'CANLI!';

  @override
  String get streamerOffline => 'OFLAYN';

  @override
  String streamerCurrentlyStreaming(String param) {
    return 'Hazırda yayımdadır: $param';
  }

  @override
  String streamerLastStream(String param) {
    return 'Son yayım $param';
  }

  @override
  String get streamerBecomeStreamer => 'Lichess yayımçısı ol';

  @override
  String get streamerDoYouHaveStream => 'Twitch və ya YouTube kanalınız var?';

  @override
  String get streamerHereWeGo => 'Getdik!';

  @override
  String get streamerAllStreamers => 'Bütün yayımçılar';

  @override
  String get streamerEditPage => 'Yayımçı səhifəsinə düzəliş et';

  @override
  String get streamerYourPage => 'Yayım səhifəniz';

  @override
  String get streamerDownloadKit => 'Yayımçı dəstini endir';

  @override
  String streamerXIsStreaming(String param) {
    return '$param yayımdadır';
  }

  @override
  String get streamerRules => 'Yayım qaydaları';

  @override
  String get streamerRule1 => 'Lichessdə yayım qoşarkən, yayım başlığına \"lichess.org\" açar sözünü daxil edin və Şahmat kateqoriyasını seçin.';

  @override
  String get streamerRule2 => 'Lichess ilə əlaqəsi olmayan bir yayım edərkən bu açar sözü çıxardın.';

  @override
  String get streamerRule3 => 'Lichess, yayımınızı avtomatik aşkarlayacaq və bu üstünlükləri aktivləşdirəcək:';
  ...
  @override
  String get streamerPerks => 'Açar söz ilə yayım aparmağın üstünlükləri';

  @override
  String get streamerPerk1 => 'Lichess profilinizdə, yanan yayımçı nişanını göstər.';

  @override
  String get streamerPerk2 => 'Yayımçılar siyahısında ən üst sırada görünün.';

  @override
  String get streamerPerk3 => 'Lichess izləyicilərinizə bildiriş göndərmək.';

  @override
  String get streamerPerk4 => 'Oyun, turnir və çalışmalarınızda yayımınızı göstərə biləcəksiniz.';

  @override
  String get streamerApproved => 'Yayımınız təsdiqləndi.';

  @override
  String get streamerPendingReview => 'Yayımınız moderatorlar tərəfindən nəzərdən keçirilir.';

  @override
  String get streamerPleaseFillIn => 'Lütfən yayımçı məlumatlarını doldurun və bir şəkil yükləyin.';

  @override
  String streamerWhenReady(String param) {
    return 'Lichess yayımçısı kimi siyahıya alınmağa hazır olanda, $param';
  }

  @override
  String get streamerRequestReview => 'moderatorun nəzərdən keçirməsini istəyin';
  ...
  @override
  String get streamerTwitchUsername => 'Twitch istifadəçi adınız və ya URL-niz';

  @override
  String get streamerOptionalOrEmpty => 'İstəyə bağlı. Yoxdursa boş buraxın';

  @override
  String get streamerYouTubeChannelId => 'Your YouTube channel ID';

  @override
  String get streamerStreamerName => 'Lichess yayımçı adınız';

  @override
  String get streamerVisibility => 'Yayımçılar səhifəsində görünsün';

  @override
  String get streamerWhenApproved => 'Moderatorlar tərəfindən təsdiqlənəndə';

  @override
  String get streamerHeadline => 'Başlıq';

  @override
  String get streamerTellUsAboutTheStream => 'Bir cümlə ilə yayımınızı təsvir edin';

  @override
  String get streamerLongDescription => 'Uzun açıqlama';

  @override
  String streamerXStreamerPicture(String param) {
    return '$param yayımçı şəkli';
  }

  @override
  String get streamerChangePicture => 'Şəkli dəyişdir/sil';

  @override
  String get streamerUploadPicture => 'Şəkil yüklə';

  @override
  String streamerMaxSize(String param) {
    return 'Maks ölçü: $param';
  }
  ...
  String streamerKeepItShort(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Qısa saxlayın: ən çox $count simvol',
      one: 'Qısa saxlayın: ən çox $count simvol',
      zero: 'Qısa saxlayın: ən çox $count simvol',
    );
    return '$_temp0';
  }
  ...
  String studyPasteYourPgnTextHereUpToNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'PGN mətninizi bura yapışdırın, ən çox $count oyuna qədər',
    );
    return '$_temp0';
  }
}
