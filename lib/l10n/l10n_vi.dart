...
class AppLocalizationsVi extends AppLocalizations {
  ...
  String get mobileNotAllFeaturesAreAvailable =>
      'Xin lưu ý rằng không phải tất cả các tính năng từ ứng dụng cũ hoặc trang web hiện đều khả dụng, nhưng chúng tôi đang bổ sung thêm các tính năng mới.';
  ...
  String get mobileOpeningExplorerNotAvailableOffline =>
      'Khám phá Khai cuộc không khả dụng khi ngoại tuyến.';

  @override
  String get mobileChallengeCreated =>
      'Đã thách đấu người chơi: Bạn sẽ được thông báo nếu trận đấu bắt đầu.\nBạn có thể truy cập trận đấu từ trang chủ.';
  ...
  String get variantChess960Title =>
      'Vị trí bắt đầu của các quân cờ hàng 1 và  8 được sắp xếp ngẫu nhiên.';
  ...
  String get variantAntichessTitle =>
      'Để mất toàn bộ quân cờ của bạn (bao gồm cả vua hoặc làm bị hết nước đi) để chiến thắng.';
  ...
  String get variantHordeTitle =>
      'Một bên có số lượng quân tốt lớn, bên kia chỉ có đội quân bình thường.';
  ...
  String get variantRacingKingsTitle =>
      'Đưa vua của bạn sang phía bên kia của bàn cờ để giành chiến thắng.';
  ...
  String get variantCrazyhouseTitle =>
      'Các quân cờ bắt được có thể được thả lại vào bàn cờ thay vì chỉ di chuyển một quân cờ.';
  ...
  String get arenaRankAverageHelp =>
      'Thứ hạng trung bình của bạn thể hiện thứ hạng đạt được của bạn so với tổng số người chơi trong mỗi giải đấu. Đây là thước đo thành tích của bạn trong giải đấu, chứ không phải xếp hạng chung của bạn.\n\nVí dụ, xếp hạng trung bình 3% có nghĩa là bạn nằm trong top 3% (chẳng hạn như vị trí thứ 30 trong số 1.000 người chơi).';
  ...
  String get broadcastPermanentlyDeleteTournament =>
      'Xóa vĩnh viễn giải đấu này, bao gồm tất cả các vòng đấu và ván đấu?';
  ...
  String get broadcastStandingsDisclaimer =>
      'Bảng xếp hạng được tính toán dựa trên các trận đấu được phát sóng và có thể khác với kết quả chính thức.';
  ...
  String get broadcastDefaultRoundNameHelp =>
      'Giữ nguyên tên mặc định sẽ tự động dịch sang mọi ngôn ngữ khác.';
  ...
  String get preferencesManeuverArrowsHelp =>
      'Trình tự các nước đi của máy tính đánh giá cho một quân cờ';

  @override
  String get preferencesHoverOverSettingLabelsForHelp =>
      'Di chuột qua các cài đặt để xem giải thích';
  ...
  String get puzzleThemeBlindSwineMateDescription =>
      'Hai quân xe cùng nhau chiếu hết vua trong một vùng có kích thước 2 x 2.';
  ...
  String get puzzleThemeBodenMateDescription =>
      'Hai quân Tượng tấn công trên các đường chéo chéo nhau chiếu hết quân vua bị kẹt bởi đồng đội của nó.';
  ...
  String get puzzleThemeCollinearMoveDescription =>
      'Hai quân cờ đối diện nhau, và một quân di chuyển dọc theo đường tấn công mà không bắt được quân cờ đối phương.';
  ...
  String get puzzleThemeCornerMateDescription =>
      'Kìm hãm vua ở góc bằng cách sử dụng một xe hoặc hậu và một mã để chiếu hết.';
  ...
  String get puzzleThemeDiscoveredCheckDescription =>
      'Đi một quân để lộ ra quân cờ tấn công đang ẩn núp, điều này thường dẫn đến lợi thế quyết định.';
  ...
  String get puzzleThemeDovetailMateDescription =>
      'Một Hậu chiếu hết vua ở ô liền kề, trong khi hai ô trốn thoát duy nhất của vua đã bị chặn bởi quân đồng minh.';
  ...
  String get puzzleThemeEnPassantAdjacentCaptureDescription =>
      'Một chiến thuật sử dụng luật bắt tốt qua đường, trong đó một quân tốt có thể bắt quân tốt đối phương vừa di chuyển đến bên cạnh nó bằng nước đi hai ô đầu tiên.';
  ...
  String get puzzleThemeEpauletteMateDescription =>
      'Hai ô trốn thoát liền kề của vua bị chiếu bị các quân cờ khác chiếm kiểm soát.';
  ...
  String get puzzleThemeForkOpposingPiecesDescription =>
      'Một nước đi trong đó một quân cờ tấn công đồng thời hai hoặc nhiều quân cờ của đối thủ.';
  ...
  String get puzzleThemeHookMateOpposingPawnDescription =>
      'Chiếu hết bằng quân xe, mã và tốt, trong đó quân tốt của đối phương cản đường thoát của vua.';
  ...
  String get puzzleThemePillsburysMateDescription =>
      'Quân xe chiếu hết, trong khi quân tượng giúp khống chế nước đi đó.';
  ...
  String get puzzleThemeMorphysMateDescription =>
      'Dùng quân tượng để chiếu vua, trong khi quân xe giúp kìm hãm vua.';
  ...
  String get puzzleThemeSwallowstailMateDescription =>
      'Một kiểu chiếu tướng có hình dáng trực quan giống đuôi chim én, tương tự như hình chữ V.';
  ...
  String get puzzleThemeOperaMateDescription =>
      'Dùng quân xe chiếu vua và dùng quân tượng để bảo vệ quân xe.';
  ...
  String get permanentLinkForAnyoneToChallengeYou =>
      'Một liên kết cố định để bất kỳ ai cũng có thể thách đấu bạn với chính xác các theo các thiết lập này.';
  ...
  String get threadsDescription =>
      'Hãy đặt giá trị này thấp hơn số luồng của CPU, giá trị có dấu tick là một lựa chọn an toàn và hợp lý';

  @override
  String get threadsDescriptionMobile =>
      'Càng nhiều luồng xử lý sẽ càng tiêu hao nhiều pin để phân tích tốt hơn';
  ...
  String get changeUsernameNotSame =>
      'Bạn chỉ có thể thay đổi cách viết hoa/thường. Ví dụ \"johndoe\" thành \"JohnDoe\".';
  ...
  String get signupEmailPromise =>
      'Chúng tôi chỉ gửi tin nhắn qua email về tài khoản của bạn và sẽ không bao giờ chia sẻ địa chỉ email của bạn với người khác.';
  ...
  String get checkSpamOrJunkFolder =>
      'Nếu bạn không nhận được email xác nhận, hãy kiểm tra thư mục Spam hoặc Thư rác. Hãy nhớ đánh dấu các tin nhắn từ lichess.org là an toàn và \"không phải thư rác\" để bạn có thể nhận được thông báo quan trọng.';
  ...
  String get processReportFasterInEnglish =>
      'Chúng tôi có thể xử lý báo cáo của bạn nhanh hơn nếu bạn viết bằng tiếng Anh.';
  ...
  String get aboutSimul =>
      'Đấu cờ đồng loạt gồm một người duy nhất chơi cùng lúc với nhiều người khác.';
  ...
  String get aboutSimulRealLife =>
      'Ý tưởng được lấy từ những sự kiện có thật. Trong thực tế, điều này bao gồm một người chủ trì cờ đồng loạt sẽ di chuyển từ bàn này qua bàn khác và đánh một nước mỗi bàn.';

  @override
  String get aboutSimulRules =>
      'Khi sự kiện đồng loạt bắt đầu, mỗi người chơi sẽ bắt đầu ván cờ với người chủ trì. Sự kiện đồng loạt kết thúc khi tất cả các ván cờ hoàn tất.';

  @override
  String get aboutSimulSettings =>
      'Cờ đồng loạt luôn không xếp hạng. Việc tái đấu, đi lại hay cho thêm thời gian đều bị vô hiệu.';
  ...
  String get creatingASimul =>
      'Việc tạo sự kiện cờ đồng loạt cho phép bạn chơi với nhiều đối thủ cùng một lúc.';

  @override
  String get simulVariantsHint =>
      'Nếu bạn chọn nhiều biến thể, mỗi người chơi sẽ được tự chọn biến thể mà họ muốn chơi.';
  ...
  String get simulAddExtraTime =>
      'Bạn có thể cộng thêm thời gian ban đầu của mình để đấu cờ đồng loạt dễ hơn.';
  ...
  String get simulAddExtraTimePerPlayer =>
      'Thêm thời gian ban đầu của bạn khi đấu với mỗi người chơi tham gia sự kiện đồng loạt.';

  @override
  String get simulHostExtraTimePerPlayer =>
      'Thời gian cộng thêm cho người chủ trì theo số người tham gia';
  ...
  String get tournamentHomeDescription =>
      'Chơi các giải đấu cờ vua nhịp độ nhanh! Tham gia một giải đấu chính thức hoặc tự tạo giải đấu của bạn. Cờ đạn, Cờ chớp, Cờ nhanh, Cờ chậm, Chess960, Vua lên đồi, ba lần chiếu tướng và nhiều lựa chọn khác cho niềm vui đánh cờ vô tận.';
  ...
  String nbPuzzles(int count) {
    String _temp0 = intl.Intl.pluralLogic(count, locale: localeName, other: '$count câu đố');
    return '$_temp0';
  }
  ...
  String nbAnonymous(int count) {
    String _temp0 = intl.Intl.pluralLogic(count, locale: localeName, other: 'Ẩn danh ($count)');
    return '$_temp0';
  }
  ...
  String get studyWelcomeToLichessStudyText =>
      'Đây là một bàn cờ phân tích được chia sẻ.<br><br>Sử dụng nó để phân tích và chú thích các ván đấu,<br>thảo luận về các thế cờ với bạn bè, <br>và tất nhiên cho các bài học cờ vua!<br><br>Đây là một công cụ mạnh mẽ. Hãy dành một chút thời gian để xem nó hoạt động như thế nào.';
