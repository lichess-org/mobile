...
class AppLocalizationsGl extends AppLocalizations {
  ...
  String activitySupportedNbMonths(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Apoiou a lichess.org durante $count mes como $param2',
    );
    return '$_temp0';
  }
  ...
  String activityPracticedNbPositions(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Practicou $count posición en $param2',
    );
    return '$_temp0';
  }
  ...
  String activitySolvedNbPuzzles(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Resolveu $count exercicio de adestramento',
    );
    return '$_temp0';
  }
  ...
  String activityPlayedNbGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Xogou $count partida de $param2',
    );
    return '$_temp0';
  }
  ...
  String activityPostedNbMessages(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Publicou $count mensaxe en $param2',
    );
    return '$_temp0';
  }
  ...
  String activityInNbCorrespondenceGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'en $count partida por correspondencia',
    );
    return '$_temp0';
  }
  ...
  String activityCompletedNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Xogou $count partida por correspondencia',
    );
    return '$_temp0';
  }
  ...
  String activityGainedNbFollowers(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Gañou $count novo seguidor',
    );
    return '$_temp0';
  }
  ...
  String activityHostedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Ofreceu $count exhibición simultánea',
    );
    return '$_temp0';
  }
  ...
  String activityJoinedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Participou en $count exhibición simultánea',
    );
    return '$_temp0';
  }
  ...
  String activityCompetedInNbTournaments(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Competiu en $count torneo Arena',
    );
    return '$_temp0';
  }
  ...
  String activityRankedInTournament(int count, String param2, String param3, String param4) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$countº na clasificación (no $param2% mellor) con $param3 partida en $param4',
    );
    return '$_temp0';
  }
  ...
  String activityCompetedInNbSwissTournaments(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Competiu en $count torneo suízo',
    );
    return '$_temp0';
  }
  ...
  @override
  String get recommendNotTouching => 'Non recomendamos cambiar estes axustes.';

  @override
  String get fewerPlayers => 'Se estableces condicións de entrada, o teu torneo terá menos xogadores.';

  @override
  String get showAdvancedSettings => 'Amosar axustes avanzados';
  ...
  @override
  String get ratingManipulation => 'Manipulación da puntuación';
  ...
  @override
  String get viewTheSolution => 'Mira a solución';
  ...
  @override
  String get boardGeometry => 'Xeometría do taboleiro';

  @override
  String get boardTheme => 'Tema do taboleiro';

  @override
  String get boardSize => 'Tamaño do taboleiro';
  ...
  String mateInXHalfMoves(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Mate en $count media xogada',
    );
    return '$_temp0';
  }
  ...
  String ratingXOverYGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Puntuación $count en $param2 partida',
    );
    return '$_temp0';
  }
  ...
  String rankIsUpdatedEveryNbMinutes(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'A posición actualízase cada minuto',
    );
    return '$_temp0';
  }
  ...
  String moreThanNbPerfRatedGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '≥ $count partida puntuada $param2',
    );
    return '$_temp0';
  }
  ...
  String needNbMorePerfGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Necesitas xogar $count partida $param2 puntuada máis',
    );
    return '$_temp0';
  }
  ...
  String needNbMoreGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Necesitas xogar $count partida puntuada máis',
    );
    return '$_temp0';
  }
  ...
  String nbPerfTypePlayersThisWeek(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count xogador de $param2 esta semana.',
    );
    return '$_temp0';
  }
  ...
  String availableInNbLanguages(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Dispoñible en $count idioma!',
    );
    return '$_temp0';
  }
  ...
  String nbSecondsToPlayTheFirstMove(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count segundo para facer o primeiro movemento',
    );
    return '$_temp0';
  }
  ...
  String andSaveNbPremoveLines(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'e garda $count variante de premovementos',
    );
    return '$_temp0';
  }
  ...
  @override
  String get puzzleDownVote => 'Vota en contra do puzzle';
  ...
  String puzzleNbPointsBelowYourPuzzleRating(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count punto por debaixo da túa puntuación de crebacabezas',
    );
    return '$_temp0';
  }
  ...
  String puzzleNbPointsAboveYourPuzzleRating(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Un punto por riba da túa puntuación de exercicios',
    );
    return '$_temp0';
  }
  ...
  @override
  String get searchAdvancedSearch => 'Busca avanzada';

  @override
  String get searchOpponentName => 'Nome do rival';

  @override
  String get searchLoser => 'Perdedor';

  @override
  String get searchFrom => 'Dende';

  @override
  String get searchTo => 'Ata';

  @override
  String get searchHumanOrComputer => 'Rival humano ou máquina';

  @override
  String get searchAiLevel => 'Nivel da IA';

  @override
  String get searchSource => 'Fonte';

  @override
  String get searchNbTurns => 'Número de quendas';

  @override
  String get searchResult => 'Resultado';

  @override
  String get searchWinnerColor => 'Cor do gañador';
  ...
  @override
  String get searchOnlyAnalysed => 'Só partidas onde a análise por ordenador estea dispoñible';

  @override
  String get searchColor => 'Cor';

  @override
  String get searchEvaluation => 'Avaliación';

  @override
  String get searchMaxNumber => 'Número máximo';

  @override
  String get searchMaxNumberExplanation => 'Número máximo de partidas que se amosarán';

  @override
  String get searchInclude => 'Incluír';
  ...
  @override
  String get searchRatingExplanation => 'A puntuación media de ambos xogadores';
  ...
  String searchSearchInXGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Busca en $count partidas',
      one: 'Busca en $count partida',
  ...
  String searchXGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Atopáronse $count partidas',
      one: 'Atopouse unha partida',
      zero: 'Atopouse unha partida',
    );
    return '$_temp0';
  }
  ...
  String searchGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other: 'Atopáronse $count partidas',
      one: 'Atopouse $count partida',
      zero: 'Atopouse $count partida',
    );
    return '$_temp0';
  }
  ...
  @override
  String get streamerLichessStreamer => 'Presentador de Lichess';

  @override
  String get streamerLive => 'EN DIRECTO!';

  @override
  String get streamerOffline => 'DESCONECTADO';

  @override
  String streamerCurrentlyStreaming(String param) {
    return 'Transmitindo agora mesmo: $param';
  }

  @override
  String streamerLastStream(String param) {
    return 'Última transmisión $param';
  }

  @override
  String get streamerBecomeStreamer => 'Convértete nun presentador de Lichess';

  @override
  String get streamerDoYouHaveStream => 'Tes unha canle de Twitch ou de YouTube?';

  @override
  String get streamerHereWeGo => 'Imos!';

  @override
  String get streamerAllStreamers => 'Todos os presentadores';

  @override
  String get streamerEditPage => 'Edita a páxina de presentador';

  @override
  String get streamerYourPage => 'A túa páxina de presentador';

  @override
  String get streamerDownloadKit => 'Descarga o equipo de presentador';
  ...
  @override
  String get streamerRules => 'Normas das transmisións';

  @override
  String get streamerRule1 => 'Inclúe a palabra chave \"lichess.org\" no título da túa transmisión e usa a categoría \"Chess\" cando retransmitas en Lichess.';

  @override
  String get streamerRule2 => 'Elimina a palabra chave cando transmitas contido que non estea relacionado con Lichess.';

  @override
  String get streamerRule3 => 'Lichess detectará a túa transmisión automaticamente e habilitará os seguintes beneficios:';

  @override
  String streamerRule4(String param) {
    return 'Le as $param para garantir que todo os participantes actúen con deportividade durante a transmisión.';
  }

  @override
  String get streamerStreamingFairplayFAQ => 'Preguntas Frecuentes sobre xogo limpo en retransmisións';

  @override
  String get streamerPerks => 'Beneficios de transmitir coa palabra chave';

  @override
  String get streamerPerk1 => 'Obtén unha flamexante icona de presentador no teu perfil de Lichess.';

  @override
  String get streamerPerk2 => 'Sube ao curuto da lista de presentadores.';

  @override
  String get streamerPerk3 => 'Notifica aos teus seguidos de Lichess.';

  @override
  String get streamerPerk4 => 'Amosa a túa transmisión nas túas partidas, torneos e estudos.';

  @override
  String get streamerApproved => 'A túa transmisión está aprobada.';

  @override
  String get streamerPendingReview => 'A túa transmisión está sendo revisada polos moderadores.';

  @override
  String get streamerPleaseFillIn => 'Por favor, cubre a túa información de presentador e sube unha foto.';

  @override
  String streamerWhenReady(String param) {
    return 'Cando esteas preparado para seres un presentador de Lichess, $param';
  }

  @override
  String get streamerRequestReview => 'solicita a revisión dun moderador';

  @override
  String get streamerStreamerLanguageSettings => 'A páxina de presentador de Lichess diríxese á túa audiencia co idioma proporcionado pola túa plataforma de transmisións. Establece o idioma predeterminado axeitado para as túas transmisións de xadrez na aplicación ou no servizo que uses para retransmitir.';

  @override
  String get streamerTwitchUsername => 'O teu usuario de Twitch ou URL';

  @override
  String get streamerOptionalOrEmpty => 'Opcional. Déixao baleiro se non tes';

  @override
  String get streamerYouTubeChannelId => 'O ID da túa canle de YouTube ou URL';

  @override
  String get streamerStreamerName => 'O teu nome de presentador en Lichess';

  @override
  String get streamerVisibility => 'Visible na páxina de presentadores';

  @override
  String get streamerWhenApproved => 'Cando sexa aprobado polos moderadores';

  @override
  String get streamerHeadline => 'Titular';

  @override
  String get streamerTellUsAboutTheStream => 'Cóntanos sobre a túa transmisión nunha frase';

  @override
  String get streamerLongDescription => 'Descrición longa';

  @override
  String streamerXStreamerPicture(String param) {
    return 'Imaxe do presentador $param';
  }

  @override
  String get streamerChangePicture => 'Cambia/borra a túa foto';

  @override
  String get streamerUploadPicture => 'Sube unha foto';

  @override
  String streamerMaxSize(String param) {
    return 'Tamaño máximo: $param';
  }
  ...
  String streamerKeepItShort(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Sé breve: máximo $count caracteres',
      one: 'Sé breve: máximo $count carácter',
      zero: 'Sé breve: máximo $count carácter',
    );
    return '$_temp0';
  }
  ...
  String stormPlayedNbRunsOfPuzzleStorm(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Xogou unha quenda de $param2',
    );
    return '$_temp0';
  }
  ...
  @override
  String get studyPleaseOnlyInvitePeopleYouKnow => 'Por favor, convida só a persoas que coñezas e que desexen activamente unirse a este estudo.';
  ...
  @override
  String get studyCopyChapterPgnDescription => 'Copiar o PGN do capítulo no portapapeis.';
  ...
  @override
  String get studyYouCanPasteThisInTheForumToEmbed => 'Podes pegar isto no foro ou no teu blog de Lichess para incrustalo';
