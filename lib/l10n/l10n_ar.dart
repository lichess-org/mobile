...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String get broadcastPermanentlyDeleteTournament =>
      'حذف هذه البطولة بشكل دائم، بما في ذلك جميع الجولات والألعاب؟';
  ...
  @override
  String get preferencesNotifyBroadcasts => 'بث';
  ...
  String get preferencesHoverOverSettingLabelsForHelp =>
      'مرّر المؤشر فوق تسميات الإعدادات لعرض تلميحات المساعدة';
  ...
  String get puzzleThemeEnPassantAdjacentCaptureDescription =>
      'تكتيك يستخدم قاعدة الأخذ بالتجاوز، التي تسمح للبيدق بأسر بيدق الخَصْم الذي تحرك للتو مربعين في حركته الأولى وأصبح ملاصقًا له، كما لو أنه تحرك مربعًا واحدًا فقط.';
  ...
  String get puzzleThemeForkOpposingPiecesDescription =>
      'نقلة تُهاجم فيها قطعةٌ واحدة قطعتين أو أكثر من قطع الخَصْم في آنٍ واحد.';
  ...
  String get puzzleThemeHookMateOpposingPawnDescription =>
      'كش مات يتحقق بالقلعة والحصان والبيدق، ويكون بيدق الخَصْم نفسه هو الذي يسدّ على ملكه مربعات الهروب.';
  ...
  @override
  String get talkInChat => 'يرجى التحلي باللطف في الدردشة!';
  ...
  @override
  String get postEdited => 'تم التعديل';
  ...
  String get processReportFasterInEnglish =>
      'سنتمكن من معالجة تقريرك بسرعة أكبر إذا أرسلته باللغة الإنجليزية.';
