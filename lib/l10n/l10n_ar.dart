...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get boardGeometry => 'شكل الرقعة';

  @override
  String get boardTheme => 'مربعات الرقعة';

  @override
  String get boardSize => 'حجم الرقعة';
  ...
  @override
  String get searchAdvancedSearch => 'بحث متقدم';

  @override
  String get searchOpponentName => 'اسم الخصم';

  @override
  String get searchLoser => 'الخاسر';

  @override
  String get searchFrom => 'من';

  @override
  String get searchTo => 'الى';

  @override
  String get searchHumanOrComputer => 'سواءً كان الخصم بشرياً أو جهاز كمبيوتر';

  @override
  String get searchAiLevel => 'مستوى الذكاء الاصطناعي';

  @override
  String get searchSource => 'المصدر';

  @override
  String get searchNbTurns => 'عدد الأدوار';

  @override
  String get searchResult => 'النتيجة';

  @override
  String get searchWinnerColor => 'لون الفائز';

  @override
  String get searchDate => 'التاريخ';

  @override
  String get searchSortBy => 'ترتيب حسب';

  @override
  String get searchAnalysis => 'تحليل';

  @override
  String get searchOnlyAnalysed => 'فقط المباريات التي يتوفر تحليل الكمبيوتر لها';

  @override
  String get searchColor => 'اللون';

  @override
  String get searchEvaluation => 'التقييم';

  @override
  String get searchMaxNumber => 'أقصى رقم';

  @override
  String get searchMaxNumberExplanation => 'أكبر عدد الألعاب المراد إرجاعها';

  @override
  String get searchInclude => 'محتوية';
  ...
  @override
  String get searchRatingExplanation => 'معدل التقييم لكلا اللاعبين';
  ...
  String searchSearchInXGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'البحث في $count مباريات شطرنج',
      many: 'البحث في $count مباراة شطرنج',
      few: 'البحث في $count مباريات شطرنج',
      two: 'البحث في مبارتي شطرنج',
      one: 'البحث في مباراة شطرنج واحدة',
      zero: 'البحث في $count ألعاب الشطرنج',
    );
    return '$_temp0';
  }
  ...
  String searchXGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'تم العثور على $count مباراة',
      many: 'تم العثور على $count مباراة',
      few: 'تم العثور على $count مباريات',
      two: 'تم العثور على مبارتان',
      one: 'تم العثور على مباراة واحدة',
      zero: 'لم يتم العثور على أي ألعاب',
    );
    return '$_temp0';
  }
  ...
  String searchGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'تم إيجاد $count لعبة',
      many: 'تم إيجاد $count لعبة',
      few: 'تم إيجاد $count لعبة',
      two: 'تم إيجاد $count لعبة',
      one: 'تم إيجاد $count لعبة',
      zero: 'لم يتم إيجاد أي لعبة',
    );
    return '$_temp0';
  }
  ...
  @override
  String get streamerLichessStreamer => 'بثوث ليشس';

  @override
  String get streamerLive => 'مباشر!';

  @override
  String get streamerOffline => 'غير متصل';

  @override
  String streamerCurrentlyStreaming(String param) {
    return 'يبث حاليا: $param';
  }
  ...
  @override
  String get streamerBecomeStreamer => 'اصبح ستريمرز لموقع الليتش';

  @override
  String get streamerDoYouHaveStream => 'هل لديك قناة تويتش أو يوتيوب؟';

  @override
  String get streamerHereWeGo => 'فلنبدأ!';

  @override
  String get streamerAllStreamers => 'جميع الستريمرز';

  @override
  String get streamerEditPage => 'تعديل صفحة البث';

  @override
  String get streamerYourPage => 'صفحة البث الخاصة بك';

  @override
  String get streamerDownloadKit => 'تحميل streamer kit';

  @override
  String streamerXIsStreaming(String param) {
    return '$param يقوم بعمل بث';
  }

  @override
  String get streamerRules => 'قواعد البث';

  @override
  String get streamerRule1 => 'قم بإدراج الكلمة المفتاحية \"lichess.org\" في عنوان البث الخاص بك ولا تنسى كذلك تصنيفه تحت فئة \"Chess\".';

  @override
  String get streamerRule2 => 'قم بنزع الكلمة المفتاحية عندما تبث أمور غير متعلقة بليشيس.';

  @override
  String get streamerRule3 => 'سيقوم ليشيس بالتعرف على بثك بصورة آلية ويمنحه الإمتيازات التالية:';

  @override
  String streamerRule4(String param) {
    return 'اقرأ $param لضمان شروط اللعب العادل خلال بثك المباشر.';
  }

  @override
  String get streamerStreamingFairplayFAQ => 'الاسئلة الشائعة للعب العادل أثناء البث';

  @override
  String get streamerPerks => 'فوائد البث باستعمال الكلمة المفتاحية';

  @override
  String get streamerPerk1 => 'احصل على أيقونة بث مشتعلة على ملفك الشخصي \"Lichess\".';

  @override
  String get streamerPerk2 => 'احجز مكانك مباشرة في أعلى القائمة الخاصة بالستريمرز.';

  @override
  String get streamerPerk3 => 'أعلِم متابعيك على Lichess.';

  @override
  String get streamerPerk4 => 'أظهر البث الخاص بك في المباريات والبطولات التي تلعبها إضافة إلى الدراسات.';

  @override
  String get streamerApproved => 'لقد تمت الموافقة على البث الخاص بك.';

  @override
  String get streamerPendingReview => 'تتم حاليا مراجعة البث الخاص بك من قبل المشرفين.';

  @override
  String get streamerPleaseFillIn => 'الرجاء ملء معلومات البث الخاصة بك، و قم برفع صورة.';

  @override
  String streamerWhenReady(String param) {
    return 'عندما تكون جاهزاً لتصبح ستريمر Lichess ، $param';
  }

  @override
  String get streamerRequestReview => 'أطلب مراجعة مشرف';

  @override
  String get streamerStreamerLanguageSettings => 'صفحة البث Lichess تستهدف جمهورك مع اللغة التي توفرها منصة البث الخاصة بك. قم بتعيين اللغة الافتراضية الصحيحة لبث الشطرنج الخاص بك في التطبيق أو الخدمة التي تستخدمها للبث.';

  @override
  String get streamerTwitchUsername => 'اسم مستخدم تويتش أو عنوان URL الخاص بك';

  @override
  String get streamerOptionalOrEmpty => 'اختياري. اتركه فارغاً إذا لم يكن هناك';

  @override
  String get streamerYouTubeChannelId => 'معرف قناتك على اليوتيوب';

  @override
  String get streamerStreamerName => 'اسم البث الخاص بك على Lichess';

  @override
  String get streamerVisibility => 'إظهار على قائمة بثوث اللاعبين';

  @override
  String get streamerWhenApproved => 'بعد الموافقة من قبل المشرفين';

  @override
  String get streamerHeadline => 'العنوان';

  @override
  String get streamerTellUsAboutTheStream => 'أخبرنا عن البث الخاص بك في جملة واحدة';

  @override
  String get streamerLongDescription => 'وصف مطول';

  @override
  String streamerXStreamerPicture(String param) {
    return '$param صورة الستريمر';
  }

  @override
  String get streamerChangePicture => 'تغيير/حذف صورتك';

  @override
  String get streamerUploadPicture => 'رفع صورة';

  @override
  String streamerMaxSize(String param) {
    return 'الحجم الأقصى: $param';
  }
  ...
  String streamerKeepItShort(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'ابقه قصيرًا: $count حرف كحد أقصى',
      many: 'ابقه قصيرًا: $count حرف أقصى',
      few: 'ابقه قصيرًا: $count حروف كحد أقصى',
      two: 'ابقه قصيرًا: حرفان كحد أقصى',
      one: 'ابقه قصيرًا: حرف واحد كحد أقصى',
      zero: 'ابقه قصيرًا: $count حرف أقصى',
    );
    return '$_temp0';
  }
  ...
  @override
  String get studyCopyChapterPgnDescription => 'نسخ فصل PGN إلى الحافظة.';
