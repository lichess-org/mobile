...
class AppLocalizationsSv extends AppLocalizations {
  ...
  String get mobilePuzzleStormFilterNothingToShow =>
      'Ingenting att visa, vänligen ändra filtren';
  ...
  String get mobilePuzzleStormSubtitle =>
      'Lös så många pussel som möjligt på 3 minuter.';
  ...
  String get activityHostedALiveStream =>
      'Var värd för en direktsänd videosändning';
  ...
  String get arenaIsRated =>
      'Turneringen är rankad och kommer påverka din rating.';
  ...
  String get arenaSomeRated =>
      'Vissa turneringar är rankade och kommer att påverka din rating.';
  ...
  String get arenaHowIsTheWinnerDecided =>
      'Hur avgörs vem som vunnit turneringen?';
  ...
  String get arenaAllowBerserkHelp =>
      'Låt spelarna halvera sin klocktid för att få en extra poäng';
  ...
  String get arenaOnlyTitledHelp =>
      'Kräv en officiell schacktitel för att delta i turneringen';

  @override
  String get arenaTournamentPairingsAreNowClosed =>
      'Turneringsmatchningarna är nu avslutade.';
  ...
  String arenaDrawingWithinNbMoves(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'Att göra remi inom $count drag kommer inte ge poäng till någon av spelarna.',
      one:
          'Att göra remi inom $count drag kommer inte ge poäng till någon av spelarna.',
    );
    return '$_temp0';
  ...
  String get broadcastHowToUseLichessBroadcasts =>
      'Hur man använder Lichess-Sändningar.';
  ...
  String get broadcastTournamentDescription =>
      'Kort beskrivning av turneringen';
  ...
  String get broadcastDefinitivelyDeleteRound =>
      'Ta bort denna runda och dess partier definitivt.';
  ...
  String get broadcastReplacePlayerTags =>
      'Valfritt: byt ut spelarnamn, ranking och titlar';
  ...
  String get broadcastStartVerySoon =>
      'Sändningen kommer att starta mycket snart.';
  ...
  String get broadcastEmbedThisBroadcast =>
      'Infoga denna sändning på din webbplats';
  ...
  String get broadcastAllBroadcastsByMonth =>
      'Visa alla sändningar efter månad';
  ...
  String get challengeDeclineGeneric =>
      'Jag accepterar inte utmaningar för tillfället.';

  @override
  String get challengeDeclineLater =>
      'Detta är inte rätt tid för mig, vänligen fråga igen senare.';
  ...
  String get challengeDeclineTimeControl =>
      'Jag antar inte utmaningar med denna tidskontroll.';

  @override
  String get challengeDeclineRated =>
      'Vänligen skicka en rankad utmaning istället.';

  @override
  String get challengeDeclineCasual =>
      'Vänligen skicka en orankad utmaning istället.';
  ...
  String get challengeDeclineVariant =>
      'Jag vill inte spela denna variant för tillfället.';
  ...
  String get challengeDeclineOnlyBot =>
      'Jag antar endast utmaningar från bottar.';

  @override
  String get challengeInviteLichessUser =>
      'Eller bjud in en Lichess-användare:';
  ...
  String get preferencesBoardHighlights =>
      'Brädmarkeringar (föregående drag och schack)';

  @override
  String get preferencesPieceDestinations =>
      'Möjliga drag (giltiga drag och förhandsdrag)';
  ...
  String get preferencesMoveListWhilePlaying =>
      'Lista med drag under spelets gång';
  ...
  String get preferencesPromoteToQueenAutomatically =>
      'Promovera till drottning automatiskt';
  ...
  String get preferencesCastleByMovingOntoTheRook =>
      'Flytta kungen till tornet eller 2 steg';

  @override
  String get preferencesInputMovesWithTheKeyboard =>
      'Mata in drag via tangentbord';
  ...
  String get preferencesNotifyBell =>
      'Spela upp ett klockljud vid ny avisering';

  @override
  String get preferencesNotifyPush =>
      'Enhetsnotifiering när du inte använder Lichess';
  ...
  String get puzzleToGetPersonalizedPuzzles =>
      'För att få personanpassade problem:';
  ...
  String get puzzleOpeningsYouPlayedTheMost =>
      'Öppningar som du spelade mest i rankade partier';
  ...
  String get puzzleUseCtrlF =>
      'Använd Ctrl+f för att hitta din favoritöppning!';
  ...
  String get puzzleJumpToNextPuzzleImmediately =>
      'Hoppa till nästa schackproblem direkt';
  ...
  String get puzzleLookupOfPlayer =>
      'Leta upp schackproblem från en spelares partier';
  ...
  String get puzzleNoPuzzlesToShow =>
      'Ingenting att visa, gå och lös några problem först!';

  @override
  String get puzzleImprovementAreasDescription =>
      'Öva på dessa för att optimera dina framsteg!';
  ...
  String get puzzleThemeBishopEndgameDescription =>
      'Ett slutspel med bara löpare och bönder.';
  ...
  String get puzzleThemeEndgameDescription =>
      'En taktik under spelets sista fas.';
  ...
  String get puzzleThemeKnightEndgameDescription =>
      'Ett slutspel med bara springare och bönder.';
  ...
  String get puzzleThemeMateIn5Description =>
      'Räkna ut en lång schackmattsekvens.';
  ...
  String get puzzleThemeMiddlegameDescription =>
      'En taktik under spelets andra fas.';
  ...
  String get puzzleThemeOneMoveDescription =>
      'Ett schackproblem som bara är ett drag långt.';
  ...
  String get puzzleThemeOpeningDescription =>
      'En taktik under spelets första fas.';
  ...
  String get puzzleThemePawnEndgameDescription =>
      'Ett slutspel med endast bönder.';
  ...
  String get puzzleThemeQueenEndgameDescription =>
      'Ett slutspel med endast dam och bönder.';
  ...
  String get puzzleThemeRookEndgameDescription =>
      'Ett slutspel med endast torn och bönder.';
  ...
  String get puzzleThemeVeryLongDescription =>
      'Fyra eller fler drag för att vinna.';
  ...
  String get settingsManagedAccountCannotBeClosed =>
      'Ditt konto hanteras och kan inte stängas.';
  ...
  String get settingsCloseAccountAreYouSure =>
      'Är du säker på att du vill stänga ditt konto?';
  ...
  String get winPreventedBy50MoveRule =>
      'Vinst förhindrad genom 50-dragsregeln';
  ...
  String get winOr50MovesByPriorMistake =>
      'Vinst eller 50 drag på grund av tidigare misstag';

  @override
  String get lossOr50MovesByPriorMistake =>
      'Förlust eller 50 drag på grund av tidigare misstag';
  ...
  String get removesTheDepthLimit =>
      'Tar bort sökdjupsbegränsningen och håller datorn varm';
  ...
  String get youNeedAnAccountToDoThat =>
      'Du behöver ett konto för att göra detta';
  ...
  String get signupEmailHint =>
      'Vi kommer endast att använda den för att återställa lösenordet.';
  ...
  String get error_weakPassword =>
      'Detta lösenord är extremt vanligt, och alltför lätt att gissa.';

  @override
  String get error_namePassword =>
      'Använd inte ditt användarnamn som lösenord.';
  ...
  String get neverTypeYourPassword =>
      'Skriv aldrig ditt Lichess-lösenord på en annan webbplats!';
  ...
  String get whatSignupUsername =>
      'Vilket användarnamn använde du för att registrera dig?';
  ...
  String get emailCanTakeSomeTime =>
      'Det kan ta en stund för det att komma fram.';

  @override
  String get refreshInboxAfterFiveMinutes =>
      'Vänta 5 minuter och uppdatera din inkorg.';
  ...
  String get emailForSignupHelp =>
      'Om allt annat misslyckas, skicka oss denna mejl:';
  ...
  String get waitForSignupHelp =>
      'Vi återkopplar snart och hjälper dig slutföra din registrering.';
  ...
  String get accountConfirmationEmailNotNeeded =>
      'Du behöver inte en e-postbekräftelse.';
  ...
  String get thisAccountViolatedTos =>
      'Detta konto bröt mot användarvillkoren för Lichess';

  @override
  String get openingExplorerAndTablebase =>
      'Öppningsutforskare & slutspelsteori';
  ...
  String get yourOpponentProposesATakeback =>
      'Din motståndare vill göra om det senaste draget';
  ...
  String get screenshotCurrentPosition =>
      'Ta en skärmdump på den aktuella positionen';
  ...
  String get makeAStudy =>
      'För förvaring och delning, överväg att göra en studie.';
  ...
  String get bewareTheGameIsRatedButHasNoClock =>
      'OBS! Partiet är rankat men har ingen tidsgräns.';
  ...
  String get writeAPrivateNoteAboutThisUser =>
      'Skriv en privat anteckning om den här användaren';
  ...
  String get letOtherPlayersInviteYouToStudy =>
      'Låt andra spelare bjuda in dig till studier';
  ...
  String get aboutSimul =>
      'Simultan går ut på att en spelare möter flera spelare samtidigt.';
  ...
  String get simulHostExtraTimePerPlayer =>
      'Extratid för värden för varje spelare som deltar';
  ...
  String get keyRequestComputerAnalysis =>
      'Begär datoranalys, lär av dina misstag';
  ...
  String get tournamentHomeTitle =>
      'Schackturnering med olika betänketider och schackvarianter';
  ...
  String get ifYouDoNotGetTheEmail =>
      'Om du inte får e-postmeddelandet inom 5 minuter:';
  ...
  String get networkLagBetweenYouAndLichess =>
      'Nätverksfördröjning mellan dig och lichess';

  @override
  String get timeToProcessAMoveOnLichessServer =>
      'Tid att bearbeta ett drag på lichess server';
  ...
  String get letOtherPlayersMessageYou =>
      'Tillåt att andra spelare skickar meddelanden till dig';

  @override
  String get receiveForumNotifications =>
      'Få aviseringar vid omnämningar i forumet';

  @override
  String get shareYourInsightsData =>
      'Dela din information från Chess Insights';
  ...
  String get everybodyGetsAllFeaturesForFree =>
      'Alla får alla funktioner gratis';
  ...
  String get usernameAlreadyUsed =>
      'Användarnamnet är upptaget, vänligen försök med ett annat.';

  @override
  String get usernamePrefixInvalid =>
      'Användarnamnet måste börja med en bokstav.';

  @override
  String get usernameSuffixInvalid =>
      'Användarnamnet måste sluta med en bokstav eller ett nummer.';
  ...
  String get drawByFiftyMoves =>
      'Spelet är remi på grund av femtio drags regeln.';
  ...
  String get doneReviewingWhiteMistakes =>
      'Färdig med utvärderingen av vits misstag';

  @override
  String get doneReviewingBlackMistakes =>
      'Färdig med utvärderingen av svarts misstag';
  ...
  String get agreementPolicy =>
      'Jag instämmer med att jag kommer att följa alla Lichess-regler.';
  ...
  String get ultraBulletDesc =>
      'Vansinnigt snabba partier: mindre än 30 sekunder';
  ...
  String get correspondenceDesc =>
      'Korrespondensschack: en eller flera dagar per drag';
  ...
  String get thisTopicIsArchived =>
      'Detta ämne har arkiverats och kan inte längre besvaras.';
  ...
  String get someoneYouReportedWasBanned =>
      'Någon du rapporterade blev avstängd';
  ...
  String get lostAgainstTOSViolator =>
      'Du förlorade mot någon som bröt mot Lichess TOS';
  ...
  String get reopenYourAccountDescription =>
      'Om du stängt ditt konto, men sedan dess har ändrat dig, får du en chans att få tillbaka ditt konto.';
  ...
  String get sentEmailWithLink =>
      'Vi har skickat ett e-postmeddelande med en länk.';
  ...
  String get youCantStartNewGame =>
      'Du kan inte starta ett nytt parti förräm detta är klart.';
  ...
  String opponentLeftCounter(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'Din motståndare lämnade partiet. Du kan begära seger om $count sekunder.',
      one:
          'Din motståndare lämnade partiet. Du kan begära seger om $count sekund.',
    );
    return '$_temp0';
  }
  ...
  String get stormYouPlayTheWhitePiecesInAllPuzzles =>
      'Du spelar de vita pjäserna i alla pussel';

  @override
  String get stormYouPlayTheBlackPiecesInAllPuzzles =>
      'Du spelar de svarta pjäserna i alla pussel';
  ...
  String get stormWaitingForMorePlayers =>
      'Väntar på att fler spelare ska gå med...';
  ...
  String get stormThisRunWasOpenedInAnotherTab =>
      'Denna loppet har öppnats i en annan flik!';
  ...
  String get studyTheChapterIsTooShortToBeAnalysed =>
      'Kapitlet är för kort för att analyseras.';
  ...
  String get studyGetAFullComputerAnalysis =>
      'Hämta en fullständig serveranalys av huvudlinjen.';
  ...
  String get studyShareChanges =>
      'Dela ändringar med åskådare och spara dem på servern';
  ...
  String get studyOnlyPublicStudiesCanBeEmbedded =>
      'Endast offentliga studier kan läggas till!';
  ...
  String get studyDeleteThisChapter =>
      'Ta bort detta kapitel. Det går inte att ångra!';
  ...
  String get studyYesKeepEveryoneOnTheSamePosition =>
      'Ja: håll alla på samma position';
  ...
  String get studyWelcomeToLichessStudyTitle =>
      'Välkommen till Lichess Studier!';
  ...
  String get studyLoadExistingLichessGameTitle =>
      'Ladda ett befintligt lichess-parti';
  ...
  String get studyBlackDefeatWhiteCanNotWin =>
      'Svart förlorar, men vit kan inte vinna';

  @override
  String get studyWhiteDefeatBlackCanNotWin =>
      'Vitt förlorar, men svart kan inte vinna';
