...
class AppLocalizationsSv extends AppLocalizations {
  ...
  String activitySupportedNbMonths(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Har stött lichess.org i $count månad som en $param2',
    );
    return '$_temp0';
  }
  ...
  String activityPracticedNbPositions(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Tränade $count ställning på $param2',
    );
    return '$_temp0';
  }
  ...
  String activitySolvedNbPuzzles(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Löste $count taktikproblem',
    );
    return '$_temp0';
  }
  ...
  String activityPlayedNbGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Spelade $count $param2-parti',
    );
    return '$_temp0';
  }
  ...
  String activityPostedNbMessages(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Postade $count inlägg i $param2',
    );
    return '$_temp0';
  }
  ...
  String activityFollowedNbPlayers(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Började följa $count spelare',
    );
    return '$_temp0';
  }
  ...
  String activityHostedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Var värd för $count simultanmatch',
    );
    return '$_temp0';
  }
  ...
  String activityJoinedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Deltog i $count simultanmatch',
    );
    return '$_temp0';
  }
  ...
  String activityCompetedInNbTournaments(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Tävlade i $count turnering',
    );
    return '$_temp0';
  }
  ...
  String activityRankedInTournament(int count, String param2, String param3, String param4) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Rankad #$count (topp $param2%) med $param3 partier i $param4',
    );
    return '$_temp0';
  }
  ...
  String activityCompetedInNbSwissTournaments(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Tävlade i $count swissturnering',
    );
    return '$_temp0';
  }
  ...
  @override
  String get rematchOfferCanceled => 'Erbjudande om returmatch tillbakadraget';

  @override
  String get rematchOfferDeclined => 'Erbjudande om returmatch avböjt';

  @override
  String get cancelRematchOffer => 'Dra tillbaka erbjudande om returmatch';
  ...
  @override
  String get boardGeometry => 'Brädets geometri';

  @override
  String get boardTheme => 'Brädets tema';

  @override
  String get boardSize => 'Brädets storlek';
  ...
  String opponentLeftCounter(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Din motståndare lämnade partiet. Du kan begära seger om $count sekund.',
    );
    return '$_temp0';
  }
  ...
  String ratingXOverYGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '${count}ranking över $param2 parti',
    );
    return '$_temp0';
  }
  ...
  String rankIsUpdatedEveryNbMinutes(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Placeringen uppdateras varje minut',
    );
    return '$_temp0';
  }
  ...
  String moreThanNbPerfRatedGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '≥ $count rankat $param2 parti',
    );
    return '$_temp0';
  }
  ...
  String needNbMorePerfGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Du behöver spela ytterligare $count rankat ${param2}parti',
    );
    return '$_temp0';
  }
  ...
  String needNbMoreGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Du behöver spela ytterligare $count rankat parti',
    );
    return '$_temp0';
  }
  ...
  String nbPerfTypePlayersThisWeek(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count ${param2}spelare denna vecka.',
    );
    return '$_temp0';
  }
  ...
  String availableInNbLanguages(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Tillgänglig på $count olika språk!',
    );
    return '$_temp0';
  }
  ...
  String nbSecondsToPlayTheFirstMove(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count sekund kvar för att spela första draget',
    );
    return '$_temp0';
  }
  ...
  @override
  String get searchAdvancedSearch => 'Avancerad sökning';

  @override
  String get searchOpponentName => 'Motståndarens namn';

  @override
  String get searchLoser => 'Förlorare';

  @override
  String get searchFrom => 'Från';

  @override
  String get searchTo => 'Till';

  @override
  String get searchHumanOrComputer => 'Om spelarens motståndare var människa eller dator';

  @override
  String get searchAiLevel => 'AI-nivå';

  @override
  String get searchSource => 'Källa';

  @override
  String get searchNbTurns => 'Antal omgångar';

  @override
  String get searchResult => 'Resultat';

  @override
  String get searchWinnerColor => 'Vinnarens färg';
  ...
  @override
  String get searchAnalysis => 'Analys';

  @override
  String get searchOnlyAnalysed => 'Endast partier där en datoranalys finns tillgänglig';

  @override
  String get searchColor => 'Färg';

  @override
  String get searchEvaluation => 'Utvärdering';

  @override
  String get searchMaxNumber => 'Maximalt antal';

  @override
  String get searchMaxNumberExplanation => 'Det maximala antalet paartier att visa';

  @override
  String get searchInclude => 'Inkludera';

  @override
  String get searchDescending => 'Fallande ordning';

  @override
  String get searchAscending => 'Stigande ordning';

  @override
  String get searchRatingExplanation => 'Genomsnittlig rating för båda spelarna';
  ...
  String searchSearchInXGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Sök i $count schackpartier',
      one: 'Sök i $count schackparti',
  ...
  String searchXGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count partier hittade',
      one: 'Ett parti hittades',
      zero: 'Ett parti hittades',
    );
    return '$_temp0';
  }
  ...
  @override
  String get streamerLichessStreamer => 'Videokanal från Lichess';

  @override
  String get streamerLive => 'DIREKTSÄNDNING!';

  @override
  String get streamerOffline => 'FRÅNKOPPLAD';

  @override
  String streamerCurrentlyStreaming(String param) {
    return 'Direktsänder video nu: $param';
  }

  @override
  String streamerLastStream(String param) {
    return 'Senaste videosändning $param';
  }

  @override
  String get streamerBecomeStreamer => 'Börja sända video från Lichess';

  @override
  String get streamerDoYouHaveStream => 'Har du en kanal på Twitch eller YouTube?';

  @override
  String get streamerHereWeGo => 'Låt oss börja!';

  @override
  String get streamerAllStreamers => 'Alla videokanaler';

  @override
  String get streamerEditPage => 'Redigera direktsändnings-sida';

  @override
  String get streamerYourPage => 'Din direktsändnings-sida';

  @override
  String get streamerDownloadKit => 'Hämta sändningstillbehör';

  @override
  String streamerXIsStreaming(String param) {
    return '$param direktsänder video';
  }

  @override
  String get streamerRules => 'Regler för videosändningar';

  @override
  String get streamerRule1 => 'Inkludera nyckelordet \"lichess.org\" i din kanaltitel när du direktsänder från Lichess.';

  @override
  String get streamerRule2 => 'Ta bort sökordet när du inte sänder Lichess-saker.';

  @override
  String get streamerRule3 => 'Lichess kommer att upptäcka din sändning automatiskt och ge dig följande fördelar:';

  @override
  String streamerRule4(String param) {
    return 'Läs vår $param för att säkerställa rent spel för alla under din videosändning.';
  }

  @override
  String get streamerStreamingFairplayFAQ => 'rent spel för videosändningar FAQ';

  @override
  String get streamerPerks => 'Fördelar med att direktsända med sökordet';

  @override
  String get streamerPerk1 => 'Få en glödande mikrofon-ikon på din Lichess-profil.';

  @override
  String get streamerPerk2 => 'Flyttas upp till toppen av listan på videokanaler.';

  @override
  String get streamerPerk3 => 'Avisera dina Lichess-följare.';

  @override
  String get streamerPerk4 => 'Visa din videosändnling i dina partier, turneringar och studier.';

  @override
  String get streamerApproved => 'Din videokanal har godkänts.';

  @override
  String get streamerPendingReview => 'Din videokanal granskas av moderatorer.';

  @override
  String get streamerPleaseFillIn => 'Vänligen fyll i din kanalinformation och ladda upp en bild.';

  @override
  String streamerWhenReady(String param) {
    return 'När du är redo att lista din Lichess-kanal, $param';
  }

  @override
  String get streamerRequestReview => 'begär en moderatorgranskning';

  @override
  String get streamerStreamerLanguageSettings => 'Lichess-streamersidan är inriktad mot målgruppen med det språket som din streaming-plattform visar. Välj korrekt standardspråk för dina schackstreams i den appen eller tjänsten du använder för dina sändningar.';

  @override
  String get streamerTwitchUsername => 'Ditt användarnamn eller din URL på Twitch';

  @override
  String get streamerOptionalOrEmpty => 'Valfritt. Lämna tomt om ingen';

  @override
  String get streamerYouTubeChannelId => 'Ditt YouTube-kanal-ID';

  @override
  String get streamerStreamerName => 'Ditt sändningsnamn på Lichess';

  @override
  String get streamerVisibility => 'Synlig på videokanal-sidan';

  @override
  String get streamerWhenApproved => 'Efter godkännande från moderatorer';

  @override
  String get streamerHeadline => 'Rubrik';

  @override
  String get streamerTellUsAboutTheStream => 'I en mening, berätta om din videokanal';

  @override
  String get streamerLongDescription => 'Lång beskrivning';

  @override
  String streamerXStreamerPicture(String param) {
    return '$param profilbild';
  }

  @override
  String get streamerChangePicture => 'Ändra/ta bort din bild';

  @override
  String get streamerUploadPicture => 'Ladda upp en bild';

  @override
  String streamerMaxSize(String param) {
    return 'Max storlek: $param';
  }
  ...
  String streamerKeepItShort(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Behåll kort: max $count tecken',
      one: 'Behåll kort: max $count tecken',
      zero: 'Behåll kort: max $count tecken',
    );
    return '$_temp0';
  }
  ...
  @override
  String get stormYouPlayTheBlackPiecesInAllPuzzles => 'Du spelar de vita pjäserna i alla pussel';
  ...
  @override
  String get studyCopyChapterPgnDescription => 'Kopiera kapitel-PGN till urklipp.';
  ...
  String studyPasteYourPgnTextHereUpToNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Klistra in din PGN-kod här, upp till $count parti',
    );
    return '$_temp0';
  }
}
