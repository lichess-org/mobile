...
class AppLocalizationsRo extends AppLocalizations {
  ...
  String get mobileAccountPreferencesHelp =>
      'Aceste preferințe sunt aplicate contului dvs. Lichess și vor fi utilizate pe toate dispozitivele.';
  ...
  String get mobileNotAllFeaturesAreAvailable =>
      'Te rugăm să reții că nu sunt disponibile toate funcțiile din vechea aplicație sau site web, dar adăugăm funcționalități tot timpul.';
  ...
  String get mobilePuzzleStormSubtitle =>
      'Rezolvă cât mai multe puzzle-uri în 3 minute.';

  @override
  String get mobilePuzzleStreakAbortWarning =>
      'Îți vei pierde seria actuală și scorul va fi salvat.';
  ...
  @override
  String get mobileSettingsCustomBackgroundPresets => 'Setări predefinite';

  @override
  String get mobileSettingsDraggedPieceTarget => 'Destinația piesei trase';

  @override
  String get mobileSettingsDraggedTargetCircle => 'Cerc';
  ...
  String get mobileSettingsImmersiveModeSubtitle =>
      'Ascunde interfața de utilizator a sistemului în timpul jocului. Folosește această opțiune dacă ești deranjat de gesturile de navigare ale sistemului la marginile ecranului. Se aplică pentru ecranele de joc și probleme de șah.';
  ...
  String get mobileSettingsPickAnImageHelp =>
      'Fundalul personalizat funcționează numai în modul întunecat. Este recomandată o imagine întunecată.';
  ...
  @override
  String get mobileSettingsPickAnImageShowBoard => 'Afișează tabla';

  @override
  String get mobileSettingsPickAnImageSwipeToDisplay =>
      'Glisați pentru a afișa alte fundaluri';

  @override
  String get mobileSettingsPieceShiftMethodEither => 'Fie atingeți sau trageți';
  ...
  String get mobileSettingsShapeDrawingSubtitle =>
      'Desenează forme folosind două degete: ține un deget pe un pătrat gol și trage cu un alt deget pentru a desena o formă.';
  ...
  String get mobileSettingsTouchFeedbackSubtitle =>
      'Când este activat, dispozitivul va vibra scurt când mutați sau capturați o piesă.';
  ...
  @override
  String get arenaArenaTournaments => 'Turnee de tip arenă';

  @override
  String get arenaIsItRated => 'Este evaluat?';
  ...
  String get arenaIsRated =>
      'Această competiție este evaluată și îți va afecta scorul.';
  ...
  String get arenaSomeRated =>
      'Unele competiții sunt evaluate și îți vor afecta scorul.';
  ...
  String get arenaDrawStreakVariants =>
      'Lungimea minimă a jocului pentru a obține puncte în cazul remizelor diferă în funcție de variantă. Tabelul de mai jos enumeră pragul pentru fiecare variantă.';

  @override
  String get arenaVariant => 'Variantă';

  @override
  String get arenaMinimumGameLength => 'Lungimea minimă a jocului';
  ...
  String get arenaCustomStartDateHelp =>
      'În fusul orar local. Acest lucru înlocuiește setarea \"Timp înainte de începerea turneului\"';

  @override
  String get arenaAllowBerserk => 'Permite Berserk';

  @override
  String get arenaAllowBerserkHelp =>
      'Lăsați jucătorii să își înjumătățească timpul pentru a obține un punct în plus';

  @override
  String get arenaAllowChatHelp =>
      'Permiteți jucătorilor să discute într-o cameră de chat';

  @override
  String get arenaArenaStreaks => 'Serie de victorii in arenă';
  ...
  @override
  String get arenaAveragePerformance => 'Performanță medie';

  @override
  String get arenaAverageScore => 'Scor mediu';

  @override
  String get arenaMyTournaments => 'Turneele mele';

  @override
  String get arenaEditTournament => 'Editare turneu';
  ...
  String arenaAllAveragesAreX(String param) {
    return 'Toate mediile de pe această pagină sunt $param.';
  }
  ...
  @override
  String get arenaPointsAvg => 'Medie puncte';

  @override
  String get arenaPointsSum => 'Sumă puncte';

  @override
  String get arenaRankAvg => 'Media rangului';
  ...
  String get arenaTournamentPairingsAreNowClosed =>
      'Cuplările în turneu sunt acum încheiate.';
  ...
  String arenaDrawingWithinNbMoves(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      few:
          'Efectuarea unei remize în primele $count mutări nu va aduce niciun punct niciunui jucător.',
      one:
          'Efectuarea unei remize la prima mutare nu va aduce niciun punct niciunui jucător.',
    );
    return '$_temp0';
  }
  ...
  String arenaViewAllXTeams(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Vezi toate cele $count de echipe',
      few: 'Vezi toate cele $count echipe',
      one: 'Vezi echipa',
    );
    return '$_temp0';
  }
  ...
  String get broadcastHowToUseLichessBroadcasts =>
      'Cum să utilizați emisiunile Lichess.';
  ...
  String get broadcastDefinitivelyDeleteRound =>
      'Șterge definitiv runda și jocurile sale.';
  ...
  String get broadcastShowScores =>
      'Arată scorurile jucătorilor pe baza rezultatelor jocului';
  ...
  String get challengeDeclineGeneric =>
      'Nu accept provocări la momentul actual.';

  @override
  String get challengeDeclineLater =>
      'Nu este timpul potrivit, te rog întreabă mai târziu.';
  ...
  String get challengeDeclineTimeControl =>
      'Nu accept provocări cu acest timp.';

  @override
  String get challengeDeclineRated =>
      'Te rog să îmi trimiți în loc o provocare oficială.';

  @override
  String get challengeDeclineCasual =>
      'Te rog să îmi trimiți în loc o provocare neoficială.';

  @override
  String get challengeDeclineStandard =>
      'Nu accept provocări de variantă acum.';

  @override
  String get challengeDeclineVariant =>
      'Nu sunt dispus să joc această variantă acum.';
  ...
  String get challengeInviteLichessUser =>
      'Sau invitați un utilizator Lichess:';
  ...
  String get coordinatesKnowingTheChessBoard =>
      'Să știi coordonatele tablei de șah e o abilitate foarte importantă:';

  @override
  String get coordinatesMostChessCourses =>
      'Majoritatea exercițiilor și cursurilor de șah folosesc des notația algebrică.';

  @override
  String get coordinatesTalkToYourChessFriends =>
      'Devine mai ușor să discuți cu prietenii tăi șahiști, căci înțelegeți „limba șahului”.';

  @override
  String get coordinatesYouCanAnalyseAGameMoreEffectively =>
      'Poți analiza o partidă mai eficient dacă stii să recunoști rapid coordonatele.';

  @override
  String get coordinatesACoordinateAppears =>
      'O coordonate apare pe tablă și trebuie să faceți clic pe pătratul corespunzător.';

  @override
  String get coordinatesASquareIsHighlightedExplanation =>
      'Un pătrat este evidențiat pe tablă și trebuie să introduceți coordonatele sale (ex. \"e4\").';

  @override
  String get coordinatesYouHaveThirtySeconds =>
      'Ai 30 de secunde pentru a găsi poziția corectă pentru cât mai multe pătrate!';

  @override
  String get coordinatesGoAsLongAsYouWant =>
      'Continuă cât de mult vrei, nu există o limită de timp!';
  ...
  String get coordinatesPracticeOnlySomeFilesAndRanks =>
      'Exersează doar câteva coloane și linii';
  ...
  @override
  String get patronBecomePatron => 'Devino un Patron Lichess';
  ...
  String get preferencesBoardHighlights =>
      'Evidențieri pe tablă (ultima mutare și șahul)';

  @override
  String get preferencesPieceDestinations =>
      'Destinația piesei (mutări valide și premutări)';
  ...
  String get preferencesMoveListWhilePlaying =>
      'Lista de mutări în timpul jocului';
  ...
  @override
  String get preferencesOnlyOnInitialPosition => 'Doar înainte de prima mutare';
  ...
  String get preferencesTakebacksWithOpponentApproval =>
      'Dă înapoi (cu aprobarea adversarului)';
  ...
  String get preferencesCorrespondenceAndUnlimited =>
      'Corespondență sau timp nelimitat';
  ...
  String get preferencesInputMovesWithTheKeyboard =>
      'Introdu mutări folosind tastatura';
  ...
  String get preferencesNotifyForumMention =>
      'Un comentariu din forum vă menționează';
  ...
  String get preferencesNotifyGameEvent =>
      'Actualizări la jocurile prin corespondență';
  ...
  String get preferencesNotifyTimeAlarm =>
      'Timpul rămas la jocurile prin corespondență e scurt';
  ...
  String get preferencesNotifyPush =>
      'Notificare dispozitiv când nu ești în Lichess';
  ...
  String get puzzleVoteToLoadNextOne =>
      'Votează pentru a-l încărca pe următorul!';
  ...
  String get puzzleFindTheBestMoveForWhite =>
      'Găsiți cea mai bună mutare pentru alb.';

  @override
  String get puzzleFindTheBestMoveForBlack =>
      'Găsiți cea mai bună mutare pentru negru.';

  @override
  String get puzzleToGetPersonalizedPuzzles =>
      'Pentru a primi probleme de șah personalizate:';
  ...
  String get puzzleUseCtrlF =>
      'Folosește Ctrl+f pentru a găsi deschiderea favorită!';
  ...
  String get puzzleJumpToNextPuzzleImmediately =>
      'Sari imediat la problema următoare';

  @override
  String get puzzlePuzzleDashboard =>
      'Panoul de control pentru probleme de șah';
  ...
  String get puzzleLookupOfPlayer =>
      'Caută puzzle-uri din jocurile unui jucător';
  ...
  String get puzzlePuzzleDashboardDescription =>
      'Antreneaza-te, analizează, fii mai bun';
  ...
  String get puzzleNoPuzzlesToShow =>
      'Nimic de arătat, joacă mai întâi câteva puzzle-uri!';

  @override
  String get puzzleImprovementAreasDescription =>
      'Antreneaza-te pentru a-ti optimiza progresul!';

  @override
  String get puzzleStrengthDescription =>
      'Obțineți cele mai bune rezultate la aceste teme';
  ...
  String get puzzleThemeBishopEndgameDescription =>
      'Un final de partidă doar cu nebuni și pioni.';
  ...
  String get puzzleThemeCastlingDescription =>
      'Adu regele în siguranță și mută tura pentru atac.';
  ...
  String get puzzleThemeEndgameDescription =>
      'O tactică în ultima etapă a jocului.';
  ...
  String get puzzleThemeKnightEndgameDescription =>
      'Un final de partidă doar cu pioni și cai.';
  ...
  String get puzzleThemeMateIn5Description =>
      'Găsește o secvență lungă de mat.';
  ...
  String get puzzleThemeMiddlegameDescription =>
      'O tactică în a doua etapă a jocului.';
  ...
  String get puzzleThemeOneMoveDescription =>
      'Un puzzle care are doar o mutare.';
  ...
  String get puzzleThemeOpeningDescription =>
      'O tactică în prima etapă a jocului.';
  ...
  String get puzzleThemePawnEndgameDescription =>
      'Un final de partidă doar cu pioni.';
  ...
  String get puzzleThemeQueenEndgameDescription =>
      'Un final de partidă doar cu regine și pioni.';
  ...
  String get puzzleThemeRookEndgameDescription =>
      'Un final de partidă doar cu turnuri și pioni.';
  ...
  String get puzzleThemeUnderPromotionDescription =>
      'Promovează într-un cal, un nebun sau o tură.';
  ...
  String get puzzleThemeVeryLongDescription =>
      'Patru mutări sau mai multe pentru a câștiga.';
  ...
  String get settingsCloseAccountAreYouSure =>
      'Ești sigur că vrei să închizi contul?';
  ...
  @override
  String get playAgainstComputer => 'Joacă împotriva calculatorului';
  ...
  String get orLetYourOpponentScanQrCode =>
      'Sau lăsați adversarul să scaneze acest cod QR';
  ...
  @override
  String get createTheGame => 'Creează jocul';
  ...
  @override
  String get cheatDetected => 'Trișare detectată';
  ...
  String get yourOpponentWantsToPlayANewGameWithYou =>
      'Adversarul dvs. vă propune o nouă partidă';
  ...
  @override
  String get talkInChat => 'Te rugăm să fii cu bun simț pe chat!';
  ...
  String get requestAComputerAnalysis =>
      'Cereți o analiză făcută de calculator';

  @override
  String get computerAnalysis => 'Analiza calculatorului';

  @override
  String get computerAnalysisAvailable =>
      'Analiza calculatorului este disponibilă';
  ...
  @override
  String get loadingEngine => 'Se încarcă motorul...';
  ...
  @override
  String get cloudAnalysis => 'Analiză cloud';
  ...
  String masterDbExplanation(String param1, String param2, String param3) {
    return 'Jocuri reale OTB ale jucătorilor cu evaluare FIDE $param1+ între $param2 și $param3';
  }
  ...
  String get openingEndgameExplorer =>
      'Explorator de deschideri/finaluri de joc';
  ...
  String get removesTheDepthLimit =>
      'Elimină limita de adâncime (și încălzește computerul)';
  ...
  String get youNeedAnAccountToDoThat =>
      'Aveți nevoie de cont pentru această acțiune';
  ...
  String get error_weakPassword =>
      'Această parolă este extrem de comună şi prea uşor de ghicit.';

  @override
  String get error_namePassword =>
      'Te rugăm să nu folosești numele tău de utilizator ca parolă.';
  ...
  String get neverTypeYourPassword =>
      'Nu introduceți niciodată parola Lichess pe un alt site!';
  ...
  String get emailConfirmNotReceived =>
      'Nu ai primit emailul de confirmare după înregistrare?';

  @override
  String get whatSignupUsername =>
      'Ce nume de utilizator ai folosit pentru a te înregistra?';
  ...
  String get accountConfirmationEmailNotNeeded =>
      'Nu aveți nevoie de un email de confirmare.';
  ...
  String get youHaveBeenTimedOut =>
      'Pentru o perioadă, nu mai aveți acces la chat.';
  ...
  @override
  String get ratingFilter => 'Filtru de rating';
  ...
  String get openingExplorerAndTablebase =>
      'Deschide exploratorul și baza de finaluri';
  ...
  @override
  String get whiteProposesTakeback => 'Albul propune revocare';

  @override
  String get blackProposesTakeback => 'Negrul propune revocare';

  @override
  String get takebackPropositionSent => 'Propunere de revocare trimisă';

  @override
  String get whiteDeclinesTakeback => 'Albul refuză revocarea';

  @override
  String get blackDeclinesTakeback => 'Negrul refuză revocarea';

  @override
  String get whiteAcceptsTakeback => 'Albul acceptă retragerea';

  @override
  String get blackAcceptsTakeback => 'Negrul acceptă retragerea';

  @override
  String get whiteCancelsTakeback => 'Albul anulează cererea de retragere';

  @override
  String get blackCancelsTakeback => 'Negrul anulează cererea de retragere';

  @override
  String get yourOpponentProposesATakeback =>
      'Adversarul tău propune revocarea unei mutări';
  ...
  String get ratingRangeIsDisabledBecauseYourRatingIsProvisional =>
      'Filtrele de rating sunt blocate pentru că ratingul tău nu este stabil. Jucarea partidelor cu rating va crește stabilitatea.';
  ...
  String ratedLessThanInPerf(String param1, String param2) {
    return 'Evaluat ≤ $param1 în $param2 în ultima săptămână';
  }
  ...
  @override
  String get standings => 'Clasament';
  ...
  String get youCanHideFlair =>
      'Există o setare pentru a ascunde flair-ul utilizatorilor pe întregul site.';
  ...
  @override
  String get createANewTopic => 'Creează un subiect nou';
  ...
  String get reportCheatBoostHelp =>
      'Adaugă link-ul de la joc(uri) și arată ce este greșit cu privire la comportamentul acestui utilizator. Nu preciza doar \"trișează\", ci spune-ne cum ai ajuns la această concluzie.';

  @override
  String get reportUsernameHelp =>
      'Explică de ce acest nume de utilizator este jignitor. Nu spune doar \"e ofensator/inadecvat\", ci spune-ne cum ai ajuns la această concluzie, mai ales în cazul în care insulta este obscură, nu este în engleză, este jargon sau este o referință istorică/culturală.';
  ...
  String get writeAPrivateNoteAboutThisUser =>
      'Scrie o notiță privată despre acest utilizator';
  ...
  String get letOtherPlayersFollowYou =>
      'Permite altor jucători să te urmărească';

  @override
  String get letOtherPlayersChallengeYou =>
      'Permite altor jucători să te provoace la joc';

  @override
  String get letOtherPlayersInviteYouToStudy =>
      'Lasă alți jucători să te invite într-un studiu';
  ...
  String get allInformationIsPublicAndOptional =>
      'Aceste date sunt publice și opționale.';
  ...
  @override
  String get error_required => 'Acest câmp este necesar';
  ...
  String get error_email_unique =>
      'Adresa de e-mail nu este validă sau este deja folosită';
  ...
  @override
  String get titleVerification => 'Verificarea titlului';
  ...
  @override
  String get averageCentipawnLoss => 'Medie centipioni pierduți';
  ...
  String get keyNextLearnFromYourMistakes =>
      'Următorul (Învață din greșelile tale)';
  ...
  String get cyclePreviousOrNextVariation =>
      'Ciclu de variație precedentă/următoare';

  @override
  String get toggleGlyphAnnotations => 'Comută comentarii la mutări';

  @override
  String get togglePositionAnnotations =>
      'Activează/Dezactivează adnotările pozițiilor';

  @override
  String get variationArrowsInfo =>
      'Săgețile de variație vă permit să navigați fără a utiliza lista mutărilor.';
  ...
  String get tournamentHomeTitle =>
      'Turnee de șah cu control de timp și variante';
  ...
  String get ifYouDoNotGetTheEmail =>
      'Dacă nu primești emailul în decurs de 5 minute:';

  @override
  String get checkAllEmailFolders =>
      'Verifică secțiunile de spam, junk și altele';
  ...
  String get networkLagBetweenYouAndLichess =>
      'Rețea lentă între tine și Lichess';
  ...
  String get youCanAlsoScrollOverTheBoardToMoveInTheGame =>
      'Derulează peste tablă pentru a te deplasa în joc.';
  ...
  String get primaryColorArrowsHowTo =>
      'Ctrl sau shift = roșu; comandă, alt, sau meta = albastru; o cheie pentru fiecare = galben.';

  @override
  String get letOtherPlayersMessageYou =>
      'Permite altor jucători să îți trimită mesaje';

  @override
  String get receiveForumNotifications =>
      'Primește notificări atunci când ești menționat în forum';
  ...
  String get usernameAlreadyUsed =>
      'Numele de utilizator este deja folosit, te rugăm să încerci altul.';

  @override
  String get usernamePrefixInvalid =>
      'Numele de utilizator trebuie să înceapă cu o literă.';
  ...
  String yourRatingIsX(String param) {
    return 'Ratingul tău este $param';
  }

  @override
  String get practiceWithComputer => 'Joacă cu calculatorul';
  ...
  @override
  String get youBrowsedAway => 'Ați părăsit jocul cu calculatorul';
  ...
  String get drawByFiftyMoves =>
      'Partida s-a terminat remiză din cauza regulii de 50 de mutări.';
  ...
  @override
  String get waitingForAnalysis => 'Așteptând analiza';

  @override
  String get noMistakesFoundForWhite =>
      'Nici o greșeală găsită din partea albelor';

  @override
  String get noMistakesFoundForBlack =>
      'Nici o greșeală găsită din partea negrelor';
  ...
  String get doneReviewingBlackMistakes =>
      'Gata cu analiza greșelilor din partea negrelor';
  ...
  String get potentialProblem =>
      'Când o potențială problemă este detectată, afișăm acest mesaj.';
  ...
  String get resignLostGames =>
      'Abandonați partidele pierdute (nu lăsați timpul să expire).';

  @override
  String get temporaryInconvenience =>
      'Ne pare rău pentru neplăcerile temporare';

  @override
  String get wishYouGreatGames =>
      'și vă dorim partide deosebite pe Lichess.org.';
  ...
  String get agreementNice =>
      'Sunt de acord să fiu mereu respectuos cu alți jucători.';
  ...
  String get agreementPolicy =>
      'Sunt de acord cu respectarea tuturor politicilor Lichess.';

  @override
  String get searchOrStartNewDiscussion =>
      'Caută sau începe o nouă conversație';
  ...
  String get ultraBulletDesc =>
      'Partide incredibil de rapide: mai puțin de 30 de secunde';
  ...
  String get correspondenceDesc =>
      'Partide prin corespondență: o mutare la una sau mai multe zile';
  ...
  String makeSureToRead(String param1) {
    return 'Asigură-te că ai citit $param1';
  }
  ...
  String get thisTopicIsArchived =>
      'Acest subiect a fost arhivat și nu mai acceptă răspunsuri.';
  ...
  String get someoneYouReportedWasBanned =>
      'Cineva pe care l-ai raportat a fost banat';
  ...
  String get clickToRevealEmailAddress =>
      '[Click pentru a dezvălui adresa de e-mail]';
  ...
  String get tournDescriptionHelp =>
      'Vrei să spui participanților ceva special? Încearcă să fii succint. Poți folosi link-uri Markdown: [nume](https://url)';
  ...
  String simulFeaturedHelp(String param) {
    return 'Arătați-vă simul-ul tuturor de pe $param. Dezactivați pentru simul-uri private.';
  }
  ...
  @override
  String get tournChat => 'Conversație';
  ...
  String get toggleLocalAnalysis =>
      'Activează/dezactivează analiza computerizată locală';

  @override
  String get toggleAllAnalysis =>
      'Activează/dezactivează analiza computerizată';
  ...
  @override
  String get focusChat => 'Comută la conversație';

  @override
  String get showHelpDialog => 'Arată acest dialog de ajutor';

  @override
  String get reopenYourAccount => 'Redeschide-ți contul';
  ...
  String get youCantStartNewGame =>
      'Nu poți începe un joc nou până când acesta nu se termină.';
  ...
  String get lichessDbExplanation =>
      'Partide evaluate obținute de la toți jucătorii Lichess';
  ...
  String get closingAccountWithdrawAppeal =>
      'Închiderea contului dvs. vă va retrage apelul';

  @override
  String get ourEventTips =>
      'Sfaturile noastre pentru organizarea evenimentelor';
  ...
  @override
  String get enableBlindMode => 'Activează modul fără vedere';
  ...
  String opponentLeftCounter(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'Adversarul tău a părăsit jocul. Poți revendica victoria peste $count de secunde.',
      few:
          'Adversarul tău a părăsit jocul. Poți revendica victoria peste $count secunde.',
      one:
          'Adversarul tău a părăsit jocul. Poți revendica victoria peste o secundă.',
    );
    return '$_temp0';
  }
  ...
  String andSaveNbPremoveLines(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'și salvează $count variații cu mutare anticipată',
  ...
  String get stormYouPlayTheWhitePiecesInAllPuzzles =>
      'Joci cu piesele albe în toate puzzle-urile';
  ...
  String get stormThisRunWasOpenedInAnotherTab =>
      'Runda a fost deschisă într-o altă filă!';
  ...
  String get studyAllSyncMembersRemainOnTheSamePosition =>
      'Toți membrii sincronizați rămân la aceeași poziție';
  ...
  @override
  String get studyCopyRawChapterPgn => 'Copiază PGN simplu';
  ...
  String get studyReadMoreAboutEmbedding =>
      'Citește mai multe despre înglobare';

  @override
  String get studyOnlyPublicStudiesCanBeEmbedded =>
      'Numai studii publice pot fi înglobate!';
  ...
  @override
  String get studyLoadAGameByUrl => 'Încărcați meciuri din URL-uri';

  @override
  String get studyLoadAPositionFromFen => 'Încărcați o poziție din FEN';

  @override
  String get studyLoadAGameFromPgn => 'Încărcați jocuri din PGN';

  @override
  String get studyAutomatic => 'Automată';

  @override
  String get studyUrlOfTheGame => 'URL-urile jocurilor, câte unul pe linie';
  ...
  String get studyYesKeepEveryoneOnTheSamePosition =>
      'Da: menține-i pe toți la aceeași poziție';
  ...
  @override
  String get studyGetTheTour => 'Ai nevoie de ajutor? Urmează turul!';

  @override
  String get studyWelcomeToLichessStudyTitle =>
      'Bine ai venit în Studiile Lichess!';

  @override
  String get studyWelcomeToLichessStudyText =>
      'Aceasta este tabla de analiză comună.<br><br> Folosește-o pentru analiza si adnotarea jocurilor, <br>discuții pe poziții cu prieteni<br> si desigur pentru lecții de șah.<br><br> Este o unealtă puternică, hai să vedem cum funcționează.';

  @override
  String get studySharedAndSaveTitle => 'Distribuit și salvat';

  @override
  String get studySharedAndSavedText =>
      'Alţi membri vă pot vedea mutările în timp real!<br>Plus, totul este salvat pentru totdeauna.';

  @override
  String get studyStudyMembersTitle => 'Membrii studiului';

  @override
  String studyStudyMembersText(String param1, String param2) {
    return '$param1 Spectatori pot vedea studiul și pot vorbi în chat.<br><br>$param2 Contribuitori pot face mutări și actualiza studiul.';
  }
  ...
  @override
  String get studyStudyChaptersTitle => 'Capitole de studiu';

  @override
  String get studyStudyChaptersText =>
      'Un studiu poate conţine mai multe capitole.<br>Fiecare capitol are o poziţie iniţială distinctă şi arbore de mutări.';

  @override
  String get studyCommentPositionTitle => 'Comentariu la o poziţie';
  ...
  @override
  String get studyAnnotatePositionTitle => 'Adnotează o poziție';

  @override
  String get studyAnnotatePositionText =>
      'Clic pe butonul !? sau clic dreapta pe lista de mutări din dreapta.<br> Simbolurile sunt comune și salvate.';

  @override
  String get studyConclusionTitle => 'Mulțumim pentru timpul tău';

  @override
  String get studyConclusionText =>
      'Poți găsi studiile tale <a href=\'/study/mine/hot\'>anterioare</a> din pagina ta de profil.<br>Există, de asemenea, un blog <a href=\'//lichess.org/blog/V0KrLSkAAMo3hsi4/study-chess-the-lichess-way\'>despre studii</a>.<br>Utilizatorii avansați ar putea dori să apese \"?\" pentru a vedea scurtături de taste.<br>Distracție plăcută!';

  @override
  String get studyCreateChapterTitle => 'Să creăm un capitol de studiu';

  @override
  String get studyCreateChapterText =>
      'Un studiu poate avea mai multe capitole.<br>Fiecare capitol are un arbore de mutări distinct,<br>și poate fi creat în diferite moduri.';

  @override
  String get studyFromInitialPositionTitle => 'Din poziţia iniţială';

  @override
  String get studyFromInitialPositionText =>
      'Doar aranjarea tablei pentru un joc nou.<br>Potrivită pentru a explora deschideri.';

  @override
  String get studyCustomPositionTitle => 'Poziție personalizată';

  @override
  String get studyCustomPositionText =>
      'Aranjați tabla cum vreți.<br>Potrivită pentru explorarea finalurilor de joc.';

  @override
  String get studyLoadExistingLichessGameTitle =>
      'Încarcă un joc existent din Lichess';

  @override
  String get studyLoadExistingLichessGameText =>
      'Lipește un URL pentru joc din Lichess<br>(de exemplu lichess.org/7fHIU0XI)<br>pentru a încărca mutările jocului în capitol.';
  ...
  String get studyFromFenStringText =>
      'Lipiți o poziție în formatul FEN<br><i>4k3/4rb2/8/7p/8/5Q2/1PP5/1K6 w</i><br>pentru a începe capitolul dintr-o poziție anume.';

  @override
  String get studyFromPgnGameTitle => 'Dintr-un PGN de joc(uri)';

  @override
  String get studyFromPgnGameText =>
      'Lipiți un joc în format PGN.<br>pentru a încărca mutări, comentarii și variații în capitol.';

  @override
  String get studyVariantsAreSupportedTitle =>
      'Studiile suportă variante de șah';

  @override
  String get studyVariantsAreSupportedText =>
      'Da, poți studia Crazyhouse<br>și toate variantele de șah de pe Lichess!';

  @override
  String get studyChapterConclusionText =>
      'Capitolele sunt salvate pentru totdeauna.<br>Distracție plăcută organizând conținutul tău de șah!';

  @override
  String get studyDoubleDefeat => 'Înfrângere dublă';

  @override
  String get studyBlackDefeatWhiteCanNotWin =>
      'Negrul pierde, dar Albul nu poate câștiga';

  @override
  String get studyWhiteDefeatBlackCanNotWin =>
      'Albul pierde, dar Negrul nu poate câștiga';
  ...
  String studyPasteYourPgnTextHereUpToNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'Lipiți textul PGN aici, până la $count meciuri. Pentru fiecare joc se creează un nou capitol.',
      few:
          'Lipiți textul PGN aici, până la $count meciuri. Pentru fiecare joc se creează un nou capitol.',
