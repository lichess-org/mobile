...
class AppLocalizationsRo extends AppLocalizations {
  ...
  @override
  String get mobileSettingsMaterialDifferenceCapturedPieces => 'Piese capturate';
  ...
  @override
  String get mobileSettingsPickAnImageSwipeToDisplay => 'Glisați pentru a afișa alte fundaluri';
  ...
  String get mobileCustomizeHomeTip =>
      'Sfat: Puteți adăuga mai multe widget-uri în ecranul principal sau să le eliminați pe cele de care nu aveți nevoie!';
  ...
  String get mobileOpeningExplorerNotAvailableOffline =>
      'Exploratorul nu se poate deschide deconectat.';

  @override
  String get mobileChallengeCreated =>
      'Provocare creată: Vei fi notificat când începe jocul.\nO poți accesa din pagina principală.';
  ...
  String get variantChess960Title =>
      'Poziţia de început a pieselor din prima linie este randomizată.';
  ...
  String get variantAntichessTitle =>
      'Pierde-ți toate piesele (sau intră în pat) pentru a câștiga jocul.';
  ...
  String get variantHordeTitle =>
      'O parte are un număr mare de pioni, cealaltă parte are o armată normală.';
  ...
  String get variantRacingKingsTitle =>
      'Adu-ți regele în cealaltă parte a tablei pentru a câștiga.';
  ...
  String get variantCrazyhouseTitle =>
      'Piesele capturate pot fi așezate înapoi pe tablă în loc de a mișca o piesă.';
  ...
  @override
  String get arenaAllowChatHelp => 'Permiteți jucătorilor să discute într-o cameră de chat';
  ...
  String get arenaRankAverageHelp =>
      'Media în clasament reprezintă poziția tipică de final, relativ la numărul total de jucători din fiecare turneu. Aceasta este o măsură a plasamentului dumneavoastră în turneu, nu a ratingului general. \n\nDe exemplu, o medie de clasament de 3% înseamnă că terminați de obicei în top 3% (cum ar fi locul 30 din 1000 de jucători).';
  ...
  @override
  String get arenaOnlyTitledHelp => 'Solicitați un titlu oficial pentru a se alătura turneului';

  @override
  String get arenaTournamentPairingsAreNowClosed => 'Cuplările în turneu sunt acum încheiate.';
  ...
  String get broadcastPermanentlyDeleteTournament =>
      'Ștergeți definitiv acest turneu, inclusiv toate rundele și jocurile?';
  ...
  String get broadcastStandingsDisclaimer =>
      'Clasamentele sunt calculate folosind jocuri difuzate şi pot fi diferite de rezultatele oficiale.';
  ...
  String get broadcastDefaultRoundNameHelp =>
      'Păstrarea numelui implicit îl va traduce automat în toate celelalte limbi.';
  ...
  @override
  String get preferencesBoardHighlights => 'Evidențieri pe tablă (ultima mutare și șahul)';
  ...
  String get preferencesExplainShowPlayerRatings =>
      'Ascunde toate ratingurile de pe Lichess, pentru a te ajuta la concentrarea pe jocul de șah.\nJocurile vor fi evaluate în continuare, această setare afectează doar ce e vizibil.';
  ...
  String get preferencesHoverOverSettingLabelsForHelp =>
      'Plasați cursorul peste etichete pentru ajutor';
  ...
  String get puzzleThemeBalestraMateDescription =>
      'Un nebun dă matul, în timp ce regina blochează pătratele rămase pentru scăpare';
  ...
  String get puzzleThemeBlindSwineMateDescription =>
      'Două ture se alătură pentru a da mat regelui pe o arie de 2x2 pătrate.';
  ...
  String get puzzleThemeCollinearMoveDescription =>
      'Două piese opuse se înfruntă una pe cealaltă, iar una mută de-a lungul liniei de atac fără a captura piesa inamică.';
  ...
  String get puzzleThemeCornerMateDescription =>
      'Restrânge regele spre colț folosind o tură sau regină și un nebun pentru a duce la mat.';
  ...
  String get puzzleThemeDiscoveredCheckDescription =>
      'Mută o piesă pentru a descoperi un șah de la o piesă de atac ascunsă, ceea ce duce adesea la un avantaj decisiv.';
  ...
  String get puzzleThemeEnPassantAdjacentCaptureDescription =>
      'O tactică ce implică regula en passant, unde un pion poate captura un pion opus care tocmai s-a mutat lângă el cu mutarea inițială de două pătrate.';
  ...
  String get puzzleThemeEpauletteMateDescription =>
      'Două pătrate de evacuare adiacente pentru un rege în șah sunt ocupate de alte piese.';
  ...
  String get puzzleThemeForkOpposingPiecesDescription =>
      'O mutare unde o piesă atacă simultan două sau mai multe piese opuse.';
  ...
  String get puzzleThemeHookMateOpposingPawnDescription =>
      'Șah-mat folosind un turn, un cal și un pion, unde un pion adversar blochează evadarea regelui.';
  ...
  String get puzzleThemePillsburysMateDescription =>
      'Tura dă mat, iar nebunul ajută la constrângerea regelui.';
  ...
  String get puzzleThemeMorphysMateDescription =>
      'Folosește nebunul ca să dai șah regelui, în timp ce tura îl constrânge.';
  ...
  String get puzzleThemeSwallowstailMateDescription =>
      'Un fel de mat care se aseamănă vizual cu o coadă de rândunică, similar cu o formă de V.';
  ...
  String get puzzleThemeTriangleMateDescription =>
      'Regina și tura, la un pătrat de regele inamic, sunt pe același linie sau coloană, separate de un singur pătrat, formând un triunghi.';
  ...
  String get puzzleThemeOperaMateDescription =>
      'Dă șah la rege cu o tură si folosește un nebun ca sa aperi tura.';
  ...
  String get puzzleThemeQuietMoveDescription =>
      'O mutare care nu dă șah, capturează sau crează o amenințare imediată, dar care pregătește o amenințare ascunsă și inevitabilă pentru o mutare ulterioară.';
  ...
  String get toInviteSomeoneToPlayGiveThisUrl =>
      'Pentru a invita pe cineva să joace, oferiți acest URL';
  ...
  String get permanentLinkForAnyoneToChallengeYou =>
      'Un link permanent pentru oricine să vă provoace cu exact aceste setări.';
  ...
  @override
  String get requestAComputerAnalysis => 'Cere analiză de la calculator';
  ...
  String get maybeIncludeMoreGamesFromThePreferencesMenu =>
      'Poate doriți să includeți mai multe jocuri prin meniul de preferințe?';
  ...
  String get multipleLinesDescription =>
      'Setaţi numărul de linii de evaluare şi de săgeţi pe tablă';
  ...
  String get threadsDescription =>
      'Setați această valoare sub numărul maxim de fire de execuție al procesorului, bifele marchează o alegere sigură';

  @override
  String get threadsDescriptionMobile =>
      'Mai multe fire de execuţie vor folosi mai multă baterie pentru o analiză mai bună';
  ...
  String get signupEmailPromise =>
      'Îți vom trimite doar e-mailuri despre contul tău și niciodată nu îți vom distribui e-mailul.';
  ...
  String get checkSpamOrJunkFolder =>
      'Dacă nu primiți un e-mail de confirmare, verificați folderul Spam sau Junk. Asigurați-vă că marcați mesajele de la lichess.org ca sigure și \"nu spam\", pentru a rămâne informat cu privire la comunicări importante.';
  ...
  @override
  String get openingExplorerAndTablebase => 'Deschide exploratorul și baza de finaluri';
  ...
  @override
  String get quote => 'Citează';

  @override
  String get postEdited => 'editat';
  ...
  String get reportUsernameHelp =>
      'Explică de ce acest nume de utilizator este jignitor. Nu spune doar \"jignește/e inadecvat\", ci spune-ne cum ai ajuns la această concluzie, mai ales în cazul în care insulta este obscură, nu este în engleză, este jargon sau este o referință istorică/culturală.';
  ...
  String get processReportFasterInEnglish =>
      'Îți putem procesa raportul mai rapid dacă scrii în engleză.';
  ...
  String get creatingASimul =>
      'Crearea unui simul vă permite să jucați împotriva mai multor adversari în același timp.';
  ...
  String get simulClockHint =>
      'Cu cât joci împotriva mai multor jucători, cu atât mai mult vei avea nevoie de timp.';
  ...
  @override
  String get tournamentHomeTitle => 'Turnee de șah cu control de timp și variante';
  ...
  @override
  String get networkLagBetweenYouAndLichess => 'Rețea lentă între tine și Lichess';
  ...
  String opponentLeftCounter(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Adversarul tău a părăsit jocul. Poți revendica victoria peste $count de secunde.',
  ...
  @override
  String get studyWelcomeToLichessStudyTitle => 'Bine ai venit în Studiile Lichess!';
  ...
  @override
  String get studyVariantsAreSupportedTitle => 'Studiile suportă variante de șah';
  ...
  @override
  String get studyBlackDefeatWhiteCanNotWin => 'Negrul pierde, dar Albul nu poate câștiga';

  @override
  String get studyWhiteDefeatBlackCanNotWin => 'Albul pierde, dar Negrul nu poate câștiga';
