...
class AppLocalizationsTr extends AppLocalizations {
  ...
  String activitySupportedNbMonths(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'lichess.org\'u $count aylığına $param2 olarak destekledi',
    );
    return '$_temp0';
  }
  ...
  String activityPracticedNbPositions(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$param2 üzerine $count alıştırma yaptı',
    );
    return '$_temp0';
  }
  ...
  String activityPostedNbMessages(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Forumda $count mesaj paylaştı: $param2',
    );
    return '$_temp0';
  }
  ...
  String activityCompletedNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count adet yazışmalı oyun tamamladı',
    );
    return '$_temp0';
  }
  ...
  String activityFollowedNbPlayers(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count oyuncuyu takip etmeye başladı',
    );
    return '$_temp0';
  }
  ...
  String activityGainedNbFollowers(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count yeni takipçi kazandı',
    );
    return '$_temp0';
  }
  ...
  String activityHostedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count simultaneye ev sahipliği yaptı',
    );
    return '$_temp0';
  }
  ...
  String activityJoinedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count eş zamanlı gösteriye katıldı',
    );
    return '$_temp0';
  }
  ...
  String activityCreatedNbStudies(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count yeni çalışma oluşturdu',
    );
    return '$_temp0';
  }
  ...
  String activityRankedInTournament(int count, String param2, String param3, String param4) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$param3 oyun oynayarak $param4 turnuvasında $count. oldu (en iyi $param2% içinde)',
    );
    return '$_temp0';
  }
  ...
  String activityCompetedInNbSwissTournaments(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count İsviçre Sistemi turnuvasına katıldı',
    );
    return '$_temp0';
  }
  ...
  @override
  String get recommendNotTouching => 'Bu ayarlara dokunmamanızı öneririz.';

  @override
  String get fewerPlayers => 'Turnuvaya katılım şartı koyarsanız, daha az oyuncu katılacaktır.';

  @override
  String get showAdvancedSettings => 'Gelişmiş ayarları göster';
  ...
  @override
  String get insult => 'Hakaret';

  @override
  String get troll => 'Trol';

  @override
  String get ratingManipulation => 'Puan manipülasyonu';
  ...
  @override
  String get boardGeometry => 'Tahta geometrisi';

  @override
  String get boardTheme => 'Tahta teması';

  @override
  String get boardSize => 'Tahta boyutu';
  ...
  String opponentLeftCounter(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Rakibiniz oyundan ayrıldı. $count saniye sonra galibiyet talep edebilirsiniz.',
    );
    return '$_temp0';
  }
  ...
  String mateInXHalfMoves(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count yarım hamle sonra mat',
    );
    return '$_temp0';
  }
  ...
  String ratingXOverYGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$param2 oyun üzerinden $count puanı',
    );
    return '$_temp0';
  }
  ...
  String rankIsUpdatedEveryNbMinutes(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Sıralama her $count dakikada bir güncellenir',
    );
    return '$_temp0';
  }
  ...
  String nbGamesWithYou(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Sizinle oynadığı oyun sayısı: $count',
    );
    return '$_temp0';
  }
  ...
  String needNbMorePerfGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count tane daha dereceli $param2 oynamanız gerekiyor',
    );
    return '$_temp0';
  }
  ...
  String needNbMoreGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count tane daha dereceli oyun oynamanız gerekiyor',
    );
    return '$_temp0';
  }
  ...
  String nbGamesInPlay(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Şu anda $count oyun oynanıyor',
    );
    return '$_temp0';
  }
  ...
  String nbPerfTypePlayersThisWeek(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Bu hafta bir $param2 oyuncusu.',
    );
    return '$_temp0';
  }
  ...
  String availableInNbLanguages(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count farklı dili destekler!',
    );
    return '$_temp0';
  }
  ...
  String nbSecondsToPlayTheFirstMove(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'İlk hamle için son $count saniye',
    );
    return '$_temp0';
  }
  ...
  String andSaveNbPremoveLines(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 've $count önceki varyantları kaydedin',
    );
    return '$_temp0';
  }
  ...
  String puzzleNbPointsBelowYourPuzzleRating(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Bulmaca puanınızın bir puan altında',
    );
    return '$_temp0';
  }
  ...
  String puzzleNbPointsAboveYourPuzzleRating(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Bulmaca puanınızdan bir puan yüksek',
    );
    return '$_temp0';
  }
  ...
  @override
  String get searchAdvancedSearch => 'Gelişmiş Arama';

  @override
  String get searchOpponentName => 'Rakibin ismi';

  @override
  String get searchLoser => 'Kaybeden';

  @override
  String get searchFrom => 'Bu değerden';

  @override
  String get searchTo => 'Bu değere kadar';

  @override
  String get searchHumanOrComputer => 'Oyuncunun rakibi insan mı yoksa bilgisayar mı';

  @override
  String get searchAiLevel => 'Yapay Zeka seviyesi';

  @override
  String get searchSource => 'Kaynak';

  @override
  String get searchNbTurns => 'Hamle sayısı';

  @override
  String get searchResult => 'Sonuç';

  @override
  String get searchWinnerColor => 'Kazanının rengi';

  @override
  String get searchDate => 'Tarih';

  @override
  String get searchSortBy => 'Sıralama ölçütü';

  @override
  String get searchAnalysis => 'Analiz';

  @override
  String get searchOnlyAnalysed => 'Sadece bilgisayar analizi yapılmış oyunları göster';

  @override
  String get searchColor => 'Renk';

  @override
  String get searchEvaluation => 'Değerlendirme';

  @override
  String get searchMaxNumber => 'En çok sayı';

  @override
  String get searchMaxNumberExplanation => 'Getirilecek en çok oyun sayısı';

  @override
  String get searchInclude => 'Dahil et';

  @override
  String get searchDescending => 'Azalan';

  @override
  String get searchAscending => 'Artan';

  @override
  String get searchRatingExplanation => 'Her iki oyuncunun ortalama puanı';
  ...
  String searchSearchInXGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count satranç maçı içinde ara',
      one: '$count satranç maçı içinde ara',
      zero: '$count satranç maçı içinde ara',
    );
    return '$_temp0';
  }
  ...
  String searchXGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count maç bulundu',
      one: 'Bir oyun bulundu',
      zero: 'Bir oyun bulundu',
    );
    return '$_temp0';
  }
  ...
  String searchGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: '$count oyun bulundu',
      zero: '$count oyun bulundu',
    );
    return '$_temp0';
  }
  ...
  @override
  String get streamerLichessStreamer => 'Lichess yayıncısı';

  @override
  String get streamerLive => 'CANLI!';

  @override
  String get streamerOffline => 'ÇEVRİMDIŞI';

  @override
  String streamerCurrentlyStreaming(String param) {
    return 'Canlı yayında: $param';
  }

  @override
  String streamerLastStream(String param) {
    return 'Son yayın: $param';
  }

  @override
  String get streamerBecomeStreamer => 'Lichess yayıncısı ol';

  @override
  String get streamerDoYouHaveStream => 'Twitch veya YouTube yayınınız mı var?';

  @override
  String get streamerHereWeGo => 'Başlayalım!';

  @override
  String get streamerAllStreamers => 'Bütün yayıncılar';

  @override
  String get streamerEditPage => 'Yayıncı sayfasını düzenle';

  @override
  String get streamerYourPage => 'Yayın sayfanız';

  @override
  String get streamerDownloadKit => 'Yayıncı ekipmanlarını indir';
  ...
  @override
  String get streamerRules => 'Yayın kuralları';

  @override
  String get streamerRule1 => 'Lichess üzerinden yayın yaparken, yayın başlığınıza \"lichess.org\" anahtar kelimesini ekleyin.';

  @override
  String get streamerRule2 => 'Lichess ile ilgisi olmayan bir yayın yaparken bu anahtar kelimeyi silin.';

  @override
  String get streamerRule3 => 'Lichess, yayınınızı otomatik olarak bulacak ve size şu avantajları sağlayacaktır:';

  @override
  String streamerRule4(String param) {
    return 'Yayın esnasında herkesin iyi bir oyun tecrübesi edinmesi için $param yazımızı okuyun.';
  }

  @override
  String get streamerStreamingFairplayFAQ => 'yayıncılar için Fairplay SSS';

  @override
  String get streamerPerks => 'Anahtar kelime ile yayın yapmanın avantajları';

  @override
  String get streamerPerk1 => 'Lichess profilinizde, yayına başladığınız zaman yanan bir yayıncı simgesine sahip olursunuz.';

  @override
  String get streamerPerk2 => 'Yayıncılar listesinde en üst sırada görünürsünüz.';

  @override
  String get streamerPerk3 => 'Lichess takipçilerinizi haberdar edersiniz.';

  @override
  String get streamerPerk4 => 'Maç, turnuva ve çalışmalarınızda yayınınızı gösterebilirsiniz.';

  @override
  String get streamerApproved => 'Yayın başvurunuz onaylandı.';

  @override
  String get streamerPendingReview => 'Yayın başvurunuz moderatörler tarafından gözden geçiriliyor.';

  @override
  String get streamerPleaseFillIn => 'Lütfen yayıncı bilgilerini doldurun ve bir fotoğraf yükleyin.';

  @override
  String streamerWhenReady(String param) {
    return 'Lichess yayıncısı olarak listelenmeye hazırsanız, $param';
  }

  @override
  String get streamerRequestReview => 'moderatör incelemesi talep edin';

  @override
  String get streamerStreamerLanguageSettings => 'Lichess yayıncı sayfası yayın platformunuz tarafından sunulan dile göre izleyici kitlenizi hedefler. Yayınlarınız için kullandığınız uygulama veya servis üzerinde satranç yayınlarınızın varsayılan dilini doğru ayarlayın.';

  @override
  String get streamerTwitchUsername => 'Twitch kullanıcı adınız veya kanal bağlantınız';

  @override
  String get streamerOptionalOrEmpty => 'İsteğe bağlı. Yoksa boş bırakın';

  @override
  String get streamerYouTubeChannelId => 'Youtube kanal kimliğiniz';

  @override
  String get streamerStreamerName => 'Lichess üzerindeki yayıncı isminiz';

  @override
  String get streamerVisibility => 'Yayıncılar sayfasına görünsün';

  @override
  String get streamerWhenApproved => 'Moderatörler tarafından onaylandığı zaman';

  @override
  String get streamerHeadline => 'Başlık';

  @override
  String get streamerTellUsAboutTheStream => 'Bir cümle ile bize yayınınızı tarif edin';

  @override
  String get streamerLongDescription => 'Ayrıntılı açıklama';

  @override
  String streamerXStreamerPicture(String param) {
    return '$param yayıncı resmi';
  }

  @override
  String get streamerChangePicture => 'Resmi değiştirin/silin';

  @override
  String get streamerUploadPicture => 'Resim yükle';

  @override
  String streamerMaxSize(String param) {
    return 'Azami boyut: $param';
  }
  ...
  String streamerKeepItShort(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Kısa tutun: En fazla $count karakter',
      one: 'Kısa tutun: En fazla $count karakter',
      zero: 'Kısa tutun: En fazla $count karakter',
    );
    return '$_temp0';
  }
  ...
  @override
  String get studyPleaseOnlyInvitePeopleYouKnow => 'Lütfen sadece tanıdığınız ve katkı sağlayacağını düşündüğünüz kişileri davet ediniz.';
  ...
  @override
  String get studyOnlyContributorsCanRequestAnalysis => 'Sadece katılımcılar bilgisayar analizi isteyebilir.';

  @override
  String get studyGetAFullComputerAnalysis => 'Bu varyant için ayrıntılı bir sunucu analizi yapın.';

  @override
  String get studyMakeSureTheChapterIsComplete => 'Bu bölümü tamamladığınızdan emin olun. Sadece bir kez bilgisayar analizi talep edebilirsiniz.';

  @override
  String get studyAllSyncMembersRemainOnTheSamePosition => 'Senkronize edilen bütün üyeler aynı pozisyonda kalır';
  ...
  @override
  String get studyCopyChapterPgnDescription => 'Bölüm PGN\'sini panoya kopyala.';
  ...
  @override
  String get studyEmbedInYourWebsite => 'İnternet sitenizde ya da blogunuzda gömülü olarak paylaşın';

  @override
  String get studyReadMoreAboutEmbedding => 'Gömülü paylaşma hakkında';

  @override
  String get studyOnlyPublicStudiesCanBeEmbedded => 'Yalnızca herkese açık çalışmalar gömülü paylaşılabilir!';
  ...
  @override
  String get studyClearAllCommentsInThisChapter => 'Bu bölümdeki bütün yorumlar ve işaretler temizlensin mi?';
  ...
  @override
  String get studyDeleteTheStudyChatHistory => 'Çalışmanın sohbet geçmişi silinsin mi? Bunun geri dönüşü yok!';
  ...
  String studyPasteYourPgnTextHereUpToNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'PGN metninizi buraya yapıştırın, en fazla $count oyuna kadar',
    );
    return '$_temp0';
  }
}
