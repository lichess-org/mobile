...
class AppLocalizationsBs extends AppLocalizations {
  ...
  String activityPlayedNbGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Odigrao/la $count $param2 partiju',
    );
    return '$_temp0';
  }
  ...
  String activityHostedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Bio/la domaćin $count simultanke',
    );
    return '$_temp0';
  }
  ...
  String activityJoinedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Učestvovao/la u $count simultanki',
    );
    return '$_temp0';
  }
  ...
  String activityRankedInTournament(int count, String param2, String param3, String param4) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Rangiran/a #$count (prvih $param2%) sa $param3 odigranom partijom u turniru $param4',
    );
    return '$_temp0';
  }
  ...
  String activityCompetedInNbSwissTournaments(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Takmičio se u $count turnirima po švicarskom sistemu',
    );
    return '$_temp0';
  }
  ...
  @override
  String get recommendNotTouching => 'Preporučujemo da ne dirate ove opcije.';

  @override
  String get fewerPlayers => 'Ako postavite uslov za učestvovanje, vaš turnir će imati manje igrača.';

  @override
  String get showAdvancedSettings => 'Pogledajte napredne postavke';
  ...
  @override
  String get insult => 'Vrijeđanje';

  @override
  String get troll => 'Provokacija';

  @override
  String get ratingManipulation => 'Manipuliranje rejtingom';
  ...
  @override
  String get boardGeometry => 'Geometrija ploče';

  @override
  String get boardTheme => 'Tema ploče';

  @override
  String get boardSize => 'Veličina ploče';
  ...
  String opponentLeftCounter(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Vaš protivnik je napustio partiju. Možete proglasiti pobjedu za $count sekundu.',
    );
    return '$_temp0';
  }
  ...
  String ratingXOverYGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count rejting na osnovu $param2 partije',
    );
    return '$_temp0';
  }
  ...
  String nbBookmarks(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count zabilježena partija',
    );
    return '$_temp0';
  }
  ...
  String giveNbSeconds(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Dodajte protivniku $count sekundu',
    );
    return '$_temp0';
  }
  ...
  String needNbMorePerfGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Trebate igrati još $count više $param2 partiju za rejting bodove',
    );
    return '$_temp0';
  }
  ...
  String needNbMoreGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Trebate igrati još $count partiju za rejting bodove',
    );
    return '$_temp0';
  }
  ...
  String nbPerfTypePlayersThisWeek(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count $param2 igrač ove sedmice.',
    );
    return '$_temp0';
  }
  ...
  String andSaveNbPremoveLines(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'i snimi $count potez unaprijed',
    );
    return '$_temp0';
  }
  ...
  String puzzleNbPointsBelowYourPuzzleRating(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Bod ispod vašeg rejtinga u problemima',
    );
    return '$_temp0';
  }
  ...
  String puzzleNbPointsAboveYourPuzzleRating(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Bod iznad vašeg rejtinga u problemima',
    );
    return '$_temp0';
  }
  ...
  @override
  String get searchAdvancedSearch => 'Napredna pretraga';

  @override
  String get searchOpponentName => 'Ime protivnika';

  @override
  String get searchLoser => 'Gubitnik';

  @override
  String get searchFrom => 'Od';

  @override
  String get searchTo => 'Do';

  @override
  String get searchHumanOrComputer => 'Bilo da je protivnik bio čovjek ili računar';

  @override
  String get searchAiLevel => 'Nivo V.I.';

  @override
  String get searchSource => 'Izvor';

  @override
  String get searchNbTurns => 'Broj poteza';

  @override
  String get searchResult => 'Rezultat';

  @override
  String get searchWinnerColor => 'Boja pobjednika';

  @override
  String get searchDate => 'Datum';

  @override
  String get searchSortBy => 'Sortiraj po';

  @override
  String get searchAnalysis => 'Analiza';

  @override
  String get searchOnlyAnalysed => 'Samo partije u kojima je dostupna računarska analiza';

  @override
  String get searchColor => 'Boja';

  @override
  String get searchEvaluation => 'Evaluacija';

  @override
  String get searchMaxNumber => 'Maksimalni broj';

  @override
  String get searchMaxNumberExplanation => 'Maksimalni broj partija za vraćanje';

  @override
  String get searchInclude => 'Uključite';

  @override
  String get searchDescending => 'Silazno';

  @override
  String get searchAscending => 'Uzlazno';

  @override
  String get searchRatingExplanation => 'Prosječni rejting oba igrača';
  ...
  String searchSearchInXGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Pretraga $count šahovskih partija',
      few: 'Pretraga $count šahovske partije',
      one: 'Pretraga $count šahovske partije',
      zero: 'Pretraga $count šahovske partije',
    );
    return '$_temp0';
  }
  ...
  String searchXGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count partija pronađeno',
      few: '$count partije pronađene',
      one: 'Jenda partija pronađena',
      zero: 'Jenda partija pronađena',
    );
    return '$_temp0';
  }
  ...
  String searchGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count partije nađene',
      few: '$count partija nađeno',
      one: '$count partija nađena',
      zero: '$count partija nađena',
    );
    return '$_temp0';
  }
  ...
  @override
  String get streamerLichessStreamer => 'Lichess emiter';

  @override
  String get streamerLive => 'UŽIVO!';

  @override
  String get streamerOffline => 'NIJE NA MREŽI';

  @override
  String streamerCurrentlyStreaming(String param) {
    return 'Trenutno emituje: $param';
  }

  @override
  String streamerLastStream(String param) {
    return 'Poslednje emitovanje: $param';
  }

  @override
  String get streamerBecomeStreamer => 'Postanite Lichess emiter';

  @override
  String get streamerDoYouHaveStream => 'Da li imate Twitch ili YouTube emiterski korisnički račun?';

  @override
  String get streamerHereWeGo => 'Idemo!';

  @override
  String get streamerAllStreamers => 'Svi emiteri';

  @override
  String get streamerEditPage => 'Uredite stranicu emitera';

  @override
  String get streamerYourPage => 'Vaša emiterska stranica';

  @override
  String get streamerDownloadKit => 'Preuzmite paket alata za emitere';

  @override
  String streamerXIsStreaming(String param) {
    return '$param emituje';
  }

  @override
  String get streamerRules => 'Pravila emitovanja';

  @override
  String get streamerRule1 => 'Uključite ključnu riječ \"lichess.org\" u naslov i koristite kategoriju \"Chess\", što znači šah, kada emitujete na Lichess-u.';

  @override
  String get streamerRule2 => 'Uklonite ključnu riječ kada emitujete sadržaj koji nije vezan za Lichess.';

  @override
  String get streamerRule3 => 'Lichess će automatski otkriti Vaše emitovanje i omogućiti sljedeće prednosti:';

  @override
  String streamerRule4(String param) {
    return 'Pročitajte naša $param kako biste osigurali korektnu igru za svakoga tokom Vašeg prijenosa uživo.';
  }

  @override
  String get streamerStreamingFairplayFAQ => 'najčešća pitanja o korektnoj igri tokom prijenosa uživo';

  @override
  String get streamerPerks => 'Prednosti emitovanja sa ključnom riječi';

  @override
  String get streamerPerk1 => 'Dobićete vatrenu ikonicu emitera na svom Lichess profilu.';

  @override
  String get streamerPerk2 => 'Probićete se na vrh liste emitera.';

  @override
  String get streamerPerk3 => 'Obavjestite svoje Lichess pratioce.';

  @override
  String get streamerPerk4 => 'Pokažite svoj kanal za emitovanje u svojim igrama, turnirima i studijama.';

  @override
  String get streamerApproved => 'Vaš kanal za emitovanje je odobren.';

  @override
  String get streamerPendingReview => 'Moderatori pregledaju Vaš kanal za emitovanje.';

  @override
  String get streamerPleaseFillIn => 'Molimo Vas da popunite Vaše informacije o emiteru i da stavite Vašu sliku.';

  @override
  String streamerWhenReady(String param) {
    return 'Kada budete spremni da budete izlistani kao lichess emiter, $param';
  }

  @override
  String get streamerRequestReview => 'zatražite pregled moderatora';

  @override
  String get streamerStreamerLanguageSettings => 'Stranica strimera na Lichessu cilja na Vašu publiku jezikom koji pruža Vaša platforma za striming. Postavite ispravan glavni jezik za Vaše šahovske striminge u aplikaciji ili usluzi koju koristite za emitiranje.';

  @override
  String get streamerTwitchUsername => 'Vaše Twitch korisničko ime ili link';

  @override
  String get streamerOptionalOrEmpty => 'Neobavezno. Ostavite prazno ako ga nemate';

  @override
  String get streamerYouTubeChannelId => 'ID Vašeg kanala na YouTubeu';

  @override
  String get streamerStreamerName => 'Ime Vašeg Lichess emiter kanala';

  @override
  String get streamerVisibility => 'Vidljivo na stranici kanala za emitovanje';

  @override
  String get streamerWhenApproved => 'Nakon odobrenja moderatora';

  @override
  String get streamerHeadline => 'Naslov';

  @override
  String get streamerTellUsAboutTheStream => 'Opišite Vaš kanal za emitovanje u jednoj rečenici';

  @override
  String get streamerLongDescription => 'Dugi opis';

  @override
  String streamerXStreamerPicture(String param) {
    return '$param slika emitera';
  }

  @override
  String get streamerChangePicture => 'Promjenite / izbrišite Vašu sliku';

  @override
  String get streamerUploadPicture => 'Učitajte sliku';

  @override
  String streamerMaxSize(String param) {
    return 'Maksimalna veličina: $param';
  }
  ...
  String streamerKeepItShort(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Neka bude kratko: $count slova maksimalno',
      few: 'Neka bude kratko: $count slova maksimalno',
      one: 'Neka bude kratko: $count slovo maksimalno',
      zero: 'Neka bude kratko: $count slovo maksimalno',
    );
    return '$_temp0';
  }
  ...
  @override
  String get studyCopyChapterPgnDescription => 'Kopirajte PGN-poglavlje u međuspremnik.';
  ...
  String studyPasteYourPgnTextHereUpToNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Ovdje zalijepite svoj PGN tekst, do $count partije',
    );
    return '$_temp0';
  }
}
