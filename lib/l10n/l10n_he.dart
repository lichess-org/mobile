...
class AppLocalizationsHe extends AppLocalizations {
  ...
  String get orLetYourOpponentScanQrCode =>
      'אפשר גם לתת ליריבך לסרוק את קוד ה־QR הזה';
  ...
  String get emailForSignupHelp =>
      'אם עדיין לא הצלחתם לפתור את הבעיה, שלחו לנו את המייל הבא:';
  ...
  String get waitForSignupHelp =>
      'אנו נחזור אליכם בהקדם כדי לסייע לכם להשלים את ההרשמה.';
  ...
  String get emptyTournamentName =>
      'השאירו ריק כדי לקרוא לטורניר על שם שחקן/ית שח דגול/ה.';
  ...
  String get simulHostExtraTimePerPlayer =>
      'זמן נוסף למארח/ת עבור כל שחקן/ית שמצטרף/ת';
  ...
  String get variationArrowsInfo =>
      'חצי הווריאנטים מאפשרים ניווט קל ללא צורך ברשימת המסעים.';
  ...
  String get tournamentHomeTitle =>
      'טורנירי שחמט הכוללים משחקים עם מגבלות זמן וסוגי שחמט מגוונים';
  ...
  String get playVariationToCreateConditionalPremoves =>
      'צרו וריאציה כדי להגדיר מסעים מותנים מראש';
  ...
  String get agreementNice =>
      'אני מסכימ/ה שתמיד אהיה אדיב/ה כלפי השחקנים האחרים.';
