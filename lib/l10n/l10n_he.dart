...
class AppLocalizationsHe extends AppLocalizations {
  ...
  @override
  String get blankedPassword => 'השתמשת בסיסמה שלך באתר אחר, ויתכן שהיא מועדת לפריצה. כדי להגן על חשבונך בליצ׳ס, עליך להגדיר סיסמה חדשה. תודה על ההבנה.';

  @override
  String get youAreLeavingLichess => 'את/ה עוזב/ת את Lichess';

  @override
  String get neverTypeYourPassword => 'לעולם אל תקלידו את סיסמתכם בליצ׳ס באף אתר אחר!';
  ...
  @override
  String get toStudy => 'הפכו ללוח למידה';
  ...
  @override
  String get boardGeometry => 'תצוגת הלוח';

  @override
  String get boardTheme => 'עיצוב הלוח';

  @override
  String get boardSize => 'גודל הלוח';
  ...
  @override
  String get lichessDbExplanation => 'משחקים מדורגים אשר נדגמו מכלל שחקני ליצ׳ס';
  ...
  @override
  String get searchAdvancedSearch => 'חיפוש מתקדם';

  @override
  String get searchOpponentName => 'שם היריב';

  @override
  String get searchLoser => 'מפסיד';

  @override
  String get searchFrom => 'מ';

  @override
  String get searchTo => 'עד';

  @override
  String get searchHumanOrComputer => 'אם היריב של השחקן היה אנושי או מחשב';

  @override
  String get searchAiLevel => 'רמת הבינה המלאכותית';

  @override
  String get searchSource => 'מקור';

  @override
  String get searchNbTurns => 'מספר התורות';

  @override
  String get searchResult => 'תוצאה';

  @override
  String get searchWinnerColor => 'הצבע המנצח';

  @override
  String get searchDate => 'תאריך';

  @override
  String get searchSortBy => 'מיין לפי';

  @override
  String get searchAnalysis => 'ניתוח';

  @override
  String get searchOnlyAnalysed => 'רק משחקים בהם ניתוח המחשב זמין';

  @override
  String get searchColor => 'צבע';

  @override
  String get searchEvaluation => 'הערכה';

  @override
  String get searchMaxNumber => 'מספר מירבי';

  @override
  String get searchMaxNumberExplanation => 'מספר מקסימלי שלי משחקים במקביל';

  @override
  String get searchInclude => 'כלול';

  @override
  String get searchDescending => 'סדר יורד';

  @override
  String get searchAscending => 'סדר עולה';

  @override
  String get searchRatingExplanation => 'הדירוג הממוצע של שני השחקנים';
  ...
  String searchSearchInXGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'חפש ב$count משחקים',
      many: 'חפש ב$count משחקים',
      two: 'חפש ב$count משחקים',
      one: 'חפש ב$count משחק',
      zero: 'חפש ב$count משחק',
    );
    return '$_temp0';
  }
  ...
  String searchXGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count משחקים נמצאו',
      many: '$count משחקים נמצאו',
      two: '$count משחקים נמצאו',
      one: 'משחק אחד נמצא',
      zero: 'משחק אחד נמצא',
    );
    return '$_temp0';
  ...
  String searchGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'נמצאו $count משחקים',
      many: 'נמצאו $count משחקים',
      two: 'נמצאו $count משחקים',
      one: 'נמצא משחק $count',
      zero: 'נמצא משחק $count',
    );
    return '$_temp0';
  }
  ...
  @override
  String get streamerLichessStreamer => 'שדרן ליצ׳ס';

  @override
  String get streamerLive => 'בשידור חי!';

  @override
  String get streamerOffline => 'מנותק';

  @override
  String streamerCurrentlyStreaming(String param) {
    return 'משדרים כרגע: $param';
  }

  @override
  String streamerLastStream(String param) {
    return 'משדר אחרון $param';
  }

  @override
  String get streamerBecomeStreamer => 'הפכו לשדרני ליצ׳ס';

  @override
  String get streamerDoYouHaveStream => 'יש לך ערוץ יוטיוב או טוויץ\'?';

  @override
  String get streamerHereWeGo => 'יוצאים לדרך!';

  @override
  String get streamerAllStreamers => 'כל השדרנים';

  @override
  String get streamerEditPage => 'ערוך עמוד שדרן';

  @override
  String get streamerYourPage => 'עמוד המשדר שלכם';

  @override
  String get streamerDownloadKit => 'הורדת ערכת משדר';
  ...
  @override
  String get streamerRules => 'חוקי שידור';

  @override
  String get streamerRule1 => 'יש לכלול את מילת המפתח \"lichess.org\" בכותרת המשדר שלכם ולהשתמש בקטגוריית \"Chess\", כשאתם משדרים בליצ׳ס.';

  @override
  String get streamerRule2 => 'יש להסיר את מילת המפתח כשאתם משדרים תוכן שאינו קשור לליצ׳ס.';

  @override
  String get streamerRule3 => 'ליצ׳ס יזהה את המשדר שלכם בצורה אוטומטית ויפעיל את ההטבות הבאות:';

  @override
  String streamerRule4(String param) {
    return 'קראו את $param כדי לאפשר משחק הוגן לכולם בזמן המשדר שלכם.';
  }

  @override
  String get streamerStreamingFairplayFAQ => 'המדריך שלנו לשידור הוגן';

  @override
  String get streamerPerks => 'הטבות שידור עם מילת המפתח';

  @override
  String get streamerPerk1 => 'תקבלו אייקון משדר בוער בפרופיל הליצ׳ס שלכם.';

  @override
  String get streamerPerk2 => 'תועלו למעלה ברשימת המשדרים.';

  @override
  String get streamerPerk3 => 'העוקבים שלכם בליצ׳ס יקבלו הודעה.';

  @override
  String get streamerPerk4 => 'תוכלו להציג את השידור שלכם במשחקים, טורנירים ובלוחות הלמידה שלכם.';

  @override
  String get streamerApproved => 'המשדר שלכם אושר.';

  @override
  String get streamerPendingReview => 'המשדר שלכם עובר בדיקת מנהלים.';

  @override
  String get streamerPleaseFillIn => 'אנא מלאו את פרטי המשדר שלכם והעלו תמונה.';

  @override
  String streamerWhenReady(String param) {
    return 'כאשר אתם מוכנים להיכנס לרשימת שדרני ליצ׳ס, $param';
  }

  @override
  String get streamerRequestReview => 'בקשו בדיקת מנהלים';

  @override
  String get streamerStreamerLanguageSettings => 'עמוד השדרנים של ליצ׳ס מכוון את הקהל שלך לפי השפה שבימת השידור שלך סיפקה לנו. הגדירו את השפה הנכונה באפליקציה או בשירות המשמשים אתכם לשידור.';

  @override
  String get streamerTwitchUsername => 'שם המשתמש או כתובת הTwitch שלכם';

  @override
  String get streamerOptionalOrEmpty => 'אופציונאלי. אם אין, השאירו את השדה ריק';

  @override
  String get streamerYouTubeChannelId => 'המזהה (ID) של ערוץ ה-YouTube שלך';

  @override
  String get streamerStreamerName => 'השם שלכם כשדרנים בליצ׳ס';

  @override
  String get streamerVisibility => 'גלוי בעמוד השדרנים';

  @override
  String get streamerWhenApproved => 'לאחר אישור מנהלים';

  @override
  String get streamerHeadline => 'כּוֹתֶרֶת';

  @override
  String get streamerTellUsAboutTheStream => 'ספרו לנו על שידורכם במשפט אחד';

  @override
  String get streamerLongDescription => 'תיאור ארוך';

  @override
  String streamerXStreamerPicture(String param) {
    return 'תמונה של השדרן $param';
  }

  @override
  String get streamerChangePicture => 'שינוי/מחיקת התמונה שלך';

  @override
  String get streamerUploadPicture => 'העלאת תמונה';

  @override
  String streamerMaxSize(String param) {
    return 'גודל מרבי: $param';
  }
  ...
  @override
  String get studyStudyPgn => 'הPGN של לוח הלמידה';

  @override
  String get studyDownloadAllGames => 'הורדת כל המשחקים';

  @override
  String get studyChapterPgn => 'הPGN של הפרק';

  @override
  String get studyCopyChapterPgn => 'העתקת ה-PGN';

  @override
  String get studyCopyChapterPgnDescription => 'העתקת ה-PGN של הפרק ללוח.';
