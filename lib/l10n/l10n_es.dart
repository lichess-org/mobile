...
class AppLocalizationsEs extends AppLocalizations {
  ...
  String activitySupportedNbMonths(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Ha colaborado con lichess.org durante $count mes como $param2',
    );
    return '$_temp0';
  }
  ...
  String activityPracticedNbPositions(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Ha practicado $count posición en $param2',
    );
    return '$_temp0';
  }
  ...
  String activitySolvedNbPuzzles(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Ha resuelto $count ejercicio de táctica',
    );
    return '$_temp0';
  }
  ...
  String activityPlayedNbGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Ha jugado $count partida $param2',
    );
    return '$_temp0';
  }
  ...
  String activityPostedNbMessages(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Ha publicado $count mensaje en $param2',
    );
    return '$_temp0';
  }
  ...
  String activityPlayedNbMoves(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Ha hecho $count movimiento',
    );
    return '$_temp0';
  }
  ...
  String activityCompletedNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Ha jugado $count partida por correspondencia',
    );
    return '$_temp0';
  }
  ...
  String activityGainedNbFollowers(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Tiene $count seguidor nuevo',
    );
    return '$_temp0';
  }
  ...
  String activityHostedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Ha ofrecido $count exhibición simultánea',
    );
    return '$_temp0';
  }
  ...
  String activityJoinedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Ha participado en $count exhibición simultánea',
    );
    return '$_temp0';
  }
  ...
  String activityCompetedInNbTournaments(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Ha competido en $count torneo',
    );
    return '$_temp0';
  }
  ...
  String activityRankedInTournament(int count, String param2, String param3, String param4) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$countº en la clasificación (dentro del $param2% mejor) con $param3 partida en $param4',
    );
    return '$_temp0';
  }
  ...
  String activityCompetedInNbSwissTournaments(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Ha competido en $count torneo suizo',
    );
    return '$_temp0';
  }
  ...
  @override
  String get boardGeometry => 'Geometría del tablero';
  ...
  String mateInXHalfMoves(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Mate en $count medio movimiento',
    );
    return '$_temp0';
  }
  ...
  String rankIsUpdatedEveryNbMinutes(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'La clasificación se actualiza cada minuto',
    );
    return '$_temp0';
  }
  ...
  String moreThanNbPerfRatedGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '≥ $count partida por puntos de $param2',
    );
    return '$_temp0';
  }
  ...
  String needNbMorePerfGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Necesitas jugar $count partida más de $param2 por puntos',
    );
    return '$_temp0';
  }
  ...
  String needNbMoreGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Necesitas jugar $count partida por puntos más',
    );
    return '$_temp0';
  }
  ...
  String nbPerfTypePlayersThisWeek(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count jugador de $param2 esta semana.',
    );
    return '$_temp0';
  }
  ...
  String availableInNbLanguages(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '¡Disponible en $count idioma!',
    );
    return '$_temp0';
  }
  ...
  String nbSecondsToPlayTheFirstMove(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count segundo para hacer el primer movimiento',
    );
    return '$_temp0';
  }
  ...
  String andSaveNbPremoveLines(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'y ahorra $count línea de premovimiento',
    );
    return '$_temp0';
  }
  ...
  @override
  String get searchAdvancedSearch => 'Búsqueda avanzada';

  @override
  String get searchOpponentName => 'Nombre del oponente';

  @override
  String get searchLoser => 'Perdedor';

  @override
  String get searchFrom => 'Desde';

  @override
  String get searchTo => 'Hasta';

  @override
  String get searchHumanOrComputer => 'Si el oponente era humano o un ordenador';

  @override
  String get searchAiLevel => 'Nivel I.A';

  @override
  String get searchSource => 'Origen';

  @override
  String get searchNbTurns => 'Cantidad de turnos';

  @override
  String get searchResult => 'Resultado';

  @override
  String get searchWinnerColor => 'Color del ganador';
  ...
  @override
  String get searchAnalysis => 'Análisis';

  @override
  String get searchOnlyAnalysed => 'Solo partidas que tengan un análisis por ordenador disponible';

  @override
  String get searchColor => 'Color';

  @override
  String get searchEvaluation => 'Evaluación';

  @override
  String get searchMaxNumber => 'Número máximo';

  @override
  String get searchMaxNumberExplanation => 'El número máximo de partidas que se mostrarán en los resultados';
  ...
  @override
  String get searchRatingExplanation => 'La puntuación media de ambos jugadores';
  ...
  String searchXGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Se han encontrado $count partidas',
      one: 'Se ha encontrado $count partida',
  ...
  String streamerCurrentlyStreaming(String param) {
    return 'Transmitiendo ahora: $param';
  }
  ...
  @override
  String get streamerBecomeStreamer => 'Hazte presentador de Lichess';

  @override
  String get streamerDoYouHaveStream => '¿Tienes un canal de Twitch o YouTube?';

  @override
  String get streamerHereWeGo => '¡Allá vamos!';

  @override
  String get streamerAllStreamers => 'Todos los presentadores';

  @override
  String get streamerEditPage => 'Editar página de presentador';

  @override
  String get streamerYourPage => 'Tu página de presentador';

  @override
  String get streamerDownloadKit => 'Descargar kit de presentador';

  @override
  String streamerXIsStreaming(String param) {
    return '$param está transmitiendo';
  }

  @override
  String get streamerRules => 'Reglas de transmisión';

  @override
  String get streamerRule1 => 'Incluye la palabra clave \"lichess.org\" en el título de tu transmisión y usa la categoría \"Chess\" cuando transmitas en Lichess.';

  @override
  String get streamerRule2 => 'Elimina la palabra clave cuando transmitas contenido que no esté relacionado a Lichess.';

  @override
  String get streamerRule3 => 'Lichess detectará tu transmisión automáticamente y habilitará los siguientes beneficios:';

  @override
  String streamerRule4(String param) {
    return 'Lee las $param para garantizar que todos los participantes actúen con deportividad durante la transmisión.';
  }

  @override
  String get streamerStreamingFairplayFAQ => 'Preguntas frecuentes sobre juego limpio en transmisiones';

  @override
  String get streamerPerks => 'Beneficios de transmitir con la palabra clave';

  @override
  String get streamerPerk1 => 'Obtén un llameante icono de presentador en tu perfil de Lichess.';

  @override
  String get streamerPerk2 => 'Sube a la cima de la lista de presentadores.';

  @override
  String get streamerPerk3 => 'Notifica a tus seguidores de Lichess.';

  @override
  String get streamerPerk4 => 'Muestra tu transmisión en tus partidas, torneos y estudios.';

  @override
  String get streamerApproved => 'Tu transmisión está aprobada.';

  @override
  String get streamerPendingReview => 'Tu transmisión está siendo revisada por los moderadores.';

  @override
  String get streamerPleaseFillIn => 'Por favor, rellena la información como presentador y sube una foto.';

  @override
  String streamerWhenReady(String param) {
    return 'Cuando estés preparado para ser listado como un presentador de Lichess, $param';
  }

  @override
  String get streamerRequestReview => 'solicitar una revisión de moderador';

  @override
  String get streamerStreamerLanguageSettings => 'La página de presentador de Lichess se dirige a tu audiencia con el idioma proporcionado por tu plataforma de transmisión. Establece el idioma predeterminado correcto para tus transmisiones de ajedrez en la aplicación o el servicio que uses para retransmitir.';

  @override
  String get streamerTwitchUsername => 'Tu nombre de usuario o URL de Twitch';

  @override
  String get streamerOptionalOrEmpty => 'Opcional. Déjalo vacío si no hay ninguno';

  @override
  String get streamerYouTubeChannelId => 'El ID de tu canal de YouTube';

  @override
  String get streamerStreamerName => 'Tu nombre de presentador en Lichess';

  @override
  String get streamerVisibility => 'Visible en la página de presentadores';

  @override
  String get streamerWhenApproved => 'Cuando lo aprueben los moderadores';

  @override
  String get streamerHeadline => 'Título';

  @override
  String get streamerTellUsAboutTheStream => 'En una frase, cuéntanos sobre tu transmisión';

  @override
  String get streamerLongDescription => 'Descripción larga';

  @override
  String streamerXStreamerPicture(String param) {
    return 'Imagen de presentador $param';
  }

  @override
  String get streamerChangePicture => 'Cambia/elimina tu imagen';

  @override
  String get streamerUploadPicture => 'Subir una foto';
  ...
  String streamerKeepItShort(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Se breve: máximo $count caracteres',
      one: 'Se breve: máximo $count carácter',
      zero: 'Se breve: máximo $count carácter',
    );
    return '$_temp0';
  }
  ...
  String stormPlayedNbRunsOfPuzzleStorm(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Has jugado una ronda de $param2',
    );
    return '$_temp0';
  }
  ...
  @override
  String get studyCopyChapterPgnDescription => 'Copiar PGN del capítulo al portapapeles.';
  ...
  String studyPasteYourPgnTextHereUpToNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Pega aquí el código PGN, $count partida como máximo',
    );
    return '$_temp0';
  }
}
