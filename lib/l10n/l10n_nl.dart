...
class AppLocalizationsNl extends AppLocalizations {
  ...
  String activitySupportedNbMonths(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Steunde lichess.org voor $count maand als $param2',
    );
    return '$_temp0';
  }
  ...
  String activityPracticedNbPositions(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Beoefende $count positie van $param2',
    );
    return '$_temp0';
  }
  ...
  String activitySolvedNbPuzzles(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count tactische puzzel opgelost',
    );
    return '$_temp0';
  }
  ...
  String activityPlayedNbGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Speelde $count $param2 partij',
    );
    return '$_temp0';
  }
  ...
  String activityPostedNbMessages(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Plaatste $count bericht in $param2',
    );
    return '$_temp0';
  }
  ...
  String activityInNbCorrespondenceGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'in $count correspondentiepartij',
    );
    return '$_temp0';
  }
  ...
  String activityCompletedNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Voltooide $count correspondentiepartijen',
    );
    return '$_temp0';
  }
  ...
  String activityGainedNbFollowers(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count nieuwe volger verworven',
    );
    return '$_temp0';
  }
  ...
  String activityJoinedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Nam deel in $count simultaan',
    );
    return '$_temp0';
  }
  ...
  String activityCreatedNbStudies(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count nieuwe studie aangemaakt',
    );
    return '$_temp0';
  }
  ...
  String activityCompetedInNbTournaments(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Nam deel in $count toernooi',
    );
    return '$_temp0';
  }
  ...
  String activityRankedInTournament(int count, String param2, String param3, String param4) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Eindigde #$count (top $param2%) met $param3 partij in $param4',
    );
    return '$_temp0';
  }
  ...
  String activityCompetedInNbSwissTournaments(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Nam deel aan $count Zwitsers toernooi',
    );
    return '$_temp0';
  }
  ...
  String activityJoinedNbTeams(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Sloot zich aan bij $count team',
    );
    return '$_temp0';
  }
  ...
  @override
  String get thisAccountViolatedTos => 'Deze account heeft de Lichess Servicevoorwaarden geschonden';
  ...
  @override
  String get recommendNotTouching => 'Wij raden aan om deze niet aan te raken.';

  @override
  String get fewerPlayers => 'Als u voorwaarden voor deelname instelt, zullen er minder spelers meedoen.';

  @override
  String get showAdvancedSettings => 'Toon uitgebreide instellingen >>';
  ...
  @override
  String get insult => 'Beledigen';

  @override
  String get troll => 'Provoceren';

  @override
  String get ratingManipulation => 'Rating manipulatie';
  ...
  @override
  String get boardGeometry => 'Bordgeometrie';

  @override
  String get boardTheme => 'Bordthema';
  ...
  String opponentLeftCounter(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Je tegenstander heeft het spel verlaten. Je kan de overwinning opeisen over $count seconde.',
    );
    return '$_temp0';
  }
  ...
  String mateInXHalfMoves(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Schaakmat in $count halfzet',
    );
    return '$_temp0';
  }
  ...
  String ratingXOverYGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count rating na $param2 partij',
    );
    return '$_temp0';
  }
  ...
  String rankIsUpdatedEveryNbMinutes(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Positie wordt elke minuut bijgewerkt',
    );
    return '$_temp0';
  }
  ...
  String moreThanNbPerfRatedGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '≥ $count $param2 partij met rating',
    );
    return '$_temp0';
  }
  ...
  String needNbMorePerfGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Je moet $count extra $param2 partij met rating spelen',
    );
    return '$_temp0';
  }
  ...
  String needNbMoreGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Je moet $count partij meer met rating spelen',
    );
    return '$_temp0';
  }
  ...
  String nbImportedGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count Geïmporteerde partij',
    );
    return '$_temp0';
  }
  ...
  String nbPerfTypePlayersThisWeek(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Eén $param2 speler deze week.',
    );
    return '$_temp0';
  }
  ...
  String availableInNbLanguages(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Beschikbaar in $count taal!',
    );
    return '$_temp0';
  }
  ...
  String nbSecondsToPlayTheFirstMove(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count seconde om de eerste zet te spelen',
    );
    return '$_temp0';
  }
  ...
  String andSaveNbPremoveLines(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'en bewaar $count premove-variant',
    );
    return '$_temp0';
  }
  ...
  String puzzleNbPointsAboveYourPuzzleRating(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Eén punt boven je puzzelrating',
    );
    return '$_temp0';
  }
  ...
  @override
  String get searchAdvancedSearch => 'Geavanceerd zoeken';

  @override
  String get searchOpponentName => 'Naam tegenstander';

  @override
  String get searchLoser => 'Verliezer';

  @override
  String get searchFrom => 'Van';

  @override
  String get searchTo => 'Tot';

  @override
  String get searchHumanOrComputer => 'Was de tegenstander een persoon of een computer';

  @override
  String get searchAiLevel => 'A.I. niveau';

  @override
  String get searchSource => 'Bron';

  @override
  String get searchNbTurns => 'Aantal zetten';

  @override
  String get searchResult => 'Uitslag';

  @override
  String get searchWinnerColor => 'Kleur winnaar';
  ...
  @override
  String get searchOnlyAnalysed => 'Alleen partijen waarvan een computeranalyse beschikbaar is';

  @override
  String get searchColor => 'Kleur';

  @override
  String get searchEvaluation => 'Computeroordeel';

  @override
  String get searchMaxNumber => 'Maximumaantal';

  @override
  String get searchMaxNumberExplanation => 'Het maximum aantal partijen dat getoond moet worden';

  @override
  String get searchInclude => 'Voeg toe';

  @override
  String get searchDescending => 'Aflopend';

  @override
  String get searchAscending => 'Oplopend';

  @override
  String get searchRatingExplanation => 'De gemiddelde rating van beide spelers';
  ...
  String searchSearchInXGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Zoek in $count schaakpartijen',
      one: 'Zoek in $count schaakpartij',
      zero: 'Zoek in $count schaakpartij',
    );
    return '$_temp0';
  }
  ...
  String searchXGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count partijen gevonden',
      one: 'Eén partij gevonden',
      zero: 'Eén partij gevonden',
    );
    return '$_temp0';
  }
  ...
  String searchGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other: '$count partijen gevonden',
      one: '$count partij gevonden',
      zero: '$count partij gevonden',
    );
    return '$_temp0';
  }
  ...
  String streamerCurrentlyStreaming(String param) {
    return 'Streamt nu: $param';
  }

  @override
  String streamerLastStream(String param) {
    return 'Vorige stream: $param';
  }

  @override
  String get streamerBecomeStreamer => 'Word een Lichess streamer';

  @override
  String get streamerDoYouHaveStream => 'Heb je een Twitch- of YouTube-kanaal?';

  @override
  String get streamerHereWeGo => 'Daar gaan we!';

  @override
  String get streamerAllStreamers => 'Alle streamers';

  @override
  String get streamerEditPage => 'Wijzig streamer pagina';

  @override
  String get streamerYourPage => 'Mijn streamer pagina';
  ...
  String streamerXIsStreaming(String param) {
    return '$param streamt nu';
  }

  @override
  String get streamerRules => 'Streaming regels';

  @override
  String get streamerRule1 => 'Voeg het trefwoord \"lichess.org\" toe aan uw stream titel wanneer je streamt op Lichess.';

  @override
  String get streamerRule2 => 'Verwijder het trefwoord wanneer u niet-Lichess dingen streamt.';

  @override
  String get streamerRule3 => 'Lichess detecteert je stream automatisch en schakelt de volgende voordelen in:';

  @override
  String streamerRule4(String param) {
    return 'Lees onze $param om te zorgen dat fair play voor iedereen geldt tijdens uw stream.';
  }

  @override
  String get streamerStreamingFairplayFAQ => 'streamen Fairplay FAQ';

  @override
  String get streamerPerks => 'Voordelen van het streamen met een trefwoord';

  @override
  String get streamerPerk1 => 'Krijg een brandende streamer pictogram op je Lichess profiel.';

  @override
  String get streamerPerk2 => 'Word aan de bovenkant van de streamers lijst toegevoegd.';

  @override
  String get streamerPerk3 => 'Waarschuw Lichess volgers.';

  @override
  String get streamerPerk4 => 'Toon je stream in je partijen, toernooien en studies.';

  @override
  String get streamerApproved => 'Je stream is goedgekeurd.';

  @override
  String get streamerPendingReview => 'Je stream wordt beoordeeld door de toezichthouders.';

  @override
  String get streamerPleaseFillIn => 'Vul je streamer informatie in en upload een foto.';

  @override
  String streamerWhenReady(String param) {
    return 'Wanneer u klaar bent om als Lichess stream vermeld te worden, $param';
  }

  @override
  String get streamerRequestReview => 'verzoek een beoordeling van een toezichthouder';

  @override
  String get streamerStreamerLanguageSettings => 'De Lichess streamerpagina toont je publiek de taal die wordt verstrekt door je streamingplatform. Stel de juiste standaardtaal in voor je schaakstreams in de app of service die je gebruikt om te streamen.';

  @override
  String get streamerTwitchUsername => 'Je Twitch gebruikersnaam of website';

  @override
  String get streamerOptionalOrEmpty => 'Optioneel. Laat leeg indien geen';

  @override
  String get streamerYouTubeChannelId => 'Jouw YouTubekanaal-ID';

  @override
  String get streamerStreamerName => 'Je streamer naam op Lichess';

  @override
  String get streamerVisibility => 'Zichtbaar op de streamers pagina';

  @override
  String get streamerWhenApproved => 'Zodra goedgekeurd door toezichthouders';

  @override
  String get streamerHeadline => 'Titel';

  @override
  String get streamerTellUsAboutTheStream => 'Vertel ons in één zin over je stream';

  @override
  String get streamerLongDescription => 'Uitgebreide omschrijving';

  @override
  String streamerXStreamerPicture(String param) {
    return '$param streamer afbeelding';
  }

  @override
  String get streamerChangePicture => 'Wijzig/verwijder je foto';

  @override
  String get streamerUploadPicture => 'Upload een foto';

  @override
  String streamerMaxSize(String param) {
    return 'Maximale grootte: $param';
  }
  ...
  String streamerKeepItShort(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Houd het kort: maximaal $count tekens',
      one: 'Houd het kort: maximaal $count tekens',
      zero: 'Houd het kort: maximaal $count tekens',
    );
    return '$_temp0';
  }
  ...
  String stormPlayedNbRunsOfPuzzleStorm(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Eén sessie $param2 gespeeld',
    );
    return '$_temp0';
  }
  ...
  @override
  String get studyPleaseOnlyInvitePeopleYouKnow => 'Nodig alleen deelnemers uit die je kent en actief mee willen doen aan deze studie.';
  ...
  @override
  String get studyCopyChapterPgnDescription => 'Kopieer hoofdstuk PGN naar klembord.';
  ...
  String studyPasteYourPgnTextHereUpToNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Plak je PGN tekst hier, tot $count spel mogelijk',
    );
    return '$_temp0';
  }
}
