...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get recommendNotTouching => 'Мы не рекомендуем задавать эти условия.';

  @override
  String get fewerPlayers => 'Если вы зададите условия участия, то в вашем турнире сможет принять участие меньше игроков.';

  @override
  String get showAdvancedSettings => 'Показать дополнительные настройки';
  ...
  @override
  String get insult => 'Оскорбление';

  @override
  String get troll => 'Троллинг';

  @override
  String get ratingManipulation => 'Махинации с рейтингом';
  ...
  @override
  String get boardGeometry => 'Вид и размер доски';

  @override
  String get boardTheme => 'Оформление доски';
  ...
  @override
  String get searchAdvancedSearch => 'Расширенный поиск';

  @override
  String get searchOpponentName => 'Имя соперника';

  @override
  String get searchLoser => 'Проигравший';

  @override
  String get searchFrom => 'С';

  @override
  String get searchTo => 'До';

  @override
  String get searchHumanOrComputer => 'Соперник был человеком или компьютером';

  @override
  String get searchAiLevel => 'Уровень ИИ';

  @override
  String get searchSource => 'Источник';

  @override
  String get searchNbTurns => 'Количество ходов';

  @override
  String get searchResult => 'Результат';

  @override
  String get searchWinnerColor => 'Цвет победителя';
  ...
  @override
  String get searchAnalysis => 'Анализ';

  @override
  String get searchOnlyAnalysed => 'Только партии, для которых выполнен компьютерный анализ';

  @override
  String get searchColor => 'Цвет';

  @override
  String get searchEvaluation => 'Оценка';

  @override
  String get searchMaxNumber => 'Максимальное число';

  @override
  String get searchMaxNumberExplanation => 'Максимальное число партий для возврата';

  @override
  String get searchInclude => 'Включая';

  @override
  String get searchDescending => 'По убыванию';

  @override
  String get searchAscending => 'По возрастанию';

  @override
  String get searchRatingExplanation => 'Средний рейтинг обоих игроков';
  ...
  String searchSearchInXGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Поиск в $count партиях',
      many: 'Поиск в $count партиях',
      few: 'Поиск в $count партиях',
      one: 'Поиск в $count партии',
      zero: 'Поиск в $count партии',
    );
    return '$_temp0';
  }
  ...
  String searchXGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Найдено $count партий',
      many: 'Найдено $count партий',
      few: 'Найдены $count партии',
      one: 'Найдена $count партия',
      zero: 'Найдена $count партия',
    );
    return '$_temp0';
  }
  ...
  @override
  String get streamerLive => 'В ЭФИРЕ!';
  ...
  String streamerCurrentlyStreaming(String param) {
    return 'Сейчас транслируют: $param';
  }

  @override
  String streamerLastStream(String param) {
    return 'Последний стрим $param';
  }

  @override
  String get streamerBecomeStreamer => 'Стать стримером Lichess';

  @override
  String get streamerDoYouHaveStream => 'У вас есть Twitch или YouTube каналы?';

  @override
  String get streamerHereWeGo => 'Поехали!';

  @override
  String get streamerAllStreamers => 'Все стримеры';

  @override
  String get streamerEditPage => 'Редактировать страницу стримера';

  @override
  String get streamerYourPage => 'Ваша страница стримера';

  @override
  String get streamerDownloadKit => 'Скачать набор инструментов стримера';

  @override
  String streamerXIsStreaming(String param) {
    return '$param стримит';
  }

  @override
  String get streamerRules => 'Правила стримов';

  @override
  String get streamerRule1 => 'Добавьте «lichess.org» в заголовок вашего стрима при трансляции на Lichess.';

  @override
  String get streamerRule2 => 'Удалите «lichess.org», если вы стримите не Lichess контент.';

  @override
  String get streamerRule3 => 'Lichess определит ваш стрим автоматически и сделает для вас следующее:';

  @override
  String streamerRule4(String param) {
    return 'Прочитайте наши $param чтобы следовать правилам честной игры на ваших стримах.';
  }

  @override
  String get streamerStreamingFairplayFAQ => 'ЧаВо для стримеров по честной игре';

  @override
  String get streamerPerks => 'Преимущества стриминга с ключевым словом «lichess.org»';

  @override
  String get streamerPerk1 => 'Добавит огненную иконку стримера в вашем профиле Lichess.';

  @override
  String get streamerPerk2 => 'Переместит наверх в списке стримеров.';

  @override
  String get streamerPerk3 => 'Уведомит ваших подписчиков Lichess.';

  @override
  String get streamerPerk4 => 'Покажет, что вы стримите, в ваших играх, турнирах и студиях.';

  @override
  String get streamerApproved => 'Ваш стрим подтверждён.';

  @override
  String get streamerPendingReview => 'Ваш стрим на проверке у модераторов.';

  @override
  String get streamerPleaseFillIn => 'Пожалуйста, заполните информацию о стриме и загрузите изображение.';

  @override
  String streamerWhenReady(String param) {
    return 'Когда вы будете готовы оказаться в списке стримеров Lichess, $param';
  }

  @override
  String get streamerRequestReview => 'запросить отзыв модератора';

  @override
  String get streamerStreamerLanguageSettings => 'Страница стримера Lichess ориентирована на ту аудиторию, язык которой предоставлен вашей платформой. Установите для ваших шахматных стримов правильный язык по умолчанию в приложении или сервисе, который вы используете для трансляции.';

  @override
  String get streamerTwitchUsername => 'Ваше имя пользователя или URL на Twitch';

  @override
  String get streamerOptionalOrEmpty => 'Необязательно. Оставьте пустым, если нет';

  @override
  String get streamerYouTubeChannelId => 'ID вашего YouTube-канала';

  @override
  String get streamerStreamerName => 'Ваше имя стримера на Lichess';

  @override
  String get streamerVisibility => 'Видимость на странице стримеров';

  @override
  String get streamerWhenApproved => 'После утверждения модераторами';

  @override
  String get streamerHeadline => 'Заголовок';

  @override
  String get streamerTellUsAboutTheStream => 'Расскажите нам о вашем стриме в одном предложении';

  @override
  String get streamerLongDescription => 'Подробное описание';

  @override
  String streamerXStreamerPicture(String param) {
    return 'Изображение стримера $param';
  }

  @override
  String get streamerChangePicture => 'Изменить или удалить ваше изображение';

  @override
  String get streamerUploadPicture => 'Загрузить изображение';

  @override
  String streamerMaxSize(String param) {
    return 'Максимальный размер: $param';
  }
  ...
  String streamerKeepItShort(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Сократите: максимум $count символов',
      many: 'Сократите: максимум $count символов',
      few: 'Сократите: максимум $count символа',
      one: 'Сократите: максимум $count символ',
      zero: 'Сократите: максимум $count символ',
    );
    return '$_temp0';
  }
  ...
  @override
  String get studyCopyChapterPgnDescription => 'Скопировать PGN главы в буфер обмена.';
  ...
  String studyPasteYourPgnTextHereUpToNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Вставьте текст в формате PGN, не больше $count игры',
    );
    return '$_temp0';
  }
}
