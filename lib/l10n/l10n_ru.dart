...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get mobilePuzzleStormNothingToShow =>
      'Ничего нет. Сыграйте несколько попыток.';
  ...
  String get mobileSettingsShapeDrawingSubtitle =>
      'Нарисуйте фигуру пальцами: держите один палец на пустом квадрате и двигайте другой палец, чтобы рисовать.';
  ...
  String get mobileSettingsTouchFeedbackSubtitle =>
      'Когда включено, устройство будет вибрировать в некоторое время при перемещении или захвате фигуры.';
  ...
  String get playFirstOpeningEndgameExplorerMove =>
      'Играть первый ход изучения дебютов/эндшпилей';
  ...
  String get signupEmailHint =>
      'Мы будем использовать его только для сброса пароля.';
  ...
  String get emailForSignupHelp =>
      'Если ничего не получилось, отправьте нам это письмо:';
  ...
  String get waitForSignupHelp =>
      'Мы скоро вернёмся к вам чтобы помочь завершить регистрацию.';
  ...
  String get ratingRangeIsDisabledBecauseYourRatingIsProvisional =>
      'Рейтинговые фильтры заблокированы, поскольку ваш рейтинг нестабилен. Игра на рейтинг повысит стабильность.';
  ...
  String get agreementPolicy =>
      'Подтверждаю, что я буду следовать всем правилам Lichess.';
