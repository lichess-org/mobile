...
class AppLocalizationsHu extends AppLocalizations {
  ...
  String accountRegisteredWithoutEmail(String param) {
    return 'A $param felhasználói fiók e-mail cím nélkül lett regisztrálva.';
  }
  ...
  String weHaveSentYouAnEmailTo(String param) {
    return 'Küldtünk egy üzenetet a $param email címre. A jelszavad megváltoztatásához kattints az üzenetben lévő linkre.';
  }
  ...
  @override
  String get boardGeometry => 'Tábla geometria';

  @override
  String get boardTheme => 'Tábla szín';

  @override
  String get boardSize => 'Tábla mérete';
  ...
  @override
  String get searchAdvancedSearch => 'Bővített keresés';

  @override
  String get searchOpponentName => 'Ellenfél neve';

  @override
  String get searchLoser => 'Vesztes';

  @override
  String get searchFrom => 'Ettől';

  @override
  String get searchTo => 'Idáig';

  @override
  String get searchHumanOrComputer => 'A játékos ellenfele ember volt vagy számítógép';

  @override
  String get searchAiLevel => 'A.I. szint';

  @override
  String get searchSource => 'Forrás';

  @override
  String get searchNbTurns => 'Lépések száma';

  @override
  String get searchResult => 'Eredmény';

  @override
  String get searchWinnerColor => 'Nyertes szín';

  @override
  String get searchDate => 'Dátum';

  @override
  String get searchSortBy => 'Rendezés';

  @override
  String get searchAnalysis => 'Elemzés';

  @override
  String get searchOnlyAnalysed => 'Csak azok a játszmák, ahol számítógépes elemzés elérhető';

  @override
  String get searchColor => 'Szín';

  @override
  String get searchEvaluation => 'Kiértékelés';

  @override
  String get searchMaxNumber => 'Legfeljebb';

  @override
  String get searchMaxNumberExplanation => 'A megjelenő találatok maximális száma';

  @override
  String get searchInclude => 'Tartalmaz';

  @override
  String get searchDescending => 'Csökkenő';

  @override
  String get searchAscending => 'Növekvő';

  @override
  String get searchRatingExplanation => 'Mindkét játékos átlagos értékszáma';
  ...
  String searchSearchInXGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Keresés $count játszmában',
      one: 'Keresés $count játszmában',
      zero: 'Keresés $count játszmában',
    );
    return '$_temp0';
  }
  ...
  String searchXGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count talált játszma',
      one: 'Egy talált játszma',
      zero: 'Egy talált játszma',
    );
    return '$_temp0';
  }
  ...
  String searchGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other: '$count talált játszma',
      one: '$count talált játszma',
      zero: '$count talált játszma',
    );
    return '$_temp0';
  }
  ...
  @override
  String get streamerLive => 'ÉLŐ!';

  @override
  String get streamerOffline => 'NINCS ADÁS';

  @override
  String streamerCurrentlyStreaming(String param) {
    return 'Jelenlegi közvetítés: $param';
  }

  @override
  String streamerLastStream(String param) {
    return 'Utolsó közvetítés $param';
  }

  @override
  String get streamerBecomeStreamer => 'Legyél Te is Lichess streamer';

  @override
  String get streamerDoYouHaveStream => 'Van már Twitch vagy YouTube csatornád?';

  @override
  String get streamerHereWeGo => 'Lássunk neki!';

  @override
  String get streamerAllStreamers => 'Összes streamer';

  @override
  String get streamerEditPage => 'Streamer oldal szerkesztése';

  @override
  String get streamerYourPage => 'Streamer oldalad';

  @override
  String get streamerDownloadKit => 'Streamer csomag letöltése';

  @override
  String streamerXIsStreaming(String param) {
    return '$param éppen közvetít';
  }

  @override
  String get streamerRules => 'Közvetítés szabályai';

  @override
  String get streamerRule1 => 'A \"lichess.org\" kulcsszó hozzáadása a közvetítés címéhez és \"Sakk\" kategória használata mikor a Lichess-en közvetítesz.';

  @override
  String get streamerRule2 => 'Távolítsd el a kulcsszót ha nem Lichess-hez kapcsolódót közvetítesz.';

  @override
  String get streamerRule3 => 'A Lichess automatikusan észleli ha közvetítesz és az alábbi beállításokat érvényesíti:';

  @override
  String streamerRule4(String param) {
    return 'Olvasd el a $param-et, hogy mindenki számára igazságos legyen a játék a közvetítés ideje alatt is.';
  }

  @override
  String get streamerStreamingFairplayFAQ => 'sportszerű közvetítés GYIK';

  @override
  String get streamerPerks => 'A kulcsszóval történő közvetítés előnyei';

  @override
  String get streamerPerk1 => 'Kapsz egy izzó streamer ikont a Lichess profilodra.';

  @override
  String get streamerPerk2 => 'A streamerek listájának elejére kerülsz.';

  @override
  String get streamerPerk3 => 'Lichess követőid értesítése.';

  @override
  String get streamerPerk4 => 'A közvetítésed mutatása a játszmáid, versenyeid és tanulmányaidnál.';

  @override
  String get streamerApproved => 'A közvetítés jóváhagyva.';

  @override
  String get streamerPendingReview => 'A közvetítésed épp moderátoraink vizsgálják.';

  @override
  String get streamerPleaseFillIn => 'Kérjük add meg a streamer adataidat és tölts fel egy képet.';

  @override
  String streamerWhenReady(String param) {
    return 'Amikor készen állsz, hogy megjelenj a Lichess streamerei között, $param';
  }

  @override
  String get streamerRequestReview => 'kérj jóváhagyást egy moderátortól';

  @override
  String get streamerStreamerLanguageSettings => 'A Lichess streamer oldala a streamer platformod nyelvi beállításait használja, ezért a közvetítésed alapértelmezett nyelvét ott tudod beállítani.';

  @override
  String get streamerTwitchUsername => 'Twitch felhasználóneved vagy URL';

  @override
  String get streamerOptionalOrEmpty => 'Nem kötelező. Hagyd üresen, ha nincs';

  @override
  String get streamerYouTubeChannelId => 'YouTube csatornád azonosítója';

  @override
  String get streamerStreamerName => 'Streamer neved a Lichess-en';

  @override
  String get streamerVisibility => 'Megjelenik a streamerek oldalán';

  @override
  String get streamerWhenApproved => 'Ha a moderátorok jóvá hagyták';

  @override
  String get streamerHeadline => 'Főcím';

  @override
  String get streamerTellUsAboutTheStream => 'A közvetítés jellemzése egy mondatban';

  @override
  String get streamerLongDescription => 'Bővebb leírás';

  @override
  String streamerXStreamerPicture(String param) {
    return '$param streamer képe';
  }

  @override
  String get streamerChangePicture => 'Kép szerkesztése/törlése';

  @override
  String get streamerUploadPicture => 'Kép feltöltése';

  @override
  String streamerMaxSize(String param) {
    return 'Maximális méret: $param';
  }
  ...
  String streamerKeepItShort(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Legyen rövid: legfeljebb $count karakter',
      one: 'Legyen rövid: legfeljebb $count karakter',
      zero: 'Legyen rövid: legfeljebb $count karakter',
    );
    return '$_temp0';
  }
  ...
  @override
  String get studyMyPrivateStudies => 'Privát tanulmányaim';
  ...
  @override
  String get studyCopyChapterPgnDescription => 'Fejezet másolása a vágólapra PGN formátumban.';
  ...
  String studyPasteYourPgnTextHereUpToNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Illeszd be a PGN szövegét legfeljebb $count játszmáig',
    );
    return '$_temp0';
  }
}
