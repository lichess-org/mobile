...
class AppLocalizationsDe extends AppLocalizations {
  ...
  String activitySupportedNbMonths(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Unterstützt lichess.org seit $count Monat als $param2',
    );
    return '$_temp0';
  }
  ...
  String activityPracticedNbPositions(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Hat $count Stellung bei $param2 geübt',
    );
    return '$_temp0';
  }
  ...
  String activitySolvedNbPuzzles(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Hat $count Taktikaufgabe gelöst',
    );
    return '$_temp0';
  }
  ...
  String activityPlayedNbGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Hat $count Partie $param2 gespielt',
    );
    return '$_temp0';
  }
  ...
  String activityPostedNbMessages(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Hat $count Nachricht in $param2 geschrieben',
    );
    return '$_temp0';
  }
  ...
  String activityInNbCorrespondenceGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'in $count Fernschachpartie',
    );
    return '$_temp0';
  }
  ...
  String activityCompletedNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Hat $count Fernschachpartie gespielt',
    );
    return '$_temp0';
  }
  ...
  String activityHostedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Hat $count Simultanvorstellung gegeben',
    );
    return '$_temp0';
  }
  ...
  String activityJoinedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Hat an $count Simultanvorstellung teilgenommen',
    );
    return '$_temp0';
  }
  ...
  String activityCreatedNbStudies(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Hat $count neue Studie erstellt',
    );
    return '$_temp0';
  }
  ...
  String activityCompetedInNbTournaments(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Hat an $count Turnier teilgenommen',
    );
    return '$_temp0';
  }
  ...
  String activityRankedInTournament(int count, String param2, String param3, String param4) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Hat Platz #$count (obere $param2%) mit $param3 Spiel in $param4 erreicht',
    );
    return '$_temp0';
  }
  ...
  String activityCompetedInNbSwissTournaments(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Hat an $count Turnier nach Schweizer System teilgenommen',
    );
    return '$_temp0';
  }
  ...
  String activityJoinedNbTeams(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Ist $count Team beigetreten',
    );
    return '$_temp0';
  }
  ...
  @override
  String get showThreat => 'Drohungen anzeigen';
  ...
  @override
  String get importGameDataPrivacyWarning => 'Dieses PGN ist öffentlich zugänglich. Nutze eine Studie, um eine Partie nur für dich zu importieren.';
  ...
  @override
  String get recommendNotTouching => 'Wir empfehlen, diese nicht zu ändern.';

  @override
  String get fewerPlayers => 'Falls du Teilnahmebedingungen setzt, wird das Turnier weniger Spieler haben.';

  @override
  String get showAdvancedSettings => 'Zeige erweiterte Einstellungen';
  ...
  @override
  String get makeAStudy => 'Lege eine Studie an um Züge langfristig zu speichern oder zu teilen.';
  ...
  @override
  String get insult => 'Beleidigung';

  @override
  String get troll => 'Troll';

  @override
  String get ratingManipulation => 'Manipulation der Wertungszahl';
  ...
  @override
  String get boardGeometry => 'Brettgröße und 3D';

  @override
  String get boardTheme => 'Brettdesign';
  ...
  String opponentLeftCounter(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Dein Gegner hat die Partie verlassen. Du kannst in $count Sekunde den Sieg beanspruchen.',
    );
    return '$_temp0';
  }
  ...
  String ratingXOverYGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count-Wertung aus $param2 Partien',
    );
    return '$_temp0';
  }
  ...
  String giveNbSeconds(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Dem Gegner $count Sekunde geben',
    );
    return '$_temp0';
  }
  ...
  String moreThanNbPerfRatedGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '≥ $count gewertetes $param2 Spiel',
    );
    return '$_temp0';
  }
  ...
  String needNbMorePerfGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Du musst noch $count gewertete Partie mehr $param2 spielen',
    );
    return '$_temp0';
  }
  ...
  String needNbMoreGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Du musst noch $count gewertetes Spiel mehr spielen',
    );
    return '$_temp0';
  }
  ...
  String nbPerfTypePlayersThisWeek(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count $param2 Spieler diese Woche.',
    );
    return '$_temp0';
  }
  ...
  String availableInNbLanguages(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Verfügbar in $count Sprache!',
    );
    return '$_temp0';
  }
  ...
  String nbSecondsToPlayTheFirstMove(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count Sekunde, um den ersten Zug zu machen',
    );
    return '$_temp0';
  }
  ...
  String andSaveNbPremoveLines(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'und speichere $count Variante im Voraus',
    );
    return '$_temp0';
  }
  ...
  String puzzleNbPointsBelowYourPuzzleRating(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Ein Punkt unter deiner Aufgaben-Wertung',
    );
    return '$_temp0';
  }
  ...
  String puzzleNbPointsAboveYourPuzzleRating(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Ein Punkt über deiner Aufgabenwertung',
    );
    return '$_temp0';
  }
  ...
  @override
  String get searchAdvancedSearch => 'Erweiterte Suche';

  @override
  String get searchOpponentName => 'Name des Gegners';

  @override
  String get searchLoser => 'Verlierer';
  ...
  @override
  String get searchHumanOrComputer => 'Ob der Gegenspieler menschlich oder ein Computer war';

  @override
  String get searchAiLevel => 'KI-Stärke';

  @override
  String get searchSource => 'Quelle';

  @override
  String get searchNbTurns => 'Zuganzahl';

  @override
  String get searchResult => 'Ergebnis';

  @override
  String get searchWinnerColor => 'Siegerfarbe';
  ...
  @override
  String get searchOnlyAnalysed => 'Nur Partien, für die eine Computeranalyse verfügbar ist';

  @override
  String get searchColor => 'Farbe';

  @override
  String get searchEvaluation => 'Auswertung';

  @override
  String get searchMaxNumber => 'Maximale Anzahl';

  @override
  String get searchMaxNumberExplanation => 'Die maximale Anzahl der anzuzeigenden Partien';

  @override
  String get searchInclude => 'Einschließen';

  @override
  String get searchDescending => 'Absteigend';

  @override
  String get searchAscending => 'Aufsteigend';

  @override
  String get searchRatingExplanation => 'Die durchschnittliche Wertungszahl beider Spieler';
  ...
  String searchSearchInXGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Suche in $count Partien',
      one: 'Suche in $count Partie',
      zero: 'Suche in $count Partie',
    );
    return '$_temp0';
  }
  ...
  String searchXGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: 'Eine Partie gefunden',
      zero: 'Eine Partie gefunden',
    );
    return '$_temp0';
  }
  ...
  String searchGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other: '$count Partien gefunden',
      one: '$count Partie gefunden',
      zero: '$count Partie gefunden',
    );
    return '$_temp0';
  }
  ...
  String streamerCurrentlyStreaming(String param) {
    return 'Streamt gerade: $param';
  }

  @override
  String streamerLastStream(String param) {
    return 'Letzter Stream $param';
  }

  @override
  String get streamerBecomeStreamer => 'Werde ein Lichess Streamer';

  @override
  String get streamerDoYouHaveStream => 'Hast du einen Twitch oder YouTube-Kanal?';

  @override
  String get streamerHereWeGo => 'Los geht\'s!';

  @override
  String get streamerAllStreamers => 'Alle Streamer';

  @override
  String get streamerEditPage => 'Streamerseite bearbeiten';

  @override
  String get streamerYourPage => 'Deine Streamerseite';

  @override
  String get streamerDownloadKit => 'Lade das Streamerpaket herunter';

  @override
  String streamerXIsStreaming(String param) {
    return '$param streamt gerade';
  }

  @override
  String get streamerRules => 'Streaming-Regeln';

  @override
  String get streamerRule1 => 'Füge das Stichwort \"lichess.org\" in deinen Streamtitel ein und verwende die Kategorie \"Chess\", wenn du auf Lichess streamst.';

  @override
  String get streamerRule2 => 'Entferne das Stichwort, wenn du gerade nicht Lichess-bezogen streamst.';

  @override
  String get streamerRule3 => 'Lichess wird automatisch deinen Stream erkennen und folgende Zusatzdienste aktivieren:';

  @override
  String streamerRule4(String param) {
    return 'Lies unsere $param, um Fairplay für alle während deines Streams zu gewährleisten.';
  }
  ...
  @override
  String get streamerPerks => 'Vorteile für das Streamen mit dem Schlüsselwort';

  @override
  String get streamerPerk1 => 'Erhalte ein flammendes Streamer-Symbol auf deinem Lichess-Profil.';

  @override
  String get streamerPerk2 => 'Werde an die Spitze der Streamerliste gesetzt.';

  @override
  String get streamerPerk3 => 'Benachrichtige deine Lichess-Follower.';

  @override
  String get streamerPerk4 => 'Zeige deinen Stream in deinen Spielen, Turnieren und Studien.';

  @override
  String get streamerApproved => 'Dein Stream wurde genehmigt.';

  @override
  String get streamerPendingReview => 'Dein Stream wird von Moderatoren überprüft.';

  @override
  String get streamerPleaseFillIn => 'Bitte fülle deine Streamer-Informationen aus und lade ein Bild hoch.';

  @override
  String streamerWhenReady(String param) {
    return 'Wenn du bereit bist als Streamer angezeigt zu werden, $param';
  }

  @override
  String get streamerRequestReview => 'fordere eine Überprüfung durch Moderatoren an';

  @override
  String get streamerStreamerLanguageSettings => 'Die Lichess-Streamer-Seite richtet sich an dein Publikum mit der Sprache deiner Streaming-Plattform. Lege die richtige Standardsprache für deine Schach-Streams in der App oder dem Dienst, welchen du für die Übertragung verwenden, fest.';

  @override
  String get streamerTwitchUsername => 'Dein Twitch-Benutzername oder die URL';

  @override
  String get streamerOptionalOrEmpty => 'Optional. Leer lassen, falls nicht verfügbar';

  @override
  String get streamerYouTubeChannelId => 'Deine YouTube-Kanal-ID';

  @override
  String get streamerStreamerName => 'Dein Streamername auf Lichess';

  @override
  String get streamerVisibility => 'Sichtbar auf der Streamerseite';

  @override
  String get streamerWhenApproved => 'Sobald von den Moderatoren genehmigt';

  @override
  String get streamerHeadline => 'Titel';

  @override
  String get streamerTellUsAboutTheStream => 'Erzähle uns in einem Satz etwas über deinen Stream';

  @override
  String get streamerLongDescription => 'Ausführliche Beschreibung';

  @override
  String streamerXStreamerPicture(String param) {
    return '$param Streamerbild';
  }

  @override
  String get streamerChangePicture => 'Ändere/Lösche dein Bild';

  @override
  String get streamerUploadPicture => 'Lade ein Bild hoch';

  @override
  String streamerMaxSize(String param) {
    return 'Maximale Größe: $param';
  }
  ...
  String streamerKeepItShort(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Kurz halten: Maximal $count Zeichen',
      one: 'Kurz fassen: Maximal $count Zeichen',
      zero: 'Kurz fassen: Maximal $count Zeichen',
    );
    return '$_temp0';
  }
  ...
  String stormPlayedNbRunsOfPuzzleStorm(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Hat einen Durchlauf von $param2 gespielt',
    );
    return '$_temp0';
  }
  ...
  @override
  String get studyPleaseOnlyInvitePeopleYouKnow => 'Bitte lade nur Leute ein, die du kennst und die aktiv an dieser Studie teilnehmen möchten.';
  ...
  @override
  String get studyCopyChapterPgnDescription => 'Kapitel-PGN in die Zwischenablage kopieren.';
  ...
  String studyPasteYourPgnTextHereUpToNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Füge deinen PGN Text hier ein, bis zu $count Partie',
    );
    return '$_temp0';
  }
}
