...
class AppLocalizationsHy extends AppLocalizations {
  ...
  @override
  String get boardGeometry => 'Խաղատախտակի տեսքն ու չափսը';

  @override
  String get boardTheme => 'Խաղատախտակի ձևավորումը';

  @override
  String get boardSize => 'Խաղատախտակի չափսը';
  ...
  @override
  String get searchAdvancedSearch => 'Ընդլայնված որոնում';

  @override
  String get searchOpponentName => 'Հակառակորդի անունը';

  @override
  String get searchLoser => 'Պարտվող';

  @override
  String get searchFrom => 'Սկսած';

  @override
  String get searchTo => 'Մինչև';

  @override
  String get searchHumanOrComputer => 'Արդյոք հակառակորդը մարդ էր, թե համակարգիչ';

  @override
  String get searchAiLevel => 'ԱԲ-յան մակարդակ';

  @override
  String get searchSource => 'Աղբյուր';

  @override
  String get searchNbTurns => 'Քայլերի քանակ';

  @override
  String get searchResult => 'Արդյունք';

  @override
  String get searchWinnerColor => 'Հաղթող գույնը';

  @override
  String get searchDate => 'Ամսաթիվ';

  @override
  String get searchSortBy => 'Դասակարգել ըստ';

  @override
  String get searchAnalysis => 'Վերլուծություն';

  @override
  String get searchOnlyAnalysed => 'Միայն այն խաղերը․ որտեղ առկա է համակարգչային վերլուծություն';

  @override
  String get searchColor => 'Գույն';

  @override
  String get searchEvaluation => 'Գնահատական';

  @override
  String get searchMaxNumber => 'Առավելագույն քանակ';

  @override
  String get searchMaxNumberExplanation => 'Վերադարձի համար անհրաժեշտ պարտիաների առավելագույն քանակ';

  @override
  String get searchInclude => 'Ներառյալ';

  @override
  String get searchDescending => 'Նվազման կարգով';

  @override
  String get searchAscending => 'Աճման կարգով';

  @override
  String get searchRatingExplanation => 'Երկու խաղացողների միջին վարկանիշը';
  ...
  String searchSearchInXGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Փնտրել $count շախմատային խաղերում',
      one: 'Փնտրել $count շախմատային խաղում',
  ...
  String searchXGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Գտնվել են $count խաղեր',
      one: 'Գտնվել է մեկ խաղ',
      zero: 'Գտնվել է մեկ խաղ',
    );
    return '$_temp0';
  }
  ...
  String searchGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Գտնվել է $count պարտիա',
      one: 'Գտնվել է $count պարտիա',
      zero: 'Գտնվել է $count պարտիա',
    );
    return '$_temp0';
  }
  ...
  @override
  String get streamerLichessStreamer => 'Lichess-ի հեռարձակող';

  @override
  String get streamerLive => 'ԵԹԵՐՈՒՄ Է';

  @override
  String get streamerOffline => 'ԵԹԵՐՈՒՄ ՉԷ';

  @override
  String streamerCurrentlyStreaming(String param) {
    return 'Այժմ հեռարձակում են` $param';
  }

  @override
  String streamerLastStream(String param) {
    return 'Վերջին հեռարձակումը $param';
  }

  @override
  String get streamerBecomeStreamer => 'Դառնալ Lichess-ի հեռարձակող';

  @override
  String get streamerDoYouHaveStream => 'Դուք ունե՞ք Twitch կամ YouTube ալիքներ։';

  @override
  String get streamerHereWeGo => 'Գնացի՜նք';

  @override
  String get streamerAllStreamers => 'Բոլոր հեռարձակողները';

  @override
  String get streamerEditPage => 'Խմբագրել հեռարձակողի էջը';

  @override
  String get streamerYourPage => 'Հեռարձակողի Ձեր էջը';

  @override
  String get streamerDownloadKit => 'Բեռնել հեռարձակողի գործիքները';

  @override
  String streamerXIsStreaming(String param) {
    return '$param-ը հեռարձակում է';
  }

  @override
  String get streamerRules => 'Հեռարձակումների կանոնները';
  ...
  String streamerRule4(String param) {
    return 'Կարդացեք մեր $paramները` ձեր հեռարձակումներում ազնիվ խաղի կանոններին հետևելու համար։';
  }

  @override
  String get streamerStreamingFairplayFAQ => 'ՀՏՀ (հաճախ տրվող հարցեր) հեռարձակողների համար` ազնիվ խաղի վերաբերյալ';
  ...
  @override
  String get streamerYouTubeChannelId => 'Ձեր յութուբյան ալիքի ID-ն';
  ...
  @override
  String get streamerHeadline => 'Վերնագիր';

  @override
  String get streamerTellUsAboutTheStream => 'Tell us about your stream in one sentence';

  @override
  String get streamerLongDescription => 'Մանրամասն նկարագրություն';
  ...
  @override
  String get streamerChangePicture => 'Փոխել կամ հեռացնել Ձեր պատկերը';

  @override
  String get streamerUploadPicture => 'Բեռնել պատկեր';

  @override
  String streamerMaxSize(String param) {
    return 'Առավելագույն չափսը` $param';
  }
  ...
  @override
  String get studyCopyChapterPgnDescription => 'Պատճենել գլխի PGN-ը փոխանակման բուֆերիմ:';
  ...
  String studyPasteYourPgnTextHereUpToNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Տեղադրեք տեսքտը PGN ձևաչափով, $count պարտիայից ոչ ավելի',
    );
    return '$_temp0';
  }
}
