...
class AppLocalizationsGa extends AppLocalizations {
  ...
  @override
  String get boardGeometry => 'Céimseata an chláir';

  @override
  String get boardTheme => 'Téama an chláir';

  @override
  String get boardSize => 'Méid an chláir';
  ...
  @override
  String get searchAdvancedSearch => 'Cuardach casta';

  @override
  String get searchOpponentName => 'Ainm céile comhraic';

  @override
  String get searchLoser => 'Caillteoir';

  @override
  String get searchFrom => 'Ó';

  @override
  String get searchTo => 'Go';

  @override
  String get searchHumanOrComputer => 'An ríomhaire nó duine a bhí sa chéile comhraic';

  @override
  String get searchAiLevel => 'Leibhéal A.I.';

  @override
  String get searchSource => 'Foinse';

  @override
  String get searchNbTurns => 'Uimhir sealanna';

  @override
  String get searchResult => 'Toradh';

  @override
  String get searchWinnerColor => 'Dath buaiteora';

  @override
  String get searchDate => 'Dáta';

  @override
  String get searchSortBy => 'Sórtáil de réir';

  @override
  String get searchAnalysis => 'Anailís';

  @override
  String get searchOnlyAnalysed => 'Cluichí le anailís ríomhaire ar fáil dóibh amháin';

  @override
  String get searchColor => 'Dath';

  @override
  String get searchEvaluation => 'Measúnú';

  @override
  String get searchMaxNumber => 'Líon uasta';

  @override
  String get searchMaxNumberExplanation => 'An líon uasta cluichí le filleadh';

  @override
  String get searchInclude => 'Iniaigh';

  @override
  String get searchDescending => 'Íslitheach';

  @override
  String get searchAscending => 'Ardaitheach';

  @override
  String get searchRatingExplanation => 'An meán-rátáil an beirt fhicheallaí';
  ...
  String searchSearchInXGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Cuardaigh i $count chluiche fichille',
      many: 'Cuardaigh i $count chluiche fichille',
      few: 'Cuardaigh i $count chluiche fichille',
      two: 'Cuardaigh i $count chluiche fichille',
      one: 'Cuardaigh i gcluiche fichille amháin',
      zero: 'Cuardaigh i gcluiche fichille amháin',
    );
    return '$_temp0';
  }
  ...
  String searchXGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count chluiche aimsithe',
      many: '$count chluiche aimsithe',
      few: '$count chluiche aimsithe',
      two: '$count chluiche aimsithe',
      one: 'Cluiche amháin aimsithe',
  ...
  String searchGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Aimsíodh $count cluiche',
      many: 'Aimsíodh $count gcluiche',
      few: 'Aimsíodh $count gcluiche',
      two: 'Aimsíodh $count chluiche',
      one: 'Aimsíodh $count cluiche',
      zero: 'Aimsíodh $count cluiche',
    );
    return '$_temp0';
  }
  ...
  @override
  String get streamerLichessStreamer => 'Sruthú Lichess';

  @override
  String get streamerLive => 'BEO!';

  @override
  String get streamerOffline => 'AS LÍNE';

  @override
  String streamerCurrentlyStreaming(String param) {
    return 'Ag sruthú faoi láthair: $param';
  }

  @override
  String streamerLastStream(String param) {
    return 'Sruth deireanach $param';
  }

  @override
  String get streamerBecomeStreamer => 'Bí i do shruthú Lichess';

  @override
  String get streamerDoYouHaveStream => 'An bhfuil cuntas Twitch nó YouTube agat?';

  @override
  String get streamerHereWeGo => 'Réidh téigh!';

  @override
  String get streamerAllStreamers => 'Sruthaithe uile';

  @override
  String get streamerEditPage => 'Cuir leathanach sruthaithe in eagar';

  @override
  String get streamerYourPage => 'Do leathanach sruthú';

  @override
  String get streamerDownloadKit => 'Íoslódáil trealamh sruthú';

  @override
  String streamerXIsStreaming(String param) {
    return '$param ag sruthlú';
  }

  @override
  String get streamerRules => 'Rialacha sruthlú';

  @override
  String get streamerRule1 => 'Cuir an eochairfhocal \"lichess.org\" san áireamh i do theideal srutha agus bain úsáid as an gcatagóir \"Ficheall\" nuair a dhéanann tú sruth ar Lichess.';

  @override
  String get streamerRule2 => 'Bain an eochair-fhocal nuair atá tú ag sruthlú stuif neamh-Lichess.';

  @override
  String get streamerRule3 => 'Braithfidh Lichess do shruth go huathoibríoch agus ligfidh sé na buntáistí seo a leanas:';

  @override
  String streamerRule4(String param) {
    return 'Léigh ár $param chun cothrom na Féinne a chinntiú do gach duine le linn do shruth.';
  }

  @override
  String get streamerStreamingFairplayFAQ => 'cCanna maidir le cothrom na Féinne a shruthlú';

  @override
  String get streamerPerks => 'Buntáistí a bhaineann le sruthú leis an eochairfhocal';

  @override
  String get streamerPerk1 => 'Faigh deilbhín sraoilleán lasrach ar do phróifíl Lichess.';

  @override
  String get streamerPerk2 => 'Teigh suas go barr an liosta sruthlaithe.';

  @override
  String get streamerPerk3 => 'Cuir in iúl do do leanúna Lichess.';

  @override
  String get streamerPerk4 => 'Taispeáin do shruth i do chluichí, comórtais agus staidéir.';

  @override
  String get streamerApproved => 'Tá do shruthlú ceadaithe.';

  @override
  String get streamerPendingReview => 'Tá modhnóirí ag athbhreithniú ar do shruth.';

  @override
  String get streamerPleaseFillIn => 'Líon isteach d’eolais sruthaithe le do thoil, agus uaslódáil pictiúr.';

  @override
  String streamerWhenReady(String param) {
    return 'Nuair atá tú réidh le liostáil mar sruthú Lichess, $param';
  }

  @override
  String get streamerRequestReview => 'iarr ar athbhreithniú modhnóra';

  @override
  String get streamerStreamerLanguageSettings => 'Díríonn leathanach sruthlóra Lichess ar do lucht féachana leis an teanga a sholáthraíonn d’ardán sruthú. Socraigh an teanga réamhshocraithe cheart do do shruthanna fichille san aip nó seirbhís a úsáideann tú chun craoladh.';

  @override
  String get streamerTwitchUsername => 'D\'ainm úsáideora nó URL Twitch';

  @override
  String get streamerOptionalOrEmpty => 'Roghnach. Fág folamh mura bhfuil ceann ann';

  @override
  String get streamerYouTubeChannelId => 'Your YouTube channel ID';

  @override
  String get streamerStreamerName => 'D\'ainm sruthú ar Lichess';

  @override
  String get streamerVisibility => 'Le feiceáil ar an leathanach sruthú';

  @override
  String get streamerWhenApproved => 'Nuair atá siad faofa ó modhnóirí';

  @override
  String get streamerHeadline => 'Ceannlíne';

  @override
  String get streamerTellUsAboutTheStream => 'Inis dúinn faoi do shruth in aon abairt amháin';

  @override
  String get streamerLongDescription => 'Cur síos fada';

  @override
  String streamerXStreamerPicture(String param) {
    return '$param pictiúr sruthaithe';
  }

  @override
  String get streamerChangePicture => 'Athraigh/scrios do phictiúr';

  @override
  String get streamerUploadPicture => 'Uaslódáil pictiúr';

  @override
  String streamerMaxSize(String param) {
    return 'Uasmhéid: $param';
  }
  ...
  String streamerKeepItShort(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Coinnigh gearr é: $count carachtar uas',
      many: 'Coinnigh gearr é: $count carachtar uas',
      few: 'Coinnigh gearr é: $count gcarachtar uas',
      two: 'Coinnigh gearr é: $count charachtar uas',
      one: 'Coinnigh gearr é: $count carachtar uas',
      zero: 'Coinnigh gearr é: $count carachtar uas',
    );
    return '$_temp0';
  }
  ...
  @override
  String get studyCopyChapterPgnDescription => 'Cóipeáil an chaibidil PGN chuig an ngearrthaisce.';
  ...
  String studyPasteYourPgnTextHereUpToNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Greamaigh do théacs PGN anseo, suas le $count cluiche',
    );
    return '$_temp0';
  }
}
