...
class AppLocalizationsBe extends AppLocalizations {
  ...
  String activitySupportedNbMonths(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Падтрымаў lichess.org на $count месяц як $param2',
    );
    return '$_temp0';
  }
  ...
  String activityPracticedNbPositions(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Практыкавана пазіцыя $count у $param2',
    );
    return '$_temp0';
  }
  ...
  String activityPlayedNbGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Згуляна $count гульня ў $param2',
    );
    return '$_temp0';
  }
  ...
  String activityPostedNbMessages(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Апублікавана $count паведамленне ў $param2',
    );
    return '$_temp0';
  }
  ...
  String activityInNbCorrespondenceGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'у $count гульні па ліставанні',
    );
    return '$_temp0';
  }
  ...
  String activityCompletedNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Згуляна $count гульня па ліставанні',
    );
    return '$_temp0';
  }
  ...
  String activityFollowedNbPlayers(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Падпісаўся на $count гульца',
    );
    return '$_temp0';
  }
  ...
  String activityHostedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Правёў $count сеанс адначасовай гульні',
    );
    return '$_temp0';
  }
  ...
  String activityJoinedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Браў удзел у $count сеансе адначасовай гульні',
    );
    return '$_temp0';
  }
  ...
  String activityCreatedNbStudies(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Стварыў $count новае даследаванне',
    );
    return '$_temp0';
  }
  ...
  String activityCompetedInNbTournaments(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Паўдзельнічаў у $count турніры',
    );
    return '$_temp0';
  }
  ...
  String activityRankedInTournament(int count, String param2, String param3, String param4) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Заняў $count месца (лепшыя $param2%) турніру $param4, узяўшы ўдзел у $param3 гульні',
    );
    return '$_temp0';
  }
  ...
  String activityCompetedInNbSwissTournaments(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Паўдзельнічаў(-ла) у $count турніры па швейцарскай сістэме',
    );
    return '$_temp0';
  }
  ...
  String activityJoinedNbTeams(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Далучыўся да $count каманды',
    );
    return '$_temp0';
  }
  ...
  @override
  String get recommendNotTouching => 'Лепей тут нічога не чапаць.';

  @override
  String get fewerPlayers => 'Калі вы задасце ўмовы ўваходу, то не ўсе гульцы змогуць далучыцца да вашага турніру.';

  @override
  String get showAdvancedSettings => 'Паказаць дадатковыя налады';
  ...
  @override
  String get insult => 'Абраза';

  @override
  String get troll => 'Троль';

  @override
  String get ratingManipulation => 'Махінацыі з рэйтынгам';
  ...
  @override
  String get boardGeometry => 'Адмалёўка дошкі';

  @override
  String get boardTheme => 'Афармленне дошкі';

  @override
  String get boardSize => 'Памер дошкі';
  ...
  String opponentLeftCounter(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Ваш сапернік пакінуў гульню. Вы можаце абвясціць перамогу праз $count секунды.',
    );
    return '$_temp0';
  }
  ...
  String rankIsUpdatedEveryNbMinutes(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Рэйтынг абнаўляецца кожную хвіліну',
    );
    return '$_temp0';
  }
  ...
  String moreThanNbPerfRatedGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '≥ $count рэйтынгавая гульня ў рэжыме «$param2»',
    );
    return '$_temp0';
  }
  ...
  String needNbMorePerfGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Вы павінны згуляць яшчэ $count рэйтынгавую гульню ў рэжыме «$param2»',
    );
    return '$_temp0';
  }
  ...
  String needNbMoreGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Вы павінны згуляць яшчэ $count рэйтынгавую гульню',
    );
    return '$_temp0';
  }
  ...
  String nbImportedGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count імпартаваная гульня',
    );
    return '$_temp0';
  }
  ...
  String nbFollowing(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'падпісаны на $count гульца',
    );
    return '$_temp0';
  }
  ...
  String blocks(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count заблакіраваны гулец',
    );
    return '$_temp0';
  }
  ...
  String nbPerfTypePlayersThisWeek(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count гулец у $param2 на гэтым тыдні.',
    );
    return '$_temp0';
  }
  ...
  String nbSecondsToPlayTheFirstMove(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count секунда на першы ход',
    );
    return '$_temp0';
  }
  ...
  String andSaveNbPremoveLines(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'і захаваць $count паслядоўнасць',
    );
    return '$_temp0';
  }
  ...
  String puzzleNbPointsBelowYourPuzzleRating(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Адзін бал менш за ваш рэйтынг задач',
    );
    return '$_temp0';
  }
  ...
  String puzzleNbPointsAboveYourPuzzleRating(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Адзін бал вышэй за ваш рэйтынг задач',
    );
    return '$_temp0';
  }
  ...
  @override
  String get searchAdvancedSearch => 'Пашыраны пошук';

  @override
  String get searchOpponentName => 'Імя суперніка';

  @override
  String get searchLoser => 'Пацярпелы';

  @override
  String get searchFrom => 'Ад';

  @override
  String get searchTo => 'Да';

  @override
  String get searchHumanOrComputer => 'З\'яўляецца лі супернік чалавекам або камп\'ютарам';

  @override
  String get searchAiLevel => 'Узровень Ш.І.';

  @override
  String get searchSource => 'Крыніца';

  @override
  String get searchNbTurns => 'Колькасць хадоў';

  @override
  String get searchResult => 'Вынік';

  @override
  String get searchWinnerColor => 'Колер пераможца';

  @override
  String get searchDate => 'Дата';

  @override
  String get searchSortBy => 'Сартаваць па';

  @override
  String get searchAnalysis => 'Аналіз';

  @override
  String get searchOnlyAnalysed => 'Толькі гульні, для якіх даступны камп\'ютарны аналіз';

  @override
  String get searchColor => 'Колер';

  @override
  String get searchEvaluation => 'Ацэнка';

  @override
  String get searchMaxNumber => 'Максімальная колькасць';

  @override
  String get searchMaxNumberExplanation => 'Максімальная колькасць гульняў, якія будуць вернуты';

  @override
  String get searchInclude => 'Уключыць';

  @override
  String get searchDescending => 'Па змяншэнні';

  @override
  String get searchAscending => 'Па ўзрастанні';

  @override
  String get searchRatingExplanation => 'Сярэдні рэйтынг абодвух гульцоў';
  ...
  String searchSearchInXGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Шукаць у $count гульнях',
      many: 'Шукаць у $count гульнях',
      few: 'Шукаць у $count гульнях',
      one: 'Шукаць у $count гульне',
      zero: 'Шукаць у $count гульне',
    );
    return '$_temp0';
  }
  ...
  String searchXGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Знойдзена $count гульняў',
      many: 'Знойдзена $count гульняў',
      few: 'Знойдзена $count гульні',
      one: 'Знойдзена $count гульня',
      zero: 'Знойдзена $count гульня',
    );
    return '$_temp0';
  }
  ...
  String searchGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count гульняў знойдзена',
      many: '$count гульняў знойдзена',
      few: '$count гульні знойдзены',
      one: '$count гульня знойдзена',
      zero: '$count гульня знойдзена',
    );
    return '$_temp0';
  }
  ...
  @override
  String get streamerLichessStreamer => 'Стрымер на Lichess';

  @override
  String get streamerLive => 'У ЭФІРЫ!';

  @override
  String get streamerOffline => 'АФЛАЙН';

  @override
  String streamerCurrentlyStreaming(String param) {
    return 'Зараз стрыміць: $param';
  }

  @override
  String streamerLastStream(String param) {
    return 'Апошні стрым $param';
  }

  @override
  String get streamerBecomeStreamer => 'Стаць страмерам на Lichess';

  @override
  String get streamerDoYouHaveStream => 'У вас ёсць каналы на Twitch або YouTube?';

  @override
  String get streamerHereWeGo => 'Пачынаем!';

  @override
  String get streamerAllStreamers => 'Усе стрымеры';

  @override
  String get streamerEditPage => 'Змяніць стрымерскую старонку';

  @override
  String get streamerYourPage => 'Ваша старонка стрымеру';

  @override
  String get streamerDownloadKit => 'Спапаваць прылады для стрыму';

  @override
  String streamerXIsStreaming(String param) {
    return '$param у эфіры';
  }

  @override
  String get streamerRules => 'Правілы стрымаў';

  @override
  String get streamerRule1 => 'Уключыце ключавое слова \"lichess.org\" да загалоўку вашай трансляцыі і выкарыстоўвайце катэгорыю \"Шахматы\" пры трансляцыі на Lichess.';

  @override
  String get streamerRule2 => 'Выдаліце ключавое слова калі стрыміце не-Lichess дзейнасць.';

  @override
  String get streamerRule3 => 'Lichess аўтаматычна выявіць ваш стрым і ўключыць наступныя перавагі:';

  @override
  String streamerRule4(String param) {
    return 'Прачытайце нашы $param каб гарантаваць сумленную гульню для ўсіх на працягу вашага стрыму.';
  }

  @override
  String get streamerStreamingFairplayFAQ => 'Частыя пытанні пра правілы сумленнай гульні пад час стрымаў';

  @override
  String get streamerPerks => 'Перавагі стрыму з ключавым словам';

  @override
  String get streamerPerk1 => 'Атрыманне вогненны значок стымеру на вашым профіле Lichess.';

  @override
  String get streamerPerk2 => 'Патрапіць ў верх спісу стрымаў.';

  @override
  String get streamerPerk3 => 'Паведамляе падпісчыкаў.';

  @override
  String get streamerPerk4 => 'Адлюстраванне стрыму у вашых гульнях, турнірах і навучаннях.';

  @override
  String get streamerApproved => 'Ваш стрым зацверджана.';

  @override
  String get streamerPendingReview => 'Ваш стрым разглядаецца мадэратарамі.';

  @override
  String get streamerPleaseFillIn => 'Калі ласка, запоўніце інфармацыю наконт стрыму і загрузіце выяву.';

  @override
  String streamerWhenReady(String param) {
    return 'Калі будзіце гатовы быць адлюстраваным як стрымер Lichess, $param';
  }

  @override
  String get streamerRequestReview => 'запрасіць прагляд мадэратара';
  ...
  @override
  String get streamerTwitchUsername => 'Ваша імя карыстальніка/спасылка на Twich';

  @override
  String get streamerOptionalOrEmpty => 'Апцыянальна. Калі няма, пакіньце пустым';

  @override
  String get streamerYouTubeChannelId => 'ID вашага YouTube канала';

  @override
  String get streamerStreamerName => 'Ваша стрымерскае імя на Lichess';

  @override
  String get streamerVisibility => 'Паказваць на старонке са стрымерамі';

  @override
  String get streamerWhenApproved => 'Пасля зацвярджэння мадэратарамі';

  @override
  String get streamerHeadline => 'Загаловак';

  @override
  String get streamerTellUsAboutTheStream => 'Распавядзіце пра ваш стрым адным сказам';

  @override
  String get streamerLongDescription => 'Поўнае апісанне';

  @override
  String streamerXStreamerPicture(String param) {
    return 'Выява стрымеру $param';
  }

  @override
  String get streamerChangePicture => 'Змяніць/выдаліць вашу выяву';

  @override
  String get streamerUploadPicture => 'Загрузіць выяву';

  @override
  String streamerMaxSize(String param) {
    return 'Максімальны памер: $param';
  }
  ...
  String streamerKeepItShort(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Сцісла: максімальна $count сімвалаў',
      many: 'Сцісла: максімальна $count сімвалаў',
      few: 'Сцісла: максімальна $count сімвала',
      one: 'Сцісла: максімальна $count сімвал',
      zero: 'Сцісла: максімальна $count сімвал',
    );
    return '$_temp0';
  }
  ...
  String stormPlayedNbRunsOfPuzzleStorm(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Выкарастана адна з $param2 спроб',
    );
    return '$_temp0';
  }
  ...
  @override
  String get studyCopyChapterPgnDescription => 'Скапіраваць PGN главы ў буфер абмену.';
  ...
  String studyPasteYourPgnTextHereUpToNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Устаўце сюды ваш PGN тэкст, не больш за $count гульню',
    );
    return '$_temp0';
  }
}
