...
class AppLocalizationsAf extends AppLocalizations {
  ...
  String activitySupportedNbMonths(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Het lichess.org vir $count maand ondersteun as \'n $param2',
    );
    return '$_temp0';
  }
  ...
  String activityPracticedNbPositions(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Het $count posisie op $param2 geoefen',
    );
    return '$_temp0';
  }
  ...
  String activitySolvedNbPuzzles(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Het $count taktiese kopkrapper opgelos',
    );
    return '$_temp0';
  }
  ...
  String activityPlayedNbGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Het $count $param2 spel gespeel',
    );
    return '$_temp0';
  }
  ...
  String activityPostedNbMessages(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Het $count boodskap in $param2 geplaas',
    );
    return '$_temp0';
  }
  ...
  String activityInNbCorrespondenceGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'in $count korrespondensie spel',
    );
    return '$_temp0';
  }
  ...
  String activityCompletedNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Voltooi $count korrespondensie spel',
    );
    return '$_temp0';
  }
  ...
  String activityFollowedNbPlayers(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Het $count speler begin volg',
    );
    return '$_temp0';
  }
  ...
  String activityGainedNbFollowers(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Het $count nuwe volger bygekry',
    );
    return '$_temp0';
  }
  ...
  String activityHostedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Het $count simul(gelyktydige ekshibisie) gereël',
    );
    return '$_temp0';
  }
  ...
  String activityJoinedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Het in $count simul(gelyktydige ekshibisie) gespeel',
    );
    return '$_temp0';
  }
  ...
  String activityCreatedNbStudies(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Het $count nuwe studie geskep',
    );
    return '$_temp0';
  }
  ...
  String activityCompetedInNbTournaments(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Het aan $count toernooi deelgeneem',
    );
    return '$_temp0';
  }
  ...
  String activityRankedInTournament(int count, String param2, String param3, String param4) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Het rang van #$count(top $param2%) met $param3 spel in $param4',
    );
    return '$_temp0';
  }
  ...
  String activityCompetedInNbSwissTournaments(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Het aan $count swiss toernooi deelgeneem',
    );
    return '$_temp0';
  }
  ...
  String activityJoinedNbTeams(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Het aangesluit by $count span',
    );
    return '$_temp0';
  }
  ...
  @override
  String get boardGeometry => 'Bord geometrie';

  @override
  String get boardTheme => 'Bordtema';

  @override
  String get boardSize => 'Bord grootte';
  ...
  String opponentLeftCounter(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Jou opponent het die spel verlaat. Jy kan die oorwinning in $count sekonde eis.',
    );
    return '$_temp0';
  }
  ...
  String ratingXOverYGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count gradering oor $param2 spel',
    );
    return '$_temp0';
  }
  ...
  String rankIsUpdatedEveryNbMinutes(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Rang word elke minuut opgedateer',
    );
    return '$_temp0';
  }
  ...
  String moreThanNbPerfRatedGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '≥ $count $param2 gegradeerde spel',
    );
    return '$_temp0';
  }
  ...
  String needNbMorePerfGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Jy het nodig om $count meer gegradeerde $param2 spel te speel',
    );
    return '$_temp0';
  }
  ...
  String nbPerfTypePlayersThisWeek(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count $param2 speler hierdie week.',
    );
    return '$_temp0';
  }
  ...
  String nbSecondsToPlayTheFirstMove(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count sekonde om die eerste skuif te speel',
    );
    return '$_temp0';
  }
  ...
  String andSaveNbPremoveLines(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'en stoor $count voorafskuif variasie',
    );
    return '$_temp0';
  }
  ...
  @override
  String get searchAdvancedSearch => 'Gevorderde soek';

  @override
  String get searchOpponentName => 'Opponent se naam';

  @override
  String get searchLoser => 'Verloorder';

  @override
  String get searchFrom => 'Vanaf';

  @override
  String get searchTo => 'Tot';

  @override
  String get searchHumanOrComputer => 'Of die speler se opponent \'n mens of \'n rekenaar was';

  @override
  String get searchAiLevel => 'A.I. vlak';

  @override
  String get searchSource => 'Bron';

  @override
  String get searchNbTurns => 'Hoeveelheid beurte';

  @override
  String get searchResult => 'Uitslag';

  @override
  String get searchWinnerColor => 'Wenner se kleur';

  @override
  String get searchDate => 'Datum';

  @override
  String get searchSortBy => 'Sorteer volgens';

  @override
  String get searchAnalysis => 'Analise';

  @override
  String get searchOnlyAnalysed => 'Slegs wedstryde waarvan daar rekenaar analise beskikbaar is';

  @override
  String get searchColor => 'Kleur';

  @override
  String get searchEvaluation => 'Evaluering';

  @override
  String get searchMaxNumber => 'Maksimum aantal';

  @override
  String get searchMaxNumberExplanation => 'Die maksimum aantal spelle om terug te voer';

  @override
  String get searchInclude => 'Voeg by';

  @override
  String get searchDescending => 'Dalende';

  @override
  String get searchAscending => 'Stygende';

  @override
  String get searchRatingExplanation => 'Die gemiddelde gradering van albei spelers';
  ...
  String searchSearchInXGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Soek in $count skaakspelle',
      one: 'Soek in $count skaakspel',
      zero: 'Soek in $count skaakspel',
    );
    return '$_temp0';
  }
  ...
  String searchXGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count wedstryde gevind',
      one: 'Een wedstryd gevind',
      zero: 'Een wedstryd gevind',
    );
    return '$_temp0';
  }
  ...
  String searchGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count spelle gevind',
      one: '$count spel gevind',
      zero: '$count spel gevind',
    );
    return '$_temp0';
  }
  ...
  @override
  String get streamerLichessStreamer => 'Lichess aanbieder';

  @override
  String get streamerLive => 'Regstreeks!';

  @override
  String get streamerOffline => 'AFLYN';

  @override
  String streamerCurrentlyStreaming(String param) {
    return 'Saai tans uit: $param';
  }

  @override
  String streamerLastStream(String param) {
    return 'Laaste uitsending $param';
  }

  @override
  String get streamerBecomeStreamer => 'Word \'n Lichess aanbieder';

  @override
  String get streamerDoYouHaveStream => 'Het jy \'n Twitch of YouTube kanaal?';

  @override
  String get streamerHereWeGo => 'Hier gaan ons!';

  @override
  String get streamerAllStreamers => 'Alle aanbieders';

  @override
  String get streamerEditPage => 'Verander aan die aanbieder se blad';

  @override
  String get streamerYourPage => 'Jou aanbiedings blad';

  @override
  String get streamerDownloadKit => 'Laai aanbieders gereedskapskas af';

  @override
  String streamerXIsStreaming(String param) {
    return '$param is besig om uit te saai';
  }

  @override
  String get streamerRules => 'Uitsaai reëls';

  @override
  String get streamerRule1 => 'Sluit die sleutelwoord \"lichess.org\" in jou uitsendingstitel in wanneer jy op Lichss uitsaai.';

  @override
  String get streamerRule2 => 'Verwyder die sleutelwoord as jy nie-Lichess dinge uitsaai.';

  @override
  String get streamerRule3 => 'Lichess sal outomaties die uitsending opmerk en vir jou die volgende voordele gee:';

  @override
  String streamerRule4(String param) {
    return 'Lees ons $param om regverdige speel vir almal te verseker tydens jou uitsaaiing.';
  }

  @override
  String get streamerStreamingFairplayFAQ => 'uitsaaiings Regverdige spel FAQ';

  @override
  String get streamerPerks => 'Voordele om met die sleutelwoord uit te saai';

  @override
  String get streamerPerk1 => 'Kry \'n vlam uitsaai ikoon op jou Lichess profiel.';

  @override
  String get streamerPerk2 => 'Word na die bopunt van die aanbieders lys geneem.';

  @override
  String get streamerPerk3 => 'Stel die wat jou op Lichess volg in kennis.';

  @override
  String get streamerPerk4 => 'Wys jou uitsending in jou spelle, toernooie en studies.';

  @override
  String get streamerApproved => 'Jou uitsending is goedgekeur.';

  @override
  String get streamerPendingReview => 'Jou uitsending word deur moderators hersien.';

  @override
  String get streamerPleaseFillIn => 'Vul asseblief jou uitsending inligting in en laai \'n prent op.';

  @override
  String streamerWhenReady(String param) {
    return 'Sodra jy gereed is om as \'n Lichess aanbieder te verskyn, $param';
  }

  @override
  String get streamerRequestReview => 'versoek hersiening deur \'n moderator';

  @override
  String get streamerStreamerLanguageSettings => 'Die Lichess uitsaaiingsblaai teiken jou gehoor met die voorsiende taal van jou uitsaaiings platform. Stel die versterkte taal vir jou skaak strome, in die uitsaaiings toepassing of diens wat jy gebruik.';

  @override
  String get streamerTwitchUsername => 'Jou Twitch gebruikersnaam of URL';

  @override
  String get streamerOptionalOrEmpty => 'Optioneel. Los leeg indien jy nie een het nie';

  @override
  String get streamerYouTubeChannelId => 'Jou YouTube-kanaal-ID';

  @override
  String get streamerStreamerName => 'Jou uitsendingsnaam op Lichess';

  @override
  String get streamerVisibility => 'Sigbaar op die aanbiederblad';

  @override
  String get streamerWhenApproved => 'Wanneer moderator dit goedkeur';

  @override
  String get streamerHeadline => 'Hoofopskrif';

  @override
  String get streamerTellUsAboutTheStream => 'Vertel ons meer van jou uitsending in een sin';

  @override
  String get streamerLongDescription => 'Lang uitbreiding';

  @override
  String streamerXStreamerPicture(String param) {
    return '$param aanbieder foto';
  }

  @override
  String get streamerChangePicture => 'Verander/verwyder jou prent';

  @override
  String get streamerUploadPicture => 'Laai prent op';

  @override
  String streamerMaxSize(String param) {
    return 'Maksimum grootte: $param';
  }
  ...
  String streamerKeepItShort(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Hou dit kort: $count karakters maks',
      one: 'Hou dit kort: $count karakter maks',
      zero: 'Hou dit kort: $count karakter maks',
    );
    return '$_temp0';
  }
  ...
  String stormPlayedNbRunsOfPuzzleStorm(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Speel een lopie van $param2',
    );
    return '$_temp0';
  }
  ...
  @override
  String get studyCopyChapterPgnDescription => 'Kopieer hoofstuk PGN na die knipbord.';
  ...
  String studyPasteYourPgnTextHereUpToNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Plak jou PGN teks hier, tot by $count spel',
    );
    return '$_temp0';
  }
}
