...
class AppLocalizationsNb extends AppLocalizations {
  ...
  String activitySupportedNbMonths(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Har støttet lichess.org i $count måned som $param2',
    );
    return '$_temp0';
  }
  ...
  String activityPracticedNbPositions(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Praktiserte $count stilling på $param2',
    );
    return '$_temp0';
  }
  ...
  String activityPlayedNbGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Har spilt $count $param2-parti',
    );
    return '$_temp0';
  }
  ...
  String activityPostedNbMessages(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Har skrevet $count innlegg i $param2',
    );
    return '$_temp0';
  }
  ...
  String activityCompletedNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Har spilt ferdig $count fjernsjakkparti',
    );
    return '$_temp0';
  }
  ...
  String activityHostedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Har vært vertskap for $count simultanoppvisning',
    );
    return '$_temp0';
  }
  ...
  String activityJoinedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Har deltatt i $count simultanoppvisning',
    );
    return '$_temp0';
  }
  ...
  String activityCreatedNbStudies(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Har laget $count ny studie',
    );
    return '$_temp0';
  }
  ...
  String activityCompetedInNbTournaments(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Har deltatt i $count arenaturnering',
    );
    return '$_temp0';
  }
  ...
  String activityRankedInTournament(int count, String param2, String param3, String param4) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Ble nummer $count (øverste $param2%) med $param3 parti i $param4',
    );
    return '$_temp0';
  }
  ...
  String activityCompetedInNbSwissTournaments(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Har deltatt i $count sveitserturnering',
    );
    return '$_temp0';
  }
  ...
  @override
  String get openingExplorerAndTablebase => 'Åpningsutforsker & tabellbase';
  ...
  @override
  String get recommendNotTouching => 'Vi anbefaler å ikke endre disse.';

  @override
  String get fewerPlayers => 'Om du stiller betingelser for å delta vil turneringa få færre deltakere.';

  @override
  String get showAdvancedSettings => 'Vis avanserte innstillinger';
  ...
  @override
  String get insult => 'Fornærmelse';

  @override
  String get troll => 'Troll';

  @override
  String get ratingManipulation => 'Ratingmanipulering';
  ...
  @override
  String get boardGeometry => 'Brettgeometri';

  @override
  String get boardTheme => 'Brett-tema';

  @override
  String get boardSize => 'Brettstørrelse';
  ...
  String opponentLeftCounter(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Motspilleren din har forlatt partiet. Du kan kreve seier om $count sekund.',
    );
    return '$_temp0';
  }
  ...
  String ratingXOverYGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count-rating over $param2 parti',
    );
    return '$_temp0';
  }
  ...
  String rankIsUpdatedEveryNbMinutes(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Rangeringen blir oppdatert hvert minutt',
    );
    return '$_temp0';
  }
  ...
  String needNbMorePerfGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Du må spille enda $count ratet $param2-parti',
    );
    return '$_temp0';
  }
  ...
  String needNbMoreGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Du må spille enda $count ratet parti',
    );
    return '$_temp0';
  }
  ...
  String lessThanNbMinutes(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Mindre enn $count minutter',
    );
    return '$_temp0';
  }
  ...
  String nbPerfTypePlayersThisWeek(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count $param2-spiller denne uken.',
    );
    return '$_temp0';
  }
  ...
  String availableInNbLanguages(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Tilgjengelig på $count språk!',
    );
    return '$_temp0';
  }
  ...
  String nbSecondsToPlayTheFirstMove(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count sekund til å ta det første trekket',
    );
    return '$_temp0';
  }
  ...
  String andSaveNbPremoveLines(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'og lagre $count linjer med forhåndstrekk',
      one: 'og lagre $count linje med forhåndstrekk',
      zero: 'og lagre $count linje med forhåndstrekk',
    );
    return '$_temp0';
  }
  ...
  String puzzleNbPointsBelowYourPuzzleRating(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Ett poeng under sjakknøttratingen din',
    );
    return '$_temp0';
  }
  ...
  String puzzleNbPointsAboveYourPuzzleRating(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Ett poeng over sjakknøttratingen din',
    );
    return '$_temp0';
  }
  ...
  @override
  String get searchAdvancedSearch => 'Avansert søk';

  @override
  String get searchOpponentName => 'Navn på motstander';

  @override
  String get searchLoser => 'Taper';

  @override
  String get searchFrom => 'Fra';

  @override
  String get searchTo => 'Til';

  @override
  String get searchHumanOrComputer => 'Om motstanderen var menneske eller maskin';

  @override
  String get searchAiLevel => 'Vanskelighetsgrad';

  @override
  String get searchSource => 'Kilde';

  @override
  String get searchNbTurns => 'Antall trekk';

  @override
  String get searchResult => 'Resultat';

  @override
  String get searchWinnerColor => 'Farge på vinner';
  ...
  @override
  String get searchOnlyAnalysed => 'Bare partier hvor maskinanalyse er tilgjengelig';

  @override
  String get searchColor => 'Farge';

  @override
  String get searchEvaluation => 'Evaluering';

  @override
  String get searchMaxNumber => 'Maksimalt antall';

  @override
  String get searchMaxNumberExplanation => 'Det maksimale antallet partier i retur';

  @override
  String get searchInclude => 'Inkluder';

  @override
  String get searchDescending => 'Synkende';

  @override
  String get searchAscending => 'Stigende';

  @override
  String get searchRatingExplanation => 'Gjennomsnittet av begge spillernes rating';
  ...
  String searchSearchInXGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Søk i $count partier',
      one: 'Søk i $count parti',
      zero: 'Søk i $count parti',
    );
    return '$_temp0';
  }
  ...
  String searchXGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count partier funnet',
      one: 'Ett parti funnet',
      zero: 'Ett parti funnet',
    );
    return '$_temp0';
  }
  ...
  String searchGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other: '$count partier funnet',
      one: '$count parti funnet',
      zero: '$count parti funnet',
    );
    return '$_temp0';
  }
  ...
  @override
  String get streamerLichessStreamer => 'Lichess-strømmer';

  @override
  String get streamerLive => 'DIREKTE!';

  @override
  String get streamerOffline => 'AVKOBLET';

  @override
  String streamerCurrentlyStreaming(String param) {
    return 'Strømmer nå: $param';
  }

  @override
  String streamerLastStream(String param) {
    return 'Strømmet sist $param';
  }

  @override
  String get streamerBecomeStreamer => 'Bli en Lichess-strømmer';

  @override
  String get streamerDoYouHaveStream => 'Har du en Twitch- eller YouTube-kanal?';

  @override
  String get streamerHereWeGo => 'Nå kjører vi!';

  @override
  String get streamerAllStreamers => 'Alle strømmere';

  @override
  String get streamerEditPage => 'Rediger strømmer-siden';

  @override
  String get streamerYourPage => 'Din strømmer-side';

  @override
  String get streamerDownloadKit => 'Last ned strømmer-pakken';

  @override
  String streamerXIsStreaming(String param) {
    return '$param strømmer nå';
  }

  @override
  String get streamerRules => 'Strømmeregler';

  @override
  String get streamerRule1 => 'Du må inkludere nøkkelordet «lichess.org» i tittelen på strømmen og bruke kategorien «Chess» når du strømmer på Lichess.';

  @override
  String get streamerRule2 => 'Fjern \"lichess.org\" fra tittelen på strømmen når du strømmer noe annet enn Lichess.';

  @override
  String get streamerRule3 => 'Lichess oppdager strømmen din automatisk og gir deg følgende fordeler:';

  @override
  String streamerRule4(String param) {
    return 'Les vår $param for å sikre like forhold for alle mens du strømmer.';
  }

  @override
  String get streamerStreamingFairplayFAQ => 'FAQ for sportslig opptreden for strømmere';

  @override
  String get streamerPerks => 'Fordeler ved å inkludere \"lichess.org\" i tittelen på strømmen';

  @override
  String get streamerPerk1 => 'Få et spesielt strømmer-ikon på Lichess-profilen din.';

  @override
  String get streamerPerk2 => 'Bli flyttet til toppen av listen over strømmere.';

  @override
  String get streamerPerk3 => 'Send en melding til følgerne dine på Lichess.';

  @override
  String get streamerPerk4 => 'Vis strømmen din i partier, turneringer og studier på Lichess.';

  @override
  String get streamerApproved => 'Strømmen din er godkjent.';

  @override
  String get streamerPendingReview => 'Strømmen din blir nå vurdert av moderatorne.';

  @override
  String get streamerPleaseFillIn => 'Vennligst fyll inn informasjon om strømmen din og last opp et bilde.';

  @override
  String streamerWhenReady(String param) {
    return 'Når du er klar til å bli listet som en Lichess-strømmer, $param';
  }

  @override
  String get streamerRequestReview => 'be om en vurdering fra en moderator';

  @override
  String get streamerStreamerLanguageSettings => 'Strømmesiden til Lichess retter seg mot publikummet ditt med språket strømmeplattformen din leverer. Angi riktig språk for sjakkstrømmene dine i appen eller tjenesten du bruker for overføringer.';

  @override
  String get streamerTwitchUsername => 'Ditt Twitch-brukernavn eller URL';

  @override
  String get streamerOptionalOrEmpty => 'Valgfritt. Kan være tom';

  @override
  String get streamerYouTubeChannelId => 'ID til YouTube-kanalen din';

  @override
  String get streamerStreamerName => 'Ditt strømmernavn på Lichess';

  @override
  String get streamerVisibility => 'Synlig på strømmersiden';

  @override
  String get streamerWhenApproved => 'Når godkjent av moderatorne';

  @override
  String get streamerHeadline => 'Overskrift';

  @override
  String get streamerTellUsAboutTheStream => 'I én setning, fortell oss om strømmen din';

  @override
  String get streamerLongDescription => 'Lang beskrivelse';

  @override
  String streamerXStreamerPicture(String param) {
    return '$param strømmerbilde';
  }

  @override
  String get streamerChangePicture => 'Endre/slette ditt strømmerbilde';

  @override
  String get streamerUploadPicture => 'Last opp et bilde';

  @override
  String streamerMaxSize(String param) {
    return 'Maks størrelse: $param';
  }
  ...
  String streamerKeepItShort(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Hold deg kort; maks $count tegn',
      one: 'Hold deg kort; maks $count tegn',
      zero: 'Hold deg kort; maks $count tegn',
    );
    return '$_temp0';
  }
  ...
  String stormPlayedNbRunsOfPuzzleStorm(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Har spilt én runde med $param2',
    );
    return '$_temp0';
  }
  ...
  @override
  String get studyPleaseOnlyInvitePeopleYouKnow => 'Inviter bare folk du kjenner som ønsker å delta i studien.';
  ...
  @override
  String get studyOnlyContributorsCanRequestAnalysis => 'Bare bidragsyterne til studien kan be om maskinanalyse.';

  @override
  String get studyGetAFullComputerAnalysis => 'Få full maskinanalyse av hovedvarianten fra serveren.';

  @override
  String get studyMakeSureTheChapterIsComplete => 'Sørg for at kapittelet er fullført. Du kan bare be om analyse én gang.';

  @override
  String get studyAllSyncMembersRemainOnTheSamePosition => 'Alle synkroniserte medlemmer ser den samme stillingen';
  ...
  @override
  String get studyCopyChapterPgnDescription => 'Kopier PGN for kapittelet til utklippstavlen.';
  ...
  @override
  String get studyClearAllCommentsInThisChapter => 'Fjern alle kommentarer og figurer i dette kapittelet?';
  ...
  @override
  String get studyDeleteTheStudyChatHistory => 'Slette studiens samtalehistorikk? Du kan ikke angre!';
  ...
  String studyPasteYourPgnTextHereUpToNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Sett inn PGN-teksten din her, maksimum $count parti',
    );
    return '$_temp0';
  }
}
