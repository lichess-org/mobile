...
class AppLocalizationsEl extends AppLocalizations {
  ...
  @override
  String get forceVariation => 'Φορσέ βαριάντα';
  ...
  @override
  String get boardGeometry => 'Γεωμετρία σκακιέρας';

  @override
  String get boardTheme => 'Θέμα σκακιέρας';

  @override
  String get boardSize => 'Μέγεθος σκακιέρας';
  ...
  @override
  String get searchAdvancedSearch => 'Προχωρημένη αναζήτηση';

  @override
  String get searchOpponentName => 'Όνομα αντιπάλου';

  @override
  String get searchLoser => 'Ηττημένος';

  @override
  String get searchFrom => 'Από';

  @override
  String get searchTo => 'Έως';

  @override
  String get searchHumanOrComputer => 'Αν ο αντίπαλος του παίκτη ήταν άνθρωπος ή υπολογιστής';

  @override
  String get searchAiLevel => 'Επίπεδο τεχνητής νοημοσύνης';

  @override
  String get searchSource => 'Πηγή';

  @override
  String get searchNbTurns => 'Αριθμός γύρων';

  @override
  String get searchResult => 'Αποτέλεσμα';

  @override
  String get searchWinnerColor => 'Χρώμα νικητή';

  @override
  String get searchDate => 'Ημερομηνία';

  @override
  String get searchSortBy => 'Ταξινόμηση κατά';

  @override
  String get searchAnalysis => 'Ανάλυση';

  @override
  String get searchOnlyAnalysed => 'Μόνο παρτίδες με ανάλυση από υπολογιστή';

  @override
  String get searchColor => 'Χρώμα';

  @override
  String get searchEvaluation => 'Ανάλυση/Πλεονεκτήματα';

  @override
  String get searchMaxNumber => 'Μέγιστος αριθμός';

  @override
  String get searchMaxNumberExplanation => 'Ο μέγιστος αριθμός παιχνιδιών που θα επιστραφούν';

  @override
  String get searchInclude => 'Να συμπεριλιφθούν';

  @override
  String get searchDescending => 'Φθίνουσα';

  @override
  String get searchAscending => 'Αύξουσα';

  @override
  String get searchRatingExplanation => 'Η μέση βαθμολογία και των δύο παικτών';
  ...
  String searchSearchInXGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Αναζήτηση σε $count παρτίδες',
      one: 'Αναζήτηση σε $count παρτίδα',
  ...
  String searchXGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count παρτίδες βρέθηκαν',
      one: 'Μία παρτίδα βρέθηκε',
      zero: 'Μία παρτίδα βρέθηκε',
    );
    return '$_temp0';
  }
  ...
  String searchGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other: '$count παρτίδες βρέθηκαν',
      one: '$count παρτίδα βρέθηκε',
      zero: '$count παρτίδα βρέθηκε',
    );
    return '$_temp0';
  }
  ...
  @override
  String get streamerLive => 'ΖΩΝΤΑΝΑ!';

  @override
  String get streamerOffline => 'ΕΚΤΟΣ ΣΥΝΔΕΣΗΣ';

  @override
  String streamerCurrentlyStreaming(String param) {
    return 'Αυτή τη στιγμή μεταδίδουν: $param';
  }

  @override
  String streamerLastStream(String param) {
    return 'Τελευταία μετάδοση $param';
  }

  @override
  String get streamerBecomeStreamer => 'Γίνετε ένας Lichess streamer';

  @override
  String get streamerDoYouHaveStream => 'Έχετε κανάλι στο Twitch ή στο YouTube;';

  @override
  String get streamerHereWeGo => 'Ξεκινάμε!';

  @override
  String get streamerAllStreamers => 'Όλοι οι streamers';

  @override
  String get streamerEditPage => 'Επεξεργασία σελίδας streamer';

  @override
  String get streamerYourPage => 'Η σελίδα σας ως streamer';

  @override
  String get streamerDownloadKit => 'Κατέβασμα πακέτου μετάδοσης';

  @override
  String streamerXIsStreaming(String param) {
    return '$param μεταδίδει';
  }

  @override
  String get streamerRules => 'Κανόνες μετάδοσης';

  @override
  String get streamerRule1 => 'Συμπεριλάβετε την λέξη-κλειδί \"lichess.org\" στο τίτλο μετάδοσης και χρησιμοποιήστε την κατηγορία \"Chess\" όταν μεταδίδετε στο Lichess.';

  @override
  String get streamerRule2 => 'Διαγράψτε τη λέξη-κλειδί αυτή όταν σταματήσετε να μεταδίδετε θέματα σχετικά με το Lichess.';

  @override
  String get streamerRule3 => 'Το Lichess θα ανιχνεύσει την μετάδοσή σας αυτόματα και θα έχετε τα ακόλουθα πλεονεκτήματα:';

  @override
  String streamerRule4(String param) {
    return 'Διαβάστε τις $param για να εξασφαλίσετε ένα δίκαιο παιχνίδι για όλους κατά τη διάρκεια της ζωντανής ροής σας.';
  }

  @override
  String get streamerStreamingFairplayFAQ => 'συχνές ερωτήσεις σχετικά με το fair play στις ζωντανές ροές';

  @override
  String get streamerPerks => 'Πλεονεκτήματα μετάδοσης με τη λέξη-κλειδί';

  @override
  String get streamerPerk1 => 'Αποκτήστε το εικονίδιο του flaming streamer στο προφίλ σας στο Lichess.';

  @override
  String get streamerPerk2 => 'Ανεβείτε στη κορυφή της λίστας των streamers.';

  @override
  String get streamerPerk3 => 'Ενημερώστε τους ακολούθους σας στο Lichess.';

  @override
  String get streamerPerk4 => 'Δείξτε τη μετάδοσή σας στα παιχνίδια, τα τουρνουά και τις μελέτες σας.';

  @override
  String get streamerApproved => 'Η μετάδοσή σας εγκρίθηκε.';

  @override
  String get streamerPendingReview => 'Η μετάδοσή σας αξιολογείται από τους διαχειριστές.';

  @override
  String get streamerPleaseFillIn => 'Παρακαλώ συμπληρώστε τις πληροφορίες σας και μεταφορτώστε μια εικόνα.';

  @override
  String streamerWhenReady(String param) {
    return 'Όταν είσαστε έτοιμος να εμφανιστείτε ως Lichess streamer, $param';
  }

  @override
  String get streamerRequestReview => 'ζητήστε αξιολόγηση από κάποιον διαχειριστή';

  @override
  String get streamerStreamerLanguageSettings => 'Η σελίδα Lichess streamer στοχεύει το κοινό σας με τη γλώσσα που παρέχεται από την πλατφόρμα ροής σας. Ορίστε τη σωστή προεπιλεγμένη γλώσσα για τις ροές σκακιού στην εφαρμογή ή την υπηρεσία που χρησιμοποιείτε για να μεταδώσετε.';

  @override
  String get streamerTwitchUsername => 'Το όνομα χρήστη σας στο Twitch ή το URL του προφίλ σας';

  @override
  String get streamerOptionalOrEmpty => 'Προαιρετικό. Αφήστε το κενό αν δεν υπάρχει';

  @override
  String get streamerYouTubeChannelId => 'Το αναγνωριστικό του YouTube καναλιού σας';

  @override
  String get streamerStreamerName => 'Το όνομα σας ως streamer στο Lichess';

  @override
  String get streamerVisibility => 'Ορατή στη σελίδα των streamers';

  @override
  String get streamerWhenApproved => 'Όταν εγκριθεί από τους διαχειριστές';

  @override
  String get streamerHeadline => 'Κεφαλίδα';

  @override
  String get streamerTellUsAboutTheStream => 'Περιγράψτε μας τη μετάδοσή σας σε μία πρόταση';

  @override
  String get streamerLongDescription => 'Πλήρης περιγραφή';

  @override
  String streamerXStreamerPicture(String param) {
    return '$param εικόνα streamer';
  }

  @override
  String get streamerChangePicture => 'Αλλαγή/διαγραφή της εικόνας σας';

  @override
  String get streamerUploadPicture => 'Μεταφόρτωση εικόνας';

  @override
  String streamerMaxSize(String param) {
    return 'Μέγιστο μέγεθος: $param';
  }
  ...
  String streamerKeepItShort(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Σύντομη περιγραφή: $count χαρακτήρες το πολύ',
      one: 'Σύντομη περιγραφή: $count χαρακτήρας το πολύ',
      zero: 'Σύντομη περιγραφή: $count χαρακτήρας το πολύ',
    );
    return '$_temp0';
  }
  ...
  @override
  String get studyCopyChapterPgnDescription => 'Αντιγραφή κεφαλαίου PGN στο πρόχειρο.';
