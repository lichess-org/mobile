...
class AppLocalizationsLt extends AppLocalizations {
  ...
  @override
  String get boardGeometry => 'Lentos geometrija';

  @override
  String get boardTheme => 'Lentos stilius';

  @override
  String get boardSize => 'Lentos dydis';
  ...
  @override
  String get searchAdvancedSearch => 'Detali paieška';

  @override
  String get searchOpponentName => 'Varžovo vardas';

  @override
  String get searchLoser => 'Pralaimėtojas';

  @override
  String get searchFrom => 'nuo';

  @override
  String get searchTo => 'iki';

  @override
  String get searchHumanOrComputer => 'Ar žaidėjo varžovas buvo žmogus, ar kompiuteris';

  @override
  String get searchAiLevel => 'D.I. lygis';

  @override
  String get searchSource => 'Šaltinis';

  @override
  String get searchNbTurns => 'Ėjimų skaičius';

  @override
  String get searchResult => 'Rezultatas';

  @override
  String get searchWinnerColor => 'Nugalėtojo spalva';

  @override
  String get searchDate => 'Data';

  @override
  String get searchSortBy => 'Rūšiuoti pagal';

  @override
  String get searchAnalysis => 'Analizė';

  @override
  String get searchOnlyAnalysed => 'Tik partijos, kurios turi kompiuterinę analizę';

  @override
  String get searchColor => 'Spalva';

  @override
  String get searchEvaluation => 'Vertinimas';

  @override
  String get searchMaxNumber => 'Didžiausias skaičius';

  @override
  String get searchMaxNumberExplanation => 'Kiek daugiausia žaidimų grąžinti';

  @override
  String get searchInclude => 'Įtraukti';

  @override
  String get searchDescending => 'Mažėjimo tvarka';

  @override
  String get searchAscending => 'Didėjimo tvarka';

  @override
  String get searchRatingExplanation => 'Vidutinis abiejų žaidėjų reitingas';
  ...
  String searchSearchInXGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Paieška tarp $count šachmatų partijų',
      many: 'Paieška tarp $count šachmatų partijų',
      few: 'Paieška tarp $count šachmatų partijų',
      one: 'Paieška tarp $count šachmatų partijos',
      zero: 'Paieška tarp $count šachmatų partijos',
    );
    return '$_temp0';
  }
  ...
  String searchXGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Rasta $count partijų',
      many: 'Rasta $count partijų',
      few: 'Rastos $count partijos',
      one: 'Rasta viena partija',
      zero: 'Rasta viena partija',
    );
    return '$_temp0';
  }
  ...
  String searchGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other: 'Rasta $count partijų',
      many: 'Rasta $count partijos',
      few: 'Rastos $count partijos',
      one: 'Rasta $count partija',
      zero: 'Rasta $count partija',
    );
    return '$_temp0';
  }
  ...
  @override
  String get streamerLichessStreamer => 'Lichess transliuotojas';

  @override
  String get streamerLive => 'GYVAI!';

  @override
  String get streamerOffline => 'NEPRISIJUNGĘ';

  @override
  String streamerCurrentlyStreaming(String param) {
    return 'Dabar transliuojama: $param';
  }

  @override
  String streamerLastStream(String param) {
    return 'Paskutinė transliacija $param';
  }

  @override
  String get streamerBecomeStreamer => 'Tapkite Lichess transliuotoju';

  @override
  String get streamerDoYouHaveStream => 'Ar turite Twitch ar YouTube paskyrą?';

  @override
  String get streamerHereWeGo => 'Pradėkime!';

  @override
  String get streamerAllStreamers => 'Visi transliuotojai';

  @override
  String get streamerEditPage => 'Keisti transliuotojo puslapį';

  @override
  String get streamerYourPage => 'Jūsų transliuotojo puslapis';

  @override
  String get streamerDownloadKit => 'Atsisiųsti transliuotojo rinkinį';

  @override
  String streamerXIsStreaming(String param) {
    return '$param transliuoja';
  }

  @override
  String get streamerRules => 'Transliacijų taisyklės';

  @override
  String get streamerRule1 => 'Transliuodami Lichess transliacijos pavadinime įterpkite \"lichess.org\" ir naudokite kategoriją \"Šachmatai\" (Chess).';

  @override
  String get streamerRule2 => 'Pašalinkite raktinį žodį kai transliuojate ne Lichess dalykus.';

  @override
  String get streamerRule3 => 'Lichess jūsų transliaciją aptiks automatiškai ir suteiks jums šiuos privalumus:';

  @override
  String streamerRule4(String param) {
    return 'Perskaitykite $param norėdami užtikrinti sąžiningą žaidimą visiems žaidėjams savo transliacijoje.';
  }

  @override
  String get streamerStreamingFairplayFAQ => 'transliacijų sąžiningumo DUK';

  @override
  String get streamerPerks => 'Pranašumai transliuojant su raktiniu žodžiu';

  @override
  String get streamerPerk1 => 'Gaukite degančią transliuotojo piktogramą savo Lichess profilį.';

  @override
  String get streamerPerk2 => 'Patekite į transliuotojų sąrašo viršų.';

  @override
  String get streamerPerk3 => 'Pranešti savo Lichess sekėjams.';

  @override
  String get streamerPerk4 => 'Parodykite savo transliaciją savo partijose, turnyruose ir studijose.';

  @override
  String get streamerApproved => 'Jūsų transliacija patvirtinta.';

  @override
  String get streamerPendingReview => 'Jūsų transliacija peržiūrima moderatorių.';

  @override
  String get streamerPleaseFillIn => 'Užpildykite savo transliuotojo informaciją ir įkelkite nuotrauką.';

  @override
  String streamerWhenReady(String param) {
    return 'Kai būsite pasiruošę būti pažymėti kaip Lichess transliuotojas, $param';
  }

  @override
  String get streamerRequestReview => 'pareikalaukite moderatoriaus peržiūros';

  @override
  String get streamerStreamerLanguageSettings => 'Lichess transliuotojo puslapius nukreipia jūsų auditoriją su kalba nurodyta jūsų transliacijos platformoje. Nustatykite tinkamą numatytąją kalbą savo šachmatų transliacijoms programėlėje ar platformoje iš kurios transliuojate.';

  @override
  String get streamerTwitchUsername => 'Jūsų Twitch vartotojo vardas ar adresas';

  @override
  String get streamerOptionalOrEmpty => 'Nebūtina. Palikite tuščią, jei nėra';

  @override
  String get streamerYouTubeChannelId => 'Jūsų YouTube kanalo ID (channel ID)';

  @override
  String get streamerStreamerName => 'Jūsų transliuotojo vardas Lichess';

  @override
  String get streamerVisibility => 'Matomas transliuotojų puslapyje';

  @override
  String get streamerWhenApproved => 'Kai bus patvirtintas moderatorių';

  @override
  String get streamerHeadline => 'Antraštė';

  @override
  String get streamerTellUsAboutTheStream => 'Papasakokite apie savo transliaciją vienu sakiniu';

  @override
  String get streamerLongDescription => 'Ilgas aprašymas';

  @override
  String streamerXStreamerPicture(String param) {
    return '$param transliuotojo nuotrauka';
  }

  @override
  String get streamerChangePicture => 'Keisti/trinti savo nuotrauką';

  @override
  String get streamerUploadPicture => 'Įkelti nuotrauką';

  @override
  String streamerMaxSize(String param) {
    return 'Maksimalus dydis: $param';
  }
  ...
  String streamerKeepItShort(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Pasirinkite trumpą: daugiausia $count ženklų',
      many: 'Pasirinkite trumpą: daugiausia $count ženklo',
      few: 'Pasirinkite trumpą: daugiausia $count žeklai',
      one: 'Pasirinkite trumpą: daugiausia $count ženklas',
      zero: 'Pasirinkite trumpą: daugiausia $count ženklas',
    );
    return '$_temp0';
  }
  ...
  @override
  String get studyCopyChapterPgnDescription => 'Kopijuoti skyriaus PGN į iškarpinę.';
  ...
  String studyPasteYourPgnTextHereUpToNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Įklijuokite savo PGN tekstą čia, iki $count žaidimo',
    );
    return '$_temp0';
  }
}
