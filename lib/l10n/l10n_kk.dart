...
class AppLocalizationsKk extends AppLocalizations {
  ...
  @override
  String get boardGeometry => 'Тақта пішіні';

  @override
  String get boardTheme => 'Тақта өңі';

  @override
  String get boardSize => 'Тақта үлкендігі';
  ...
  @override
  String get searchAdvancedSearch => 'Терең іздеу';

  @override
  String get searchOpponentName => 'Қарсыластың аты';

  @override
  String get searchLoser => 'Жеңілген';

  @override
  String get searchFrom => 'Бастап';

  @override
  String get searchTo => 'Дейін';

  @override
  String get searchHumanOrComputer => 'Қарсыласты таңдаңыз: адам не компьютер';

  @override
  String get searchAiLevel => 'Компьютер деңгейі';

  @override
  String get searchSource => 'Іздеу жері';

  @override
  String get searchNbTurns => 'Жүрістер саны';

  @override
  String get searchResult => 'Нәтиже';

  @override
  String get searchWinnerColor => 'Жеңімпаз түсі';

  @override
  String get searchDate => 'Күні';

  @override
  String get searchSortBy => 'Сұрыптау шарты';

  @override
  String get searchAnalysis => 'Талдау';

  @override
  String get searchOnlyAnalysed => 'Тек компьютерлік талдауға бейім ойындар';

  @override
  String get searchColor => 'Түсі';

  @override
  String get searchEvaluation => 'Бағалау';

  @override
  String get searchMaxNumber => 'Ойын саны';

  @override
  String get searchMaxNumberExplanation => 'Іздеу нәтижесінде қанша ойын көрсету';

  @override
  String get searchInclude => 'Құрамы';

  @override
  String get searchDescending => 'Кему бойымен';

  @override
  String get searchAscending => 'Өсу бойымен';

  @override
  String get searchRatingExplanation => 'Екі ойыншының орташа рейтингі';
  ...
  String searchSearchInXGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count ойында іздеу',
      one: '$count ойында іздеу',
      zero: '$count ойында іздеу',
    );
    return '$_temp0';
  }
  ...
  String searchXGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count ойын табылды',
      one: 'Бір ойын табылды',
      zero: 'Бір ойын табылды',
    );
    return '$_temp0';
  }
  ...
  String searchGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other: '$count ойын табылды',
      one: '$count ойын табылды',
      zero: '$count ойын табылды',
    );
    return '$_temp0';
  }
  ...
  @override
  String get streamerLichessStreamer => 'Личес стримері';

  @override
  String get streamerLive => 'Тікелей эфир!';

  @override
  String get streamerOffline => 'Эфирден тыс';

  @override
  String streamerCurrentlyStreaming(String param) {
    return 'Қазіргі стрим: $param';
  }

  @override
  String streamerLastStream(String param) {
    return 'Кейінгі стрим $param';
  }

  @override
  String get streamerBecomeStreamer => 'Личес стримері болу';

  @override
  String get streamerDoYouHaveStream => 'Сізде YouTube не Twitch арнасы бар ма?';

  @override
  String get streamerHereWeGo => 'Кеттік!';

  @override
  String get streamerAllStreamers => 'Барлық стримерлер';

  @override
  String get streamerEditPage => 'Стример парақшасын өңдеу';

  @override
  String get streamerYourPage => 'Сіздің стример парақшаңыз';

  @override
  String get streamerDownloadKit => 'Стример құралдарын жүктеп алу';

  @override
  String streamerXIsStreaming(String param) {
    return '$param стрим жүргізіп отыр';
  }

  @override
  String get streamerRules => 'Стрим жүргізудің ережелері';

  @override
  String get streamerRule1 => 'Личестің стримін жүргізгенде, \"lichess.org\" кілтсөзін стрим тақырыбына қосып, \"Chess\" санатын таңдаңыз.';

  @override
  String get streamerRule2 => 'Личестен басқа нәрсенің стримін жүргізсеңіз, кілтсөзді алып тастаңыз.';

  @override
  String get streamerRule3 => 'Личес стриміңізді автоматты түрде анықтап, келесі жеңілдіктерге жол ашады:';

  @override
  String streamerRule4(String param) {
    return 'Стрим кезінде бәрі бірдей әділ ойнау үшін біздің $param оқыңыз.';
  }

  @override
  String get streamerStreamingFairplayFAQ => 'Әділ стрим ойын туралы Жұрттан-сұрақ';

  @override
  String get streamerPerks => 'Стримді кілтсөзбен жүргізудің артықшылығы';

  @override
  String get streamerPerk1 => 'Личес куәлігіңізде жалынды стример таңбашасы шығады.';

  @override
  String get streamerPerk2 => 'Стримерлер тізімінің төбесіне шығасыз.';

  @override
  String get streamerPerk3 => 'Личес серіктеріңізді ескертесіз.';

  @override
  String get streamerPerk4 => 'Стримді өз ойындарыңызда, жарыс пен зерттеуде көрсетесіз.';

  @override
  String get streamerApproved => 'Сіздің стриміңіз расталды.';

  @override
  String get streamerPendingReview => 'Сіздің стриміңіз модераторлардың тексеруінде.';

  @override
  String get streamerPleaseFillIn => 'Стример мәліметтерін толтырып, суретіңізді жүктеп салыңыз.';

  @override
  String streamerWhenReady(String param) {
    return 'Личес стримерлер қатарына қосылу үшін $param';
  }

  @override
  String get streamerRequestReview => 'модератор тексеруін сұраңыз';

  @override
  String get streamerStreamerLanguageSettings => 'Личес стример парақшаңыз белгілі бір тілді көрерменге арналған. Бұл тіл стрим жасайтын платформаның тіліне негізделген. Шахмат стримді бастар бұрын лайықты тілді көрсетілім жасайтын қызметте я қолданбада орнатып алыңыз.';

  @override
  String get streamerTwitchUsername => 'Twitch тіркеулі атыңыз немесе URL';

  @override
  String get streamerOptionalOrEmpty => 'Міндетті емес. Жоқ болса, бос қалдырыңыз';

  @override
  String get streamerYouTubeChannelId => 'Сіздің YouTube арнаңыздың ID';

  @override
  String get streamerStreamerName => 'Личестегі стример атыңыз';

  @override
  String get streamerVisibility => 'Стримерлер парақшасында көріну';

  @override
  String get streamerWhenApproved => 'Модераторлар растаса';

  @override
  String get streamerHeadline => 'Басты тақырып';

  @override
  String get streamerTellUsAboutTheStream => 'Стрим туралы бір сөйлеммен айтып беріңіз';

  @override
  String get streamerLongDescription => 'Ұзын сипаттама';

  @override
  String streamerXStreamerPicture(String param) {
    return '$param стримердің суреті';
  }

  @override
  String get streamerChangePicture => 'Суретті өзгерту/жою';

  @override
  String get streamerUploadPicture => 'Суретті жүктеп салу';

  @override
  String streamerMaxSize(String param) {
    return 'Өлшемнің шегі: $param';
  }
  ...
  String streamerKeepItShort(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Қысқа болсын: ең көбі $count таңба',
      one: 'Қысқа болсын: ең көбі $count таңба',
      zero: 'Қысқа болсын: ең көбі $count таңба',
    );
    return '$_temp0';
  }
  ...
  @override
  String get studyCopyChapterPgnDescription => 'Тараудың PGN-ын көшіру.';
  ...
  String studyPasteYourPgnTextHereUpToNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'PGN мәтінін осында қойыңыз, $count ойын ғана',
    );
    return '$_temp0';
  }
}
