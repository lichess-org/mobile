...
class AppLocalizationsKk extends AppLocalizations {
  ...
  String get playFirstOpeningEndgameExplorerMove =>
      'Бастау/ойынсоңы қорынан бірінші қадам жасау';
  ...
  String get waitForSignupHelp =>
      'Тіркелуді аяқтау үшін біз тез арада жауап береміз.';
  ...
  String get agreementPolicy =>
      'Мен Личестің барлық қағидаларын ұстанамын деп уәде беремін.';
