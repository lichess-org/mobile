...
class AppLocalizationsSr extends AppLocalizations {
  ...
  @override
  String get mobilePuzzleStormFilterNothingToShow => 'Нема ништа за приказивање, молимо вас промените филтере';
  ...
  @override
  String get mobileSettingsHomeWidgets => 'Почетне компоненте';
  ...
  @override
  String get mobileSettingsMaterialDifferenceCapturedPieces => 'Узете фигуре';
  ...
  @override
  String get mobileSettingsPickAnImageSwipeToDisplay => 'Превуци да прикажеш друге позадине';

  @override
  String get mobileSettingsPieceShiftMethodEither => 'Додирни или превуци';
  ...
  String activityRankedInSwissTournament(String param1, String param2) {
    return 'Рангиран/а #$param1 у $param2';
  }

  @override
  String get activitySignedUp => 'Пријавио/ла се за lichess.org';
  ...
  String activitySupportedNbMonths(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Подржаo/ла lichess.org на $count месеци као $param2',
      few: 'Подржаo/ла lichess.org на $count месеца као $param2',
      one: 'Подржаo/ла lichess.org на $count месец као $param2',
    );
    return '$_temp0';
  }
  ...
  String activityPracticedNbPositions(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Вежбаo/ла $count позиција на $param2',
      few: 'Вежбаo/ла $count позиције на $param2',
      one: 'Вежбаo/ла $count позицију на $param2',
    );
    return '$_temp0';
  }
  ...
  String activitySolvedNbPuzzles(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Решио/ла $count тренинг проблема',
      few: 'Решио/ла $count тренинг проблема',
      one: 'Решио/ла $count тренинг проблем',
    );
    return '$_temp0';
  }
  ...
  String activityPlayedNbGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Одиграо/ла $count $param2 партија',
      few: 'Одиграо/ла $count $param2 партије',
      one: 'Одиграо/ла $count $param2 партију',
    );
    return '$_temp0';
  }
  ...
  String activityPostedNbMessages(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Поставио/ла $count порука у $param2',
      few: 'Поставио/ла $count поруке у $param2',
      one: 'Поставио/ла $count поруку у $param2',
    );
    return '$_temp0';
  }
  ...
  String activityPlayedNbMoves(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Одиграо/ла $count потеза',
      few: 'Одиграо/ла $count потеза',
      one: 'Одиграо/ла $count потез',
    );
    return '$_temp0';
  }
  ...
  String activityCompletedNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Завршио/ла $count дописних партија',
      few: 'Завршио/ла $count дописне партије',
      one: 'Завршио/ла $count дописну партију',
    );
    return '$_temp0';
  }
  ...
  String activityFollowedNbPlayers(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Почео/ла пратити $count играча',
      few: 'Почео/ла пратити $count играча',
      one: 'Почео/ла пратити $count играча',
    );
    return '$_temp0';
  }
  ...
  String activityGainedNbFollowers(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Стекао/ла $count нових пратилаца',
      few: 'Стекао/ла $count нова пратилаца',
      one: 'Стекао/ла $count новог пратиоца',
    );
    return '$_temp0';
  }
  ...
  String activityHostedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Организовао/ла $count симултанки',
      few: 'Организовао/ла $count симултанке',
      one: 'Организовао/ла $count симултанку',
    );
    return '$_temp0';
  }
  ...
  String activityJoinedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Учествовао/ла у $count симултанки',
      few: 'Учествовао/ла у $count симултанке',
      one: 'Учествовао/ла у $count симултанки',
    );
    return '$_temp0';
  }
  ...
  String activityCreatedNbStudies(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Направио/ла $count нових студија',
      few: 'Направио/ла $count нове студије',
      one: 'Направио/ла $count нову студију',
    );
    return '$_temp0';
  }
  ...
  String activityCompetedInNbTournaments(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Такмичио/ла се у $count Арена турнира',
      few: 'Такмичио/ла се у $count Арена турнира',
      one: 'Такмичио/ла се у $count Арена турниру',
    );
    return '$_temp0';
  }
  ...
  String activityRankedInTournament(int count, String param2, String param3, String param4) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Рангиран/а #$count (првих $param2%) са $param3 партија у $param4',
      few: 'Рангиран/а #$count (првих $param2%) са $param3 партије у $param4',
      one: 'Рангиран/а #$count (првих $param2%) са $param3 партијом у $param4',
    );
    return '$_temp0';
  }
  ...
  String activityCompetedInNbSwissTournaments(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Такмичио/ла се у $count Швајцарских турнира',
      few: 'Такмичио/ла се у $count Швајцарска турнира',
      one: 'Такмичио/ла се у $count Швајцарском турниру',
    );
    return '$_temp0';
  }
  ...
  String activityJoinedNbTeams(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Придружио/ла се $count тимова',
      few: 'Придружио/ла се $count тима',
      one: 'Придружио/ла се $count тиму',
    );
    return '$_temp0';
  }
  ...
  @override
  String get arenaWillBeNotified => 'Бићеш обавештен/а када турнир почне, тако да је сигурно играти у другом прозору док чекаш.';

  @override
  String get arenaIsRated => 'Овај турнир је рангиран и утицаће на твој рејтинг.';

  @override
  String get arenaIsNotRated => 'Овај турнир *није* рангиран и *неће* утицати на твој рејтинг.';

  @override
  String get arenaSomeRated => 'Неки турнири су рангирани и утицаће на твој рејтинг.';
  ...
  @override
  String get arenaHowDoesItEndAnswer => 'Турнир има сат који одбројава. Када сат достигне нула, турнирска лествица се залеђује и победник је проглашен. Партије у току морају бити завршене, међутим, оне се нерачунају за турнир.';

  @override
  String get arenaOtherRules => 'Остала важна правила';

  @override
  String get arenaThereIsACountdown => 'Постоји одбројавање за твој први потез. Не прављење потеза у овом периоду ће предати партију твом противнику.';

  @override
  String get arenaThisIsPrivate => 'Ово је приватни турнир';

  @override
  String arenaShareUrl(String param) {
    return 'Подели овај линк како би допустито/ла људима да се придруже: $param';
  }
  ...
  @override
  String get arenaVariant => 'Варијанта';
  ...
  @override
  String get arenaCustomStartDate => 'Прилагођени почетни датум';

  @override
  String get arenaCustomStartDateHelp => 'У твојој локалној временској зони. Ово надјачава \"Време пре него што турнир започне\" поставку';

  @override
  String get arenaAllowBerserk => 'Дозволи Берсерк';

  @override
  String get arenaAllowBerserkHelp => 'Допусти играчима да преполове своје време сата да добију додатни бод';

  @override
  String get arenaAllowChatHelp => 'Допусти играчима да дискутују у соби за ћаскање';

  @override
  String get arenaArenaStreaks => 'Арена низови';

  @override
  String get arenaArenaStreaksHelp => 'После 2 победе, узастопне победе дају 4 бода уместо 2.';
  ...
  @override
  String get arenaPointsSum => 'Збир бодова';

  @override
  String get arenaRankAvg => 'Rank average';

  @override
  String get arenaTournamentWinners => 'Победници турнира';
  ...
  String arenaDrawingWithinNbMoves(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Ремизирање партије у првих $count потеза неће донети бодове ни једном играчу.',
      few: 'Ремизирање партије у прва $count потеза неће донети бодове ни једном играчу.',
      one: 'Ремизирање партије у првом $count потезу неће доносити бодове ни једном играчу.',
    );
    return '$_temp0';
  }
  ...
  String arenaViewAllXTeams(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Погледај свих $count тимова',
      few: 'Погледај сва $count тима',
      one: 'Погледај тим',
    );
    return '$_temp0';
  }
  ...
  @override
  String get broadcastBroadcastCalendar => 'Календар преноса';
  ...
  @override
  String get broadcastAboutBroadcasts => 'О преносима';
  ...
  @override
  String get broadcastAddRound => 'Додај рунду';
  ...
  @override
  String get broadcastRoundName => 'Назив рунде';

  @override
  String get broadcastTournamentName => 'Назив догађаја';

  @override
  String get broadcastTournamentDescription => 'Кратак опис турнира';
  ...
  @override
  String get broadcastCurrentGameUrl => 'Линк тренутне партије';

  @override
  String get broadcastDownloadAllRounds => 'Download all rounds';

  @override
  String get broadcastResetRound => 'Ресетуј ову рунду';
  ...
  @override
  String get challengeChallengeToPlay => 'Изазови';
  ...
  @override
  String get challengeRegisterToSendChallenges => 'Молимо да се региструјеш како би слао/ла изазове овом кориснику.';

  @override
  String challengeYouCannotChallengeX(String param) {
    return 'Не можеш изазвати $param.';
  }
  ...
  String challengeYourXRatingIsTooFarFromY(String param1, String param2) {
    return 'Твој $param1 рејтинг је предалек од $param2.';
  }

  @override
  String challengeCannotChallengeDueToProvisionalXRating(String param) {
    return 'Не може се изазвати због пробног $param рејтинга.';
  }
  ...
  @override
  String get challengeDeclineLater => 'Изазов ми тренутно не одговара, молим те изазови касније.';

  @override
  String get challengeDeclineTooFast => 'Ова временска контрола је пребрза за мене, молим те изазови опет са споријом партијом.';

  @override
  String get challengeDeclineTooSlow => 'Ова временска контрола је преспора за мене, молим те изазови опет са бржом партијом.';

  @override
  String get challengeDeclineTimeControl => 'Не прихватам изазове са овом временском контролом.';

  @override
  String get challengeDeclineRated => 'Молим те пошаљи рангиран изазов уместо овог.';

  @override
  String get challengeDeclineCasual => 'Молим те пошаљи нерангиран изазов уместо овог.';
  ...
  @override
  String get challengeDeclineOnlyBot => 'Само прихватам изазове од ботова.';
  ...
  @override
  String get coordinatesCoordinateTraining => 'Тренинг координата';

  @override
  String coordinatesAverageScoreAsWhiteX(String param) {
    return 'Просечан скор као бели: $param';
  }

  @override
  String coordinatesAverageScoreAsBlackX(String param) {
    return 'Просечан скор као црни: $param';
  }

  @override
  String get coordinatesKnowingTheChessBoard => 'Знати координате шаховске табле је веома важна шаховска вештина из више разлога:';

  @override
  String get coordinatesMostChessCourses => 'Већина шаховских курсева и вежби опширно користе алгебарску нотацију.';

  @override
  String get coordinatesTalkToYourChessFriends => 'Олакшава ти да причаш са твојим шаховским пријатељима, јер обоје разумете \'језик шаха\'.';

  @override
  String get coordinatesYouCanAnalyseAGameMoreEffectively => 'Можеш ефективније анализирати партију ако можеш брзо препознати координате.';
  ...
  @override
  String get coordinatesShowCoordinates => 'Прикажи координате';

  @override
  String get coordinatesShowCoordsOnAllSquares => 'Координате на сваком пољу';

  @override
  String get coordinatesShowPieces => 'Прикажи фигуре';

  @override
  String get coordinatesStartTraining => 'Започни тренинг';

  @override
  String get coordinatesFindSquare => 'Пронађи поље';
  ...
  @override
  String get perfStatProvisional => 'пробни';

  @override
  String get perfStatNotEnoughRatedGames => 'Није одиграно довољно рангираних партија да се успостави поуздан рејтинг.';

  @override
  String perfStatProgressOverLastXGames(String param) {
    return 'Напредак у последњих $param партија:';
  }

  @override
  String perfStatRatingDeviation(String param) {
    return 'Рејтинг девијација: $param.';
  }

  @override
  String perfStatRatingDeviationTooltip(String param1, String param2, String param3) {
    return 'Мања вредност значи да је рејтинг стабилнији. Преко $param1, рејтинг се рачуна као пробни. Да будеш укључен у рејтингу, ова вредност би требала бити испод $param2 (стандардни шах) или $param3 (варијанте).';
  }
  ...
  @override
  String get perfStatRatedGames => 'Рангираних партија';

  @override
  String get perfStatTournamentGames => 'Турнирских партија';

  @override
  String get perfStatBerserkedGames => 'Берсерковане партије';

  @override
  String get perfStatTimeSpentPlaying => 'Време проведено играјући';

  @override
  String get perfStatAverageOpponent => 'Просечни противник';

  @override
  String get perfStatVictories => 'Победа';

  @override
  String get perfStatDefeats => 'Пораза';

  @override
  String get perfStatDisconnections => 'Искључења';

  @override
  String get perfStatNotEnoughGames => 'Недовољно партија одиграно';
  ...
  @override
  String get perfStatWinningStreak => 'Победнички низ';

  @override
  String get perfStatLosingStreak => 'Губитнички низ';
  ...
  @override
  String get perfStatLessThanOneHour => 'Мање од једног сата између партија';

  @override
  String get perfStatMaxTimePlaying => 'Максимално време проведено играјући';
  ...
  @override
  String get preferencesSnapArrowsToValidMoves => 'Закачи стрелице на важеће потезе';

  @override
  String get preferencesSayGgWpAfterLosingOrDrawing => 'Реци \"Good game, well played\" након пораза или ремија';

  @override
  String get preferencesYourPreferencesHaveBeenSaved => 'Твоје преференсе су сачуване.';

  @override
  String get preferencesScrollOnTheBoardToReplayMoves => 'Скролуј на табли да поновиш потезе';
  ...
  @override
  String get preferencesNotifyBell => 'Notification within Lichess';
  ...
  @override
  String get puzzleToGetPersonalizedPuzzles => 'Да би добио/ла персонализоване проблеме:';
  ...
  @override
  String get puzzleClickToSolve => 'Кликни да решиш';
  ...
  @override
  String get puzzlePuzzleComplete => 'Проблем завршен!';
  ...
  @override
  String get puzzleNotTheMove => 'То није тражени потез!';

  @override
  String get puzzleTrySomethingElse => 'Покушај нешто друго.';
  ...
  @override
  String get puzzleHidden => 'сакривен';
  ...
  @override
  String get puzzleContinueTraining => 'Настави тренинг';
  ...
  @override
  String get puzzleAddAnotherTheme => 'Додај још једну тему';

  @override
  String get puzzleNextPuzzle => 'Next puzzle';

  @override
  String get puzzleJumpToNextPuzzleImmediately => 'Скочи до следећег проблема одмах';

  @override
  String get puzzlePuzzleDashboard => 'Преглед Проблема';

  @override
  String get puzzleImprovementAreas => 'Подручја за побољшање';

  @override
  String get puzzleStrengths => 'Јаке стране';

  @override
  String get puzzleHistory => 'Историја проблема';

  @override
  String get puzzleSolved => 'решено';

  @override
  String get puzzleFailed => 'нетачно';

  @override
  String get puzzleStreakDescription => 'Реши све теже проблеме и изгради победнички низ. Нема сата, тако да узми своје верме. Један погрешан потез и игра је готова! Али можеш прескочити један потез по сесији.';

  @override
  String puzzleYourStreakX(String param) {
    return 'Твој низ: $param';
  }

  @override
  String get puzzleStreakSkipExplanation => 'Прескочи овај потез да задржиш свој низ! Само ради једном по трци.';

  @override
  String get puzzleContinueTheStreak => 'Настави низ';

  @override
  String get puzzleNewStreak => 'Нови низ';

  @override
  String get puzzleFromMyGames => 'Из мојих партија';

  @override
  String get puzzleLookupOfPlayer => 'Погледај проблеме из играчевих партија';

  @override
  String get puzzleSearchPuzzles => 'Претражи проблеме';

  @override
  String get puzzleFromMyGamesNone => 'Немаш проблеме у бази података, али Lichess те и даље много воли.\n\nИграј брзопотезне и класичне партије како би повећао/ла шансе да имаш проблем додат из твоје партије!';
  ...
  @override
  String get puzzleImprovementAreasDescription => 'Train these to optimise your progress!';
  ...
  String puzzleNbPointsBelowYourPuzzleRating(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count бодова испод твог проблемског рејтинга',
      few: '$count бода испод твог проблемског рејтинга',
      one: 'Један бод испод твог проблемског рејтинга',
    );
    return '$_temp0';
  }
  ...
  String puzzleNbPointsAboveYourPuzzleRating(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count бодова изнад твог проблемског рејтинга',
      few: '$count бода изнад твог проблемског рејтинга',
      one: 'Један бод изнад твог проблемског рејтинга',
    );
    return '$_temp0';
  }
  ...
  @override
  String get puzzleThemeAdvancedPawn => 'Напредан пешак';

  @override
  String get puzzleThemeAdvancedPawnDescription => 'Један од твојих пешака је дубоко у противничкој позицији, можда прети да промовише.';

  @override
  String get puzzleThemeAdvantage => 'Предност';

  @override
  String get puzzleThemeAdvantageDescription => 'Искористи шансу да стекнеш одлучујућу предност. (200cp ≤ евалуација ≤ 600cp)';

  @override
  String get puzzleThemeAnastasiaMate => 'Анастазијин мат';

  @override
  String get puzzleThemeAnastasiaMateDescription => 'Скакач и топ или краљица се удружују да заробе противничког краља између ивице табле и његове фигуре.';

  @override
  String get puzzleThemeArabianMate => 'Арапски мат';

  @override
  String get puzzleThemeArabianMateDescription => 'Скакач и топ се удруже како би заробили противничког краља на ћошку табле.';
  ...
  @override
  String get puzzleThemeBackRankMateDescription => 'Матирај краља на његовом почетном реду, када је тамо заробљен својим фигурама.';
  ...
  @override
  String get puzzleThemeCapturingDefender => 'Узми браниоца';
  ...
  @override
  String get puzzleThemeCrushing => 'Уништавајуће';

  @override
  String get puzzleThemeCrushingDescription => 'Уочи противнички превид да стекнеш огромну предност. (евалуација ≥ 600cp)';
  ...
  @override
  String get puzzleThemeDoubleBishopMate => 'Мат са два ловца';
  ...
  @override
  String get puzzleThemeDovetailMate => 'Коцијев мат';

  @override
  String get puzzleThemeDovetailMateDescription => 'Дама даје мат суседном краљу, чија су једина два излазна поља препречена његовим фигурама.';

  @override
  String get puzzleThemeEquality => 'Изједначење';

  @override
  String get puzzleThemeEqualityDescription => 'Врати се из губитне позиције и осигурај реми или изједначену позицију. (евалуација ≤ 200cp)';

  @override
  String get puzzleThemeKingsideAttack => 'Напад на краљевом крилу';

  @override
  String get puzzleThemeKingsideAttackDescription => 'Напад на противничког краља, након што се рокадирао на краљевој страни.';

  @override
  String get puzzleThemeClearance => 'Рашчишћавање';

  @override
  String get puzzleThemeClearanceDescription => 'Потез, често са темпом, који чисти поље, колону или дијагоналу за пратећу тактичку идеју.';
  ...
  @override
  String get puzzleThemeHangingPiece => 'Небрањена фигура';

  @override
  String get puzzleThemeHangingPieceDescription => 'Тактика у којој је противничка фигура небрањена или недовољно брањена и слободна за узимање.';
  ...
  @override
  String get puzzleThemeInterference => 'Пресецање';

  @override
  String get puzzleThemeInterferenceDescription => 'Померање своје између две противничке фигуре да оставиш једну или обе противничке фигуре небрањене, као скакач на одбрањеном пољу између два топа.';

  @override
  String get puzzleThemeIntermezzo => 'Међупотез';

  @override
  String get puzzleThemeIntermezzoDescription => 'Уместо играња очекиваног потеза, прво умешај други потез стварајући непосредну претњу на коју противник мора одговорити. Такође познат као \"Цвишенцуг\" или \"Уметнути потез\".';
  ...
  @override
  String get puzzleThemeLongDescription => 'Три потеза до победе.';

  @override
  String get puzzleThemeMaster => 'Мајсторске партије';

  @override
  String get puzzleThemeMasterDescription => 'Проблеми из партија које су играли играчи са титулом.';

  @override
  String get puzzleThemeMasterVsMaster => 'Партије Мајстора против Мајстора';

  @override
  String get puzzleThemeMasterVsMasterDescription => 'Проблеми из партија између два играча са титулом.';

  @override
  String get puzzleThemeMate => 'Шах-мат';

  @override
  String get puzzleThemeMateDescription => 'Победи партију са стилом.';

  @override
  String get puzzleThemeMateIn1 => 'Мат у 1';

  @override
  String get puzzleThemeMateIn1Description => 'Матирај у једном потезу.';

  @override
  String get puzzleThemeMateIn2 => 'Мат у 2';

  @override
  String get puzzleThemeMateIn2Description => 'Матирај у два потеза.';

  @override
  String get puzzleThemeMateIn3 => 'Мат у 3';

  @override
  String get puzzleThemeMateIn3Description => 'Матирај у три потеза.';

  @override
  String get puzzleThemeMateIn4 => 'Мат у 4';

  @override
  String get puzzleThemeMateIn4Description => 'Матирај у четири потеза.';
  ...
  @override
  String get puzzleThemeMiddlegameDescription => 'Тактика током друге фазе партије.';

  @override
  String get puzzleThemeOneMove => 'Једнопотезни проблем';

  @override
  String get puzzleThemeOneMoveDescription => 'Проблем од само једног потеза.';

  @override
  String get puzzleThemeOpening => 'Отварање';

  @override
  String get puzzleThemeOpeningDescription => 'Тактика током прве фазе партије.';
  ...
  @override
  String get puzzleThemePinDescription => 'Тактика која укључује везивања, где фигура не може да се помери без откривања напада на вреднију фигуру.';
  ...
  @override
  String get puzzleThemeQueenEndgameDescription => 'Завршница са само дамама и пешацима.';

  @override
  String get puzzleThemeQueenRookEndgame => 'Дама и Топ';

  @override
  String get puzzleThemeQueenRookEndgameDescription => 'Завршница са само дамама, топовима и пешацима.';

  @override
  String get puzzleThemeQueensideAttack => 'Напад на дамином крилу';

  @override
  String get puzzleThemeQueensideAttackDescription => 'Напад на противничког краља, након што се рокадирао на даминој страни.';

  @override
  String get puzzleThemeQuietMove => 'Тихи потез';

  @override
  String get puzzleThemeQuietMoveDescription => 'Потез који не шахира, узима или ствара тренутну претњну узимања. Уместо тога, припрема сакривену и неодбрањиву претњу за каснији потез.';
  ...
  @override
  String get puzzleThemeSacrificeDescription => 'Тактика која укључује привремено давање материјала, да се добије предност након форсираног низа потеза.';

  @override
  String get puzzleThemeShort => 'Кратак проблем';

  @override
  String get puzzleThemeShortDescription => 'Два потеза до победе.';

  @override
  String get puzzleThemeSkewer => 'Ражањ';

  @override
  String get puzzleThemeSkewerDescription => 'Тактички мотив у којем напад на вредну фигуру приморава њено померање, откривајући мање вредну фигуру иза ње, која потом може бити узета или нападнута, супротност везивању.';

  @override
  String get puzzleThemeSmotheredMate => 'Угушени мат';

  @override
  String get puzzleThemeSmotheredMateDescription => 'Мат достављен скакачем у ком матиран краљ није у могућности да се помери јер је окружен (или угушен) својим фигурама.';

  @override
  String get puzzleThemeSuperGM => 'Партије супервелемајстора';

  @override
  String get puzzleThemeSuperGMDescription => 'Проблеми из партија које су играли најбољи играчи на свету.';

  @override
  String get puzzleThemeTrappedPiece => 'Заробљена фигура';

  @override
  String get puzzleThemeTrappedPieceDescription => 'Фигура не може избећи да буде узета јер су јој потези ограничени.';

  @override
  String get puzzleThemeUnderPromotion => 'Потпромоција';

  @override
  String get puzzleThemeUnderPromotionDescription => 'Промоција у скакача, ловца или топа.';

  @override
  String get puzzleThemeVeryLong => 'Веома дугачак проблем';

  @override
  String get puzzleThemeVeryLongDescription => 'Четири потеза или више за победу.';

  @override
  String get puzzleThemeXRayAttack => 'Рендгенски напад';

  @override
  String get puzzleThemeXRayAttackDescription => 'Фигура напада или брани поље, кроз противничку фигуру.';

  @override
  String get puzzleThemeZugzwang => 'Изнудица';

  @override
  String get puzzleThemeZugzwangDescription => 'Противник је ограничен у потезима које може направити и сви потези погоршавају његову позицију.';

  @override
  String get puzzleThemeMix => 'Здрава мешавина';

  @override
  String get puzzleThemeMixDescription => 'Свега по мало. Не знаш шта да очекујеш, па остајеш спреман за све! Баш као у правим партијама.';
  ...
  @override
  String get toInviteSomeoneToPlayGiveThisUrl => 'Да позовеш некога да игра, проследи овaј линк';
  ...
  @override
  String get reusableChallengeUrl => 'Вишекратни линк за изазов';

  @override
  String get permanentLinkForAnyoneToChallengeYou => 'Трајни линк за било кога да те изазове са тачно овим подешавањима.';

  @override
  String get waiting => 'Чека се';

  @override
  String get yourTurn => 'Твој потез';
  ...
  @override
  String get whiteIsVictorious => 'Бели је победио';
  ...
  @override
  String get cheatDetected => 'Варање Откривено';

  @override
  String get kingInTheCenter => 'Краљ у центру';

  @override
  String get threeChecks => 'Три шаха';

  @override
  String get raceFinished => 'Трка се завршила';

  @override
  String get variantEnding => 'Завршетак варијанте';
  ...
  @override
  String get whitePlays => 'Бели на потезу';

  @override
  String get blackPlays => 'Црни на потезу';

  @override
  String get opponentLeftChoices => 'Твој противник је изашао из партије. Можеш прогласити победу, прогласити партију ремијем или чекати.';

  @override
  String get forceResignation => 'Прогласи победу';

  @override
  String get forceDraw => 'Приморај реми';

  @override
  String get talkInChat => 'Молимо Вас да будете љубазни у ћаскању!';

  @override
  String get theFirstPersonToComeOnThisUrlWillPlayWithYou => 'Прва особа која дође на овај линк ће играти са тобом.';
  ...
  @override
  String get whiteDidntMove => 'Бели се није померио';

  @override
  String get blackDidntMove => 'Црни се није померио';

  @override
  String get whiteAborted => 'Бели је прекинуо партију';

  @override
  String get blackAborted => 'Црни је прекинуо партију';

  @override
  String get requestAComputerAnalysis => 'Затражи рачунарску анализу';

  @override
  String get computerAnalysis => 'Рачунарска анализа';

  @override
  String get computerAnalysisAvailable => 'Рачунарска анализа доступна';

  @override
  String get computerAnalysisDisabled => 'Онемогућена компјутерска анализа';

  @override
  String get analysis => 'Табла за анализу';
  ...
  @override
  String get usingServerAnalysis => 'Користи се серверска анализа';

  @override
  String get loadingEngine => 'Учитавање рачунара...';

  @override
  String get calculatingMoves => 'Израчунавам потезе...';

  @override
  String get engineFailed => 'Грешка при учитавању рачунара';
  ...
  @override
  String get showThreat => 'Покажи претњу';

  @override
  String get inLocalBrowser => 'у локалном претраживачу';

  @override
  String get toggleLocalEvaluation => 'Укључи/искључи локалну процену';

  @override
  String get promoteVariation => 'Промовиши варијацију';

  @override
  String get makeMainLine => 'Направи главном линијом';
  ...
  @override
  String get forceVariation => 'Приморај варијацијом';

  @override
  String get copyVariationPgn => 'Ископирај ПГН варијације';

  @override
  String get copyMainLinePgn => 'Копирај PGN главне линије';

  @override
  String get move => 'Потез';

  @override
  String get variantLoss => 'Пораз варијанте';

  @override
  String get variantWin => 'Победа варијанте';
  ...
  String minRatingX(String param) {
    return 'Минималан рејтинг од $param';
  }

  @override
  String maxRatingX(String param) {
    return 'Максималан рејтинг од $param';
  }
  ...
  @override
  String get noGameFound => 'Нема пронађених партија';

  @override
  String get maxDepthReached => 'Достигнут максимални број потеза!';

  @override
  String get maybeIncludeMoreGamesFromThePreferencesMenu => 'Можда укључи више партија из менија за префенсе?';
  ...
  @override
  String get unknownDueToRounding => 'Због могућег заокруживања DTZ вредности у Syzygy табелама завршница, победа/пораз су загарантовани само ако се препоручена линија из табеле пратила од последњег узимања или пешачког потеза.';
  ...
  @override
  String get visualMotifs => 'Визуелни мотиви';

  @override
  String get undefendedPieces => 'Небрањене фигуре';

  @override
  String get pinnedPieces => 'Везане фигуре';

  @override
  String get checkableKing => 'Краљ подложан шаху';

  @override
  String get multipleLines => 'Више линија';

  @override
  String get multipleLinesDescription => 'Постави број линија процене и потезних стрелица на табли';

  @override
  String get searchTime => 'Време претраге';
  ...
  @override
  String get threadsDescription => 'Постави ово испод броја нити твог процесора, ознака је добар сигуран избор';
  ...
  @override
  String get memoryDescription => 'Више вредности могу побољшати перформансе';
  ...
  @override
  String get moveTimes => 'Времена потеза';

  @override
  String get flipBoard => 'Окрени таблу';
  ...
  @override
  String get threefoldRepetition => 'Троструко поновљена позиција';

  @override
  String get claimADraw => 'Прогласи реми';

  @override
  String get drawClaimed => 'Реми проглашен';
  ...
  @override
  String get currentGames => 'Партије у току';
  ...
  @override
  String get youNeedAnAccountToDoThat => 'Треба ти налог да то урадиш';

  @override
  String get signUp => 'Региструј се';

  @override
  String get computersAreNotAllowedToPlay => 'Рачунарима и играчима који користе рачунарску помоћ није дозвољено играти. Молимо Вас да не користите шаховске програме, базе података или помоћ других играча током играња. Такође имајте на уму да је отварање више налога строго непожељно и да ће претерано коришћење више налога довести до забрањивања приступа.';
  ...
  String xPostedInForumY(String param1, String param2) {
    return '$param1 је објавио/ла у теми $param2';
  }
  ...
  @override
  String get minutesPerSide => 'Минута по играчу';
  ...
  @override
  String get variantsDescription => 'Више начина за играње';

  @override
  String get timeControl => 'Временска контрола';

  @override
  String get realTime => 'Стварновременa';

  @override
  String get correspondence => 'Дописнa';
  ...
  @override
  String get ratingStats => 'Рејтинг статистике';

  @override
  String get username => 'Корисничко име';

  @override
  String get usernameOrEmail => 'Корисничко име или имејл';

  @override
  String get changeUsername => 'Промени корисничко име';

  @override
  String get changeUsernameNotSame => 'Само величина слова може да се промени. На пример \"johndoe\" у \"JohnDoe\".';

  @override
  String get changeUsernameDescription => 'Промени своје корисничко име. Ово се може урадити само једном и само ти је дозвољено да промениш величину слова у свом корисничком имену.';
  ...
  @override
  String get forgotPassword => 'Заборавили лозинку?';
  ...
  @override
  String get youAreLeavingLichess => 'Напушташ Lichess';
  ...
  String sendEmailForAccountVerification(String param) {
    return 'Ако не можеш пронаћи твој имејл за потврду, пошали имејл на $param и ми ћемо потврдити твој налог за тебе.';
  }
  ...
  @override
  String get gamesPlayed => 'Одиграних партија';
  ...
  @override
  String get drawOfferAccepted => 'Понуда за реми прихваћена';
  ...
  @override
  String get yourOpponentOffersADraw => 'Твој противник нуди реми';
  ...
  @override
  String get playingRightNow => 'Тренутно се игра';

  @override
  String get eventInProgress => 'Управо се одиграва';

  @override
  String get finished => 'Завршено';

  @override
  String get abortGame => 'Прекини партију';

  @override
  String get gameAborted => 'Партија прекинута';

  @override
  String get standard => 'Стандардна';

  @override
  String get customPosition => 'Произвољна позиција';

  @override
  String get unlimited => 'Неограничена';

  @override
  String get unlimitedDescription => 'Узми колико год времена ти је потребно';

  @override
  String get mode => 'Тип';

  @override
  String get casual => 'Нерангирана';

  @override
  String get rated => 'Рангирана';

  @override
  String get casualTournament => 'Нерангирани';

  @override
  String get ratedTournament => 'Рангирани';
  ...
  @override
  String get rematchOfferSent => 'Понуда за реванш послата';

  @override
  String get rematchOfferAccepted => 'Понуда за реванш прихваћена';

  @override
  String get rematchOfferCanceled => 'Понуда за реванш повучена';

  @override
  String get rematchOfferDeclined => 'Понуда за реванш одбијена';

  @override
  String get cancelRematchOffer => 'Откажи понуду за реванш';

  @override
  String get viewRematch => 'Погледај реванш';
  ...
  @override
  String get inbox => 'Сандуче';

  @override
  String get chatRoom => 'Соба за ћаскање';

  @override
  String get loginToChat => 'Пријави се да ћаскаш';

  @override
  String get youHaveBeenTimedOut => 'Тајм-аутован/а си.';

  @override
  String get spectatorRoom => 'Соба за гледаоце';

  @override
  String get composeMessage => 'Састави поруку';
  ...
  @override
  String get incrementInSeconds => 'Додатак у секундама';

  @override
  String get freeOnlineChess => 'Бесплатан Интернетски Шах';

  @override
  String get exportGames => 'Извези партије';

  @override
  String get ratingFilter => 'Филтер за рејтинг';
  ...
  @override
  String get proposeATakeback => 'Предложи враћање потеза';

  @override
  String get whiteProposesTakeback => 'Бели предлаже враћање потеза';

  @override
  String get blackProposesTakeback => 'Црни предлаже враћање потеза';

  @override
  String get takebackPropositionSent => 'Враћање потеза послато';

  @override
  String get whiteDeclinesTakeback => 'Бели одбија враћање потеза';

  @override
  String get blackDeclinesTakeback => 'Црни одбија враћање потеза';

  @override
  String get whiteAcceptsTakeback => 'Бели прихвата враћање потеза';
  ...
  @override
  String get bookmarkThisGame => 'Обележи ову партију';
  ...
  @override
  String get tournamentPoints => 'Бодови са турнира';

  @override
  String get viewTournament => 'Погледај турнир';

  @override
  String get backToTournament => 'Назад на турнир';
  ...
  String yourPerfRatingIsTooHigh(String param1, String param2) {
    return 'Твој $param1 рејтинг ($param2) је превисок';
  }

  @override
  String yourTopWeeklyPerfRatingIsTooHigh(String param1, String param2) {
    return 'Твој највиши недељни $param1 рејтинг ($param2) је превисок';
  }

  @override
  String yourPerfRatingIsTooLow(String param1, String param2) {
    return 'Твој $param1 рејтинг ($param2) је пренизак';
  }

  @override
  String ratedMoreThanInPerf(String param1, String param2) {
    return 'Рејтован ≥ $param1 у $param2';
  }

  @override
  String ratedLessThanInPerf(String param1, String param2) {
    return 'Рејтован ≤ $param1 у $param2 последњих недељу дана';
  }

  @override
  String mustBeInTeam(String param) {
    return 'Мораш бити у тиму $param';
  }

  @override
  String youAreNotInTeam(String param) {
    return 'Ниси у тиму $param';
  }

  @override
  String get backToGame => 'Назад на партију';

  @override
  String get siteDescription => 'Бесплатан интернетски шах сервер. Играј шах у чистом окружењу. Без регистрације, без реклама, без потребних додатака. Играј шах са рачунаром, пријатељима или насумичним противницима.';

  @override
  String xJoinedTeamY(String param1, String param2) {
    return '$param1 се придружио/ла тиму $param2';
  }

  @override
  String xCreatedTeamY(String param1, String param2) {
    return '$param1 је основао/ла тим $param2';
  }
  ...
  @override
  String get averageElo => 'Просечни рејтинг';
  ...
  @override
  String get leaderboard => 'Најбољи играчи';
  ...
  @override
  String get playerNames => 'Имена играча';

  @override
  String get moveAnnotations => 'Анотације потеза';

  @override
  String get pasteTheFenStringHere => 'Налепи FEN текст овде';

  @override
  String get pasteThePgnStringHere => 'Налепи PGN текст овде';
  ...
  @override
  String get thisIsAChessCaptcha => 'Ово је шаховска капча.';

  @override
  String get clickOnTheBoardToMakeYourMove => 'Кликај на таблу да направиш свој потез и докажи да си људско биће.';

  @override
  String get captcha_fail => 'Молимо Вас да решите шаховску капчу.';

  @override
  String get notACheckmate => 'Није шах-мат';

  @override
  String get whiteCheckmatesInOneMove => 'Бели матира у једном потезу';

  @override
  String get blackCheckmatesInOneMove => 'Црни матира у једном потезу';

  @override
  String get retry => 'Покушај поново';

  @override
  String get reconnecting => 'Поново повезујемо';
  ...
  @override
  String get following => 'Пратиш';

  @override
  String get unfollow => 'Отпрати';
  ...
  @override
  String get standings => 'Пласман';

  @override
  String get createANewTournament => 'Направи нови турнир';
  ...
  @override
  String get safeTournamentName => 'Изабери веома сигурно име за турнир.';

  @override
  String get inappropriateNameWarning => 'Било шта имало неприкладно може довести до затварања твог налога.';
  ...
  String standByX(String param) {
    return 'Причекај $param, упарујемо играче, спреми се!';
  }
  ...
  @override
  String get movesPlayed => 'Потеза одиграно';

  @override
  String get whiteWins => 'Беле победе';

  @override
  String get blackWins => 'Црне победе';

  @override
  String get drawRate => 'Проценат ремија';

  @override
  String get draws => 'Ремији';
  ...
  @override
  String get randomChess960Position => 'Насумична Шах960 позиција';

  @override
  String get startPosition => 'Почетна позиција';

  @override
  String get clearBoard => 'Очисти таблу';

  @override
  String get loadPosition => 'Учитај позицију';

  @override
  String get isPrivate => 'Приватни';
  ...
  String profileCompletion(String param) {
    return 'Попуњеност профила: $param';
  }
  ...
  @override
  String get ifNoneLeaveEmpty => 'Ако немаш, остави празно';
  ...
  @override
  String get inlineNotation => 'Линијска нотација';
  ...
  @override
  String get previouslyOnLichessTV => 'Претходно на Lichess ТВ-у';
  ...
  @override
  String get bewareTheGameIsRatedButHasNoClock => 'Опрезно, партија је рангирана али нема шаховског сата!';

  @override
  String get success => 'Успех';

  @override
  String get automaticallyProceedToNextGameAfterMoving => 'Аутоматски пребаци на следећу партију после потеза';

  @override
  String get autoSwitch => 'Аутопребацивање';
  ...
  @override
  String get descPrivateHelp => 'Текст који ће видети само чланови тима. Ако је постављен, замењује јавни опис за чланове тима.';
  ...
  @override
  String get createANewTopic => 'Направи нову тему';
  ...
  @override
  String get lastPost => 'Задња објава';

  @override
  String get views => 'Прегледa';

  @override
  String get replies => 'Одговора';
  ...
  @override
  String get reopen => 'Поново отвори';

  @override
  String get quote => 'Цитирај';

  @override
  String get postEdited => 'измењено';

  @override
  String get message => 'Порука';

  @override
  String get createTheTopic => 'Направи тему';

  @override
  String get reportAUser => 'Пријави корисника';
  ...
  @override
  String get whatIsIheMatter => 'Шта је у питању?';

  @override
  String get cheat => 'Варање';

  @override
  String get troll => 'Провоцирање';

  @override
  String get other => 'Друго';

  @override
  String get reportCheatBoostHelp => 'Залијепите везу до игре и објасните шта није у реду са понашањем корисника. Немојте само рећи \"варао\", али реците како сте дошли до тог закључка. Ваша пријава ће бити обрађена брже ако је напишете на енглеском језику.';
  ...
  @override
  String get error_provideOneCheatedGameLink => 'Молимо Вас да наведете бар један линк до партије са сумњом варања.';
  ...
  @override
  String get typePrivateNotesHere => 'Напиши приватне белешке овде';
  ...
  @override
  String get clearField => 'Очисти поље';
  ...
  @override
  String get newPasswordAgain => 'Нова лозинка (поново)';
  ...
  @override
  String get letOtherPlayersFollowYou => 'Допусти да те други играчи прате';

  @override
  String get letOtherPlayersChallengeYou => 'Допусти да те други играчи изазову';

  @override
  String get letOtherPlayersInviteYouToStudy => 'Допусти другим играчима да те позову у студију';

  @override
  String get sound => 'Звук';

  @override
  String get none => 'Ниједна';
  ...
  @override
  String get onSlowGames => 'На спорим партијама';
  ...
  @override
  String get allInformationIsPublicAndOptional => 'Све информације су јавне и необавезне.';

  @override
  String get biographyDescription => 'Говори о себи, твојим интересовањима, шта ти се свиђа у шаху, твојим омиљеним отварањима, играчима, ...';

  @override
  String get listBlockedPlayers => 'Прикажи играче које си блокирао/ла';

  @override
  String get human => 'Особа';
  ...
  String tpTimeSpentPlaying(String param) {
    return 'Време проведено играјући: $param';
  }

  @override
  String get watchGames => 'Гледај партије';

  @override
  String tpTimeSpentOnTV(String param) {
    return 'Време приказа на ТВ-у: $param';
  }
  ...
  @override
  String get mobileApp => 'Мобилна Апликација';
  ...
  String xIsAFreeYLibreOpenSourceChessServer(String param1, String param2) {
    return '$param1 је бесплатан ($param2), слободан, шаховски сервер без реклама, са отвореним изворним кодом.';
  }
  ...
  @override
  String get titleVerification => 'Верификација титуле';
  ...
  @override
  String get createdSimuls => 'Новостворене симултанке';

  @override
  String get hostANewSimul => 'Организуј нову симултанку';
  ...
  @override
  String get noSimulExplanation => 'Ова симултанка не постоји.';

  @override
  String get returnToSimulHomepage => 'Врати се на почетну страну симултанке';

  @override
  String get aboutSimul => 'Симултанке обухватају суочавање једонг играча против неколико играча одједном.';

  @override
  String get aboutSimulImage => 'Од 50 противника, Фишер је победио 47 партија, ремизирао 2, и изгубио 1.';

  @override
  String get aboutSimulRealLife => 'Концепт је преузет из догађаја у стварном свету. У стварном животу, то обухвата кретање домаћина симултанке од стола до стола како би одиграо један потез.';

  @override
  String get aboutSimulRules => 'Када симултанка започне, сваки играч почиње партију са домаћином. Симултанка се завршава када су све партије завршене.';

  @override
  String get aboutSimulSettings => 'Симултанке су увек нерангиране. Реванши, враћања потеза и додавања времена су искључени.';
  ...
  @override
  String get simulVariantsHint => 'Ако одабереш неколико варијанти, сваки играч има могућност да бира коју да игра.';

  @override
  String get simulClockHint => 'Што више играча играш, више времена ти може бити потребно.';
  ...
  @override
  String get tournamentFAQ => 'Најчешће постављена питања о Арена турнирима';

  @override
  String get timeBeforeTournamentStarts => 'Време пре него што турнир започне';

  @override
  String get averageCentipawnLoss => 'Просечан центипијунски губитак';
  ...
  @override
  String get keyEnterOrExitVariation => 'уђи/изађи из варијације';
  ...
  @override
  String get toggleObservationAnnotations => 'Укључи/искључи анотације посматрања';
  ...
  @override
  String get tournamentHomeTitle => 'Шаховски турнири са разним временским контролама и варијантама';

  @override
  String get tournamentHomeDescription => 'Играј брзе шаховске турнире! Придружи се званичном организованом турниру или направи свој. Метак-шах, Блиц, Класични, Шах960, Краљ брда, Три шаха и више доступних опција за неограничену шаховску забаву.';
  ...
  @override
  String get tournamentMayHaveBeenCanceled => 'Турнир је можда био отказан ако су сви играчи изашли пре него што је почео.';

  @override
  String get returnToTournamentsHomepage => 'Врати се на почетну страну турнира';

  @override
  String weeklyPerfTypeRatingDistribution(String param) {
    return 'Недељна $param рејтинг дистрибуција';
  }

  @override
  String yourPerfTypeRatingIsRating(String param1, String param2) {
    return 'Твој $param1 рејтинг је $param2.';
  }

  @override
  String youAreBetterThanPercentOfPerfTypePlayers(String param1, String param2) {
    return 'Бољи/а си него $param1 од $param2 играча.';
  }
  ...
  String youDoNotHaveAnEstablishedPerfTypeRating(String param) {
    return 'Немаш утврђен $param рејтинг.';
  }

  @override
  String get yourRating => 'Твој рејтинг';
  ...
  @override
  String get checkYourEmail => 'Проверите Ваш Имејл';

  @override
  String get weHaveSentYouAnEmailClickTheLink => 'Послали смо Вам имејл. Кликните линк у имејлу да активирате свој налог.';

  @override
  String get ifYouDoNotSeeTheEmailCheckOtherPlaces => 'Ако не видите имејл, проверите друга места на којима може бити, као Ваш отпад, нежељена пошта, друштвене мреже или друге датотеке.';

  @override
  String get ifYouDoNotGetTheEmail => 'Ако не добијеш имејл у року од 5 минута:';

  @override
  String get checkAllEmailFolders => 'Провери сав отпад, нежељену пошту и остале датотеке';

  @override
  String verifyYourAddress(String param) {
    return 'Потврди да је $param твоја имејл адреса';
  }

  @override
  String weHaveSentYouAnEmailTo(String param) {
    return 'Послали смо имејл на $param. Кликните линк у имејлу да промените своју лозинку.';
  }

  @override
  String byRegisteringYouAgreeToBeBoundByOur(String param) {
    return 'Регистрацијом, слажеш се са $param.';
  }

  @override
  String readAboutOur(String param) {
    return 'Прочитајте шта је наша $param.';
  }

  @override
  String get networkLagBetweenYouAndLichess => 'Мрежно кашњење између тебе и Lichess-а';

  @override
  String get timeToProcessAMoveOnLichessServer => 'Време обраде потеза на Lichess-овом серверу';

  @override
  String get downloadAnnotated => 'Преузими са белешкама';

  @override
  String get downloadRaw => 'Преузми без белешки';

  @override
  String get downloadImported => 'Преузми увезено';

  @override
  String get downloadAllGames => 'Преузми све партије';

  @override
  String get crosstable => 'Таблица сусрета';

  @override
  String get youCanAlsoScrollOverTheBoardToMoveInTheGame => 'Скролуј преко табле да се помераш кроз партију.';

  @override
  String get scrollOverComputerVariationsToPreviewThem => 'Скролуј преко рачунарских варијација да их прегледаш.';

  @override
  String get analysisShapesHowTo => 'Притисни шифт+клик или десни-клик да нацрташ кругове и стрелице на табли.';

  @override
  String get primaryColorArrowsHowTo => 'Ctrl или shift = црвена, command; alt или meta = плава; по дугме из сваке = жута.';

  @override
  String get letOtherPlayersMessageYou => 'Допусти другим играчима да ти пошаљу поруку';

  @override
  String get receiveForumNotifications => 'Прими обавештења када се поменеш на форуму';

  @override
  String get shareYourInsightsData => 'Подели податке твог шаховског увида';

  @override
  String get withNobody => 'Ни са ким';
  ...
  @override
  String get kidMode => 'Дечији режим';

  @override
  String get kidModeIsEnabled => 'Дечији режим је укључен.';

  @override
  String get kidModeExplanation => 'Ово је о сигурности. У дечијем режиму, све комуникације на сајту су искључене. Омогућите ово за Вашу децу и школске ученике како бисте их заштитили од других интернет корисника.';

  @override
  String inKidModeTheLichessLogoGetsIconX(String param) {
    return 'У дечијем режиму, Lichess-ов лого добија $param икону да бисте знали да су Ваша деца сигурна.';
  }
  ...
  @override
  String get enableKidMode => 'Омогући Дечији режим';

  @override
  String get disableKidMode => 'Онемогући Дечији режим';
  ...
  @override
  String get everybodyGetsAllFeaturesForFree => 'Сви добијају све могућности за бесплатно';
  ...
  String xHostsY(String param1, String param2) {
    return '$param1 организује $param2';
  }

  @override
  String xJoinsY(String param1, String param2) {
    return '$param1 се придружио/ла $param2';
  }

  @override
  String xLikesY(String param1, String param2) {
    return '$param1 каже да му/јој се свиђа $param2';
  }
  ...
  @override
  String get deviceTheme => 'Тема уређаја';
  ...
  @override
  String get backgroundImageUrl => 'Линк позадинске слике:';
  ...
  @override
  String get opacity => 'Непрозирност';
  ...
  @override
  String get boardReset => 'Ресетуј боје на подразумевано';

  @override
  String get pieceSet => 'Сет фигура';

  @override
  String get embedInYourWebsite => 'Угради у свој сајт';

  @override
  String get usernameAlreadyUsed => 'Ово корисничко име је већ у употреби, молимо Вас да изаберете друго.';

  @override
  String get usernamePrefixInvalid => 'Корисничко име мора започети са словом.';

  @override
  String get usernameSuffixInvalid => 'Корисничко име мора завршити са словом или бројем.';

  @override
  String get usernameCharsInvalid => 'Корисничко име мора садржати само слова, бројеве, подвлаке и цртице. Узастопне подвлаке и цртице нису дозвољене.';

  @override
  String get usernameUnacceptable => 'Ово корисничко име није прихватљиво.';

  @override
  String get playChessInStyle => 'Играј шах у стилу';

  @override
  String get chessBasics => 'Шаховске основе';
  ...
  String yourRatingIsX(String param) {
    return 'Твој рејтинг је $param';
  }

  @override
  String get practiceWithComputer => 'Вежбај са рачунаром';

  @override
  String anotherWasX(String param) {
    return 'Још један је био $param';
  }

  @override
  String bestWasX(String param) {
    return 'Најбољи је био $param';
  }

  @override
  String get youBrowsedAway => 'Отишао/ла си далеко';

  @override
  String get resumePractice => 'Настави вежбање';

  @override
  String get drawByFiftyMoves => 'Партија је ремизирана правилом педесет потеза.';

  @override
  String get theGameIsADraw => 'Партија је нерешена.';

  @override
  String get computerThinking => 'Рачунар размишља ...';

  @override
  String get seeBestMove => 'Види најбољи потез';

  @override
  String get hideBestMove => 'Сакриј најбољи потез';

  @override
  String get getAHint => 'Добиј савет';

  @override
  String get evaluatingYourMove => 'Процењивање твог потеза ...';

  @override
  String get whiteWinsGame => 'Бели побеђује';

  @override
  String get blackWinsGame => 'Црни побеђује';

  @override
  String get learnFromYourMistakes => 'Научи из својих грешака';

  @override
  String get learnFromThisMistake => 'Научи из ове грешке';

  @override
  String get skipThisMove => 'Прескочи овај потез';
  ...
  String xWasPlayed(String param) {
    return '$param је био одигран';
  }

  @override
  String get findBetterMoveForWhite => 'Нађи бољи потез за белог';

  @override
  String get findBetterMoveForBlack => 'Нађи бољи потез за црног';

  @override
  String get resumeLearning => 'Настави учити';

  @override
  String get youCanDoBetter => 'Можеш одрадити боље';

  @override
  String get tryAnotherMoveForWhite => 'Пробај други потез за белог';

  @override
  String get tryAnotherMoveForBlack => 'Пробај други потез за црног';
  ...
  @override
  String get noMistakesFoundForWhite => 'Ниједна грешка није нађена за белог';

  @override
  String get noMistakesFoundForBlack => 'Ниједна грешка није нађена за црног';
  ...
  @override
  String get doItAgain => 'Одради поново';

  @override
  String get reviewWhiteMistakes => 'Прегледај беле грешке';

  @override
  String get reviewBlackMistakes => 'Прегледај црне грешке';
  ...
  @override
  String get conditionalPremoves => 'Условни предпотези';

  @override
  String get addCurrentVariation => 'Додај тренутну варијацију';

  @override
  String get playVariationToCreateConditionalPremoves => 'Одиграј варијацију да направиш условне предпотезе';

  @override
  String get noConditionalPremoves => 'Нема условних предпотеза';

  @override
  String playX(String param) {
    return 'Одиграј $param';
  }

  @override
  String challengeX(String param) {
    return 'Изазови $param';
  }
  ...
  @override
  String get weHadToTimeYouOutForAWhile => 'Морали смо ти дати тајм-аут на неко време.';

  @override
  String get why => 'Зашто?';

  @override
  String get pleasantChessExperience => 'Циљамо да обезбедимо пријатно искуство шаха за све.';

  @override
  String get goodPractice => 'Због тога, морамо се побринути да сви играчи прате добре праксе.';
  ...
  @override
  String get resignLostGames => 'Предај изгубљене партије (немој пуштати време да истекне).';

  @override
  String get temporaryInconvenience => 'Извињавамо се на привременој нелагодности,';

  @override
  String get wishYouGreatGames => 'и желимо ти одличне партије на lichess.org.';
  ...
  @override
  String get agreementAssistance => 'Слажем се да никада нећу добијати помоћ током својих партија (од стране шаховског рачунара, књиге, базе података или неке друге особе).';

  @override
  String get agreementNice => 'Слажем се да ћу увек бити поштен према другим играчима.';

  @override
  String agreementMultipleAccounts(String param) {
    return 'Слажем се да нећу направити више налога (осим из разлога наведених у $param).';
  }
  ...
  String mentionedYouInX(String param1) {
    return 'те је споменуо/ла у \"$param1\".';
  }

  @override
  String xMentionedYouInY(String param1, String param2) {
    return '$param1 те је споменуо/ла у \"$param2\".';
  }
  ...
  @override
  String get youAreNowPartOfTeam => 'Ти си сада део тима.';
  ...
  @override
  String get congratsYouWon => 'Честитке, победио/ла си!';
  ...
  @override
  String get lostAgainstTOSViolator => 'Изубио/ла си рејтинг бодове од некога ко је прекршио Lichess-ове услове коришћења услуге';

  @override
  String refundXpointsTimeControlY(String param1, String param2) {
    return 'Повратак: $param1 $param2 рејтинг бодова.';
  }

  @override
  String get timeAlmostUp => 'Време је скоро истекло!';

  @override
  String get clickToRevealEmailAddress => '[Кликни да откријеш имејл адресу]';

  @override
  String get download => 'Преузми';

  @override
  String get coachManager => 'Тренерски менаџер';

  @override
  String get streamerManager => 'Стримерски менаџер';

  @override
  String get cancelTournament => 'Откажи турнир';

  @override
  String get tournDescription => 'Опис турнира';

  @override
  String get tournDescriptionHelp => 'Желиш ли нешто посебно поручити учесницима? Покушај да буде кратко. Доступни су Markdown линкови: [назив](https://url)';

  @override
  String get ratedFormHelp => 'Партије су рангиране и утичу на рејтинге играча';

  @override
  String get onlyMembersOfTeam => 'Само чланови тима';

  @override
  String get noRestriction => 'Без ограничења';

  @override
  String get minimumRatedGames => 'Минимално рангираних партија';

  @override
  String get minimumRating => 'Минимални рејтинг';

  @override
  String get maximumWeeklyRating => 'Максимални седмични рејтинг';

  @override
  String positionInputHelp(String param) {
    return 'Налепи важећи FEN да почнеш сваку партију из задате позиције.\nРади само за стандардне партије, не са варијантама.\nМожеш користити $param да створиш FEN позицију, затим је налепити овде.\nОстави празно да започнеш партије из нормалне почетне позиције.';
  }

  @override
  String get cancelSimul => 'Откажи симултанку';

  @override
  String get simulHostcolor => 'Боја домаћина за сваку партију';

  @override
  String get estimatedStart => 'Предвиђено време почетка';

  @override
  String simulFeatured(String param) {
    return 'Истакни на $param';
  }

  @override
  String simulFeaturedHelp(String param) {
    return 'Прикажи своју симултанку свима на $param. Онемогући за приватне симултанке.';
  }
  ...
  @override
  String get inYourLocalTimezone => 'У твојој локалној временској зони';

  @override
  String get tournChat => 'Ћаскање турнира';

  @override
  String get noChat => 'Без ћаскања';

  @override
  String get onlyTeamLeaders => 'Само вође тима';
  ...
  @override
  String get mouseTricks => 'Трикови мишем';

  @override
  String get toggleLocalAnalysis => 'Укључи/искључи локалну рачунарску анализу';

  @override
  String get toggleAllAnalysis => 'Укључи/искључи све рачунарске анализе';

  @override
  String get playComputerMove => 'Одиграј најбољи рачунарски потез';

  @override
  String get analysisOptions => 'Опције анализе';

  @override
  String get focusChat => 'Фокусирај ћаскање';

  @override
  String get showHelpDialog => 'Прикажи овај слој за помоћ';

  @override
  String get reopenYourAccount => 'Поново отвори свој налог';

  @override
  String get reopenYourAccountDescription => 'Ако си затворио/ла свој налог, али си се у међувремену предомислио/ла, добијаш шансу да повратиш свој налог.';
  ...
  @override
  String get youCantStartNewGame => 'Не можеш започети нову партију док је твој потез.';
  ...
  @override
  String get closingAccountWithdrawAppeal => 'Затварање твог налога ће повући твоју жалбу';
  ...
  @override
  String get lichessPatronInfo => 'Lichess је добротворна организација и потпуно бесплатан/слободан софтвер отвореног изворног кода. Зависимо од корисничких донација како бисмо подржали наше оперативне трошкове, развој и садржај. Без наше великодушне заједнице, не бисмо могли да покрећемо сајт. Хвала вам што сте нам се придружили!  ';

  @override
  String get nothingToSeeHere => 'Тренутно нема ништа за видети овде.';

  @override
  String get stats => 'Статистике';

  @override
  String get accessibility => 'Приступачност';

  @override
  String get enableBlindMode => 'Укључи режим за слепе';

  @override
  String get disableBlindMode => 'Искључи режим за слепе';
  ...
  String thereAreNoResultsForX(String param) {
    return 'Нема резултата за \"$param\"';
  }
  ...
  String nbBookmarks(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count обележених партија',
      few: '$count обележене партије',
      one: '$count обележена партија',
    );
    return '$_temp0';
  }
  ...
  String rankIsUpdatedEveryNbMinutes(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      few: 'Ранг се ажурира свака $count минута',
  ...
  String nbGamesWithYou(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count партија са тобом',
      few: '$count партије са тобом',
      one: '$count партија са тобом',
    );
    return '$_temp0';
  }
  ...
  String giveNbSeconds(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Дај $count секунди',
      few: 'Дај $count секунде',
      one: 'Дај $count секунд',
    );
    return '$_temp0';
  }
  ...
  String nbTournamentPoints(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count турнирских бодова',
      few: '$count турнирска бода',
      one: '$count турнирски бод',
    );
    return '$_temp0';
  }
  ...
  String moreThanNbRatedGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '≥ $count рангираних партија',
      few: '≥ $count рангиране партије',
  ...
  String moreThanNbPerfRatedGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '≥ $count $param2 рангираних партија',
      few: '≥ $count $param2 рангиране партије',
  ...
  String needNbMorePerfGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Мораш одиграти још $count $param2 рангираних партија',
      few: 'Мораш одиграти још $count $param2 рангиране партије',
      one: 'Мораш одиграти још $count $param2 рангирану партију',
    );
    return '$_temp0';
  }
  ...
  String needNbMoreGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Мораш одиграти још $count рангираних партија',
      few: 'Мораш одиграти још $count рангиране партије',
      one: 'Мораш одиграти још $count рангирану партију',
    );
    return '$_temp0';
  }
  ...
  String nbImportedGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count увезених партија',
      few: '$count увезене партије',
      one: '$count увезена партија',
    );
    return '$_temp0';
  }
  ...
  String nbGamesInPlay(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count партија у игри',
      few: '$count партије у игри',
      one: '$count партија у игри',
    );
    return '$_temp0';
  }
  ...
  String maximumNbCharacters(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Максимално: $count карактера.',
      few: 'Максимално: $count карактера.',
      one: 'Максимално: $count карактер.',
    );
    return '$_temp0';
  }
  ...
  String nbForumPosts(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count објава на форуму',
      few: '$count објаве на форуму',
      one: '$count објава на форуму',
    );
    return '$_temp0';
  }
  ...
  String nbSecondsToPlayTheFirstMove(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count секунди да се одигра први потез',
      few: '$count секунде да се одигра први потез',
      one: '$count секунд да се одигра први потез',
    );
    return '$_temp0';
  }
  ...
  String andSaveNbPremoveLines(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'и сачувај $count предпотезних линија',
      few: 'и сачувај $count предпотезне линије',
      one: 'и сачувај $count предпотезну линију',
    );
    return '$_temp0';
  }
  ...
  @override
  String get stormYouPlayTheWhitePiecesInAllPuzzles => 'Играш са белим фигурама у свим проблемима';

  @override
  String get stormYouPlayTheBlackPiecesInAllPuzzles => 'Играш са црним фигурама у свим проблемима';
  ...
  @override
  String get stormNewRun => 'Нова рунда (тастер: Space)';

  @override
  String get stormEndRun => 'Заврши рунду (тастер: Enter)';

  @override
  String get stormHighscores => 'Рекорди';

  @override
  String get stormViewBestRuns => 'Погледај најбоље рунде';
  ...
  @override
  String get stormGetReady => 'Спреми се!';

  @override
  String get stormWaitingForMorePlayers => 'Чека се да се придружи више играча...';

  @override
  String get stormRaceComplete => 'Трка завршена!';

  @override
  String get stormSpectating => 'Посматраш';

  @override
  String get stormJoinTheRace => 'Придружи се трци!';

  @override
  String get stormStartTheRace => 'Започни трку';

  @override
  String stormYourRankX(String param) {
    return 'Твој ранг: $param';
  }

  @override
  String get stormWaitForRematch => 'Сачекај реванш';

  @override
  String get stormNextRace => 'Следећа трка';

  @override
  String get stormJoinRematch => 'Придружи се реваншу';

  @override
  String get stormWaitingToStart => 'Чека се да се почне';

  @override
  String get stormCreateNewGame => 'Направи нову игру';

  @override
  String get stormJoinPublicRace => 'Придружи се јавној трци';

  @override
  String get stormRaceYourFriends => 'Тркај се са пријатељима';

  @override
  String get stormSkip => 'прескочи';

  @override
  String get stormSkipHelp => 'Можеш прескочити један потез по трци:';

  @override
  String get stormSkipExplanation => 'Прескочи овај потез да задржиш свој комбо! Само ради једном по трци.';
  ...
  String stormPlayedNbRunsOfPuzzleStorm(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Одиграо/ла $count рунди $param2-а',
      few: 'Одиграо/ла $count рунде $param2-а',
      one: 'Одиграо/ла једну рунду $param2-а',
    );
    return '$_temp0';
  }
  ...
  String studyStudiesCreatedByX(String param) {
    return 'Студије које је направио/ла $param';
  }
  ...
  @override
  String get studyAlphabetical => 'Абецедно';
  ...
  String studyXBroughtToYouByY(String param1, String param2) {
    return '$param1, донето вама од стране $param2';
  }
  ...
  @override
  String get studyClearAllCommentsInThisChapter => 'Очисти све коментаре, глифове и нацртане облике у овом поглављу';
  ...
  @override
  String get studyLoadAGameByUrl => 'Учитај партије преко линкова';

  @override
  String get studyLoadAPositionFromFen => 'Учитај позицију из FEN-а';

  @override
  String get studyLoadAGameFromPgn => 'Учитај партијe из PGN-а';

  @override
  String get studyAutomatic => 'Аутоматска';

  @override
  String get studyUrlOfTheGame => 'Линкови партија, један по реду';
  ...
  @override
  String get studyAllowCloning => 'Дозволи клонирање';
  ...
  @override
  String get studyContributors => 'Доприносиоци';
  ...
  @override
  String get studyEnableSync => 'Омогући sync';
  ...
  @override
  String get studyBrilliantMove => 'Бриљантан потез';

  @override
  String get studyBlunder => 'Превид';

  @override
  String get studyInterestingMove => 'Занимљив потез';

  @override
  String get studyDubiousMove => 'Сумњив потез';

  @override
  String get studyOnlyMove => 'Једини потез';

  @override
  String get studyZugzwang => 'Изнудица';

  @override
  String get studyEqualPosition => 'Једнака позиција';

  @override
  String get studyUnclearPosition => 'Нејасна позиција';

  @override
  String get studyWhiteIsSlightlyBetter => 'Бели је благо бољи';

  @override
  String get studyBlackIsSlightlyBetter => 'Црни је благо бољи';

  @override
  String get studyWhiteIsBetter => 'Бели је бољи';

  @override
  String get studyBlackIsBetter => 'Црни је бољи';

  @override
  String get studyWhiteIsWinning => 'Бели побеђује';

  @override
  String get studyBlackIsWinning => 'Црни побеђује';

  @override
  String get studyNovelty => 'Новитет';

  @override
  String get studyDevelopment => 'Развој';

  @override
  String get studyInitiative => 'Иницијатива';

  @override
  String get studyAttack => 'Напад';

  @override
  String get studyCounterplay => 'Противигра';

  @override
  String get studyTimeTrouble => 'Цајтнот';

  @override
  String get studyWithCompensation => 'Са компензацијом';

  @override
  String get studyWithTheIdea => 'Са идејом';

  @override
  String get studyNextChapter => 'Следеће поглавље';

  @override
  String get studyPrevChapter => 'Претходно поглавље';

  @override
  String get studyStudyActions => 'Студијске радње';

  @override
  String get studyTopics => 'Теме';

  @override
  String get studyMyTopics => 'Моје теме';

  @override
  String get studyPopularTopics => 'Популарне теме';
  ...
  @override
  String get studyStudyMembersTitle => 'Чланови студије';
  ...
  @override
  String get studyStudyChaptersTitle => 'Поглавља студије';
  ...
  @override
  String get studyFromPgnGameTitle => 'Из PGN партије';
  ...
  @override
  String get studyDoubleDefeat => 'Дупли пораз';
  ...
  String timeagoNbWeeksAgo(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'пре $count недеља',
      few: 'пре $count недеље',
      one: 'пре $count недељу',
    );
    return '$_temp0';
  }
  ...
  String timeagoNbMinutesRemaining(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'преостало још $count минута',
      few: 'преостала још $count минута',
      one: 'преостао још $count минут',
    );
    return '$_temp0';
  }
  ...
  String timeagoNbHoursRemaining(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'преостало још $count сати',
      few: 'преостала још $count сата',
      one: 'преостао још $count сат',
    );
    return '$_temp0';
  }
