...
class AppLocalizationsFi extends AppLocalizations {
  ...
  @override
  String get recommendNotTouching => 'Emme suosittele näihin koskemista.';

  @override
  String get fewerPlayers => 'Jos asetat liittymisehtoja, turnauksessasi tulee olemaan vähemmän pelaajia.';

  @override
  String get showAdvancedSettings => 'Näytä lisäasetukset';
  ...
  @override
  String get insult => 'Loukkaus';

  @override
  String get troll => 'Trolli';

  @override
  String get ratingManipulation => 'Vahvuusluvun manipulointi';
  ...
  @override
  String get boardGeometry => 'Laudan geometria';

  @override
  String get boardTheme => 'Laudan tyyli';

  @override
  String get boardSize => 'Laudan koko';
  ...
  @override
  String get searchAdvancedSearch => 'Tarkennettu haku';

  @override
  String get searchOpponentName => 'Vastustajan nimi';

  @override
  String get searchLoser => 'Häviäjä';

  @override
  String get searchFrom => 'Mistä';

  @override
  String get searchTo => 'Mihin';

  @override
  String get searchHumanOrComputer => 'Oliko pelaajan vastustaja ihminen vai tietokone';

  @override
  String get searchAiLevel => 'Tekoälyn taso';

  @override
  String get searchSource => 'Hakukohde';

  @override
  String get searchNbTurns => 'Kuinka monta vuoroa';

  @override
  String get searchResult => 'Tulos';

  @override
  String get searchWinnerColor => 'Voittajan väri';

  @override
  String get searchDate => 'Pvm';

  @override
  String get searchSortBy => 'Lajittelutapa';

  @override
  String get searchAnalysis => 'Analyysi';

  @override
  String get searchOnlyAnalysed => 'Vain pelit, joihin on saatavilla tietokoneanalyysi';

  @override
  String get searchColor => 'Väri';

  @override
  String get searchEvaluation => 'Arviointi';

  @override
  String get searchMaxNumber => 'Maksimimäärä';

  @override
  String get searchMaxNumberExplanation => 'Haettavien pelien maksimimäärä';

  @override
  String get searchInclude => 'Sisältää';

  @override
  String get searchDescending => 'Laskeva';

  @override
  String get searchAscending => 'Nouseva';

  @override
  String get searchRatingExplanation => 'Molempien pelaajien vahvuuslukujen keskiarvo';
  ...
  String searchSearchInXGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Hae $count shakkipelistä',
      one: 'Hae $count shakkipelistä',
      zero: 'Hae $count shakkipelistä',
    );
    return '$_temp0';
  }
  ...
  String searchXGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count peliä löytyi',
      one: 'Yksi peli löytyi',
      zero: 'Yksi peli löytyi',
    );
    return '$_temp0';
  }
  ...
  String searchGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Löytyi $count peliä',
      one: 'Löytyi $count peli',
      zero: 'Löytyi $count peli',
    );
    return '$_temp0';
  }
  ...
  @override
  String get streamerLichessStreamer => 'Lichess-striimaaja';

  @override
  String get streamerLive => 'JUURI NYT!';

  @override
  String get streamerOffline => 'POISSA';

  @override
  String streamerCurrentlyStreaming(String param) {
    return 'Parhaillaan striimaavat: $param';
  }

  @override
  String streamerLastStream(String param) {
    return 'Viimeisin striimi $param';
  }

  @override
  String get streamerBecomeStreamer => 'Ryhdy Lichess-striimaajaksi';

  @override
  String get streamerDoYouHaveStream => 'Onko sinulla Twitch- tai YouTube-kanava?';

  @override
  String get streamerHereWeGo => 'Menoksi!';

  @override
  String get streamerAllStreamers => 'Kaikki striimaajat';

  @override
  String get streamerEditPage => 'Muokkaa striimaajasivuasi';

  @override
  String get streamerYourPage => 'Striimaajasivusi';

  @override
  String get streamerDownloadKit => 'Lataa striimaajan tarvikkeet';

  @override
  String streamerXIsStreaming(String param) {
    return '$param striimaa';
  }

  @override
  String get streamerRules => 'Striimaussäännöt';

  @override
  String get streamerRule1 => 'Sisällytä avainsana \"lichess.org\" striimisi otsikkoon kun striimaat Lichess-sisältöä.';

  @override
  String get streamerRule2 => 'Poista avainsana, kun striimaat Lichessiin liittymätöntä sisältöä.';

  @override
  String get streamerRule3 => 'Lichess havaitsee striimisi automaattisesti ja tarjoaa etuja:';

  @override
  String streamerRule4(String param) {
    return 'Lue meidän $param:mme taataksesi striimisi aikana reilun pelin kaikille.';
  }

  @override
  String get streamerStreamingFairplayFAQ => 'striimien reilun pelin FAQ';

  @override
  String get streamerPerks => 'Avainsanalla striimaamisen hyödyt';

  @override
  String get streamerPerk1 => 'Lichess-profiiliisi ilmestyy liekehtivä striimausikoni.';

  @override
  String get streamerPerk2 => 'Nouset striimaajalistauksen keulille.';

  @override
  String get streamerPerk3 => 'Lichess-seuraajasi saavat ilmoituksen.';

  @override
  String get streamerPerk4 => 'Striimi näkyy peleissäsi, turnauksissasi ja tutkielmissasi.';

  @override
  String get streamerApproved => 'Striimisi hyväksyttiin.';

  @override
  String get streamerPendingReview => 'Striimisi on moderaattorien arvioitavana.';

  @override
  String get streamerPleaseFillIn => 'Syötä striimaajatiedot ja lataa kuva.';

  @override
  String streamerWhenReady(String param) {
    return 'Kun haluat Lichess-striimaajien listalle, $param';
  }

  @override
  String get streamerRequestReview => 'pyydä moderaattorin arviointia';

  @override
  String get streamerStreamerLanguageSettings => 'Lichessin striimaajasivu on suunnattu yleisölle striimialustasi kielellä. Aseta shakkistriimeillesi sopiva kieli niiden lähetykseen käyttämässäsi sovelluksessa tai palvelussa.';

  @override
  String get streamerTwitchUsername => 'Twitch-käyttäjänimesi tai URL';

  @override
  String get streamerOptionalOrEmpty => 'Ei-pakollinen. Jätä tyhjäksi jollei sinulla ole';

  @override
  String get streamerYouTubeChannelId => 'Youtube-kanavasi ID';

  @override
  String get streamerStreamerName => 'Striimaajanimesi Lichessissä';

  @override
  String get streamerVisibility => 'Näkyy striimaajat-sivulla';

  @override
  String get streamerWhenApproved => 'Kun moderaattori hyväksyy';

  @override
  String get streamerHeadline => 'Otsikko';

  @override
  String get streamerTellUsAboutTheStream => 'Kerro striimistäsi yhdellä lauseella';

  @override
  String get streamerLongDescription => 'Pitkä kuvaus';

  @override
  String streamerXStreamerPicture(String param) {
    return '$param striimaajakuva';
  }

  @override
  String get streamerChangePicture => 'Vaihda/poista kuva';

  @override
  String get streamerUploadPicture => 'Lataa kuva';

  @override
  String streamerMaxSize(String param) {
    return 'Enimmäiskoko: $param';
  }
  ...
  String streamerKeepItShort(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Pidä se lyhyenä: $count merkkiä enintään',
      one: 'Pidä se lyhyenä: $count merkki enintään',
  ...
  @override
  String get studyCopyChapterPgnDescription => 'Kopioi tämän luvun PGN leikepöydälle.';
  ...
  String studyPasteYourPgnTextHereUpToNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Liitä PGN tähän, enintään $count peli',
    );
    return '$_temp0';
  }
}
