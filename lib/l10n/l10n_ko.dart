...
class AppLocalizationsKo extends AppLocalizations {
  ...
  String activityPlayedNbMoves(int count) {
    String _temp0 = intl.Intl.pluralLogic(count, locale: localeName, other: '$count 수를');
    return '$_temp0';
  }

  @override
  String activityInNbCorrespondenceGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(count, locale: localeName, other: '$count개의 통신 대국에서 둠');
    return '$_temp0';
  }
  ...
  String activityFollowedNbPlayers(int count) {
    String _temp0 = intl.Intl.pluralLogic(count, locale: localeName, other: '$count 명을 팔로우 시작함');
    return '$_temp0';
  }
  ...
  String activityHostedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(count, locale: localeName, other: '$count 번의 다면기를 주최함');
    return '$_temp0';
  }

  @override
  String activityJoinedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(count, locale: localeName, other: '$count 번의 다면기에 참가함');
    return '$_temp0';
  }
  ...
  String get puzzleThemeAnastasiaMateDescription =>
      '나이트와 룩 또는 퀸이 힘을 합쳐 상대 킹을 보드 가장자리와 자신의 기물 사이에 가둡니다.';
  ...
  String get puzzleThemeCollinearMoveDescription =>
      '마주 보는 두 기물이 있을 때, 한 말이 공격선을 따라 이동하되 상대 말을 잡지 않는 수입니다.';
  ...
  String get puzzleThemeDiscoveredCheckDescription =>
      '기물을 움직여서 가려졌던 공격 기물로 체크합니다. 많은 경우 결정적인 이점을 얻습니다.';
  ...
  String get puzzleThemeEnPassantAdjacentCaptureDescription =>
      '앙파상 규칙을 포함한 전술입니다. 상대 폰이 처음에 두 칸 이동해서 자신의 폰 바로 옆 칸으로 이동했을 경우, 그 폰을 잡을 수 있습니다.';
  ...
  String get puzzleThemeHookMateOpposingPawnDescription =>
      '상대 폰이 킹의 탈출로를 막고 있는 상태에서 룩, 나이트, 폰으로 가하는 체크메이트입니다.';
  ...
  String get checkSpamOrJunkFolder =>
      '만약 확인 이메일을 받지 못하셨다면, 스팸함이나 휴지통을 확인하세요. 중요한 연락을 계속 통보받기 위해서는 lichess.org에서 발송된 메시지를 안전함 및 \"스팸이 아님\"으로 설정하세요.';
  ...
  String get ratingRangeIsDisabledBecauseYourRatingIsProvisional =>
      '귀하의 레이팅이 안정적이지 않기 때문에 레이팅 필터가 잠겨 있습니다. 레이팅 반영 게임을 플레이하면 안정성이 향상됩니다.';
  ...
  String get importGameExplanation =>
      '체스 대국의 PGN을 붙여넣어 복기와 컴퓨터 분석을 진행하고, 채팅을 치고, 공유 가능한 링크를 생성하세요.';
  ...
  String get usernameCharsInvalid =>
      '사용자 이름에는 알파벳, 숫자, 언더스코어 ( _ ), 하이픈 ( - ) 만을 사용할 수 있습니다. 언더스코어와 하이픈은 연속으로 사용할 수 없습니다.';
  ...
  String get lichessPatronInfo =>
      'Lichess는 비영리 기구이며 완전한 무료/자유 오픈소스 소프트웨어입니다. 모든 운영 비용, 개발, 컨텐츠 조달은 전적으로 사용자들의 기부로 이루어집니다. 마음씨 좋은 사용자 분들이 없었더라면, 이 사이트는 유지될 수 없을 겁니다. 함께해 주셔서 감사합니다!  ';
  ...
  String nbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(count, locale: localeName, other: '$count개의 대국');
    return '$_temp0';
  }
  ...
  String nbAnonymous(int count) {
    String _temp0 = intl.Intl.pluralLogic(count, locale: localeName, other: '익명 ($count)');
    return '$_temp0';
  }
  ...
  String teamBattleOfNbTeams(int count) {
    String _temp0 = intl.Intl.pluralLogic(count, locale: localeName, other: '$count팀의 대국');
    return '$_temp0';
  }

  @override
  String teamNbLeadersPerTeam(int count) {
    String _temp0 = intl.Intl.pluralLogic(count, locale: localeName, other: '팀 당 리더 $count명');
    return '$_temp0';
  }
