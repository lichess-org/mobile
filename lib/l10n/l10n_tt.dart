...
class AppLocalizationsTt extends AppLocalizations {
  ...
  @override
  String get recommendNotTouching => 'Боларны тимәскә кинәш итәбез.';

  @override
  String get fewerPlayers => 'Бәйгегә керү тәлапләрен куйсагыз, уенчылар саны әзрәк булыр.';

  @override
  String get showAdvancedSettings => 'Кушылма көйләүләрне күрсәтү';
  ...
  @override
  String get insult => 'Хурламак';

  @override
  String get troll => 'Троль';

  @override
  String get ratingManipulation => 'Рейтинг белән уйнамак';
  ...
  @override
  String get boardGeometry => 'Такта һәнсәдәсе';

  @override
  String get boardTheme => 'Такта бизәге';

  @override
  String get boardSize => 'Такта зурлыгы';
  ...
  @override
  String get searchAdvancedSearch => 'Киңләндерелгән табу';

  @override
  String get searchOpponentName => 'Рәкыйп исеме';

  @override
  String get searchLoser => 'Җиңелгән';

  @override
  String get searchFrom => 'Кемдән';

  @override
  String get searchTo => 'Бу датага кадәр';

  @override
  String get searchHumanOrComputer => 'Уенчы рәкыйп инсан яки компьютермы';

  @override
  String get searchAiLevel => 'A.I. дәрәҗәсе';

  @override
  String get searchSource => 'Чыганак';

  @override
  String get searchNbTurns => 'Борылыш саны';

  @override
  String get searchResult => 'Нәтиҗә';

  @override
  String get searchWinnerColor => 'Җиңү төсе';

  @override
  String get searchDate => 'Сәнә';

  @override
  String get searchSortBy => 'Тәртипләү';

  @override
  String get searchAnalysis => 'Тәхлил кылу';

  @override
  String get searchOnlyAnalysed => 'Фәкать компьютер чишүе мәүҗүд булган уеннар';

  @override
  String get searchColor => 'Төс';
  ...
  String searchSearchInXGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Табырга $count шаһмат уеннарын',
    );
    return '$_temp0';
  }
  ...
  @override
  String get streamerLichessStreamer => 'Личес агымчысы';

  @override
  String get streamerLive => 'ЯШӘ!';

  @override
  String get streamerOffline => 'ТОТАШМАГАН';

  @override
  String streamerCurrentlyStreaming(String param) {
    return 'Хәзерге агымлар: $param';
  }

  @override
  String streamerLastStream(String param) {
    return 'Соңгы агым $param';
  }

  @override
  String get streamerBecomeStreamer => 'Lichess агымы бул';

  @override
  String get streamerDoYouHaveStream => 'Сездә Twitch яки YouTube каналы бармы?';

  @override
  String get streamerHereWeGo => 'Монда йөрибез!';

  @override
  String get streamerAllStreamers => 'Барлык агымчылар';

  @override
  String get streamerEditPage => 'Агымчы битен үзгәртергә';

  @override
  String get streamerYourPage => 'Сезнең агым бите';

  @override
  String get streamerDownloadKit => 'Агым җиентыгын йөкләргә';
  ...
  @override
  String get streamerRules => 'Агым кагыйдәләре';

  @override
  String get streamerRule1 => '\"Lichess.org\" ачкыч сүзен агым исеменә кертегез һәм Личесс агылганда \"Шаһмат\" категориясен кулланыгыз.';

  @override
  String get streamerRule2 => 'Личесс булмаган әйберләрне агызганда ачкыч сүзне бетерегез.';

  @override
  String get streamerRule3 => 'Личесс сезнең агымны автоматик рәвештә табачак һәм түбәндәге мөмкинлекләрне эшләтәчәк:';
  ...
  @override
  String get streamerPerks => 'Ачкыч сүз белән агымның өстенлекләре';

  @override
  String get streamerPerk1 => 'Личесс профилегездә ялкынлы агым иконасын алыгыз.';

  @override
  String get streamerPerk2 => 'Агымчылар исемлегенең башына менегез.';

  @override
  String get streamerPerk3 => 'Хәбәр итү Личесс иярүчеләрен.';

  @override
  String get streamerPerk4 => 'Күрсәтергә сезнең агымда сезнең уеннарны, бәйгеләрне һәм өйрәнүләр.';

  @override
  String get streamerApproved => 'Сезнең агым расланган.';

  @override
  String get streamerPendingReview => 'Сезнең агым модераторлар тарафыннан карала.';

  @override
  String get streamerPleaseFillIn => 'Зинһар, агымдагы мәгълүматны тутырыгыз һәм рәсем йөкләгез.';

  @override
  String streamerWhenReady(String param) {
    return 'Сез Lichess агымы исемлегенә керергә әзер булгач, $param';
  }

  @override
  String get streamerRequestReview => 'модератор раслауны карый';
  ...
  @override
  String get streamerTwitchUsername => 'Сезнең Twitch кулланучы исеме яки URL';

  @override
  String get streamerOptionalOrEmpty => 'Ихтимал. Әгәр дә булмаса, буш калдырыгыз';

  @override
  String get streamerYouTubeChannelId => 'Your YouTube channel ID';

  @override
  String get streamerStreamerName => 'Личесста сезнең агым исеме';

  @override
  String get streamerVisibility => 'Күрсәтә алган агымчы бите';

  @override
  String get streamerWhenApproved => 'Модераторлар тарафыннан расланган вакытта';

  @override
  String get streamerHeadline => 'Атамасы';

  @override
  String get streamerTellUsAboutTheStream => 'Агым турында бер җөмләдә сөйләгез';

  @override
  String get streamerLongDescription => 'Озын тасвирлау';

  @override
  String streamerXStreamerPicture(String param) {
    return '$param агым рәсеме';
  }

  @override
  String get streamerChangePicture => 'Алыштырырга/бетерергә сезнең рәсемне';

  @override
  String get streamerUploadPicture => 'Кертергә рәсам';

  @override
  String streamerMaxSize(String param) {
    return 'Зурлыкның азагы $param';
  }
  ...
  String streamerKeepItShort(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Кыскартып саклагыз: азагында $count билге',
    );
    return '$_temp0';
  }
  ...
  @override
  String get studyPrivate => 'Яшерен';

  @override
  String get studyMyStudies => 'Минем өйрәнеш';

  @override
  String get studyStudiesIContributeTo => 'Өйрәнеш Мин үз һиссамны кушамын';

  @override
  String get studyMyPublicStudies => 'Минем җәмгыяти өйрәнеш';

  @override
  String get studyMyPrivateStudies => 'Минем шәхси өйрәнеш';

  @override
  String get studyMyFavoriteStudies => 'Минем сөемле өйрәнеш';

  @override
  String get studyWhatAreStudies => 'Бу ни өйрәнеш?';

  @override
  String get studyAllStudies => 'Барча өйрәнешләр';

  @override
  String studyStudiesCreatedByX(String param) {
    return 'Өйрәнеш $param белән ясалган';
  }

  @override
  String get studyNoneYet => 'Хәле юк.';

  @override
  String get studyHot => 'Кайнар';

  @override
  String get studyDateAddedNewest => 'Кушылган сәна(иң яңа)';

  @override
  String get studyDateAddedOldest => 'Кушылган сәнә(иң олуг)';

  @override
  String get studyRecentlyUpdated => 'Якында яңартылган';

  @override
  String get studyMostPopular => 'Иң мәшһүр';

  @override
  String get studyAlphabetical => 'Әлифбаи';

  @override
  String get studyAddNewChapter => 'Яңа баб өстәлеш';

  @override
  String get studyAddMembers => 'Әгъза өстәргә';

  @override
  String get studyInviteToTheStudy => 'Өйрәнеш чакырырга';

  @override
  String get studyPleaseOnlyInvitePeopleYouKnow => 'Илтимәс, фәкать вә ошбу өйрәнеш колынышка өстәгән әдәмләрне таклиф колу.';

  @override
  String get studySearchByUsername => 'Кулланучынәмә белән табырга';

  @override
  String get studySpectator => 'Тамашачы';

  @override
  String get studyContributor => 'Хиссадәрче';

  @override
  String get studyKick => 'Бәрү';

  @override
  String get studyLeaveTheStudy => 'Чыгыш өйрәнештән';

  @override
  String get studyYouAreNowAContributor => 'Сез хәзер Һиссадәрче';

  @override
  String get studyYouAreNowASpectator => 'Сез хәзер тамашачы';

  @override
  String get studyPgnTags => 'PGN тамгасы';

  @override
  String get studyLike => 'Ошый';

  @override
  String get studyUnlike => 'Unlike';

  @override
  String get studyNewTag => 'Яңа тамга';

  @override
  String get studyCommentThisPosition => 'Ошбу позицияне шәрхләмәк';

  @override
  String get studyCommentThisMove => 'Хәрәкәтне шәрхләү';

  @override
  String get studyAnnotateWithGlyphs => 'Глифлар белән өзек бирү';

  @override
  String get studyTheChapterIsTooShortToBeAnalysed => 'Бу баб бик кыска таһлил колынды.';

  @override
  String get studyOnlyContributorsCanRequestAnalysis => 'Өйрәнеш һиссадәрләр компьютер чишелешен тәлап итмәк.';

  @override
  String get studyGetAFullComputerAnalysis => 'Барча сервер-яктагы компьютер чишлешен асасий юнәлеш алыгыз.';

  @override
  String get studyMakeSureTheChapterIsComplete => 'Бабның тәгликъ икәнлегендә очаныч һасил колмак. Сез таһлилне фәкать бир мәртә колышыңыз мөмкин.';

  @override
  String get studyAllSyncMembersRemainOnTheSamePosition => 'Барлык SYNC әгъзалары һаман хәләттә кылмак';

  @override
  String get studyShareChanges => 'Үзгәрешләрне тамашачылар белән юшәрик колыш вә аларны серверда саклау';

  @override
  String get studyPlaying => 'Уйнамак';

  @override
  String get studyShowEvalBar => 'Evaluation bars';

  @override
  String get studyFirst => 'Беренче';

  @override
  String get studyPrevious => 'Алдагы';

  @override
  String get studyNext => 'Киләсе';

  @override
  String get studyLast => 'Сонгы';

  @override
  String get studyShareAndExport => 'Юшәрик & яшдүр';

  @override
  String get studyCloneStudy => 'Клонлау';

  @override
  String get studyStudyPgn => 'Өйрәнеш PGN';

  @override
  String get studyDownloadAllGames => 'Йөкләргә барча уеннарны';

  @override
  String get studyChapterPgn => 'Баб PGN';

  @override
  String get studyCopyChapterPgn => 'PGN-ны күчереп алу';

  @override
  String get studyCopyChapterPgnDescription => 'Copy chapter PGN to clipboard.';

  @override
  String get studyDownloadGame => 'Йөкләш уенны';

  @override
  String get studyStudyUrl => 'Өйрәнеш URL';

  @override
  String get studyCurrentChapterUrl => 'Хәзерге баб URL';

  @override
  String get studyYouCanPasteThisInTheForumToEmbed => 'Сез җайлаштырасыз форумны ябыштырыш колыш';
  ...
  @override
  String get studyOrientation => 'Урнашу';

  @override
  String get studyAnalysisMode => 'Вәдъ әл-тәһлил';

  @override
  String get studyPinnedChapterComment => 'Дәбүс баб шәрһе';

  @override
  String get studySaveChapter => 'Сакламак бабны';

  @override
  String get studyClearAnnotations => 'Чистартырга шүрүхне';

  @override
  String get studyClearVariations => 'Clear variations';

  @override
  String get studyDeleteChapter => 'Бетерергә бабны';

  @override
  String get studyDeleteThisChapter => 'Бетерергә бабны? Монда чигенү юк!';
  ...
  @override
  String get studyNoPinnedComment => 'Бернинди дә';

  @override
  String get studyNormalAnalysis => 'Гәдати тәһлил';
  ...
  @override
  String get studyAutomatic => 'Автоматик';
  ...
  @override
  String get studyVisibility => 'Küreneş';

  @override
  String get studyPublic => 'Җәмһүри';
  ...
  @override
  String get studyNobody => 'Лә Әхәд';

  @override
  String get studyOnlyMe => 'Фәкать мин';

  @override
  String get studyContributors => 'Һиссадәрче';
  ...
  @override
  String get studyTopics => 'Темалар';
  ...
  @override
  String get studyBack => 'Артка';

  @override
  String get studyPlayAgain => 'Яңадан уйнау';
