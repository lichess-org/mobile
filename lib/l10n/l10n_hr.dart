...
class AppLocalizationsHr extends AppLocalizations {
  ...
  @override
  String get mobileSettingsMaterialDifferenceCapturedPieces => 'Pojedene figure';
  ...
  String get variantAntichessTitle =>
      'Izgubi sve svoje figure (ili budi patiran) da bi pobijedio partiju.';
  ...
  String get variantAtomicTitle =>
      'Uništavaj protivničkog kralja nuklearnim bombama da bi pobijedio partiju.';
  ...
  String get variantHordeTitle =>
      'Jedna strana ima veliki broj pješaka, druga ima normalnu vojsku.';
  ...
  String get variantRacingKingsTitle =>
      'Vodi svog kralja na drugu stranu ploče da bi pobijedio partiju.';
  ...
  String get variantCrazyhouseTitle =>
      'Igrači mogu vratiti pojedene figure na ploču umjesto jednog poteza.';
  ...
  String get studyWelcomeToLichessStudyText =>
      'Ovo je dijeljena analitička ploča.<br><br>Koristi je za analizu i komentiranje partija,<br>diskusiju o pozicijama s prijateljima<br>i naravno za satove šaha!<br><br>To je moćan alat, ajmo da odvojimo malo vremena da vidimo kako funkcijonira.';
  ...
  String get studySharedAndSavedText =>
      'Drugi članovi mogu vidjeti tvoje poteze u stvarnom vremenu!<br>Osim toga, je sve zauvijek spremljeno.';
  ...
  String get studyStudyChaptersText =>
      'Studija može sadržavati nekoliko poglavlja.<br>Svako poglavlje ima zasebnu početnu poziciju i stablo poteza.';
  ...
  String get studyAnnotatePositionText =>
      'Klikni na dugme \"!?\" ili desnim klikom miša na listu poteza.<br>Označenja se djele i čuvaju.';
  ...
  String get studyConclusionText =>
      'Svoje <a href=\'/study/mine/hot\'>stare studije</a> možeš pronaći na stranici svog profila.<br>Postoji i <a href=\'//lichess.org/blog/V0KrLSkAAMo3hsi4/study-chess-the-lichess-way\'>blog objava na blogu o studijama</a>.<br>Napredni korisnici možda žele pritisnuti \"?\" da bi vidjeli prečice na tastaturi.<br>Uživaj!';
  ...
  String get studyCreateChapterText =>
      'Studija može imati nekoliko poglavlja.<br>Svako poglavlje ima zasebno stablo poteza,<br>i može se kreirati na različite načine.';
  ...
  String get studyFromInitialPositionText =>
      'Ploča spremna za novu partiju.<br> Korisno za istraživanje otvaranja.';
  ...
  String get studyCustomPositionText =>
      'Postavi ploču na svoj način.<br>Korisno za istraživanje završnica.';
  ...
  String get studyLoadExistingLichessGameText =>
      'Unesi URL lichess partije<br>(na primjer lichess.org/7fHIU0XI)<br> da bi učitao poteze u poglavlju.';
  ...
  String get studyFromFenStringText =>
      'Unesi poziciju iz FEN formata<br><i>4k3/4rb2/8/7p/8/5Q2/1PP5/1K6 w</i><i>da bi počeo poglavlje od pozicije.';
  ...
  String get studyFromPgnGameText =>
      'Unesi partiju iz PGN formata<br>da bi učitao poteze, komentare i varijante iz poglavlja.';
  ...
  String get studyVariantsAreSupportedText =>
      'Da, možeš proučiti Crazyhouse<br>i sve druge lichess varijante!';

  @override
  String get studyChapterConclusionText =>
      'Poglavlja se čuvaju zauvijek.<br>Zabavi se organizirajući svojih šahovskih sadržaja!';
