...
class AppLocalizationsHr extends AppLocalizations {
  ...
  @override
  String get recommendNotTouching => 'Preporučamo da ne ovo ne dira.';

  @override
  String get fewerPlayers => 'Ako se postavi uvjet za sudjelovanje, turnir će imati manje igrača.';

  @override
  String get showAdvancedSettings => 'Prikaži napredne postavke';
  ...
  @override
  String get ratingManipulation => 'Manipulacija rejtingom';
  ...
  @override
  String get searchAdvancedSearch => 'Napredno pretraživanje';

  @override
  String get searchOpponentName => 'Ime suparnika';
  ...
  @override
  String get searchHumanOrComputer => 'Bilo da je protivnik igrača bio čovjek ili kompjuter';

  @override
  String get searchAiLevel => 'Nivo U.I.';
  ...
  @override
  String get searchSortBy => 'Sortiraj prema';

  @override
  String get searchAnalysis => 'Analiza';

  @override
  String get searchOnlyAnalysed => 'Samo partije u kojima je dostupna šahovska analiza';

  @override
  String get searchColor => 'Boja';

  @override
  String get searchEvaluation => 'Vrednovanje';

  @override
  String get searchMaxNumber => 'Maksimalan broj';

  @override
  String get searchMaxNumberExplanation => 'Maksimalan broj igara za povratak';

  @override
  String get searchInclude => 'Uključi';
  ...
  String searchSearchInXGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Traži u $count šahovskih partija',
      few: 'Traži u $count šahovskih partija',
      one: 'Traži u $count šahovskih partija',
      zero: 'Traži u $count šahovskih partija',
    );
    return '$_temp0';
  }
  ...
  String searchXGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Pronađeno je $count partija',
      few: 'Pronađeno je $count partija',
      one: 'Pronađena je jedna partija',
      zero: 'Pronađena je jedna partija',
    );
    return '$_temp0';
  }
  ...
  String searchGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other: 'Pronađeno je $count partija',
      few: 'Pronađene su $count partije',
      one: 'Pronađena je $count partija',
      zero: 'Pronađena je $count partija',
    );
    return '$_temp0';
  }
  ...
  String streamerCurrentlyStreaming(String param) {
    return 'Trenutno prenosi: $param';
  }

  @override
  String streamerLastStream(String param) {
    return 'Posljednji prijenos uživo $param';
  }
  ...
  @override
  String get streamerDoYouHaveStream => 'Imate li Twitch ili YouTube korisnički račun?';
  ...
  String streamerXIsStreaming(String param) {
    return '$param prenosi';
  }

  @override
  String get streamerRules => 'Pravila emitiranja';

  @override
  String get streamerRule1 => 'Uključite ključnu riječ \"lichess.org\" u naslov i koristite kategoriju \"šah\" kada emitirate na Lichess-u.';

  @override
  String get streamerRule2 => 'Uklonite ključnu riječ kada emitirate sadržaj koji nije vezan za Lichess.';

  @override
  String get streamerRule3 => 'Lichess će automatski otkriti Vaše emitiranje i omogućiti sljedeće prednosti:';

  @override
  String streamerRule4(String param) {
    return 'Pročitaj $param da bi osiguro poštenu igru za sve u tvom prijenosu.';
  }

  @override
  String get streamerStreamingFairplayFAQ => 'Često postavljana pitanja o poštenoj igri tijekom prijenosa';

  @override
  String get streamerPerks => 'Prednosti emitiranja sa ključnom riječi';

  @override
  String get streamerPerk1 => 'Dobiti ćete vatrenu ikonicu emitera na svom Lichess profilu.';

  @override
  String get streamerPerk2 => 'Probiti ćete se na vrh liste emitera.';

  @override
  String get streamerPerk3 => 'Obavjestite svoje Lichess pratioce.';

  @override
  String get streamerPerk4 => 'Pokažite svoj kanal za emitiranje u svojim igrama, turnirima i studijama.';

  @override
  String get streamerApproved => 'Vaš kanal za emitiranje je odobren.';

  @override
  String get streamerPendingReview => 'Moderatori pregledavaju Vaš kanal za emitiranje.';
  ...
  @override
  String get streamerStreamerLanguageSettings => 'Stranica Lichess streamer cilja vašu publiku jezikom koji nudi vaša platforma za streaming. Postavite točan zadani jezik za svoje šahovske streamove u aplikaciji ili usluzi koju koristite za emitiranje.';

  @override
  String get streamerTwitchUsername => 'Vaše Twitch korisničko ime ili poveznica';

  @override
  String get streamerOptionalOrEmpty => 'Neobavezno. Ostavite prazno ako ga nemate';

  @override
  String get streamerYouTubeChannelId => 'ID tvog YouTube kanala';

  @override
  String get streamerStreamerName => 'Ime Vašeg Lichess kanala emitiranja';

  @override
  String get streamerVisibility => 'Vidljivo na stranici kanala za emitirnje';
  ...
  @override
  String get streamerTellUsAboutTheStream => 'Opišite Vaš kanal za emitiranje u jednoj rečenici';
  ...
  String streamerKeepItShort(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Neka bude kratko: najviše $count slova',
      few: 'Neka bude kratko: najviše $count slova',
      one: 'Neka bude kratko: najviše $count slovo',
      zero: 'Neka bude kratko: najviše $count slovo',
    );
    return '$_temp0';
  }
  ...
  @override
  String get studyCopyChapterPgnDescription => 'Kopiraj PNG poglavlja u međuspremnik.';
  ...
  String studyPasteYourPgnTextHereUpToNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Ovdje zalijepite svoj PGN tekst, do $count igre',
    );
    return '$_temp0';
  }
}
