...
class AppLocalizationsNn extends AppLocalizations {
  ...
  String activitySupportedNbMonths(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Stødde lichess.org for $count i månaden som $param2',
    );
    return '$_temp0';
  }
  ...
  String activityPracticedNbPositions(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Har øvd på $count stillingar i emnet $param2',
    );
    return '$_temp0';
  }
  ...
  String activitySolvedNbPuzzles(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Har løyst $count taktikkoppgåve',
    );
    return '$_temp0';
  }
  ...
  String activityPlayedNbGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Har spela $count $param2 parti',
    );
    return '$_temp0';
  }
  ...
  String activityPostedNbMessages(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Har skrive $count innlegg i $param2',
    );
    return '$_temp0';
  }
  ...
  String activityCompletedNbGames(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Har spela $count fjernsjakkparti',
    );
    return '$_temp0';
  }
  ...
  String activityHostedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Har vore vert for $count simultanframsyningar',
    );
    return '$_temp0';
  }
  ...
  String activityJoinedNbSimuls(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Har vore deltakar i $count simultanframsyningar',
    );
    return '$_temp0';
  }
  ...
  String activityCreatedNbStudies(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Har laga $count nye studiar',
    );
    return '$_temp0';
  }
  ...
  String activityCompetedInNbTournaments(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Har deltatt i $count turnering',
    );
    return '$_temp0';
  }
  ...
  String activityRankedInTournament(int count, String param2, String param3, String param4) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Kom på plass #$count (topp $param2%) med $param3 parti i $param4',
    );
    return '$_temp0';
  }
  ...
  String activityCompetedInNbSwissTournaments(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Har vore med i $count sveitserturnering',
    );
    return '$_temp0';
  }
  ...
  @override
  String get recommendNotTouching => 'Vi tilrår å ikkje endre desse.';

  @override
  String get fewerPlayers => 'Om du set opp vilkår for deltaking vil turneringa di få færre deltakarar.';

  @override
  String get showAdvancedSettings => 'Vis avanserte innstillingar';
  ...
  @override
  String get firstName => 'Førenamn';

  @override
  String get lastName => 'Etternamn';
  ...
  @override
  String get boardSize => 'Brettstorleik';
  ...
  String opponentLeftCounter(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Motspelaren din har forlate partiet. Du kan krevje vinst om $count sekund.',
    );
    return '$_temp0';
  }
  ...
  String rankIsUpdatedEveryNbMinutes(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Rangeringa blir oppdatert kvart minutt',
    );
    return '$_temp0';
  }
  ...
  String moreThanNbPerfRatedGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '≥ $count rangert $param2 parti',
    );
    return '$_temp0';
  }
  ...
  String needNbMorePerfGames(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Du må spela $count fleire $param2 rangerte parti',
    );
    return '$_temp0';
  }
  ...
  String nbPerfTypePlayersThisWeek(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: '$count $param2 spelar denne veka.',
    );
    return '$_temp0';
  }
  ...
  String availableInNbLanguages(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Tilgjengeleg på $count språk!',
    );
    return '$_temp0';
  }
  ...
  String andSaveNbPremoveLines(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'og lagra $count line med førehandstrekk',
    );
    return '$_temp0';
  }
  ...
  String puzzleNbPointsBelowYourPuzzleRating(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Eitt poeng under problemløysar-ratinga di',
    );
    return '$_temp0';
  }
  ...
  String puzzleNbPointsAboveYourPuzzleRating(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Eitt poeng over problemløysar-ratinga di',
    );
    return '$_temp0';
  }
  ...
  @override
  String get searchOpponentName => 'Namn på motspelar';

  @override
  String get searchLoser => 'Tapar';

  @override
  String get searchFrom => 'Frå';

  @override
  String get searchTo => 'Til';

  @override
  String get searchHumanOrComputer => 'Om motspelaren var menneske eller maskin';

  @override
  String get searchAiLevel => 'Spelestyrke (AI-nivå)';

  @override
  String get searchSource => 'Kjelde';

  @override
  String get searchNbTurns => 'Antal trekk';

  @override
  String get searchResult => 'Resultat';

  @override
  String get searchWinnerColor => 'Farge på vinnar';
  ...
  @override
  String get searchOnlyAnalysed => 'Berre parti der maskinanalyse er tilgjengeleg';
  ...
  @override
  String get searchMaxNumber => 'Høgste antal';

  @override
  String get searchMaxNumberExplanation => 'Maksimum antal spel som kan koma attende';

  @override
  String get searchInclude => 'Inkluder';

  @override
  String get searchDescending => 'Fallande';

  @override
  String get searchAscending => 'Stigande';

  @override
  String get searchRatingExplanation => 'Gjennomsnittet av ratingtalet til begge spelarane';
  ...
  String searchGamesFound(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other: 'Fann $count parti',
      one: 'Fann $count parti',
      zero: 'Fann $count parti',
    );
    return '$_temp0';
  }
  ...
  @override
  String get streamerLichessStreamer => 'Lichess-strøymar';

  @override
  String get streamerLive => 'DIREKTESENDING!';

  @override
  String get streamerOffline => 'FRÅKOPLA';

  @override
  String streamerCurrentlyStreaming(String param) {
    return 'Sender no: $param';
  }

  @override
  String streamerLastStream(String param) {
    return 'Siste sending $param';
  }

  @override
  String get streamerBecomeStreamer => 'Bli en Lichess-strøymar';

  @override
  String get streamerDoYouHaveStream => 'Har du ein kanal på Twitch eller YouTube?';

  @override
  String get streamerHereWeGo => 'Lat oss starte opp!';

  @override
  String get streamerAllStreamers => 'Alle sendingar';

  @override
  String get streamerEditPage => 'Rediger sendings-sida';

  @override
  String get streamerYourPage => 'Direktesendings-sida di';

  @override
  String get streamerDownloadKit => 'Last ned sendingspakka';

  @override
  String streamerXIsStreaming(String param) {
    return '$param direktesender video';
  }

  @override
  String get streamerRules => 'Regler for videosendingar';

  @override
  String get streamerRule1 => 'Du må sette inn \"lichess.org\" i tittelen på straumen når du sender på Lichess.';

  @override
  String get streamerRule2 => 'Fjern \"lichess. org\" frå tittelen på straumen når du sender stoff som ikkje er frå Lichess.';

  @override
  String get streamerRule3 => 'Lichess oppdagar sendinga di automatisk og gir deg følgande fordelar:';

  @override
  String streamerRule4(String param) {
    return 'Les vår $param for å sikra like tilhøve for alle som deltek på din stream.';
  }

  @override
  String get streamerStreamingFairplayFAQ => 'FAQ for rettvist spel';

  @override
  String get streamerPerks => 'Fordelar ved å inkludere \"lichess. org\" i tittelen på straumen';

  @override
  String get streamerPerk1 => 'Få eit flammande mikrofon-ikon på Lichess-profilen din.';

  @override
  String get streamerPerk2 => 'Bli flytta til toppen av lista over strøymarar.';

  @override
  String get streamerPerk3 => 'Send ei melding til følgarane dine på Lichess.';

  @override
  String get streamerPerk4 => 'Vis straumen din i parti, turneringar og studiar på Lichess.';

  @override
  String get streamerApproved => 'Straumen din er godkjent.';

  @override
  String get streamerPendingReview => 'Strømmen din blir no vurdert av moderatorane.';

  @override
  String get streamerPleaseFillIn => 'Ver venleg og fyll inn informasjon om straumen din og last opp eit bilete.';

  @override
  String streamerWhenReady(String param) {
    return 'Når du er klar til å bli lista som en Lichess-strøymar, $param';
  }

  @override
  String get streamerRequestReview => 'be om ei omdøming frå ein moderator';

  @override
  String get streamerStreamerLanguageSettings => 'Strøymingssida til Lichess rettar seg mot det publikumet med same språket som strøymingsplatformen tilbyr. Oppgje det riktige standardspråket for sjakkstrøymingane dine i appen eller tenesta du brukar for å kringkaste.';

  @override
  String get streamerTwitchUsername => 'Brukarnamnet ditt eller URLen din på Twitch';

  @override
  String get streamerOptionalOrEmpty => 'Valfri. Kan vera tom';

  @override
  String get streamerYouTubeChannelId => 'ID til YouTube-kanalen din';

  @override
  String get streamerStreamerName => 'Strøymarnamn på Lichess';

  @override
  String get streamerVisibility => 'Synleg på videokanal-sida';

  @override
  String get streamerWhenApproved => 'Når stadfesta av moderatorane';

  @override
  String get streamerHeadline => 'Overskrift';

  @override
  String get streamerTellUsAboutTheStream => 'Fortel om videokanalen din i ei setning';

  @override
  String get streamerLongDescription => 'Lang utgreiing';

  @override
  String streamerXStreamerPicture(String param) {
    return '$param profilbilete';
  }

  @override
  String get streamerChangePicture => 'Endre/slette profilbiletet';

  @override
  String get streamerUploadPicture => 'Last opp eit bilete';

  @override
  String streamerMaxSize(String param) {
    return 'Maks storleik: $param';
  }
  ...
  String streamerKeepItShort(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Maksimum $count teikn',
      one: 'Maksimum $count teikn',
      zero: 'Maksimum $count teikn',
    );
    return '$_temp0';
  }
  ...
  String stormPlayedNbRunsOfPuzzleStorm(int count, String param2) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      zero: 'Har spela ein runde med $param2',
    );
    return '$_temp0';
  }
  ...
  @override
  String get studyCopyChapterPgnDescription => 'Kopier kapittel-PGN til utklippstavla.';
