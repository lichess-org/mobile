          ...
          children: [
            ...
            Center(
              child: SecondaryButton(
                semanticsLabel: 'Set custom time control',
                child: const Text('Start'),
                onPressed: () {
                  controller.updateOptions(
                    TimeIncrement(
                      topClockTime * secondsPerMinute,
                      topClockIncrement,
                    ),
                    TimeIncrement(
                      bottomClockTime * secondsPerMinute,
