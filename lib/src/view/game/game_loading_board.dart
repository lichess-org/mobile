...
class _OpenChallengeLoadingContentState extends ConsumerState<OpenChallengeLoadingContent> {
  ...
  @override
  Widget build(BuildContext context) {
    final challengeLink = '$kLichessHost/${widget.challenge.id}';
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: GestureDetector(
                        onTap: () => Clipboard.setData(ClipboardData(text: challengeLink)),
                        child: Text.rich(
                          TextSpan(
                            children: [
                              const WidgetSpan(
                    ...
                    // TODO Display a user selector widget here, to turn it into a direct challenge
                  ],
                ),
              ),
            ),
