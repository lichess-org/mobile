...
class _CreateStudyBottomSheetState extends ConsumerState<CreateStudyBottomSheet> {
  ...
  Widget build(BuildContext context) {
    return BottomSheetScrollableContainer(
      ...
      // its own, so without this the on-screen keyboard covers the submit button
      // button while the study name is being edited.
                ...
                ListTile(
                  ...
                  trailing: Switch(
                    ...
                    onChanged: (bool value) =>
                        setState(() => payload = payload.copyWith(sticky: value)),
                  ),
                ),
              ],
            ),
