...
class AnalysisScreenBody extends ConsumerWidget {
  const AnalysisScreenBody({
    required this.pgn,
    required this.options,
    required this.enableDrawingShapes,
    this.broadcastWrapBoardBuilder,
  });
          ...
          child: SafeArea(
            ...
            child: LayoutBuilder(
              builder: (context, constraints) {
                ...
                Widget maybeWrapBoardBuilder(AnalysisBoard board) {
                  if (broadcastWrapBoardBuilder == null) {
                    return board;
                  } else {
                    return broadcastWrapBoardBuilder!(
                      ref,
                      board,
                      ctrlProvider,
                      boardSize,
                ...
                final maybeWrappedBoard = maybeWrapBoardBuilder(
                  AnalysisBoard(
                    pgn,
                    options,
                    boardSize,
