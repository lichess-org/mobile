...
class AuthWidgetController extends StateNotifier<AsyncValue<void>> {
  AuthWidgetController({required this.authRepository}) : super(const AsyncData<void>(null));

  final AuthRepository authRepository;

  Future<void> signIn() async {
    state = const AsyncLoading();
    state = (await authRepository.signIn().run())
...
final authControllerProvider =
    StateNotifierProvider.autoDispose<AuthWidgetController, AsyncValue<void>>((ref) {
