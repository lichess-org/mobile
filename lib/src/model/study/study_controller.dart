...
@freezed
sealed class StudyState with _$StudyState implements EvaluationMixinState, AbstractAnalysisState {
  const StudyState._();
...
@freezed
sealed class StudyCurrentNode with _$StudyCurrentNode implements AbstractAnalysisCurrentNode {
