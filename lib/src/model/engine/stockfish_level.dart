...
enum StockfishLevel {
  level1(skill: -20, multiPv: 10, searchTime: Duration(milliseconds: 500), threads: 1),
  level2(skill: -10, multiPv: 8, searchTime: Duration(milliseconds: 500), threads: 1),
  level3(skill: -4, multiPv: 7, searchTime: Duration(milliseconds: 610), threads: 1),
  level4(skill: 0, multiPv: 6, searchTime: Duration(milliseconds: 765), threads: 1),
  level5(skill: 4, multiPv: 5, searchTime: Duration(milliseconds: 920), threads: 1),
  level6(skill: 6, multiPv: 4, searchTime: Duration(milliseconds: 1075), threads: 2),
  level7(skill: 8, multiPv: 4, searchTime: Duration(milliseconds: 1225), threads: 2),
  level8(skill: 10, multiPv: 4, searchTime: Duration(milliseconds: 1380), threads: 2),
  level9(skill: 12, multiPv: 4, searchTime: Duration(milliseconds: 1535), threads: 2),
  level10(skill: 14, multiPv: 4, searchTime: Duration(milliseconds: 1690), threads: 2),
  level11(skill: 16, multiPv: 4, searchTime: Duration(milliseconds: 1845), threads: 2),
