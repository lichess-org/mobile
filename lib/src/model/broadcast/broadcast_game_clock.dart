...
@riverpod
class BroadcastClockController extends _$BroadcastRoundController {
  ...
  Future<BroadcastRoundGames> build(BroadcastRoundId broadcastRoundId) async {
    _socketClient = ref
        ...
        .open(BroadcastClockController.broadcastSocketUri(broadcastRoundId));
...
@riverpod
Future<BroadcastGameClockState> roundClocks(
    RoundClocksRef ref, BroadcastRoundId roundId) async {
  final games =
