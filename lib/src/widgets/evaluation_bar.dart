...
class EvaluationBar extends StatelessWidget {
  ...
  const EvaluationBar({super.key, required this.height, required this.whiteWinnigChances});

  const EvaluationBar.loading({super.key, required this.height}) : whiteWinnigChances = 0;
