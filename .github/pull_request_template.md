Please read what follows, then replace it with your pull request message.

# Rules about AI-assisted code contributions

AI-generated code can be accepted under the following conditions:
...
- Include the AI tools you used in the pull-request message.

For more information, see the [AI-assisted code contribution policy](https://github.com/lichess-org/mobile/blob/main/AI_POLICY.md).
