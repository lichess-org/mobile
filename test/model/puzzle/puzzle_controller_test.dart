...
void main() {
  ...
  group('PuzzleController.loadForReview', () {
    test('keeps the puzzle in view mode past the first-move delay', () async {
      final container = await makeContainer();
      ...
      // The opponent's first move is scheduled 1s after a context is loaded for play. A reviewed
      // puzzle must stay in view mode rather than flipping to play mode.
