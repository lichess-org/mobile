...
void main() {
  ...
  group('Engine evaluation', () {
    group('Engine move tree', () {
      ...
      testWidgets(
        'computer variations are displayed in the move tree when computer analysis is enabled',
        (tester) async {
      ...
      testWidgets(
        'computer variations are not displayed in the move tree when computer analysis is disabled',
        (tester) async {
    ...
    group('Engine gauge', () {
      ...
      testWidgets(
        'engine gauge is displayed on an analysed game, even if engine eval is disabled',
        (tester) async {
    ...
    group('Engine best move arrow', () {
      testWidgets('best move arrow is not displayed if best move arrow is disabled', (
        tester,
      ) async {
