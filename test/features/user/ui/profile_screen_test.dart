...
void main() {
  ...
  setUpAll(() {
    reset(mockClient);
    when(() => mockClient.get(
            Uri.parse('$kLichessHost/api/games/user/$testUserName?max=10')))
